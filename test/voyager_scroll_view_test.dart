...
void main() {
  testWidgets('overscroll survives a relayout under a hovering cursor', (
    tester,
  ) async {
    ...
    final fieldControllers = List.generate(
      6,
      (i) => TextEditingController(text: 'field $i'),
    );
    addTearDown(() {
    ...
    for (var i = 0; i < 30; i++) {
      ...
      expect(
        ...
        reason:
            'overscroll snapped back from $previous to $offset on frame '
          ...
          body: Column(
            children: [
              VoyagerScrollView(
                ...
                child: Row(children: [SizedBox(height: 42, width: 2000)]),
              ),
            ],
          ),
        ),
