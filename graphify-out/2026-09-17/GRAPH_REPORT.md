# Graph Report - Voyager  (2026-09-17)

## Corpus Check
- 1046 files · ~1,468,141 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 26207 nodes · 41488 edges · 687 communities (622 shown, 65 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 297 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `85884c1c`
...
8. `remoteSyncServiceProvider` - 64 edges
...
Cohesion: 0.00
Nodes (1148): BoolColumn get, _, _accentColorMeta, actualTableName, _addedAtMeta, _alertOnPeriodicPromptsMeta, _alertTimeHourMeta, _algorithmMeta (+1140 more)
...
Cohesion: 0.01
Nodes (329): addCustomWord, _applicationCompanion, applyJobExperienceSnippetEdit, applySnippetEdit, _categoryCompanion, _childCompanion, _companyCompanion, countCardsReviewedToday (+321 more)

### Community 3 - "Calendar Feature — calendar_page"
Cohesion: 0.01
Nodes (269): AnimationStatusListener?, _, CalendarEvent?, _abortMorphAnimation, accentColor, adjacentColor, _advanceWarmup, _appliedSavedCalendarView (+261 more)
...
Cohesion: 0.01
Nodes (256): CharacterOpRegistry, CharacterOpRegistry get, CharacterSequenceCrdtMerger, CrdtDocumentResolver, _activeDebouncers, _activelyEditedDocuments, addPendingTextMergeListener, _adoptLegacySnippets (+248 more)
...
Cohesion: 0.01
Nodes (174): JournalDebugLogger?, JournalWriteCoordinator?, accent, accentColor, allEntriesCount, _appliedSavedPreferences, _applySavedPreferencesIfReady, _attachedEntryId (+166 more)

### Community 10 - "Firebase Auth (windows) — messages.g.cpp"
Cohesion: 0.02
Nodes (237): GenerateInterfaces, string_view, AuthPigeonFirebaseApp::AuthPigeonFirebaseApp(), custom_auth_domain, tenant_id, ToEncodableList, EncodableList, EncodableMap (+229 more)

### Community 11 - "Finance Feature — finance_transaction_modal"
Cohesion: 0.06
Nodes (31): EditableTextState, package:voyager/core/media/widgets/media_paste_scope.dart, package:voyager/core/text/list_text_editing.dart, field, main, pump, _pumpBody, pumpJournalPage (+23 more)
...
Cohesion: 0.01
Nodes (171): GeometricWaveShape, accentColor, alertOnPeriodicPrompts, alertTimeHour, autocorrectEnabled, birthDate, birthYear, calendarNavigateLeftKey (+163 more)

### Community 14 - "Test Suite — study_card_editor_images_tes"
Cohesion: 0.01
Nodes (258): @DriftDatabase, dart:io, dart:typed_data, Directory, FirebaseStorage, MediaService, _attempts, _downloadDraining (+250 more)

### Community 15 - "Sync Engine — firestore_document_mapper"
Cohesion: 0.01
Nodes (200): applicationUrl, assetRoomEventToFirestore, assetToFirestore, assetValuationToFirestore, body, bucketListItemToFirestore, budgetToFirestore, calendarEventToFirestore (+192 more)
...
Cohesion: 0.01
Nodes (191): AuthNotifier, AutocorrectScopeData, CacheStatusSnapshot, ChangeNotifierProvider, ConnectivityStatusController, DataExportService, DevSettingsController, DreamWriteCoordinator (+183 more)
...
Cohesion: 0.08
Nodes (28): paperShaderProvider, _BackSolution, _backTitleKey, build, _CardBack, _CardFront, _cardRadius, controller (+20 more)
...
Cohesion: 0.02
Nodes (103): _applyPendingNotesMerge, _beginEditingSession, _buildFields, _buildSubtaskList, _clearDueDate, _close, color, _container (+95 more)

### Community 28 - "Study Feature — ConsumerState"
Cohesion: 0.03
Nodes (65): _accentColor, _activeQuery, _baseline, body, _bodyController, _bodyFocusNode, _changeEntryDateAndTime, _coordinator (+57 more)
...
Cohesion: 0.02
Nodes (103): BreakdownSlice, budgetsProvider, CashFlowGranularity, ContextMenuRegionState, FinanceBreakdownChart, FinanceBreakdownMode, financeCategoriesProvider, financeUiPrefsProvider (+95 more)

### Community 31 - "Firebase Auth (windows) — messages.g.cpp"
Cohesion: 0.03
Nodes (89): InternalActionCodeInfoData, InternalAuthCredentialInput, K, InternalActionCodeInfo, InternalActionCodeSettings, InternalAdditionalUserInfo, InternalAuthCredential, InternalIdTokenResult (+81 more)

### Community 32 - "Test Suite — jobs_track_flow_test"
Cohesion: 0.01
Nodes (212): CalendarRepository, DateTime? stamp,
  int, _Device, DreamRepository, DriftJournalRepository, fakes/fake_weather_api_client.dart, FirestorePullService, RemoteSyncService (+204 more)

### Community 33 - "Journal Feature — journal_list_actions"
Cohesion: 0.02
Nodes (101): AnimatedContainer, DateTime? deletedAt,
  int, JournalRepository, MoodGradientSlider, DriftJournalRepository, searchEntries, SearchService, package:drift/drift.dart (+93 more)
...
Cohesion: 0.02
Nodes (102): DreamEntry?, accentColor, _appliedSavedWidth, _bodyEditorKey, _bodyEntryId, _bodyFocusNode, bodyPreview, bodyTextFor (+94 more)

### Community 37 - "Firebase Auth (windows) — messages.g.cpp"
Cohesion: 0.03
Nodes (56): FlutterDesktopMessage, TextureVariant, FlutterDesktopPluginRegistrarRef, FirebaseAuthPluginCApiRegisterWithRegistrar(), ErrorOr, v_, FlutterError, code_ (+48 more)
...
Cohesion: 0.03
Nodes (82): studyDecksProvider, studyFoldersProvider, studyStatsProvider, build, createState, excludeFolderIds, _moveHere, _moving (+74 more)
...
Cohesion: 0.02
Nodes (95): AuthRepository, BackupFormatException, class MockDocumentReference extends, ../test/fakes/fake_weather_api_client.dart, addCustomWord, authStateChanges, batch, batchCreatedCount (+87 more)
...
Cohesion: 0.03
Nodes (61): package:flutter/gestures.dart, package:voyager/features/todo/todo_edit_panel.dart, package:voyager/features/todo/todo_list_search_bar.dart, deleteTaskFromRow, gesture, main, pumpAndSettle, tap (+53 more)

### Community 49 - "Test Suite — package:flutter/services"
Cohesion: 0.04
Nodes (48): build, DevPerfStallLogSection, _logDialogOpen, _showLogDialog, _apply, build, createState, emptyLabel (+40 more)
...
Cohesion: 0.03
Nodes (81): StudyCard, _AddImageButton, _AddImageButtonState, autofocus, _back, _busy, _cardId, _CardSide (+73 more)
...
Cohesion: 0.09
Nodes (35): rankingCategoriesProvider, rankingChildrenByParentProvider, rankingParentCountsProvider, rankingParentsProvider, RankingFilters, build, _pickView, build (+27 more)
...
Cohesion: 0.03
Nodes (73): jobsTrackDraftStoreProvider, applications, _applyFromClipboard, _baseline, child, _clearClipboardFill, _ClipboardBanner, _clipboardTitle (+65 more)
...
Cohesion: 0.02
Nodes (127): File, GlassButton, DriftSettingsRepository, ListView, package:drift/native.dart, package:voyager/core/snippets/snippet_settings_launcher.dart, package:voyager/core/sync/firestore_document_mapper.dart, package:voyager/core/tags/tag_palette.dart (+119 more)
...
Cohesion: 0.02
Nodes (103): FocusNode, loadDictionaryFromAssets, raw, buildTextSpan, dispose, _emphasis, focusNode, _forward (+95 more)

### Community 74 - "Rankings Feature — rankings_edit_panel"
Cohesion: 0.01
Nodes (167): ByteData, Finder get, Image, _Await, TrackerRepository, package:flutter_riverpod/flutter_riverpod.dart, package:voyager/app/providers.dart, package:voyager/core/theme/voyager_theme.dart (+159 more)

### Community 75 - "Test Suite — dart:ui"
Cohesion: 0.02
Nodes (80): paletteColor, resolvePaletteColor, srsMasteryColor, copyWith, fieldHintStyle, theme, appSettingsWithGeometricTextureParams, appSettingsWithGeometricWaveParams (+72 more)

### Community 76 - "Workout Feature — exercise_detail_view"
Cohesion: 0.03
Nodes (86): calendarsProvider, exerciseSetLogsProvider, DriftWorkoutRepository, _resetEventColor, _save, anchorRect, anchorRectFor, box (+78 more)
...
Cohesion: 0.03
Nodes (76): studyFolderByIdProvider, accent, build, color, count, items, label, maxWidth (+68 more)
...
Cohesion: 0.05
Nodes (58): journalAllEntryIdsProvider, journalDebugLoggerProvider, journalEntryCacheInvalidatorProvider, journalEntryCountsProvider, journalListEntriesProvider, journalRepositoryProvider, journalsProvider, journalWriteCoordinatorProvider (+50 more)
...
Cohesion: 0.03
Nodes (70): financeRepositoryProvider, subscriptionsProvider, Subscription, BillRadarPanel, build, _delete, _dueColor, _dueLabel (+62 more)

### Community 86 - "Todo Feature — todo_list_actions"
Cohesion: 0.03
Nodes (88): colorPaletteProvider, todoListsProvider, todoRepositoryProvider, build, _changeEventColor, _add, pickAccentColor, allLists (+80 more)

### Community 87 - "Study Feature — ConsumerState"
Cohesion: 0.03
Nodes (84): leetCodeRepositoryProvider, remoteSyncServiceProvider, studyRepositoryProvider, _save, _LeetCodeSessionPageState, _save, card, cards (+76 more)
...
Cohesion: 0.01
Nodes (163): AppDatabase, DriftFinanceRepository, FinanceRepository, DriftFinanceRepository, deleteBudgetWithUndo, deleteSubscriptionWithUndo, softDeleteWithUndo, MemoryFinanceUiPrefsStore? prefsStore,
  bool (+155 more)

### Community 90 - "Test Suite — scroll_offset_isolate_test"
Cohesion: 0.04
Nodes (50): AutocorrectFlashLayer, package:voyager/core/snippets/snippet_enabled_scope.dart, package:voyager/core/snippets/snippet_index.dart, package:voyager/core/snippets/snippet_session.dart, package:voyager/core/spellcheck/autocorrect_enabled_scope.dart, package:voyager/core/widgets/autocorrect_flash_layer.dart, package:voyager/domain/models/snippet.dart, backspace (+42 more)

### Community 91 - "Shared Widgets — _State"
Cohesion: 0.03
Nodes (61): MessageHandler, WindowProcDelegate, BinaryMessengerImpl, handlers_, messenger_, Send, SetMessageHandler, BinaryMessageHandler (+53 more)
...
Cohesion: 0.04
Nodes (89): ConsumerState, ConsumerStatefulWidget, allDreamEntriesProvider, dreamRepositoryProvider, dreamWriteCoordinatorProvider, jobApplicationsProvider, jobCategoriesProvider, jobCompaniesProvider (+81 more)
...
Cohesion: 0.03
Nodes (79): _addMonths, allocatedAt, amountCents, amountOverMaxError, anchorDueDate, annualCents, annualCentsFor, asOf (+71 more)

### Community 100 - "Firebase Auth (android) — FlutterFirebaseAuthPlugin"
Cohesion: 0.04
Nodes (54): financeRepositoryProvider, _save, _detach, _delete, _save, build, _canSave, _CategoryModal (+46 more)
...
Cohesion: 0.03
Nodes (51): GeneratedPluginRegistrant, Keep, FlutterDesktopViewControllerRef, FlutterDesktopViewRef, nanoseconds, FlutterDesktopEngineRef, FlutterDesktopPluginRegistrarRef, function (+43 more)
...
Cohesion: 0.02
Nodes (103): sessionShuffleRandomProvider, studyAllCardsProvider, studyAllDecksProvider, studyCardImagesProvider, _syncProblems, _syncQueue, build, _applyDecision (+95 more)
...
Cohesion: 0.01
Nodes (141): Completer, EditableText, http.BaseClient, context, focus, isTextInputFocused, subtreeIsVisible, LeetCodeRepository (+133 more)
...
Cohesion: 0.05
Nodes (42): ChangeNotifier, FirestoreWriteGate, appendOperation, appendOperationGroup, appendOperationsBatch, claimCalendarLock, claimWeatherFetchLock, _collection (+34 more)

### Community 125 - "Shared Widgets — tag_suggestion_overlay"
Cohesion: 0.04
Nodes (53): FocusOnKeyEventCallback?, tagColorsProvider, tagPoolProvider, accentColor, _accept, build, _caretGap, child (+45 more)
...
Cohesion: 0.02
Nodes (122): FocusNode get, InputCounterWidgetBuilder?, accentColor, alignLabelToTop, allowShortHeight, autocorrectAllowed, autofocus, borderRadius (+114 more)
...
Cohesion: 0.06
Nodes (32): 10. Component sketch (implementation guide), 11. Risks & constraints, 12. Acceptance checklist, 13. Follow-ups (explicitly later), 1. Goals, 2. Product decisions (locked), 3. Problem (current state), 4.1 Process & tray (+24 more)
...
Cohesion: 0.04
Nodes (47): _, authRepositoryProvider, build, createState, dispose, _emailController, _error, _formatAuthError (+39 more)
...
Cohesion: 0.04
Nodes (55): Archive, MediaRepository, SettingsRepository, archive, backupFormatVersion, backupManifestFileName, backupMediaDirectory, buildArchiveContents (+47 more)
...
Cohesion: 0.04
Nodes (56): formatTime12Hour, formatTimeOfDay12Hour, jm, local, now, _closingAfterSave, _completed, createState (+48 more)
...
Cohesion: 0.04
Nodes (74): AutomaticKeepAliveClientMixin, ChildIndexGetter?, EdgeInsetsGeometry, IndexedWidgetBuilder, _VimFieldOverlay, _VimFieldOverlayState, VimTextScope, _VimTextScopeState (+66 more)

### Community 157 - "Firebase Auth (windows) — firebase_auth_plugin.cpp"
Cohesion: 0.08
Nodes (26): BillingPeriod, _amountController, _amountFocusNode, build, _canSave, _colorValue, container, createState (+18 more)
...
Cohesion: 0.05
Nodes (46): AppSettings, AppThemeMode, colorPaletteProvider, _changeEventColor, _addMinorPetalColor, _controller, createState, dispose (+38 more)
...
Nodes (79): Color? highlightColor,
  List, color, createRenderObject, paint, _paintFill, _paragraphOf, updateRenderObject, applyStyledRanges (+71 more)
...
Cohesion: 0.03
Nodes (66): JobApplication, RankingStatus, application, build, _cell, color, _colorColumnWidth, _columnFlex (+58 more)
...
Cohesion: 0.09
Nodes (22): double? contentWidth,
  bool, build, child, EnterToSubmitScope, onSubmit, _textFieldHasFocus, build, contentWidth (+14 more)
...
Cohesion: 0.02
Nodes (98): Icon, IconButton, byId, refreshed, RepeatIconButton, OverlayState, package:voyager/core/media/widgets/media_gallery_strip.dart, package:voyager/core/widgets/repeat_selector_popover.dart (+90 more)
...
Cohesion: 0.03
Nodes (77): Exception, InMemorySyncRepository, defaultColorPalette, id, OutOfSyncJournalEntryPurge, OutOfSyncJournalEntryTarget, purgeAll, purgeOne (+69 more)
...
Cohesion: 0.05
Nodes (50): autocorrectScopeProvider, devGeometricTexturePanelOpenProvider, devLeafGalleryPanelOpenProvider, geometricDebugRowFadeProvider, geometricShaderProvider, geometricTextureParamsProvider, petalFieldParamsProvider, snippetScopeProvider (+42 more)
...
Cohesion: 0.04
Nodes (55): clearLog, _enqueue, log, _logFileName, logFilePath, _maxLogBytes, readLog, SyncCompareLogger (+47 more)
...
Cohesion: 0.05
Nodes (39): _canvasController, createState, dispose, geometry, getClip, _globalCenterFor, _grassColor, _groundedLeavesFor (+31 more)
...
Cohesion: 0.03
Nodes (62): LeetCodeCramPage, LeetCodeScratchPad, LeetCodeSessionPage, package:voyager/features/leetcode/leetcode_cram_page.dart, package:voyager/features/leetcode/leetcode_session_page.dart, required String title,
  List, _button, enterText (+54 more)

### Community 236 - "Shell Feature — weather_chart_plot_cache"
Cohesion: 0.03
Nodes (77): anchor, _BreakdownRow, build, child, count, counts, date, difficulty (+69 more)
...
Cohesion: 0.02
Nodes (87): abortIfAlreadyRestored, floor, RestoreSuperseded, restoreVersionFrom, toString, DriftRankingRepository, assets, captions (+79 more)
...
Cohesion: 0.04
Nodes (45): BaseSliderTrackShape, int?, accent, build, fillColor, getPreferredRect, getPreferredSize, gradient (+37 more)
...
Cohesion: 0.05
Nodes (43): activeWorkoutPlanProvider, exercisesProvider, _activeLabel, _ActivePlanButton, build, createState, _CycleAnchorControl, _CycleLengthControl (+35 more)
...
Cohesion: 0.21
Nodes (13): authRepositoryProvider, customWordsProvider, flaggedWordsProvider, geometricTextureParamsProvider, geometricWaveParamsProvider, build, _DictionaryTile, _GeometricSettings (+5 more)
...
Cohesion: 0.02
Nodes (126): AutocorrectSession, _bleed, build, _buildPath, _cachedPath, _cachedSize, _clear, color (+118 more)

### Community 284 - "Shared Widgets — _State"
Cohesion: 0.03
Nodes (70): AppLifecycleListener?, dispose, _handleLifecycleState, initState, _isVisible, _lifecycle, _lifecycleVisible, _minimized (+62 more)

### Community 285 - "Shared Widgets — date_selector_popover"
Cohesion: 0.05
Nodes (36): FirebaseException, classifySyncFailure, describeSyncFailure, _permanentFirestoreCodes, SyncFailureKind, toString, android, DefaultFirebaseOptions (+28 more)
...
Cohesion: 0.05
Nodes (38): addExerciseToDay, clearExercisePrescription, createExercise, currentExercise, deleted, deletePlanEntry, exercise, ExerciseDeletion (+30 more)
...
Cohesion: 0.06
Nodes (31): class, build, canManage, createState, _error, initialTrigger, messenger, openSettings (+23 more)
...
Cohesion: 0.05
Nodes (52): allTodoTasksProvider, calendarRepositoryProvider, calendarsProvider, calendarViewEventsProvider, todoListStatsProvider, todoTasksProvider, allCalendars, assigner (+44 more)
...
Cohesion: 0.02
Nodes (86): AutocorrectEnabledScope, AutocorrectScopeData, data, disabled, enabled, hashCode, of, operator (+78 more)
...
Cohesion: 0.03
Nodes (57): FirebaseAuthMultiFactorException, dart:math, FirebaseAuthException, nextQuote, QuoteBank, _quotes, _random, _used (+49 more)
...
Cohesion: 0.05
Nodes (37): build, CompactBackBar, label, onBack, _BudgetModal, _BudgetModalState, build, _canSave (+29 more)
...
Cohesion: 0.09
Nodes (31): AssetRoomEvent, assetRoomEventsProvider, assetsProvider, assetValuationsProvider, contributionRoomsProvider, _NetWorthCard, build, _RoomSection (+23 more)
...
Nodes (17): DateTime? asOf,
  List, _barCents, build, color, ContributionRoomBar, endsWith, summary, text (+9 more)
...
Cohesion: 0.03
Nodes (70): studyCardsProvider, studyDeckByIdProvider, studyDeckGraphProvider, studyDeckStatsProvider, StudyDeckLink, build, _cramSession, createState (+62 more)

### Community 361 - "Calendar Feature — calendar_keyboard_shortcuts"
Cohesion: 0.10
Nodes (20): build, CalendarKeyboardShortcuts, _CalendarKeyboardShortcutsState, calendarNavShortcutsEnabled, child, createState, dispose, _handleKeyEvent (+12 more)
...
Cohesion: 0.09
Nodes (24): notificationBadgeStateProvider, accent, _anchorKey, _bellHeight, _bellWidth, build, _controller, createState (+16 more)
...
Cohesion: 0.14
Nodes (14): Budget, financeLedgerTagFilterProvider, budget, _BudgetRow, color, _delete, _EmptyBudgets, pace (+6 more)
...
Cohesion: 0.05
Nodes (42): AsyncNotifier, SettingsNotifier, AppSettings, package:voyager/core/widgets/tag_chip.dart, package:voyager/features/leetcode/leetcode_providers.dart, static AppSettings?, _ThemedSettings, build (+34 more)
...
Cohesion: 0.05
Nodes (39): BoxFit, double?, mediaTransferWorkerProvider, asset, borderRadius, build, byHeight, _bytes (+31 more)
...
Cohesion: 0.06
Nodes (50): authNotifierProvider, backgroundSyncOrchestratorProvider, connectivityStatusProvider, databaseProvider, deviceIdProvider, firestoreWriteGateProvider, HotkeyService, lazyLoadProvider (+42 more)

### Community 412 - "Demo Feature"
Cohesion: 0.03
Nodes (62): GoRouter, Key? get, auth, _preloadedShellPaths, routerProvider, settingsRepo, package:go_router/go_router.dart, package:voyager/core/sync/connectivity_status.dart (+54 more)
...
### Community 415 - "Auth"
Cohesion: 0.03
Nodes (77): mediaServiceProvider, mediaStorageProvider, mediaStorageUsageProvider, accent, accentColor, asset, build, collection (+69 more)
...
Cohesion: 0.03
Nodes (70): package:voyager/core/constants/calendar_constants.dart, package:voyager/features/calendar/calendar_manage_sheet.dart, package:voyager/features/calendar/calendar_page.dart, package:voyager/features/shell/reveal_request.dart, calendars, container, db, main (+62 more)
...
Cohesion: 0.02
Nodes (81): BackdropFilter, BuildContext, ColoredBox, WindowSizeClassX, _attachedToastDwell, attachImagesForOwner, count, facet (+73 more)
...
Cohesion: 0.09
Nodes (21): GlobalKey, GlobalKey get, _CapsLockCaretPainter, VimAnchoredChrome, attach, ClampToTargetBounds, createRenderObject, detach (+13 more)
...
Cohesion: 0.05
Nodes (38): DateTimeRange, goalAllocationsProvider, _AllocateModal, _AllocateModalState, _amountController, build, _canSave, container (+30 more)
...
Cohesion: 0.08
Nodes (25): IconData? get, Iterable, buildCatalogMenu, calendarManageMenuEntries, configurableManageMenuEntries, defaultCalendarManageMenuEntries, defaultCatalogMenuChild, defaultConfigurableManageMenuEntries (+17 more)

### Community 471 - "Firebase Auth (android) — FlutterFirebaseAuthRegistrar"
Cohesion: 0.22
Nodes (10): cachedCurrentWeatherProvider, connectivityStatusProvider, currentWeatherProvider, build, _ConnectivityIndicator, _WeatherButton, _WeatherButtonState, build (+2 more)
...
Cohesion: 0.25
Nodes (11): financeCategoriesProvider, transactionsProvider, build, _NetFlowDetailCard, _NetFlowDetailCardState, build, FinancePage, _FinanceView (+3 more)
...
Cohesion: 0.25
Nodes (9): AuthPigeonFirebaseApp, app_name_, FromEncodableList, Hash, operator==, set_app_name, set_custom_auth_domain, set_tenant_id (+1 more)

### Community 532 - "Journal Feature — journal_page"
Cohesion: 0.15
Nodes (14): todoSortDebugLoggerProvider, build, DevTodoSortDebugSection, _logDialogOpen, _showLogDialog, _addTask, _applyOptimisticActiveOrder, _clearTaskDueDate (+6 more)
...
Cohesion: 0.32
Nodes (7): build, LeetCodePage, _LeetCodeViewMode, _leetCodeViewModeProvider, package:voyager/features/leetcode/leetcode_actions.dart, package:voyager/features/leetcode/leetcode_dashboard.dart, package:voyager/features/leetcode/leetcode_review_deck.dart

### Community 539 - "firebase_auth_repository.dart"
Cohesion: 0.08
Nodes (25): _auth, _authErrorMessage, authStateChanges, _controller, currentUserId, dispose, fallback, FirebaseAuthRepository (+17 more)

### Community 540 - "Calendar Feature — calendar_page"
Cohesion: 0.05
Nodes (37): Brightness?, Color, build, color, ColorCornerFlag, colorValue, _CornerFlagPainter, JournalBookmarkFlag (+29 more)

### Community 541 - "Calendar Feature — calendar_page"
Cohesion: 0.25
Nodes (7): package:voyager/features/leetcode/leetcode_scratch_draft.dart, package:voyager/features/leetcode/leetcode_scratch_draft_store.dart, dir, file, main, _session, store

### Community 543 - "newline_normalization_test.dart"
Cohesion: 0.08
Nodes (37): ConsumerWidget, allJournalEntriesProvider, analyticsServiceProvider, periodicPromptServiceProvider, trackerCacheInvalidatorProvider, trackersProvider, trackerValuesProvider, workoutDaysProvider (+29 more)
...
Cohesion: 0.03
Nodes (72): build, _CalendarManageDialog, _CalendarManageDialogState, _calendars, _counts, _createCalendar, _createdCalendarId, createdId (+64 more)
...
Cohesion: 0.06
Nodes (31): _accept, active, allEntries, build, createState, dayIndex, _edit, _editCustom (+23 more)
...
### Community 591 - "Timer?"
Cohesion: 0.04
Nodes (52): class ConnectivityStatusController extends, Duration, _Repaint, CapsLockState, DevSettingsController, FpsMonitorController, JournalDebugLogger, PerfStallLogger (+44 more)
...
Cohesion: 0.10
Nodes (20): CalendarEvent, day, event, RevealRequest, revealRequestProvider, RevealTargetType, task, type (+12 more)
...
Cohesion: 0.03
Nodes (55): JobRepository, DriftJobRepository, package:voyager/core/constants/job_constants.dart, package:voyager/domain/models/job_models.dart, package:voyager/features/jobs/job_clipboard_parser.dart, package:voyager/features/jobs/jobs_actions.dart, package:voyager/features/jobs/jobs_stage_colors.dart, String? applicationUrl,
  List (+47 more)
...
Cohesion: 0.11
Nodes (17): double get, _RenderCapsLockCaret, RenderVimAnchoredChrome, RenderClampToTargetBounds, _RenderTapThroughBarrier, RenderProseHighlightUnderlay, applyPaintTransform, attach (+9 more)
...
Cohesion: 0.03
Nodes (65): Alignment, bool? enableDrag,
  BorderRadius, BorderRadius, autofocus, build, child, CtrlEnterToSubmitScope, isSubmitChord (+57 more)
...
Cohesion: 0.03
Nodes (63): DriftTodoRepository, DriftTrackerRepository, package:voyager/core/constants/journal_constants.dart, package:voyager/core/constants/todo_sort_constants.dart, package:voyager/domain/models/todo_models.dart, package:voyager/domain/todo/todo_recurring_completion.dart, required int done,
...
## Knowledge Gaps
- **19451 isolated node(s):** `Out of scope`, `Interpretation note (journal)`, `3. Problem (current state)`, `4.1 Process & tray`, `4.2 Focus router` (+19446 more)
...
- **Why does `InternalActionCodeInfo` connect `Firebase Auth (macos) — firebase_auth_messages.g` to `Firebase Auth (macos) — CustomPigeonHeader`, `Firebase Auth (android) — NonNull`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `ActionCodeInfoOperationBox` connect `Firebase Auth (macos) — firebase_auth_messages.g` to `Firebase Auth (macos) — CustomPigeonHeader`, `Firebase Auth (android) — NonNull`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **What connects `Out of scope`, `Interpretation note (journal)`, `3. Problem (current state)` to the rest of the system?**
  _19452 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Drift Database Schema — app_database` be split into smaller, more focused modules?**
  _Cohesion score 0.0017406440382941688 - nodes in this community are weakly interconnected._
