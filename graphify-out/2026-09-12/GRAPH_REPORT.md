...
## Corpus Check
- 977 files · ~1,342,935 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 24349 nodes · 38663 edges · 640 communities (583 shown, 57 thin omitted)
...
1. `_State` - 126 edges
2. `remoteSyncServiceProvider` - 91 edges
...
## Communities (640 total, 57 thin omitted)

### Community 0 - "Drift Database Schema — app_database"
Cohesion: 0.00
Nodes (1068): BoolColumn get, _, _accentColorMeta, actualTableName, _addedAtMeta, _alertOnPeriodicPromptsMeta, _alertTimeHourMeta, _algorithmMeta (+1060 more)
...
Cohesion: 0.01
Nodes (297): addCustomWord, _applicationCompanion, _categoryCompanion, _childCompanion, _companyCompanion, countCardsReviewedToday, countCardsReviewedTotal, countDueCards (+289 more)
...
Cohesion: 0.01
Nodes (223): CharacterOpRegistry get, _activeDebouncers, _activelyEditedDocuments, addPendingTextMergeListener, applyPendingDreamEntryTextMerge, applyPendingJournalEntryTextMerge, applyPendingTodoTaskNotesMerge, at (+215 more)

### Community 8 - "Todo Feature — todo_page"
Cohesion: 0.01
Nodes (212): AsyncValue, accent, accentColor, activeCount, _activeInList, _activeMatchKey, _activeSectionHeight, _addingTask (+204 more)

### Community 9 - "Journal Feature — journal_page"
Cohesion: 0.01
Nodes (172): accent, accentColor, allEntriesCount, _appliedSavedPreferences, _applySavedPreferencesIfReady, _attachedEntryId, _bodyFocusNode, bodyPreview (+164 more)

### Community 10 - "Firebase Auth (windows) — messages.g.cpp"
Cohesion: 0.02
Nodes (201): GenerateInterfaces, string_view, AuthPigeonFirebaseApp, app_name_, AuthPigeonFirebaseApp::AuthPigeonFirebaseApp(), custom_auth_domain, Hash, set_app_name (+193 more)

### Community 11 - "Finance Feature — finance_transaction_modal"
Cohesion: 0.04
Nodes (51): amountCents, _amountController, container, createState, _date, _datePopoverOpen, dispose, draft (+43 more)
...
Cohesion: 0.02
Nodes (106): dart:io, Directory, MediaFileStore, package:image/image.dart, package:voyager/core/media/media_service.dart, package:voyager/core/media/widgets/media_drop_target.dart, package:voyager/core/media/widgets/media_fan_stack.dart, package:voyager/core/media/widgets/media_image.dart (+98 more)
...
Cohesion: 0.01
Nodes (136): ChangeNotifierProvider, activeWorkoutSessionProvider, all, allJournalEntriesScope, assetsProvider, backupCollectionsProvider, bills, brightness (+128 more)
...
Cohesion: 0.06
Nodes (5): get, NonNull, Builder, CanIgnoreReturnValue, InternalSignInProvider
...
Cohesion: 0.04
Nodes (73): rankingCategoriesProvider, rankingChildrenByParentProvider, rankingParentsProvider, RankingFilters, build, _CategoryMenu, build, _createCategory (+65 more)

### Community 25 - "Jobs Feature — StatelessWidget"
Cohesion: 0.02
Nodes (103): _AnalyticsToolbar, _EmptyTrackersCard, _GridView, _HeatmapGroupDivider, _HeatmapMonthTile, _MacroStatsRow, _SectionLabel, _StatChip (+95 more)
...
Cohesion: 0.04
Nodes (60): , studyDeckGraphProvider, studyDecksProvider, studyFoldersProvider, _cramSession, createState, deckId, deckNameHint (+52 more)
...
Cohesion: 0.04
Nodes (40): FlutterDesktopMessage, TextureVariant, ErrorOr, v_, FlutterError, code_, details_, message_ (+32 more)
...
Cohesion: 0.06
Nodes (37): mediaDiskLowProvider, mediaServiceProvider, mediaStorageProvider, mediaStorageUsageProvider, build, _reload, build, _reload (+29 more)
...
Cohesion: 0.02
Nodes (104): class MockDocumentReference extends, DocumentReference, FirebaseFirestore, package:fake_cloud_firestore/fake_cloud_firestore.dart, package:voyager/core/sync/outbox_sync_worker.dart, package:voyager/data/remote/firestore_sync_repository.dart, ../test/fakes/fake_weather_api_client.dart, addCustomWord (+96 more)
...
Cohesion: 0.01
Nodes (170): dart:convert, DateTime? stamp,
  int, DreamRepository, FirebaseException, JournalRepository, CrdtDocumentResolver, _merger, _mergeSyncOperations (+162 more)
...
Cohesion: 0.01
Nodes (206): id, OutOfSyncJournalEntryPurge, OutOfSyncJournalEntryTarget, purgeAll, purgeOne, searchHint, targets, title (+198 more)
...
Cohesion: 0.02
Nodes (89): Finder get, contains, embedded, firebaseAuthErrorMessage, invalidCredentialHints, _isGenericInternalMessage, lower, _messageFromEmbeddedDetails (+81 more)
...
Cohesion: 0.04
Nodes (61): studyStatsProvider, borderColor, build, child, _closeDeck, _closeGeneration, _closing, _create (+53 more)

### Community 55 - "Ephemeral — string"
Cohesion: 0.04
Nodes (50): FlutterDesktopViewRef, _set, WindowProcDelegate, function, TextureRegistrarImpl::UnregisterTexture(), FlutterView, view_, HWND (+42 more)
...
Cohesion: 0.06
Nodes (44): authNotifierProvider, backgroundSyncOrchestratorProvider, connectivityStatusProvider, databaseProvider, deviceIdProvider, lazyLoadProvider, liveSyncProvider, quotesLoadedProvider (+36 more)
...
Cohesion: 0.04
Nodes (8): GeneratedAndroidFirebaseAuth, InternalAuthCredential, InternalAuthCredentialInput, InternalMultiFactorSession, InternalPhoneMultiFactorAssertion, InternalUserProfile, Override, SuppressWarnings
...
Cohesion: 0.04
Nodes (83): colorPaletteProvider, remoteSyncServiceProvider, studyRepositoryProvider, todoListsProvider, todoRepositoryProvider, build, _changeEventColor, _add (+75 more)
...
Cohesion: 0.03
Nodes (61): WorkoutRepository, anchorRect, anchorRectFor, box, _ChartPlaceholder, _close, _controller, createState (+53 more)
...
Cohesion: 0.02
Nodes (137): EditableTextState, FocusNode?, isAndroid, isLinux, isWindows, VoyagerPlatform, loadDictionaryFromAssets, raw (+129 more)
...
Cohesion: 0.05
Nodes (40): FocusNode get, GlobalKey, GlobalKey get, attach, createRenderObject, detach, _handleScroll, _hasAttemptedScrollLookup (+32 more)
...
Cohesion: 0.04
Nodes (56): anchorRect, build, _close, _closing, _comparing, controller, _copy, createState (+48 more)

### Community 84 - "Caps Lock — caps_lock_caret_indicator"
Cohesion: 0.03
Nodes (60): CurvedAnimation, accentColor, allowed, attach, _blockCaret, build, capsLockBadgeVisible, capsLockMarkInk (+52 more)

### Community 85 - "Journal Feature — journal_list_actions"
Cohesion: 0.04
Nodes (45): build, color, counts, JobsSparkline, anchor, _BreakdownRow, build, child (+37 more)
...
Cohesion: 0.02
Nodes (157): fakes/fake_weather_api_client.dart, deleteBudgetWithUndo, deleteSubscriptionWithUndo, softDeleteWithUndo, id, JobColumn, jobRequiredColumns, label (+149 more)

### Community 90 - "Test Suite — scroll_offset_isolate_test"
Cohesion: 0.02
Nodes (126): ProseSpanBuilder, _bleed, build, _buildPath, _cachedPath, _cachedSize, _clear, color (+118 more)
...
Cohesion: 0.06
Nodes (32): 1, busiest, byDay, _CalendarHover, _columnsFor, counts, createState, date (+24 more)
...
Cohesion: 0.12
Nodes (29): App, AuthError, FederatedOAuthProvider, Future, FlutterError, InternalFirebaseAuthSettings, InternalVerifyPhoneNumberRequest, string (+21 more)
...
Cohesion: 0.03
Nodes (75): BillingPeriod, _addMonths, allocatedAt, amountCents, anchorDueDate, annualCents, annualCentsFor, asOf (+67 more)
...
Cohesion: 0.03
Nodes (65): ByteData, Image, _Await, accent, _anchorKey, _bellHeight, _bellWidth, createState (+57 more)

### Community 109 - "Study Feature — ConsumerState"
Cohesion: 0.04
Nodes (45): studyAllCardsProvider, build, _returnRestoredCard, accent, after, before, _canRedo, _canUndo (+37 more)
...
Cohesion: 0.20
Nodes (41): FutureBase, AuthPigeonFirebaseApp, AuthResult, function, InternalActionCodeSettings, InternalSignInProvider, InternalUserProfile, FirebaseAuthPlugin (+33 more)
...
Cohesion: 0.01
Nodes (150): Completer, _FakeLeetCodeApi, http.BaseClient, LeetCodeTrackDraft? draft,
  String?, applySettings, devForceConflictUi, disableCache, loadFromSettings (+142 more)
...
Cohesion: 0.04
Nodes (58): cachedCurrentWeatherProvider, currentWeatherProvider, syncActivityProvider, accent, axis, _bottomFade, branchIndex, build (+50 more)

### Community 123 - "Constants — leetcode_constants"
Cohesion: 0.05
Nodes (41): decodeColorPaletteJson, encodeColorPaletteJson, formatColorHex, jsonEncode, normalizeColorValue, normalized, paletteContains, parsed (+33 more)
...
Cohesion: 0.03
Nodes (72): FocusOnKeyEventCallback?, tagColorsProvider, defaultColorPalette, ActiveTagToken, counts, end, filterTagSuggestions, _hashCodeUnit (+64 more)
...
Cohesion: 0.07
Nodes (28): CalendarRepository, FinanceRepository, InMemorySyncRepository, DriftCalendarRepository, DriftFinanceRepository, RemoteSyncService, SyncedWriteNotifier, _SlowCalendarRepository (+20 more)
...
Cohesion: 0.04
Nodes (45): Archive, MediaRepository, archive, backupFormatVersion, backupManifestFileName, backupMediaDirectory, buildArchiveContents, _collections (+37 more)
...
Cohesion: 0.03
Nodes (57): DateTime? now,
  bool, amountCents, assetCents, best, BreakdownFocusResult, BreakdownSlice, byAsset, cash (+49 more)
...
Cohesion: 0.04
Nodes (49): _applyDecision, bucket0, bucket1, bucket2, _BucketProgressBar, _canRedo, _canUndo, _cardKey (+41 more)
...
Cohesion: 0.06
Nodes (50): journalAllEntryIdsProvider, journalDebugLoggerProvider, journalEntryCacheInvalidatorProvider, journalEntryCountsProvider, journalListEntriesProvider, journalRepositoryProvider, journalsProvider, journalWriteCoordinatorProvider (+42 more)
...
Cohesion: 0.05
Nodes (37): AnalyticsService, booleanTrueCount, completedTasks, countWords, heatmapIntensity, integerSeries, interpolateConsecutive, rollingMax (+29 more)
...
Cohesion: 0.05
Nodes (39): Brightness, accentLineAmount, accentLineTarget, appBar, blurScale, brightness, _build, card (+31 more)
...
Cohesion: 0.02
Nodes (113): Axis, build, CompactBackBar, label, onBack, WeightUnit, Exercise, controller (+105 more)
...
Cohesion: 0.04
Nodes (42): FirebaseAuthMultiFactorException, dart:math, FirebaseAuthException, indices, main, r, sorted, nextQuote (+34 more)

### Community 195 - "Test Suite — package:flutter_riverpod/flu"
Cohesion: 0.04
Nodes (55): IconData, _accent, accentColor, anchor, build, _buildCustomPage, _buildPresetPage, _commit (+47 more)
...
Cohesion: 0.05
Nodes (40): RankingFieldValue, RankingTemplateField, accent, accentColor, build, child, createState, didUpdateWidget (+32 more)
...
Cohesion: 0.06
Nodes (37): TrackerValue, applicationId, applicationUrl, archivedAt, categoryId, changedAt, colorValue, company (+29 more)

### Community 206 - "Rankings Feature — rankings_score_stars"
Cohesion: 0.06
Nodes (36): accentColor, _attach, build, controller, createState, _detach, didUpdateWidget, dispose (+28 more)
...
Cohesion: 0.11
Nodes (18): CacheItemStatus get, checks, _checksEqual, _checksEqualLists, detail, idle, isFullyPrewarmed, label (+10 more)

### Community 209 - "Sync Engine — outbox_sync_worker"
Cohesion: 0.03
Nodes (68): Delay, _authRepo, clearFor, _clearPending, data, _db, drainableCollections, _drainIndividually (+60 more)
...
Cohesion: 0.04
Nodes (59): int get, financeRepositoryProvider, transactionsProvider, copyWith, description, fromJson, hashCode, id (+51 more)
...
Cohesion: 0.05
Nodes (37): googleOAuthClientId, _googleOAuthClientIdRaw, googleOAuthClientSecret, _googleOAuthClientSecretRaw, googleOAuthRedirectPort, id, isGoogleOAuthClientSecretConfigured, isGoogleOAuthConfigured (+29 more)
...
Cohesion: 0.06
Nodes (43): build, _canvasController, createState, dispose, geometry, getClip, _globalCenterFor, _grassColor (+35 more)
...
Cohesion: 0.07
Nodes (38): build, LeetCodePage, _LeetCodeViewMode, _leetCodeViewModeProvider, leetCodeDeckDifficultyFilterProvider, leetCodeDeckSearchIndexProvider, leetCodeDeckSearchQueryProvider, leetCodeDeckTagFilterProvider (+30 more)
...
Cohesion: 0.14
Nodes (16): EncodableValue, unique_ptr, EventSink, EndOfStreamInternal, ErrorInternal, SuccessInternal, string, T (+8 more)
...
Cohesion: 0.03
Nodes (80): ConsumerWidget, activeWorkoutPlanProvider, exercisesProvider, workoutPlanEntriesProvider, workoutPlansProvider, SpringMotion, _HeatmapGrid, _AssetRow (+72 more)
...
Cohesion: 0.05
Nodes (43): dart:typed_data, Exception, MediaImageFormat, currentUid, delete, download, MediaStoragePermanentFailure, message (+35 more)
...
Cohesion: 0.02
Nodes (84): DateTime? deletedAt,
  int, detectDreamEntryConflict, detectJournalEntryConflict, detectTodoTaskConflict, isConflict, _isCorruptedOpChain, _isHardDreamMetadataCollision, _isHardMetadataCollision (+76 more)
...
Cohesion: 0.08
Nodes (24): DateTimeRange, _AllocateModal, _AllocateModalState, _amountController, _canSave, container, createState, _date (+16 more)
...
Cohesion: 0.04
Nodes (50): dropdownMenuTheme, _itemHighlightRadius, itemPadding, menuBorderRadius, menuColor, menuColorOf, menuStyle, menuTheme (+42 more)
...
Cohesion: 0.07
Nodes (26): DateTime?, StatisticTracker, build, HeatmapCalendar, month, tracker, values, applicationUrl (+18 more)
...
Cohesion: 0.06
Nodes (32): CashFlowGranularity, breakdownChart, breakdownMode, cashFlowGranularity, _chain, copyWith, defaults, _file (+24 more)
...
Cohesion: 0.07
Nodes (27): DriftRankingRepository, package:voyager/features/rankings/rankings_edit_panel.dart, package:voyager/features/rankings/rankings_header.dart, package:voyager/features/rankings/rankings_providers.dart, package:voyager/features/rankings/rankings_row.dart, RankingRepository, categories, chipText (+19 more)
...
Cohesion: 0.06
Nodes (30): JournalWriteCoordinator, coordinator, journalRepository, remoteSync, saveEntry, SearchEntrySaveHelper, package:voyager/core/sync/journal_write_coordinator.dart, package:voyager/core/sync/pending_flush_registry.dart (+22 more)
...
Cohesion: 0.03
Nodes (59): MessageHandler, MethodCallHandler, MultiFactorTotpHostApi, MultiFactorTotpSecretHostApi, MultiFactorUserHostApi, MultiFactorTotpHostApi, GenerateSecret, GetAssertionForEnrollment (+51 more)

### Community 278 - "Shared Widgets — keep_alive_scroll"
Cohesion: 0.02
Nodes (100): financeRepositoryProvider, BillRadarPanel, build, _delete, _dueColor, _dueLabel, _duplicate, _EmptyRadar (+92 more)
...
Cohesion: 0.09
Nodes (24): assetValuationsProvider, _asOf, _AssetModal, _AssetModalState, build, _canSave, _colorValue, container (+16 more)

### Community 284 - "Shared Widgets — _State"
Cohesion: 0.04
Nodes (46): AppLifecycleListener?, dispose, _handleLifecycleState, initState, _isVisible, _lifecycle, _lifecycleVisible, _minimized (+38 more)

### Community 285 - "Shared Widgets — date_selector_popover"
Cohesion: 0.06
Nodes (34): formatTime12Hour, formatTimeOfDay12Hour, jm, local, now, accentColor, build, _canPop (+26 more)
...
Cohesion: 0.06
Nodes (36): after, before, _canRedo, _canUndo, _cardKey, _clearHistory, createState, _deleteAndAdvance (+28 more)
...
Cohesion: 0.13
Nodes (14): _dreamRepository, DreamWriteCoordinator, _findTask, _journalRepository, _remoteSync, saveEntry, saveTask, _todoRepository (+6 more)
...
Cohesion: 0.13
Nodes (23): build, devDisablePetalFieldProvider, devForceOfflineProvider, DevPage, devShowTimeSelectorHitboxesProvider, devSlowHeatmapPopoverAnimationProvider, devSlowTodoEditPanelAnimationProvider, devVerboseSyncProvider (+15 more)
...
Cohesion: 0.02
Nodes (89): AsyncNotifier, SettingsNotifier, AppSettings, _kLeetCodeActivityBreakpoint, _kLeetCodeActivityCardWidth, _kLeetCodeSplitBreakpoint, LeetCodeDashboard, LeetCodeDashboardHeader (+81 more)
...
Cohesion: 0.07
Nodes (27): _AddImageButton, _AddImageButtonState, autofocus, _back, build, _busy, _cardId, _CardSide (+19 more)
...
Cohesion: 0.05
Nodes (42): createState, DevRemotePurgeSection, _DevRemotePurgeSectionState, dispose, _entryIdController, _purgeEntry, _purging, alsoVia (+34 more)
...
Cohesion: 0.08
Nodes (24): _advance, build, createState, dispose, _done, _frame, initState, plotSize (+16 more)
...
Cohesion: 0.09
Nodes (21): dart:async, _callbacks, flushAll, instance, PendingFlushRegistry, register, unregister, _activeUntil (+13 more)
...
Cohesion: 0.02
Nodes (83): AutocorrectScopeData, data, disabled, enabled, hashCode, of, operator, service (+75 more)
...
Cohesion: 0.16
Nodes (21): assetsProvider, assetValuationsProvider, budgetsProvider, financeCategoriesProvider, _BreakdownCard, _breakdownFocusProvider, build, _CashFlowCard (+13 more)

### Community 359 - "Remote API Clients — desktop_google_oauth"
Cohesion: 0.07
Nodes (56): ConsumerState, ConsumerStatefulWidget, studyAllDecksProvider, studyCardImagesProvider, studyCardsProvider, studyDeckByIdProvider, studyDeckStatsProvider, _CalendarManageDialog (+48 more)
...
Cohesion: 0.04
Nodes (84): CapsLockCaretIndicator, _CapsLockCaretIndicatorState, _Thumbnail, _ThumbnailState, WindowVisibility, _VimFieldOverlay, _VimFieldOverlayState, VimTextScope (+76 more)
...
Cohesion: 0.06
Nodes (33): int? current,
  Set, assign, nextColor, palette, PaletteAssigner, paletteFromItems, pickColorFromPalette, pickPaletteColorWithRef (+25 more)
...
Cohesion: 0.03
Nodes (73): paperShaderProvider, _PaperBackground, LeetCodeProblem, LeetCodeSolution, anchorRect, build, _close, _closing (+65 more)

### Community 371 - "Media Handling — media_clipboard"
Cohesion: 0.10
Nodes (19): InheritedWidget, MediaPasteOwnerScope, SnippetEnabledScope, AutocorrectEnabledScope, ProsePasteScope, enabled, _isFreeTextKeyboard, obscureText (+11 more)
...
Cohesion: 0.04
Nodes (51): Client, FirebaseFunctions?, _call, CloudFunctionWeatherClient, _firestore, FirestoreWeatherReader, _functions, getCurrentWeather (+43 more)
...
Cohesion: 0.07
Nodes (27): bool?, LeetCodeProblem? get, leetCodeScratchDraftStoreProvider, buildScratchArea, dispose, _expanding, _expandScratch, flushScratch (+19 more)
...
Cohesion: 0.05
Nodes (33): Color?, Key? dateKey,
  double, alphaBlend, base, build, ChartHoverBubble, chartTooltipBubbleColor, chartTooltipDateStyle (+25 more)

### Community 398 - "Todo Feature — todo_page"
Cohesion: 0.05
Nodes (42): Card, DateTime? dueAt,
  double, package:voyager/core/theme/srs_mastery_color.dart, package:voyager/core/widgets/voyager_time_picker_spinner.dart, package:voyager/features/study/study_card_tile.dart, package:voyager/features/study/study_flip_card.dart, algorithm, card (+34 more)
...
Cohesion: 0.03
Nodes (56): int? initialColor,
  String, Calendar, build, calendars, _checked, createState, host, _others (+48 more)
...
Cohesion: 0.12
Nodes (15): ClipRect, VoyagerSpinnerWheel, package:voyager/core/widgets/voyager_number_wheel.dart, package:voyager/core/widgets/voyager_spinner_wheel.dart, package:voyager/features/rankings/rankings_score_input.dart, package:voyager/features/rankings/rankings_score_stars.dart, _host, _ignore (+7 more)
...
Cohesion: 0.02
Nodes (126): @DriftDatabase, AppDatabase, DriftSettingsRepository, DriftTodoRepository, DriftTrackerRepository, ListView, package:voyager/core/constants/todo_sort_constants.dart, package:voyager/core/snippets/snippet_settings_launcher.dart (+118 more)

### Community 418 - "Shell Feature — shell_page_storage_keys"
Cohesion: 0.05
Nodes (37): build, _calendars, _counts, _createCalendar, _createdCalendarId, createdId, createState, _deleteCalendar (+29 more)
...
Cohesion: 0.06
Nodes (31): Alignment, BorderRadius, autofocus, build, child, CtrlEnterToSubmitScope, isSubmitChord, key (+23 more)

### Community 427 - "Shared Widgets — double?"
Cohesion: 0.15
Nodes (12): double get, formatDisplay, formatKilograms, formatKilogramsWithUnit, fromKilograms, kilogramsForWheelIndex, label, max (+4 more)
...
Cohesion: 0.05
Nodes (39): accent, activeStatuses, _averageWidth, categories, category, _CategoryTrigger, _CheckTile, color (+31 more)
...
Cohesion: 0.06
Nodes (24): AuthStateListener, FirebaseAuth, FirebasePluginPlatform, FirebaseService, ForceResendingToken, IdTokenListener, Locale?, PhoneMultiFactorInfo (+16 more)

### Community 435 - "Firebase Auth (macos) — CustomPigeonHeader"
Cohesion: 0.15
Nodes (14): _chain, clear, _deleteQuietly, draft, _draftFileName, _file, FileJobsTrackDraftStore, JobsTrackDraftStore (+6 more)
...
Cohesion: 0.12
Nodes (17): Credential, AdditionalUserInfo, EncodableMap, InternalAdditionalUserInfo, InternalUserCredential, InternalUserDetails, map, PhoneAuthCredential (+9 more)
...
Cohesion: 0.03
Nodes (60): active, anchor, batch, completeTodoTask, due, latest, listId, next (+52 more)
...
Cohesion: 0.06
Nodes (33): EditableText, context, focus, isTextInputFocused, subtreeIsVisible, _added, _amount, container (+25 more)
...
Cohesion: 0.06
Nodes (28): kMinTouchTarget, didChangeAppLifecycleState, didChangeViewFocus, instance, _viewFocused, SnippetSettingsLauncher, updateShouldNotify, _capName (+20 more)
...
Cohesion: 0.10
Nodes (26): Auth, auth::AuthStateListener, auth::IdTokenListener, User, mutex, StreamHandler<flutter::EncodableValue>, AuthStateStreamHandler, auth_ (+18 more)
...
Cohesion: 0.03
Nodes (53): BackdropFilter, colorForLeetCodeDifficulty, key, kLeetCodeEasyColor, kLeetCodeHardColor, kLeetCodeMediumColor, labelForLeetCodeDifficulty, labelForLeetCodeLanguage (+45 more)
...
Cohesion: 0.06
Nodes (39): autocorrectScopeProvider, devGeometricTexturePanelOpenProvider, devGeometricWavePanelOpenProvider, geometricDebugRowFadeProvider, geometricTextureParamsProvider, geometricWaveParamsProvider, snippetScopeProvider, themeModeProvider (+31 more)

### Community 532 - "Journal Feature — journal_page"
Cohesion: 0.07
Nodes (27): bool get, isCompactWidth, kCompactWidthBreakpoint, WindowSizeClass, copyWith, EventRecurrence, frequency, hashCode (+19 more)
...
Cohesion: 0.04
Nodes (58): Color? highlightColor,
  List, applyStyledRanges, best, collapsed, colorFor, cursor, emphasis, end (+50 more)
...
Cohesion: 0.22
Nodes (9): leetCodeApiClientProvider, leetCodeRepositoryProvider, _save, startLeetCodeTrackFlow, leetCodeTrackDraftStoreProvider, _fetchByTypedTitle, initState, _save (+1 more)
...
Cohesion: 0.05
Nodes (39): crossfade, reduced, VoyagerMotion, _buffered, _maxBuffered, notify, notifyOne, onWrite (+31 more)
...
Cohesion: 0.29
Nodes (7): _BreakdownPie, _BreakdownPieState, _CashFlowChart, _CashFlowChartState, _NetWorthChart, _NetWorthChartState, State
...
Cohesion: 0.33
Nodes (6): StudyRepository, _RecordingStudyRepository, _FakeStudyRepository, _FakeStudyRepository, _RecordingStudyRepository, _RecordingStudyRepository
...
Cohesion: 0.08
Nodes (29): leetcodeProblemsProvider, _ActivityDetailCard, _ActivityDetailCardState, anchorRect, build, _close, _closing, _controller (+21 more)
...
Cohesion: 0.10
Nodes (29): allTodoTasksProvider, calendarViewEventsProvider, googleCalendarSyncProvider, settingsProvider, todoListStatsProvider, todoTasksProvider, workoutDaysProvider, _StatisticDetailPopup (+21 more)

## Knowledge Gaps
- **17977 isolated node(s):** `Summary`, `1. High — Context-menu Convert keeps origin across Expense ↔ Deposit`, `2. Low (disputed) — Origin suggestion ranking vs HLD Jobs parity`, `3. Low (disputed) — `mergeTransactionFromRemote` treats missing `origin` like explicit null`, `4. Medium — Tags Enter saves; HLD says keep prior Tags Enter rules / Ctrl+Enter submits` (+17972 more)
...
- **Why does `ActionCodeInfoOperation` connect `Study Feature — ConsumerState` to `Firebase Auth (ios) — firebase_auth_messages.g`, `Firebase Auth (macos) — firebase_auth_messages.g`, `Test Suite — package:flutter_test/flutter`, `Firebase Auth (android) — NonNull`, `Firebase Auth (windows) — messages.g.cpp`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Why does `InternalActionCodeInfo` connect `Firebase Auth (ios) — firebase_auth_messages.g` to `Study Feature — ConsumerState`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `ActionCodeInfoOperationBox` connect `Firebase Auth (ios) — firebase_auth_messages.g` to `Study Feature — ConsumerState`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **What connects `Summary`, `1. High — Context-menu Convert keeps origin across Expense ↔ Deposit`, `2. Low (disputed) — Origin suggestion ranking vs HLD Jobs parity` to the rest of the system?**
  _17978 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Drift Database Schema — app_database` be split into smaller, more focused modules?**
  _Cohesion score 0.0018709073900841909 - nodes in this community are weakly interconnected._
