...
## Corpus Check
- 982 files · ~1,350,823 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 24456 nodes · 38596 edges · 965 communities (605 shown, 360 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 297 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2821491f`
...
## Communities (965 total, 360 thin omitted)
...
Cohesion: 0.01
Nodes (189): journalAllEntryIdsProvider, journalEntryCountsProvider, journalListEntriesProvider, journalRepositoryProvider, journalsProvider, changeJournalListColor, createJournalList, renameJournalList (+181 more)

### Community 10 - "Firebase Auth (windows) — messages.g.cpp"
Cohesion: 0.03
Nodes (182): GenerateInterfaces, string_view, AuthPigeonFirebaseApp::AuthPigeonFirebaseApp(), EncodableMap, EncodableValue, FlutterError, InternalActionCodeSettings, InternalTotpSecret (+174 more)

### Community 11 - "Finance Feature — finance_transaction_modal"
Cohesion: 0.04
Nodes (46): TransactionType, amountCents, _amountController, container, createState, _date, _datePopoverOpen, dispose (+38 more)
...
Cohesion: 0.03
Nodes (80): dart:io, Directory, MediaFileStore, package:image/image.dart, package:voyager/core/media/media_service.dart, package:voyager/core/media/widgets/media_fan_stack.dart, package:voyager/data/services/media_file_store.dart, package:voyager/features/leetcode/leetcode_scratch_draft_store.dart (+72 more)
...
Cohesion: 0.02
Nodes (131): hiddenNotificationFeedProvider, notificationRepositoryProvider, pinnedNotesProvider, visibleNotificationFeedProvider, accent, _addNote, _AnalyticsSection, _AnalyticsSectionState (+123 more)

### Community 19 - "Journal Feature — journal_page"
Cohesion: 0.01
Nodes (194): ChangeNotifierProvider, activeWorkoutSessionProvider, all, allJournalEntriesScope, authNotifierProvider, backgroundSyncOrchestratorProvider, backupCollectionsProvider, bills (+186 more)
...
Cohesion: 0.04
Nodes (72): rankingChildrenByParentProvider, rankingParentsProvider, RankingFilters, build, _CategoryMenu, _FilterMenu, _SortMenu, actionLabel (+64 more)
...
Cohesion: 0.04
Nodes (54): build, _counts, createdId, _createdJournalId, _createJournal, createState, _deleteJournal, initState (+46 more)

### Community 30 - "Finance Feature — finance_analytics_view"
Cohesion: 0.03
Nodes (76): abs, accent, _AnalyticsCard, anchor, _arcMidpoint, asset, _barsSpace, _bottomReserved (+68 more)

### Community 31 - "Firebase Auth (windows) — messages.g.cpp"
Cohesion: 0.03
Nodes (98): InternalAuthCredentialInput, K, AuthPigeonFirebaseApp, app_name_, custom_auth_domain, FromEncodableList, Hash, operator== (+90 more)

### Community 32 - "Test Suite — jobs_track_flow_test"
Cohesion: 0.02
Nodes (95): Container, DateTime? dateApplied,
  List, package:voyager/core/constants/job_constants.dart, package:voyager/domain/models/job_models.dart, package:voyager/features/jobs/jobs_page.dart, package:voyager/features/jobs/jobs_table.dart, required String company,
  List, addApplication (+87 more)

### Community 33 - "Journal Feature — journal_list_actions"
Cohesion: 0.01
Nodes (236): defaultColorPalette, FirestorePullService, JournalWriteCoordinator, RemoteSyncService, reconcileTagPalette, records, rewritten, DriftLeetCodeRepository (+228 more)
...
Cohesion: 0.03
Nodes (61): FlutterDesktopMessage, TextureVariant, ErrorOr, v_, FlutterError, code_, details_, message_ (+53 more)
...
Cohesion: 0.06
Nodes (38): mediaDiskLowProvider, mediaServiceProvider, mediaStorageProvider, mediaStorageUsageProvider, build, _reload, build, _reload (+30 more)
...
Cohesion: 0.04
Nodes (36): MessageHandler, GenerateInterfaces, MultiFactoResolverHostApi, MultiFactorTotpHostApi, MultiFactorTotpSecretHostApi, BasicMessageChannel, codec_, messenger_ (+28 more)
...
Cohesion: 0.03
Nodes (68): studyStatsProvider, borderColor, build, child, _closeDeck, _closeGeneration, _closing, _create (+60 more)
...
Cohesion: 0.04
Nodes (8): InternalAdditionalUserInfo, InternalFirebaseAuthSettings, InternalIdTokenResult, InternalUserInfo, Nullable, AdditionalUserInfo, InternalAdditionalUserInfo, InternalIdTokenResult

### Community 48 - "Test Suite — package:voyager/domain/model"
Cohesion: 0.02
Nodes (113): AnimatedContainer, package:drift/drift.dart, package:flutter/gestures.dart, package:voyager/core/constants/journal_constants.dart, package:voyager/core/constants/todo_constants.dart, package:voyager/core/theme/voyager_list_item_surface.dart, package:voyager/domain/models/todo_models.dart, package:voyager/features/todo/todo_edit_panel.dart (+105 more)
...
Cohesion: 0.03
Nodes (91): ConsumerWidget, autocorrectScopeProvider, devGeometricTexturePanelOpenProvider, devGeometricWavePanelOpenProvider, devLeafGalleryPanelOpenProvider, geometricDebugRowFadeProvider, geometricShaderProvider, geometricTextureParamsProvider (+83 more)
...
Cohesion: 0.02
Nodes (84): Finder get, _dreamRepository, DreamWriteCoordinator, _findTask, _journalRepository, _remoteSync, saveEntry, saveTask (+76 more)
...
Cohesion: 0.02
Nodes (95): , studyDeckGraphProvider, studyDecksProvider, studyFoldersProvider, StudyDeckLink, _cramSession, createState, deckId (+87 more)
...
Cohesion: 0.09
Nodes (7): AuthPigeonFirebaseApp, FirebaseAuthHostApi, FirebaseAuthUserHostApi, InternalUserCredential, InternalUserDetails, MultiFactorUserHostApi, Result
...
Cohesion: 0.08
Nodes (23): ActivityAware, ActivityPluginBinding, FlutterFirebasePlugin, FlutterPlugin, FlutterPluginBinding, Task, FlutterFirebaseAuthPlugin, Activity (+15 more)
...
Cohesion: 0.02
Nodes (83): formatTime12Hour, formatTimeOfDay12Hour, jm, local, now, 90, active, _BubbleRow (+75 more)
...
Cohesion: 0.03
Nodes (64): GeometricTextureParamsNotifier, GeometricWaveParamsNotifier, accentColor, animates, _animating, baseColor, build, _clock (+56 more)

### Community 72 - "Test Suite — package:flutter_test/flutter"
Cohesion: 0.03
Nodes (69): BackgroundSyncOrchestrator, backoffMultiplier, _bucketListRepository, _calendarRepository, cancelScheduledDocumentSync, _crdtResolver, _debouncer, _debouncerFor (+61 more)
...
Cohesion: 0.05
Nodes (39): _accent, build, category, children, _commitText, createState, _current, didUpdateWidget (+31 more)
...
Cohesion: 0.01
Nodes (171): EditableText, EditableTextState, buildOverscrollIndicator, buildScrollbar, createState, didChangeAppLifecycleState, dispose, _flushAllPendingEdits (+163 more)
...
Cohesion: 0.03
Nodes (62): createState, DevOutOfSyncPurgeSection, _DevOutOfSyncPurgeSectionState, _lastResults, _purgeAll, _purging, card, cards (+54 more)

### Community 88 - "Test Suite — leetcode_session_hides_test"
Cohesion: 0.04
Nodes (56): FocusNode, FocusNode get, buildTextSpan, dispose, _emphasis, focusNode, _forward, _markupFor (+48 more)

### Community 89 - "Firebase Auth (android) — NonNull"
Cohesion: 0.02
Nodes (160): fakes/fake_weather_api_client.dart, Key? get, deleteBudgetWithUndo, deleteSubscriptionWithUndo, softDeleteWithUndo, id, JobColumn, jobRequiredColumns (+152 more)

### Community 90 - "Test Suite — scroll_offset_isolate_test"
Cohesion: 0.04
Nodes (59): build, color, controller, createState, didUpdateWidget, dispose, em, getClip (+51 more)
...
Cohesion: 0.03
Nodes (60): DailyFlow, NetFlowSeries, 1, build, busiest, _CalendarHover, _columnsFor, createState (+52 more)
...
Cohesion: 0.12
Nodes (23): ActionCodeSettings, GetTokenResult, MultiFactorInfo, FlutterFirebaseAuthPluginException, FlutterError, FlutterFirebaseAuthUser, Activity, AuthPigeonFirebaseApp (+15 more)
...
Cohesion: 0.02
Nodes (111): File, package:drift/native.dart, package:path/path.dart, package:voyager/core/dev/out_of_sync_journal_entry_purge.dart, package:voyager/core/widgets/notification_urgency_dot.dart, package:voyager/domain/models/analytics_models.dart, package:voyager/domain/models/life_tracker_models.dart, package:voyager/domain/services/analytics_service.dart (+103 more)
...
Cohesion: 0.17
Nodes (10): crossfade, reduced, VoyagerMotion, _buffered, _maxBuffered, notify, notifyOne, onWrite (+2 more)
...
Cohesion: 0.03
Nodes (61): ByteData, Image, _Await, accent, _anchorKey, _bellHeight, _bellWidth, createState (+53 more)
...
Cohesion: 0.06
Nodes (32): bool get, DateTime?, isCompactWidth, kCompactWidthBreakpoint, WindowSizeClass, copyWithDeleted, createdAt, deletedAt (+24 more)
...
Cohesion: 0.14
Nodes (63): AuthError, Credential, FederatedOAuthProvider, FutureBase, AuthPigeonFirebaseApp, AuthResult, FlutterError, function (+55 more)

### Community 115 - "Test Suite — package:flutter_riverpod/flu"
Cohesion: 0.11
Nodes (17): package:voyager/core/media/widgets/media_gallery_strip.dart, container, db, dueDate, kTodoEditPanelWidth, kTodoRowMinWidth, _listId, main (+9 more)

### Community 116 - "Test Suite — package:voyager/domain/repos"
Cohesion: 0.03
Nodes (76): _FakeLeetCodeApi, LeetCodeTrackDraft? draft,
  String?, LeetCodeApiClient, package:voyager/data/remote/leetcode_api_client.dart, _RecordingLeetCodeRepository, _FlakyCountsApi, _algorithmField, button (+68 more)
...
Cohesion: 0.08
Nodes (34): cachedCurrentWeatherProvider, currentWeatherProvider, syncActivityProvider, build, _confirmDeleteAllEntries, _confirmResetJournals, devDisablePetalFieldProvider, devForceOfflineProvider (+26 more)

### Community 121 - "Test Suite — todo_page_perf_test"
Cohesion: 0.03
Nodes (71): build, QuickJournalPopup, QuickTodoPopup, getOrderedDestinations, icon, index, label, order (+63 more)

### Community 122 - "Study Feature — ConsumerState"
Cohesion: 0.02
Nodes (87): _, GoRouter, isExpired, purgeCutoff, purgeEligibleAfter, SoftDeletePolicy, accent, axis (+79 more)

### Community 123 - "Constants — leetcode_constants"
Cohesion: 0.06
Nodes (34): JobsActions get, _actions, category, _CategoryTile, color, companies, company, companyCount (+26 more)

### Community 124 - "Remote API Clients — firestore_sync_repository"
Cohesion: 0.05
Nodes (39): DocumentReference, FirebaseFirestore, appendOperation, appendOperationGroup, appendOperationsBatch, claimCalendarLock, claimWeatherFetchLock, _collection (+31 more)
...
Cohesion: 0.02
Nodes (121): BackdropFilter, dart:ui, Error, byId, refreshed, package:flutter_test/flutter_test.dart, package:voyager/core/spellcheck/voyager_spell_check_service.dart, package:voyager/core/theme/app_fonts.dart (+113 more)
...
Cohesion: 0.05
Nodes (70): ActionCodeInfoOperationBox, -initWithValue, AuthPigeonFirebaseApp, -init, +makeWithAppNametenantIdcustomAuthDomain, <GenerateInterfaces>, -pigeonInterfaceInfoerror, NSArray (+62 more)
...
Cohesion: 0.04
Nodes (42): Completer, http.BaseClient, colorForLeetCodeDifficulty, key, kLeetCodeEasyColor, kLeetCodeHardColor, kLeetCodeMediumColor, labelForLeetCodeDifficulty (+34 more)
...
Cohesion: 0.03
Nodes (81): rankingCategoriesProvider, build, child, EnterToSubmitScope, onSubmit, _textFieldHasFocus, Calendar, build (+73 more)
...
Cohesion: 0.06
Nodes (31): double get, WeightUnit, formatDisplay, formatKilograms, formatKilogramsWithUnit, fromKilograms, kilogramsForWheelIndex, label (+23 more)

### Community 144 - "Media Handling — media_paste_scope"
Cohesion: 0.06
Nodes (33): MediaClipboard, _attachFromClipboard, build, _busy, child, clipboard, collection, createState (+25 more)
...
Cohesion: 0.05
Nodes (43): Duration? dwell,
  Duration, IconData? icon,
  List, actions, build, _controller, createState, didChangeAppLifecycleState, didUpdateWidget (+35 more)
...
Cohesion: 0.04
Nodes (74): allTodoTasksProvider, calendarTodoMarkersProvider, calendarViewEventsProvider, colorPaletteProvider, googleCalendarSyncProvider, todoListsProvider, todoListStatsProvider, todoRepositoryProvider (+66 more)
...
Cohesion: 0.06
Nodes (29): accentColor, build, _canPop, createState, _currentDateTime, didChangeDependencies, dispose, _focusRequested (+21 more)
...
Cohesion: 0.04
Nodes (52): accent, accentColor, asset, collection, count, createState, didUpdateWidget, documentId (+44 more)

### Community 176 - "Workout Feature — workout_island"
Cohesion: 0.07
Nodes (28): WorkoutPlanEntry, _accept, active, allEntries, build, createState, dayIndex, _edit (+20 more)
...
Cohesion: 0.09
Nodes (21): package:voyager/core/media/widgets/media_drop_target.dart, package:voyager/core/media/widgets/media_paste_scope.dart, field, main, pump, _pumpBody, pumpJournalPage, tap (+13 more)
...
Cohesion: 0.05
Nodes (43): accentColor, alignLabelToTop, allowShortHeight, autocorrectAllowed, autofocus, borderRadius, build, _buildField (+35 more)

### Community 190 - "Media Handling — media_lightbox"
Cohesion: 0.05
Nodes (40): Drag?, assets, build, captions, _controllerFor, _copyImage, createState, _current (+32 more)
...
Cohesion: 0.06
Nodes (29): autofocus, build, child, CtrlEnterToSubmitScope, isSubmitChord, key, keyboard, onSubmit (+21 more)
...
Cohesion: 0.06
Nodes (31): MediaService, DriftMediaRepository, MediaRepository, package:voyager/core/sync/firestore_collections.dart, db, encodePng, fileStore, image (+23 more)
...
Cohesion: 0.04
Nodes (51): package:voyager/features/study/study_cram_page.dart, package:voyager/features/study/study_session_page.dart, container, db, _deckId, _deleteShownCard, gesture, main (+43 more)

### Community 204 - "Dev Feature — dev_geometric_wave_tile"
Cohesion: 0.10
Nodes (19): IconButton, RepeatIconButton, container, db, _due, dueDate, _listId, main (+11 more)

### Community 205 - "Domain Models — SoftDeletable"
Cohesion: 0.06
Nodes (38): TrackerValue, AssetValuation, FinancialTransaction, GoalAllocation, Subscription, applicationId, applicationUrl, archivedAt (+30 more)
...
Cohesion: 0.01
Nodes (187): DateTimeRange, financeRepositoryProvider, Asset, Budget, FinanceCategory, _amountController, _canSave, container (+179 more)
...
Cohesion: 0.02
Nodes (91): LeafDesign, _AnalyticsToolbar, _EmptyTrackersCard, _GridView, _HeatmapGroupDivider, _HeatmapMonthTile, _MacroStatsRow, _SectionLabel (+83 more)
...
Cohesion: 0.13
Nodes (14): archive, backupFormatVersion, backupManifestFileName, backupMediaDirectory, buildArchiveContents, _collections, DataExportService, exportDataToZip (+6 more)
...
Cohesion: 0.06
Nodes (31): MediaImageFormat, bytes, byteSize, contentHash, _decode, decoded, encoded, false (+23 more)
...
Cohesion: 0.01
Nodes (237): @DriftDatabase, DateTime? stamp,
  int, _Device, SyncEngine, AppDatabase, InMemorySyncRepository, DriftJournalRepository, DriftSettingsRepository (+229 more)

### Community 246 - "Shared Widgets — search_highlight_text"
Cohesion: 0.06
Nodes (35): class ConnectivityStatusController extends, _Repaint, CapsLockState, DevSettingsController, FpsMonitorController, JournalDebugLogger, TodoSortDebugLogger, WindowFocusWatcher (+27 more)
...
Cohesion: 0.05
Nodes (34): CapsLockIndicatorScope, enabled, of, updateShouldNotify, calendar, debug, journal, manage (+26 more)
...
Cohesion: 0.05
Nodes (42): ProseSpanBuilder, _activeEditRange, build, _cachedSpans, controller, createState, descenderClearance, didChangeDependencies (+34 more)
...
Cohesion: 0.07
Nodes (30): dart:async, clearLog, _enqueue, log, _logFileName, logFilePath, _maxLogBytes, readLog (+22 more)
...
Cohesion: 0.07
Nodes (27): _AddImageButton, _AddImageButtonState, autofocus, _back, _busy, _cardId, _CardSide, controller (+19 more)
...
Cohesion: 0.06
Nodes (34): FirebaseStorage, _attempts, _downloadDraining, _downloadOne, _downloadWakeupPending, drain, drainDownloads, drainUploads (+26 more)
...
Cohesion: 0.05
Nodes (37): build, CompactBackBar, label, onBack, build, color, ColorCornerFlag, colorValue (+29 more)

### Community 268 - "Study Feature — ConsumerState"
Cohesion: 0.03
Nodes (58): studyFolderByIdProvider, display, divisions, _GeometricTextureSlider, label, max, min, onChanged (+50 more)
...
Cohesion: 0.03
Nodes (63): budget, color, _delete, _EmptyBudgets, pace, _PacingBar, spentCents, spentFraction (+55 more)
...
Cohesion: 0.08
Nodes (22): _auth, call, _http, HttpCallableClient, projectId, region, _uriFor, close (+14 more)

### Community 284 - "Shared Widgets — _State"
Cohesion: 0.03
Nodes (69): AppLifecycleListener?, dispose, _handleLifecycleState, initState, _isVisible, _lifecycle, _lifecycleVisible, _minimized (+61 more)

### Community 285 - "Shared Widgets — date_selector_popover"
Cohesion: 0.07
Nodes (26): accentColor, build, _canPop, createState, didUpdateWidget, dispose, _firstSelected, _focusedMonth (+18 more)
...
Cohesion: 0.05
Nodes (45): allDreamEntriesProvider, build, customQuotesProvider, dreamRepositoryProvider, dreamWriteCoordinatorProvider, quotePoolProvider, saveSettings, settingsRepositoryProvider (+37 more)

### Community 304 - "Study Feature — ConsumerState"
Cohesion: 0.02
Nodes (83): AsyncNotifier, SettingsNotifier, AppSettings, _apiKeyController, build, createState, didUpdateWidget, dispose (+75 more)
...
Cohesion: 0.04
Nodes (75): ConsumerState, ConsumerStatefulWidget, jobCategoriesProvider, notificationBadgeStateProvider, MediaFanStack, _MediaFanStackState, MediaGalleryStrip, _MediaGalleryStripState (+67 more)
...
Cohesion: 0.08
Nodes (33): allJournalEntriesProvider, analyticsServiceProvider, periodicPromptServiceProvider, trackerCacheInvalidatorProvider, trackersProvider, trackerValuesProvider, workoutDaysProvider, AnalyticsPage (+25 more)
...
Cohesion: 0.09
Nodes (13): MultiFactorAssertion, MultiFactorResolver, FlutterFirebaseMultiFactor, AuthPigeonFirebaseApp, InternalMultiFactorInfo, InternalMultiFactorSession, InternalPhoneMultiFactorAssertion, InternalUserCredential (+5 more)
...
Cohesion: 0.04
Nodes (49): FirebaseAuthMultiFactorException, dart:math, FirebaseAuthException, indices, main, r, sorted, accent (+41 more)
...
Cohesion: 0.05
Nodes (66): WindowVisibility, _PalettePickDialog, _PalettePickDialogState, DateSelectorPopover, _DateSelectorPopoverState, DateTimeSelectorPopover, _DateTimeSelectorPopoverState, GeometricTexture (+58 more)
...
Cohesion: 0.19
Nodes (21): jobApplicationsProvider, jobCompaniesProvider, jobSeasonsProvider, jobStagesProvider, build, _SeasonsTab, _StagesTab, build (+13 more)
...
Cohesion: 0.03
Nodes (82): LeetCodeProblem, LeetCodeSolution, anchorRect, build, _close, _closing, _ComplexityTile, _controller (+74 more)
...
Nodes (64): DateTime? deletedAt,
  int, MoodGradientSlider, searchEntries, SearchService, package:voyager/core/widgets/keep_alive_scroll.dart, package:voyager/core/widgets/mood_gradient_slider.dart, package:voyager/domain/models/journal_models.dart, package:voyager/features/search/search_page.dart (+56 more)

### Community 377 - "Test Suite — package:flutter_riverpod/flu"
Cohesion: 0.17
Nodes (11): HWND, LPARAM, LRESULT, UINT, WPARAM, FlutterWindow, flutter_controller_, FlutterWindow::FlutterWindow() (+3 more)
...
Cohesion: 0.07
Nodes (28): dart:convert, CrdtDocumentResolver, _merger, _mergeSyncOperations, resolvePayload, detectDreamEntryConflict, detectJournalEntryConflict, detectTodoTaskConflict (+20 more)
...
Cohesion: 0.10
Nodes (20): Card, ContextMenuRegion, ContextMenuRegionState, package:voyager/core/theme/srs_mastery_color.dart, algorithm, card, difficulty, explanation (+12 more)
...
Cohesion: 0.08
Nodes (23): FlutterDesktopViewRef, WindowProcDelegate, FlutterView, view_, HWND, IDXGIAdapter, GetRegistrar(), FlutterDesktopPluginRegistrarRef (+15 more)

### Community 401 - "Test Suite — prose_highlight_rounding_test"
Cohesion: 0.03
Nodes (62): Alignment, BorderRadius, BoxFit, Color, double?, asset, borderRadius, byHeight (+54 more)

### Community 402 - "Firebase Auth (android) — NonNull"
Cohesion: 0.06
Nodes (32): IconData, int? initialColor,
  String, accentColor, build, child, dense, ellipsize, fillWhenActive (+24 more)
...
Cohesion: 0.10
Nodes (18): _auth, AuthNotifier, dispose, _isAuthenticated, _subscription, begin, complete, fail (+10 more)
...
Cohesion: 0.02
Nodes (81): Icon, build, _calendars, _counts, _createCalendar, _createdCalendarId, createdId, createState (+73 more)

### Community 419 - "Ephemeral — string"
Cohesion: 0.10
Nodes (38): Point, OnCreate, OnDestroy, HWND, LPARAM, LRESULT, RECT, Size (+30 more)
...
Cohesion: 0.09
Nodes (18): contains, embedded, firebaseAuthErrorMessage, invalidCredentialHints, _isGenericInternalMessage, lower, _messageFromEmbeddedDetails, normalizedCode (+10 more)
...
Cohesion: 0.13
Nodes (15): GetPlatformVersion, AdditionalUserInfo, EncodableMap, InternalAdditionalUserInfo, map, PhoneAuthCredential, Variant, firebase_auth_windows::FirebaseAuthPlugin::ConvertToEncodableMap() (+7 more)
...
Cohesion: 0.11
Nodes (17): publishAsset, publishReference, _remoteSync, _attachedToastDwell, attachImagesForOwner, count, facet, fileStore (+9 more)
...
Cohesion: 0.12
Nodes (13): appSettingsWithGeometricTextureParams, appSettingsWithGeometricWaveParams, copyWith, geometricTextureParamsFromSettings, geometricWaveParamsFromSettings, _advance, createState, _done (+5 more)

### Community 457 - "Settings Feature — settingsRepositoryProvider"
Cohesion: 0.07
Nodes (27): Client, CloudFunctionWeatherClient, _apiKey, DevOpenWeatherClient, _http, _periodFromForecastItem, refreshForecast, refreshWeather (+19 more)
...
Cohesion: 0.17
Nodes (12): lifeTrackerStatsProvider, accentColor, BlossomStatPopup, build, _lineWidth, _padding, painter, stat (+4 more)
...
Cohesion: 0.08
Nodes (23): dart:typed_data, Exception, googleOAuthClientId, _googleOAuthClientIdRaw, googleOAuthClientSecret, _googleOAuthClientSecretRaw, googleOAuthRedirectPort, id (+15 more)
...
Cohesion: 0.13
Nodes (14): RecurrenceRule, package:voyager/core/widgets/repeat_selector_popover.dart, package:voyager/domain/models/recurrence_rule.dart, _anchor, captured, _choose, initial, interact (+6 more)
...
Cohesion: 0.08
Nodes (24): DateTime? recurrenceEndDate,
  String, package:voyager/features/calendar/calendar_overlap_engine.dart, required DateTime end,
  RecurrenceRule, _d, end, false, id, main (+16 more)
...
Cohesion: 0.25
Nodes (7): BuildContext, WindowSizeClassX, package:voyager/core/widgets/voyager_toast.dart, ctx, main, pumpHost, pumpWidget
...
Cohesion: 0.12
Nodes (16): 10. Info — Store mode still shows “Manage categories”, 1. High — Context-menu Convert keeps origin across Expense ↔ Deposit, 2. Low (disputed) — Origin suggestion ranking vs HLD Jobs parity, 3. Low (disputed) — `mergeTransactionFromRemote` treats missing `origin` like explicit null, 4. Medium — Tags Enter saves; HLD says keep prior Tags Enter rules / Ctrl+Enter submits, 5. Medium — Transaction modal date chip still uses 24h Yesterday (DST hole), 6. Low — Type switch does not explicitly close the origin overlay, 7. Medium — `FinancialTransaction.copyWith` cannot clear `origin` (or `note`) to null (+8 more)
...
### Community 573 - "Drift Database Schema — app_database"
Cohesion: 0.33
...
Cohesion: 0.19
Nodes (9): <MultiFactorTotpSecretHostApi>, -generateQrCodeUrlSecretKeyaccountNameissuercompletion, -openInOtpAppSecretKeyqrCodeUrlcompletion, <MultiFactorUserHostApi>, -enrollPhoneAppassertiondisplayNamecompletion, -enrollTotpAppassertionIddisplayNamecompletion, -getEnrolledFactorsAppcompletion, -getSessionAppcompletion (+1 more)
...
### Community 591 - "_TrackerDialog"
Cohesion: 0.17
Nodes (12): build, _controller, createState, dispose, hintText, initialValue, showWorkoutNameModal, _submit (+4 more)

### Community 599 - "-registerAuthStateListenerAppcompletion"
Cohesion: 0.22
Nodes (8): MethodCallHandler, string, T, unique_ptr, MethodChannel, codec_, messenger_, name_

### Community 600 - "-verifyPhoneNumberApprequestcompletion"
Cohesion: 0.15
Nodes (12): package:voyager/core/widgets/selection_highlight_layer.dart, base, _code, _codeLineStarts, copyWith, _divergedTypeScale, main, _numberLineStarts (+4 more)
...
Cohesion: 0.06
Nodes (67): journalEntryCacheInvalidatorProvider, journalWriteCoordinatorProvider, leetCodeApiClientProvider, leetCodeRepositoryProvider, remoteSyncServiceProvider, searchServiceProvider, studyAllCardsProvider, studyAllDecksProvider (+59 more)
...
### Community 938 - "googleCalendarSyncProvider"
Cohesion: 0.18
...
### Community 946 - "_LifeTreeCanvasState"
Cohesion: 0.18
...
### Community 947 - "_PinnedNoteRowState"
Cohesion: 0.20
Nodes (9): kCycleWorkoutPlanId, kMaxReps, kMaxSets, kMaxWeightKg, kMaxWeightLb, kStarterExercises, kWeeklyWorkoutPlanId, kWeightStepKg (+1 more)

### Community 948 - "WeatherForecastChart"
Cohesion: 0.20
Nodes (9): _count, derivedColor, fallback, forStage, _indexByName, isExplicit, JobStageColors, of (+1 more)

### Community 949 - "FLTPhoneNumberVerificationStreamHandler"
Cohesion: 0.20
...
### Community 950 - "InternalPhoneMultiFactorAssertion"
Cohesion: 0.22
...
### Community 951 - "package:voyager/core/soft_delete/soft_delete_toast.dart"
Cohesion: 0.22
...
### Community 954 - "_revealEvent"
Cohesion: 0.33
Nodes (3): App, Future, GetPluginConstantsForFirebaseApp

### Community 955 - "_revealTask"
Cohesion: 0.29
...
### Community 956 - "heatmap_calendar.dart"
Cohesion: 0.29
...
### Community 959 - "-checkActionCodeAppcodecompletion"
Cohesion: 0.50
...
## Knowledge Gaps
- **18088 isolated node(s):** `s`, `ops`, `pos`, `main`, `s1` (+18083 more)
...
- **Why does `ActionCodeInfoOperation` connect `Firebase Auth (android) — NonNull` to `Firebase Auth (ios) — firebase_auth_messages.g`, `Firebase Auth (macos) — firebase_auth_messages.g`, `Domain Models — DateTime?`, `Firebase Auth (android) — NonNull`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `FLTFirebaseAuthPlugin` connect `Firebase Auth (macos) — FLTFirebaseAuthPlugin` to `-randomNonce`, `Firebase Auth (macos) — CustomPigeonHeader`?**
...
- **What connects `s`, `ops`, `pos` to the rest of the system?**
  _18089 weakly-connected nodes found - possible documentation gaps or missing edges._
