# Graph Report - Voyager  (2026-08-16)

## Corpus Check
- 677 files · ~867,711 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 16989 nodes · 27346 edges · 716 communities (425 shown, 291 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 296 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c8f28131`
...
## Communities (716 total, 291 thin omitted)

### Community 0 - "Database Data"
Cohesion: 0.00
Nodes (561): BoolColumn get, _, _accentColorMeta, actualTableName, _addedAtMeta, _alertOnPeriodicPromptsMeta, _alertTimeHourMeta, _algorithmMeta (+553 more)
...
Cohesion: 0.01
Nodes (160): journalListEntriesProvider, accentColor, _appliedSavedPreferences, _applyJournalDeletedUiState, _applySavedPreferencesIfReady, _bodyFocusNode, bodyPreview, _bodySaveTimer (+152 more)

### Community 4 - "Features Shell"
Cohesion: 0.02
Nodes (125): Iterable, allowOverflow, allowVerticalOverflow, axisMaxY, axisMinY, belowPath, bottom, bottomAxisHeight (+117 more)
...
Cohesion: 0.01
Nodes (185): CharacterOpRegistry get, _activeDebouncers, _activelyEditedDocuments, addPendingTextMergeListener, applyPendingDreamEntryTextMerge, applyPendingJournalEntryTextMerge, applyPendingTodoTaskNotesMerge, at (+177 more)

### Community 7 - "Todo Features"
Cohesion: 0.02
Nodes (90): _applyPendingNotesMerge, _beginEditingSession, build, _buildHeader, _clearDueDate, _close, color, _controller (+82 more)

### Community 8 - "Repositories Domain"
Cohesion: 0.01
Nodes (200): addCustomWord, appendOperation, appendOperationGroup, appendOperationsBatch, authStateChanges, claimCalendarLock, claimWeatherFetchLock, countCardsReviewedToday (+192 more)
...
Cohesion: 0.01
Nodes (145): AsyncValue, CurvedAnimation, _activeInList, _activeSectionHeight, animateIn, _animController, _appliedSavedShowAllTasks, _applyListMoveOptimistic (+137 more)

### Community 12 - "Models Domain"
Cohesion: 0.01
Nodes (137): accentColor, alertOnPeriodicPrompts, alertTimeHour, birthDate, birthYear, calendarNavigateLeftKey, calendarNavigateRightKey, colorPalette (+129 more)

### Community 13 - "Calendar Markers"
Cohesion: 0.03
Nodes (68): build, buildCalendarTodoMarkers, CalendarDayTodoBar, CalendarDayTodoTile, calendarMaxTodoIconsPerDay, calendarMorphTodoIconProgress, calendarPackWeekAllDayShelf, calendarPackWeekEvents (+60 more)
...
Cohesion: 0.01
Nodes (209): addCustomWord, countCardsReviewedToday, countCardsReviewedTotal, countDueCards, countDueCardsInDeck, countEntriesByJournal, _db, deleteAllEntries (+201 more)

### Community 16 - "Sync Weather"
Cohesion: 0.02
Nodes (87): class MockDocumentReference extends, DocumentReference, Exception, FirebaseFirestore, SyncPayloadTooLargeException, BackupFormatException, package:voyager/data/remote/firestore_sync_repository.dart, package:voyager/features/settings/services/data_import_service.dart (+79 more)
...
Cohesion: 0.02
Nodes (103): activeWorkoutSessionProvider, all, allJournalEntriesScope, backupCollectionsProvider, bills, buildBackupCollections, buildCalendarTodoMarkers, buildNotificationFeed (+95 more)

### Community 19 - "Analytics Features"
Cohesion: 0.01
Nodes (218): DateTime get, accent, _addOption, all, analytics, anchor, anchorDateRect, anchorIndex (+210 more)
...
Cohesion: 0.03
Nodes (68): accent, child, _completingNow, _controller, createState, _dateLabel, days, didChangeDependencies (+60 more)
...
Cohesion: 0.05
Nodes (40): Archive, SettingsRepository, archive, backupFormatVersion, backupManifestFileName, buildArchiveContents, _collections, DataExportService (+32 more)
...
Cohesion: 0.04
Nodes (54): AddListDropdownValue, addListLabel, _AddListMenuItem, _AddListMenuItemState, _addListSentinel, BorderedRoundedDropdown, build, closedTrailing (+46 more)
...
Cohesion: 0.05
Nodes (40): _amPmController, applyTo, build, _buildWheel, createBallisticSimulation, createState, _currentAmPmIndex, _currentDate (+32 more)

### Community 30 - "Calendar Features"
Cohesion: 0.03
Nodes (66): _, allDay, allDayEvent, available, calendarDayEntriesForDay, CalendarDayEntry, CalendarDayEntryKind, calendarVisibleEntryCount (+58 more)
...
Cohesion: 0.03
Nodes (90): studyCardsProvider, studyDeckByIdProvider, studyDecksProvider, studyDeckStatsProvider, studyFoldersProvider, studyStatsProvider, build, build (+82 more)
...
Cohesion: 0.01
Nodes (182): Float32List, Image?, ImageShader?, a, accentColor, apply, _atlas, _atlasColors (+174 more)

### Community 39 - "Sync Engine"
Cohesion: 0.04
Nodes (56): BackgroundSyncOrchestrator, backoffMultiplier, _bucketListRepository, _calendarRepository, cancelScheduledDocumentSync, _crdtResolver, _debouncer, _debouncerFor (+48 more)

### Community 40 - "Calendar Event"
Cohesion: 0.05
Nodes (42): accentColor, alignLabelToTop, autofocus, borderRadius, build, _buildField, contentPadding, controller (+34 more)
...
Cohesion: 0.03
Nodes (76): build, color, ColorCornerFlag, colorValue, _CornerFlagPainter, JournalBookmarkFlag, JournalTitleCornerFlag, onSelected (+68 more)
...
Cohesion: 0.06
Nodes (35): createState, DevRemotePurgeSection, _DevRemotePurgeSectionState, dispose, _entryIdController, _purgeEntry, _purging, allJournals (+27 more)
...
Cohesion: 0.03
Nodes (60): _Device, _buffered, _maxBuffered, notify, notifyOne, onWrite, SyncedWriteNotifier, DriftBucketListRepository (+52 more)
...
Cohesion: 0.05
Nodes (42): anchor, _BreakdownRow, build, child, count, counts, date, difficulty (+34 more)
...
Cohesion: 0.02
Nodes (97): dart:convert, FirebaseException, SyncEngine, classifySyncFailure, describeSyncFailure, _permanentFirestoreCodes, SyncFailureKind, toString (+89 more)

### Community 62 - "Sync Activity"
Cohesion: 0.04
Nodes (52): abs, accent, _AnalyticsCard, anchor, _arcMidpoint, asset, _barsSpace, _bottomReserved (+44 more)
...
Cohesion: 0.04
Nodes (74): journalAllEntryIdsProvider, journalEntryCacheInvalidatorProvider, journalEntryCountsProvider, journalRepositoryProvider, journalsProvider, journalWriteCoordinatorProvider, quoteBankProvider, searchServiceProvider (+66 more)

### Community 67 - "Windows Ephemeral"
Cohesion: 0.06
Nodes (36): dart:typed_data, _Pixels, RenderRepaintBoundary, accentRun, bytes, closeTo, colorAt, _darkAccent (+28 more)

### Community 68 - "Firestore Data"
Cohesion: 0.03
Nodes (60): BackdropFilter, _amountController, build, createState, _date, _datePopoverOpen, dispose, existing (+52 more)
...
Cohesion: 0.05
Nodes (45): colorPaletteProvider, build, _changeEventColor, build, created, _createJournal, createState, _deleteJournal (+37 more)

### Community 73 - "Domain Services"
Cohesion: 0.06
Nodes (32): _bandAt, build, color, controller, createState, didUpdateWidget, dispose, focusNode (+24 more)

### Community 74 - "Widgets Keep"
Cohesion: 0.04
Nodes (49): Component, ComponentRegistrar, enabled, _isFreeTextKeyboard, obscureText, of, readOnly, true (+41 more)

### Community 75 - "Domain Services"
Cohesion: 0.05
Nodes (33): FlutterDesktopMessage, variant, TextureVariant, ErrorOr, v_, FlutterError, code_, details_ (+25 more)

### Community 76 - "Main App"
Cohesion: 0.04
Nodes (50): Finder get, id, OutOfSyncJournalEntryPurge, OutOfSyncJournalEntryTarget, purgeAll, purgeOne, searchHint, targets (+42 more)
...
Nodes (40): BoxConstraints?, BoxConstraints? constraints,
  ...
  bool, EdgeInsets, kVoyagerFieldScrollPadding, barrierColor, barrierDismissible (+32 more)
...
Cohesion: 0.05
Nodes (43): calendarEventsProvider, calendarRepositoryProvider, calendarsProvider, calendarTodoMarkersProvider, workoutDaysProvider, allCalendars, assigner, changeCalendarListColor (+35 more)
...
Cohesion: 0.06
Nodes (33): autoExpand, _Badge, createState, dispose, _editError, _editingId, error, initState (+25 more)

### Community 95 - "Theme Menu"
Cohesion: 0.11
Nodes (17): at, centers, count, _countRebuilds, counts, element, frame, _hoverStepCost (+9 more)
...
Cohesion: 0.06
Nodes (44): bool?, authNotifierProvider, backgroundSyncOrchestratorProvider, cachedCurrentWeatherProvider, connectivityStatusProvider, databaseProvider, lazyLoadProvider, liveSyncProvider (+36 more)
...
Cohesion: 0.03
Nodes (149): string_view, AuthPigeonFirebaseApp::AuthPigeonFirebaseApp(), EncodableMap, InternalActionCodeSettings, string, EncodableMap, InternalActionCodeInfoData::InternalActionCodeInfoData(), InternalActionCodeSettings (+141 more)
...
Cohesion: 0.07
Nodes (30): TrackerValue, Calendar, CalendarEvent, calendarId, colorValue, copyWith, end, EventRecurrence (+22 more)
...
Cohesion: 0.05
Nodes (40): DriftTodoRepository, TodoRepository, package:voyager/core/constants/todo_sort_constants.dart, package:voyager/domain/models/todo_models.dart, package:voyager/domain/todo/todo_task_sorting.dart, required int done,
  bool, required String id,
  bool, main (+32 more)

### Community 109 - "Dev Sync"
Cohesion: 0.04
Nodes (45): accentColor, _accept, _caretGap, child, _close, _closedTokenStart, color, controller (+37 more)
...
Cohesion: 0.04
Nodes (48): _absorbEdit, _advanceTabstop, _applying, _applyValue, _caret, contains, cutsLiteral, dispose (+40 more)
...
Cohesion: 0.05
Nodes (62): VimTextOverlay, _VimTextOverlayState, _VimFieldOverlay, _VimFieldOverlayState, VimTextScope, _VimTextScopeState, LabeledTextField, _LabeledTextFieldState (+54 more)

### Community 117 - "Sync Debouncer"
Cohesion: 0.04
Nodes (57): CodeController, LeetCodeCodeController, build, _buildEditor, code, _codeContentPadding, _codeDecoration, _codeEditorShortcuts (+49 more)
...
Cohesion: 0.08
Nodes (22): int?, build, colorValue, tag, TagChip, colorValue, completed, copyWith (+14 more)
...
Cohesion: 0.03
Nodes (69): EditableTextState, FocusNode, package:flutter_code_editor/flutter_code_editor.dart, package:voyager/core/snippets/snippet_enabled_scope.dart, package:voyager/core/snippets/snippet_session.dart, package:voyager/core/vim/vim_enabled_scope.dart, package:voyager/core/vim/vim_text_overlay.dart, package:voyager/core/vim/vim_text_scope.dart (+61 more)
...
Cohesion: 0.06
Nodes (31): JournalRepository, package:drift/drift.dart, package:voyager/core/constants/journal_constants.dart, support/journal_page_harness.dart, main, _bodyField, countEntriesByJournal, countEntriesCalls (+23 more)
...
Cohesion: 0.06
Nodes (32): subscriptionsProvider, Subscription, BillRadarPanel, build, _dueColor, _dueLabel, _EmptyRadar, showAnnual (+24 more)
...
Cohesion: 0.04
Nodes (48): CustomPainter, dart:math, indices, main, r, sorted, _ConfettiPainter, _VimOverlayPainter (+40 more)
...
Cohesion: 0.03
Nodes (71): accentColor, _advanceWidth, boxes, build, _caretForegroundFor, caretOffset, child, computeLuminance (+63 more)
...
Cohesion: 0.05
Nodes (44): AppLifecycleListener?, configureDesktopWindow, desktopWindowChromeActive, _desktopWindowConfigured, _away, _controller, dispose, _focusedSingleLineEditable (+36 more)

### Community 151 - "Widgets Confirm"
Cohesion: 0.11
Nodes (23): Auth, auth::AuthStateListener, auth::IdTokenListener, mutex, StreamHandler<flutter::EncodableValue>, AuthStateStreamHandler, auth_, listener_ (+15 more)

### Community 152 - "Weather Fakes"
Cohesion: 0.03
Nodes (68): GlobalKey, GlobalKey get, LayerLink, anchorOffset, applyPaintTransform, asIs, attach, build (+60 more)
...
Cohesion: 0.03
Nodes (59): Card, DateTime? dueAt,
  double, accent, build, _buildResults, _controller, createState, dispose (+51 more)
...
Cohesion: 0.04
Nodes (47): AppThemeMode, BillingPeriod, CalendarViewMode, HeatmapMode, SnippetExpandKey, StartupPageMode, TrackerCadence, TrackerStyle (+39 more)
...
Cohesion: 0.06
Nodes (31): build, QuickJournalPopup, QuickTodoPopup, getOrderedDestinations, icon, index, label, order (+23 more)

### Community 164 - "App Providers"
Cohesion: 0.03
Nodes (72): VimSession, accentColor, _active, _badge, _beginSuspension, blockCaret, build, builder (+64 more)
...
Cohesion: 0.05
Nodes (36): dropdownMenuTheme, _itemHighlightRadius, itemPadding, menuBorderRadius, menuColor, menuColorOf, menuStyle, menuTheme (+28 more)
...
Cohesion: 0.03
Nodes (72): leetcodeProblemsProvider, _ActivityDetailCard, _ActivityDetailCardState, anchorRect, build, _close, _closing, _controller (+64 more)
...
Cohesion: 0.07
Nodes (28): package:flutter/rendering.dart, package:voyager/core/widgets/notched_field_border.dart, package:voyager/features/dream_journal/dream_sticky_note.dart, RenderEditable?, _contentPadding, controller, _editableOrigin, focusNode (+20 more)
...
Cohesion: 0.18
Nodes (19): assetsProvider, assetValuationsProvider, budgetsProvider, financeCategoriesProvider, tagColorsProvider, transactionsProvider, _BreakdownCard, build (+11 more)
...
Cohesion: 0.07
Nodes (27): confirmed, context, copyLeetCodeCode, dismiss, draft, draftFuture, _firstCodeOf, gradeAndSaveLeetCodeProblem (+19 more)
...
Cohesion: 0.07
Nodes (31): class ConnectivityStatusController extends, DevSettingsController, FpsMonitorController, JournalDebugLogger, TodoSortDebugLogger, WindowFocusWatcher, ChangeNotifier, ConnectivityStatusController (+23 more)
...
Cohesion: 0.02
Nodes (134): DateTimeRange, financeRepositoryProvider, goalAllocationsProvider, savingsGoalsProvider, Budget, FinanceCategory, SavingsGoal, _AllocateModal (+126 more)
...
Cohesion: 0.06
Nodes (34): Delay, _authRepo, clearFor, _clearPending, data, _db, drainableCollections, _drainIndividually (+26 more)

### Community 203 - "Color"
Cohesion: 0.04
Nodes (46): accent, axis, _bottomFade, branchIndex, child, color, _CompactShell, _CompactStatusStrip (+38 more)
...
Cohesion: 0.04
Nodes (87): allTodoTasksProvider, leetCodeRepositoryProvider, remoteSyncServiceProvider, studyRepositoryProvider, todoListsProvider, todoRepositoryProvider, todoTasksProvider, _deleteTodoTask (+79 more)
...
Cohesion: 0.20
Nodes (9): FEEDBACK, Finance, Global App, Journal, LeetCode Tracker, Life Tracker, Search, Settings (+1 more)

### Community 227 - "MorphDayEventStack"
Cohesion: 0.02
Nodes (84): LeetCodeTrackDraft? draft,
  LeetCodeTrackDraftOutcome, accentColor, _addExample, _addSolution, algorithm, _applyRetrack, _attachDraftListeners, _attachSolutionListeners (+76 more)
...
Cohesion: 0.03
Nodes (73): LeetCodeProblem, LeetCodeSolution, anchorRect, build, _close, _closing, _ComplexityTile, _controller (+65 more)
...
Cohesion: 0.12
Nodes (15): int? current,
  Set, assign, nextColor, palette, PaletteAssigner, paletteFromItems, pickColorFromPalette, pickPaletteColorWithRef (+7 more)
...
Cohesion: 0.04
Nodes (55): bucketListItemsProvider, bucketListRepositoryProvider, BucketListItem, completed, completedAt, copyWith, createdAt, deletedAt (+47 more)
...
Cohesion: 0.02
Nodes (98): studyAllCardsProvider, StudyCard, _back, build, _canSave, createState, deckId, _delete (+90 more)
...
Cohesion: 0.11
Nodes (18): _collapseBlankLines, cut, _decodeHtmlEntities, _dropFromFirstExample, _dropTrailingSections, _exampleHeading, examples, headings (+10 more)

### Community 252 - "package:voyager/core/sync/text_delta_injector.dart"
Cohesion: 0.05
Nodes (38): _allDayFocusNode, build, _buildPayload, _calendarFlagColor, _calendarId, calendars, _closingAfterSave, _colorValue (+30 more)
...
Cohesion: 0.06
Nodes (35): autoExpand, copyWith, false, fromJson, hashCode, hasMatch, i, id (+27 more)
...
Cohesion: 0.03
Nodes (59): Exercise, controller, count, createState, _CurrentExerciseTitle, didUpdateWidget, _discard, dispose (+51 more)
...
Cohesion: 0.06
Nodes (47): ConsumerState, ConsumerStatefulWidget, ColorPickerField, _ColorPickerFieldState, CalendarEventPanel, _CalendarEventPanelState, CalendarTodoPanel, _CalendarTodoPanelState (+39 more)
...
Cohesion: 0.07
Nodes (29): _activeEditRange, build, _cachedSpans, controller, createState, descenderClearance, didChangeDependencies, didUpdateWidget (+21 more)

### Community 267 - "alertOnPeriodicPrompts"
Cohesion: 0.02
Nodes (107): , @DriftDatabase, Directory, fakes/fake_weather_api_client.dart, File, AppDatabase, DriftSettingsRepository, package:drift/native.dart (+99 more)
...
Cohesion: 0.07
Nodes (47): ConsumerWidget, activeWorkoutPlanProvider, allJournalEntriesProvider, analyticsServiceProvider, devLeafGalleryPanelOpenProvider, exercisesProvider, paperShaderProvider, periodicPromptServiceProvider (+39 more)

### Community 270 - "amountCents"
Cohesion: 0.04
Nodes (63): build, customQuotesProvider, customWordsProvider, quotePoolProvider, saveSettings, settingsRepositoryProvider, cancelLabel, confirmed (+55 more)
...
Cohesion: 0.09
Nodes (26): remoteSyncCompareServiceProvider, syncCompareLoggerProvider, build, _compareAllTodoLists, _compareJournalEntries, _compareTodoList, _comparing, createState (+18 more)

### Community 275 - "body"
Cohesion: 0.07
Nodes (28): package:voyager/features/leetcode/leetcode_flashcard.dart, package:voyager/features/leetcode/leetcode_inline_code.dart, package:voyager/features/leetcode/leetcode_mini_flashcard.dart, String? description,
  String, algorithm, _allText, codeLanguage, explanation (+20 more)

### Community 276 - "boolValue"
Cohesion: 0.04
Nodes (59): allDreamEntriesProvider, dreamRepositoryProvider, dreamWriteCoordinatorProvider, settingsProvider, SpringMotion, _defaultEventColor, build, build (+51 more)
...
Cohesion: 0.10
Nodes (19): TodoTask, BackupCollection, backupContentEquals, BackupRecord, buildBackupCollections, content, data, fromJson (+11 more)
...
Cohesion: 0.07
Nodes (27): bool get, BuildContext, attempted, attemptedFraction, attemptedPercent, CacheItemState, cacheStateColor, cacheStateLabel (+19 more)
...
Cohesion: 0.03
Nodes (79): Axis, build, CompactBackBar, label, onBack, _accept, active, allEntries (+71 more)
...
Cohesion: 0.03
Nodes (68): currentWeatherProvider, GeometricWaveShape, display, divisions, _GeometricTextureSlider, label, max, min (+60 more)
...
Cohesion: 0.13
Nodes (21): leetCodeDeckDifficultyFilterProvider, leetCodeDeckSearchQueryProvider, leetCodeDeckTagFilterProvider, build, _ControlBar, createState, _DeckSkeleton, _EmptyDeck (+13 more)

### Community 296 - "_StableViewScrollPosition"
Cohesion: 0.04
Nodes (49): MessageHandler, FirebaseAuthUserHostApi, FirebaseAuthUserHostApi, Delete, GetIdToken, LinkWithCredential, LinkWithProvider, ReauthenticateWithCredential (+41 more)
...
Cohesion: 0.12
Nodes (19): hiddenNotificationFeedProvider, notificationRepositoryProvider, pinnedNotesProvider, trackersProvider, visibleNotificationFeedProvider, _addNote, _AnalyticsSection, _AnalyticsSectionState (+11 more)
...
Cohesion: 0.11
Nodes (16): _auth, AuthNotifier, dispose, _isAuthenticated, _subscription, isAndroid, isWindows, VoyagerPlatform (+8 more)
...
Cohesion: 0.15
Nodes (14): notificationBadgeStateProvider, accent, _anchorKey, _bellHeight, _bellWidth, build, createState, _hovered (+6 more)
...
Nodes (29): DateTime? dueAt,
  int, isDue, longestJournalStreak, missedPeriods, _nextPeriod, PeriodicPromptService, periodStartFor, package:voyager/domain/models/enums.dart (+21 more)
...
Cohesion: 0.08
Nodes (23): allLists, assigner, choice, color, context, deleted, deleteTodoList, initial (+15 more)
...
Cohesion: 0.13
Nodes (16): InternalFirebaseAuthSettings, InternalFirebaseAuthSettings, app_verification_disabled_for_testing, force_recaptcha_flow, FromEncodableList, Hash, operator==, phone_number (+8 more)
...
Cohesion: 0.05
Nodes (41): AnimatedContainer, AsyncNotifier, SettingsNotifier, AppSettings, package:flutter/gestures.dart, package:voyager/core/theme/voyager_list_item_surface.dart, package:voyager/features/leetcode/leetcode_activity_bubble.dart, package:voyager/features/leetcode/leetcode_activity_calendar.dart (+33 more)
...
Cohesion: 0.06
Nodes (33): BaseSliderTrackShape, Color, Key? dateKey,
  double, alphaBlend, base, build, ChartHoverBubble, chartTooltipBubbleColor (+25 more)

### Community 354 - "vim_enabled_scope.dart"
Cohesion: 0.07
Nodes (29): Duration, barrierColor, barrierDismissible, shellNavHoverDuration, shellNavHoverFill, shellNavItemHeight, shellNavItemWidth, shellNavSelectedFill (+21 more)
...
Cohesion: 0.13
Nodes (14): _endpoint, fetchBySlug, fetchMostRecentAcceptedSubmission, fetchQuestionCounts, _http, LeetCodeApiClient, _naiveSlugify, _parseDifficulty (+6 more)
...
Cohesion: 0.20
Nodes (8): package:fl_chart/fl_chart.dart, package:voyager/features/shell/weather_chart_curve.dart, main, _readingTests, _series, curveFor, main, spots

### Community 366 - "life_tracker_models.dart"
Cohesion: 0.06
Nodes (30): int get, active, data, disabled, enabled, expandKey, hashCode, index (+22 more)
...
Cohesion: 0.18
Nodes (9): dart:ui, Error, didChangeAppLifecycleState, didChangeViewFocus, instance, _viewFocused, static final WindowFocusWatcher, main (+1 more)
...
Cohesion: 0.04
Nodes (47): dart:io, _append, applySettings, _appStartMarker, bodyDraftEntryIds, bodyFocused, bodyText, clearLog (+39 more)

### Community 378 - "PetalField"
Cohesion: 0.07
Nodes (27): FirestorePullService, RemoteSyncService, package:voyager/core/sync/remote_sync_service.dart, package:voyager/features/leetcode/leetcode_page.dart, RenderObject?, _background, _boundaryKey, _fadingAncestors (+19 more)
...
Cohesion: 0.33
Nodes (5): insideTag, tagRanges, tokenizeWords, _wordPattern, package:voyager/core/utils/journal_tags.dart
...
Cohesion: 0.03
Nodes (103): InternalAuthCredentialInput, K, EncodableList, InternalAdditionalUserInfo, InternalAuthCredential, InternalIdTokenResult, InternalMultiFactorInfo, InternalMultiFactorSession (+95 more)
...
### Community 442 - "InternalUserDetails"
Cohesion: 0.05
Nodes (33): _set, function, TextureRegistrarImpl::UnregisterTexture(), GetRegistrar(), FlutterDesktopPluginRegistrarRef, T, unique_ptr, Plugin (+25 more)

### Community 443 - "<FirebaseAuthUserHostApi>"
Cohesion: 0.13
Nodes (15): <FirebaseAuthUserHostApi>, -deleteAppcompletion, -getIdTokenAppforceRefreshcompletion, -linkWithCredentialAppinputcompletion, -linkWithProviderAppsignInProvidercompletion, -reauthenticateWithCredentialAppinputcompletion, -reauthenticateWithProviderAppsignInProvidercompletion, -reloadAppcompletion (+7 more)

### Community 444 - "geometric_texture_settings.dart"
Cohesion: 0.33
...
Cohesion: 0.08
Nodes (29): authRepositoryProvider, todoListStatsProvider, build, createState, dispose, _emailController, _error, _formatAuthError (+21 more)

### Community 462 - "<MultiFactorTotpHostApi>"
Cohesion: 0.07
Nodes (29): Duration? dwell,
  Duration, IconData? icon,
  List, actions, build, _controller, createState, dismiss, dismissed (+21 more)
...
### Community 510 - "ByteStreamWriter"
Cohesion: 0.06
Nodes (33): Alignment, BorderRadius, IconData, body, build, floatingActionButton, PlatformAdaptiveScaffold, accentBorder (+25 more)
...
### Community 647 - "static final"
Cohesion: 0.07
Nodes (28): DriftLeetCodeRepository, LeetCodeRepository, package:voyager/core/tags/tag_suggestions.dart, package:voyager/features/leetcode/leetcode_track_modal.dart, _FakeLeetCodeRepository, _RecordingLeetCodeRepository, _RecordingLeetCodeRepository, _FakeLeetCodeRepository (+20 more)

### Community 648 - "PixelBufferTexture"
Cohesion: 0.47
Nodes (4): CopyBufferCallback, FlutterDesktopPixelBuffer, PixelBufferTexture, copy_buffer_callback_

### Community 649 - "dart:ui"
Cohesion: 0.33
...
### Community 651 - "heatmap_calendar.dart"
Cohesion: 0.22
...
### Community 655 - "_TagSuggestionPortalState"
Cohesion: 0.40
...
Cohesion: 0.07
Nodes (37): devGeometricTexturePanelOpenProvider, devGeometricWavePanelOpenProvider, geometricDebugRowFadeProvider, geometricShaderProvider, geometricTextureParamsProvider, geometricWaveParamsProvider, snippetScopeProvider, themeModeProvider (+29 more)
...
### Community 664 - "package:voyager/domain/services/weather_forecast_chart.dart"
Cohesion: 0.50
Nodes (4): FLTAuthStateChannelStreamHandler, -initWithAuth, FlutterStreamHandler, NSObject

### Community 667 - "<MultiFactorTotpHostApi>"
Cohesion: 0.33
Nodes (6): <MultiFactorUserHostApi>, -enrollPhoneAppassertiondisplayNamecompletion, -enrollTotpAppassertionIddisplayNamecompletion, -getEnrolledFactorsAppcompletion, -getSessionAppcompletion, -unenrollAppfactorUidcompletion
...
### Community 669 - "package:voyager/domain/services/weather_forecast_chart.dart"
Cohesion: 0.06
Nodes (29): dart:async, _callbacks, flushAll, instance, PendingFlushRegistry, register, unregister, _activeUntil (+21 more)

### Community 671 - "stat_number_format_test.dart"
Cohesion: 0.03
Nodes (60): journalDebugLoggerProvider, studyFolderByIdProvider, loadDictionaryFromAssets, raw, srsMasteryColor, build, child, EnterToSubmitScope (+52 more)

### Community 679 - "voyager_icons.dart"
Cohesion: 0.18
Nodes (9): calendar, debug, journal, manage, search, VoyagerIcons, kMinTouchTarget, package:flutter/widgets.dart (+1 more)

### Community 681 - "_HeatmapSquare"
Cohesion: 0.50
...
Cohesion: 0.06
Nodes (41): flutter::StandardCodecSerializer, GenerateInterfaces, EncodableValue, FlutterError, MultiFactoResolverHostApi, MultiFactorTotpHostApi, MultiFactorTotpSecretHostApi, MultiFactorUserHostApi (+33 more)
...
### Community 705 - "InternalPhoneMultiFactorAssertion"
Cohesion: 0.22
...
### Community 715 - "FLTPhoneNumberVerificationStreamHandler"
Cohesion: 0.20
...
### Community 718 - "<MultiFactorTotpHostApi>"
Cohesion: 0.24
Nodes (7): <MultiFactorTotpHostApi>, -generateSecretSessionIdcompletion, -getAssertionForEnrollmentSecretKeyoneTimePasswordcompletion, -getAssertionForSignInEnrollmentIdoneTimePasswordcompletion, <MultiFactorTotpSecretHostApi>, -generateQrCodeUrlSecretKeyaccountNameissuercompletion, -openInOtpAppSecretKeyqrCodeUrlcompletion

## Knowledge Gaps
- **11905 isolated node(s):** `s`, `ops`, `pos`, `main`, `s1` (+11900 more)
...
- **Why does `ActionCodeInfoOperation` connect `FLTAuthStateChannelStreamHandler` to `Todo Task`, `addedAt`, `Windows Ephemeral`, `Constants Google`, `Features Settings`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `InternalActionCodeInfo` connect `Features Settings` to `FLTAuthStateChannelStreamHandler`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `ActionCodeInfoOperationBox` connect `Features Settings` to `FLTAuthStateChannelStreamHandler`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **What connects `s`, `ops`, `pos` to the rest of the system?**
  _11906 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Database Data` be split into smaller, more focused modules?**
  _Cohesion score 0.0035587188612099642 - nodes in this community are weakly interconnected._
