# Graph Report - Voyager  (2026-07-24)

## Corpus Check
- 357 files · ~345,477 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7835 nodes · 11054 edges · 440 communities (245 shown, 195 thin omitted)
...
## Communities (440 total, 195 thin omitted)
...
Cohesion: 0.02
Nodes (88): _applyPendingNotesMerge, _beginEditingSession, build, _buildHeader, _clearDueDate, _close, color, _compactIconButtonStyle (+80 more)
...
Cohesion: 0.02
Nodes (95): CurvedAnimation, _activeInList, animateIn, _animController, _applyListMoveOptimistic, _applyPersistedSortBatchToUi, _applySortBatchOptimistic, _buildCheckbox (+87 more)
...
Cohesion: 0.04
Nodes (61): dart:convert, fakes/fake_weather_api_client.dart, SyncEngine, InMemorySyncRepository, list, loadQuotesFromAssets, raw, package:flutter_test/flutter_test.dart (+53 more)
...
Cohesion: 0.03
Nodes (62): AsyncValue, all, allJournalEntriesScope, buildCalendarTodoMarkers, controller, dailyTrackers, dataExportServiceProvider, db (+54 more)
...
Cohesion: 0.04
Nodes (48): build, createState, dispose, initialColor, initState, _nameController, palette, _selectedColor (+40 more)

### Community 21 - "Search Features"
Cohesion: 0.05
Nodes (42): journalWriteCoordinatorProvider, searchServiceProvider, _writeCoordinatorOrNull, _accentColor, _bodyController, _bodyFocusNode, build, _changeEntryDateAndTime (+34 more)

### Community 22 - "Todo Features"
Cohesion: 0.07
Nodes (33): journalListEntriesProvider, journalRepositoryProvider, build, created, createState, _deleteJournal, _entryCounts, initState (+25 more)
...
Cohesion: 0.04
Nodes (49): boxH, boxW, cappedMaxHeight, cappedMaxWidth, cell, clipPartialNextRow, ColorPaletteGrid, _ColorSwatch (+41 more)
...
Cohesion: 0.06
Nodes (31): accent, branchIndex, child, color, createState, dispose, event, _hovered (+23 more)
...
Cohesion: 0.08
Nodes (26): assetValuationsProvider, _asOf, _AssetModal, _AssetModalState, build, _canSave, _colorValue, createState (+18 more)
...
Cohesion: 0.07
Nodes (32): calendarRepositoryProvider, calendarsProvider, allCalendars, assigner, changeCalendarListColor, choice, color, controller (+24 more)

### Community 39 - "Sync Engine"
Cohesion: 0.05
Nodes (36): BackgroundSyncOrchestrator, backoffMultiplier, _calendarRepository, cancelScheduledDocumentSync, _crdtResolver, _debouncer, _debouncerFor, _delayForAttempt (+28 more)
...
Cohesion: 0.08
Nodes (34): authNotifierProvider, backgroundSyncOrchestratorProvider, databaseProvider, lazyLoadProvider, liveSyncProvider, quotesLoadedProvider, shellDataWarmupProvider, syncEngineProvider (+26 more)
...
Cohesion: 0.06
Nodes (33): InputCounterWidgetBuilder?, accentColor, autofocus, build, buildCounter, controller, createState, cursorColor (+25 more)

### Community 52 - "Weather Features"
Cohesion: 0.05
Nodes (44): journalAllEntryIdsProvider, journalEntryCountsProvider, quoteBankProvider, settingsRepositoryProvider, weatherServiceProvider, AppSettings, _apiKeyController, build (+36 more)

### Community 53 - "Widgets Field"
Cohesion: 0.06
Nodes (34): bool?, FocusNode get, accentColor, alignLabelToTop, autofocus, borderRadius, build, contentPadding (+26 more)
...
Cohesion: 0.13
Nodes (15): double?, fpsMonitorProvider, accent, build, current, _FpsCard, _FpsReadout, _graphHeight (+7 more)
...
Cohesion: 0.06
Nodes (34): dataImportServiceProvider, journalsProvider, todoListStatsProvider, allJournals, assigner, changeJournalListColor, choice, color (+26 more)
...
Cohesion: 0.15
Nodes (11): calendar, debug, journal, manage, search, VoyagerIcons, package:flutter/widgets.dart, package:voyager/core/utils/key_binding.dart (+3 more)
...
Cohesion: 0.04
Nodes (51): dart:io, Future, clearLog, _enqueue, log, _logFileName, logFilePath, _maxLogBytes (+43 more)
...
Cohesion: 0.04
Nodes (56): journalDebugLoggerProvider, pendingStatEntriesProvider, weatherIconData, build, StatisticsActionFab, _closingAfterSave, _completed, createState (+48 more)
...
Cohesion: 0.07
Nodes (27): StatisticTracker, build, HeatmapCalendar, month, tracker, values, _buildEditor, createState (+19 more)
...
Cohesion: 0.10
Nodes (25): deviceIdProvider, syncActivityProvider, build, _confirmDeleteAllEntries, _confirmResetJournals, DevPage, devShowTimeSelectorHitboxesProvider, devSlowHeatmapPopoverAnimationProvider (+17 more)
...
Cohesion: 0.09
Nodes (22): applySettings, devForceConflictUi, loadFromSettings, _persist, setDevForceConflictUi, setShowCacheStatus, setShowCalendarInstantViewSwitch, setShowCalendarZoomPrewarm (+14 more)
...
Cohesion: 0.08
Nodes (27): @immutable, CacheItemStatus get, int get, CacheItemStatus, ConfettiEffect, PaperTextureParams, PetalFieldParams, checks (+19 more)

### Community 105 - "Features Calendar"
Cohesion: 0.10
Nodes (23): themeModeProvider, _AppBackground, build, buildScrollbar, createState, didChangeAppLifecycleState, dispose, _flushAllPendingEdits (+15 more)
...
Cohesion: 0.11
Nodes (17): Client, FirebaseAuth, _apiKey, _http, _periodFromForecastItem, refreshForecast, refreshWeather, _auth (+9 more)
...
Cohesion: 0.05
Nodes (34): int?, decoration, restingColor, selectedColor, VoyagerListItemSurface, best, colorFor, cursor (+26 more)
...
Cohesion: 0.06
Nodes (32): colorPaletteProvider, build, _changeEventColor, createJournalList, _createJournal, pickAccentColor, _addMinorPetalColor, divisions (+24 more)
...
Cohesion: 0.09
Nodes (21): BinaryMessenger, Send, SetMessageHandler, EventChannel, codec_, messenger_, name_, string (+13 more)
...
Cohesion: 0.09
Nodes (35): _ConfettiBurst, _ConfettiBurstState, _ContextMenuOverlay, _ContextMenuOverlayState, ContextMenuRegion, _ContextMenuRegionState, _CreateNameColorDialog, _CreateNameColorDialogState (+27 more)
...
Cohesion: 0.08
Nodes (25): IconData, build, QuickJournalPopup, QuickTodoPopup, icon, index, label, order (+17 more)
...
Cohesion: 0.05
Nodes (41): Alignment, BorderRadius, alignment, blurSigma, borderColor, borderOpacity, borderRadius, borderWidth (+33 more)
...
Cohesion: 0.09
Nodes (20): isDue, longestJournalStreak, missedPeriods, _nextPeriod, PeriodicPromptService, periodStartFor, package:voyager/domain/models/enums.dart, analytics (+12 more)
...
Cohesion: 0.08
Nodes (22): ChangeNotifier, _auth, AuthNotifier, dispose, _isAuthenticated, _subscription, DevSettingsController, FpsMonitorController (+14 more)
...
Cohesion: 0.07
Nodes (27): EditableText, build, child, EnterToSubmitScope, onSubmit, _textFieldHasFocus, build, child (+19 more)
...
Cohesion: 0.06
Nodes (48): ConsumerWidget, assetsProvider, budgetsProvider, financeCategoriesProvider, tagColorsProvider, transactionsProvider, CashFlowGranularity, _HeatmapGrid (+40 more)

### Community 164 - "App Providers"
Cohesion: 0.06
Nodes (38): financeRepositoryProvider, _save, _delete, _save, _BudgetModal, _BudgetModalState, build, _canSave (+30 more)
...
Cohesion: 0.06
Nodes (65): ConsumerState, ConsumerStatefulWidget, allTodoTasksProvider, cachedCurrentWeatherProvider, calendarEventsProvider, calendarTodoMarkersProvider, journalEntryCacheInvalidatorProvider, remoteSyncServiceProvider (+57 more)

### Community 169 - "@immutable"
Cohesion: 0.33
Nodes (6): Color, currentWeatherProvider, accent, build, main, _WeatherRailProbe
...
Cohesion: 0.10
Nodes (18): class, geometricShaderProvider, appSettingsWithGeometricTextureParams, appSettingsWithGeometricWaveParams, copyWith, geometricTextureParamsFromSettings, geometricWaveParamsFromSettings, _advance (+10 more)
...
Cohesion: 0.25
Nodes (7): dart:async, _callbacks, flushAll, instance, PendingFlushRegistry, register, unregister
...
Cohesion: 0.06
Nodes (38): DateTimeRange, goalAllocationsProvider, savingsGoalsProvider, formatTime12Hour, formatTimeOfDay12Hour, jm, local, now (+30 more)
...
Cohesion: 0.15
Nodes (12): build, child, color, GeometricProgressRing, paint, progress, _RingPainter, segments (+4 more)
...
Cohesion: 0.40
Nodes (6): devLeafGalleryPanelOpenProvider, paperShaderProvider, petalFieldParamsProvider, _PaperBackground, build, DevLeafGallerySection
...
Cohesion: 0.05
Nodes (47): _, @DriftDatabase, Delay, _authRepo, _db, _firestore, initialize, _instance (+39 more)
...
Cohesion: 0.05
Nodes (35): bool get, HotKey?, configureDesktopWindow, desktopWindowChromeActive, _desktopWindowConfigured, body, build, floatingActionButton (+27 more)
...
Cohesion: 0.12
Nodes (15): package:voyager/core/constants/todo_sort_constants.dart, package:voyager/domain/todo/todo_task_sorting.dart, required String id,
  bool, byId, dueDate, dueDateSetAt, id, main (+7 more)

### Community 362 - "dart:ui"
Cohesion: 0.06
Nodes (30): applyMergedPayload, applyMergedText, CharacterSequenceCrdtMerger, _extractExplicitCharOps, _extractSnapshot, _latestSnapshot, mergeOperations, _pickBody (+22 more)
...
## Knowledge Gaps
- **5684 isolated node(s):** `s`, `ops`, `pos`, `main`, `s1` (+5679 more)
...
- **Why does `DartProject` connect `quick_popups.dart` to `MessageHandler`, `Gradient Widgets`, `FlutterViewController::HandleTopLevelWindowProc`, `Windows Runner`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **What connects `s`, `ops`, `pos` to the rest of the system?**
  _5684 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `Journal Features` be split into smaller, more focused modules?**
