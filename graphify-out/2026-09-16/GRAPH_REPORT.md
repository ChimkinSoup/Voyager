...
## Summary
- 25947 nodes · 41259 edges · 653 communities (605 shown, 48 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 297 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4b3a441d`
...
## Communities (653 total, 48 thin omitted)

### Community 0 - "Drift Database Schema — app_database"
Cohesion: 0.00
Nodes (1142): BoolColumn get, _, _accentColorMeta, actualTableName, _addedAtMeta, _alertOnPeriodicPromptsMeta, _alertTimeHourMeta, _algorithmMeta (+1134 more)
...
Cohesion: 0.01
Nodes (271): AnimationStatusListener?, _, CalendarEvent?, _abortMorphAnimation, accentColor, adjacentColor, _advanceWarmup, _appliedSavedCalendarView (+263 more)
...
Cohesion: 0.01
Nodes (251): CharacterOpRegistry get, CharacterSequenceCrdtMerger, CrdtDocumentResolver, _activeDebouncers, _activelyEditedDocuments, addPendingTextMergeListener, _adoptLegacySnippets, applyPendingDreamEntryTextMerge (+243 more)
...
Cohesion: 0.01
Nodes (198): JournalDebugLogger?, JournalWriteCoordinator?, journalAllEntryIdsProvider, journalEntryCacheInvalidatorProvider, journalEntryCountsProvider, journalListEntriesProvider, journalRepositoryProvider, _confirmDeleteAllEntries (+190 more)
...
Cohesion: 0.04
Nodes (56): AutocorrectFlashLayer, EditableText, context, focus, isTextInputFocused, subtreeIsVisible, package:voyager/core/snippets/snippet_enabled_scope.dart, package:voyager/core/snippets/snippet_index.dart (+48 more)
...
Cohesion: 0.03
Nodes (73): dart:io, MediaFileStore, package:image/image.dart, package:voyager/core/media/media_service.dart, package:voyager/core/media/widgets/media_drop_target.dart, package:voyager/core/media/widgets/media_fan_stack.dart, package:voyager/core/media/widgets/media_image.dart, package:voyager/data/services/media_file_store.dart (+65 more)

### Community 15 - "Sync Engine — firestore_document_mapper"
Cohesion: 0.01
Nodes (203): applicationUrl, assetRoomEventToFirestore, assetToFirestore, assetValuationToFirestore, body, bucketListItemToFirestore, budgetToFirestore, calendarEventToFirestore (+195 more)
...
Cohesion: 0.02
Nodes (137): hiddenNotificationFeedProvider, notificationRepositoryProvider, pinnedNotesProvider, visibleNotificationFeedProvider, accent, _addNote, build, child (+129 more)

### Community 19 - "Journal Feature — journal_page"
Cohesion: 0.01
Nodes (157): AuthNotifier, AutocorrectScopeData, CacheStatusSnapshot, ChangeNotifierProvider, ConnectivityStatusController, DataExportService, DevSettingsController, DreamWriteCoordinator (+149 more)
...
Cohesion: 0.02
Nodes (108): ContextMenuRegionState, _applyPendingNotesMerge, _beginEditingSession, _buildFields, _buildSubtaskList, _clearDueDate, _close, color (+100 more)

### Community 28 - "Study Feature — ConsumerState"
Cohesion: 0.03
Nodes (67): journalWriteCoordinatorProvider, searchServiceProvider, _writeCoordinatorOrNull, _accentColor, _activeQuery, _baseline, body, _bodyController (+59 more)

### Community 29 - "Test Suite — journal_settings_dialog_test"
Cohesion: 0.02
Nodes (100): AssetRoomEvent? get, assetRoomEventsProvider, assetsProvider, assetValuationsProvider, contributionRoomsProvider, AssetRoomEvent, Asset, build (+92 more)

### Community 30 - "Finance Feature — finance_analytics_view"
Cohesion: 0.02
Nodes (102): budgetsProvider, financeCategoriesProvider, tagColorsProvider, transactionsProvider, abs, accent, _AnalyticsCard, anchor (+94 more)

### Community 31 - "Firebase Auth (windows) — messages.g.cpp"
Cohesion: 0.03
Nodes (122): InternalActionCodeInfoData, InternalAuthCredentialInput, K, FromEncodableList, operator==, ToEncodableList, AuthPigeonFirebaseApp, EncodableList (+114 more)

### Community 32 - "Test Suite — jobs_track_flow_test"
Cohesion: 0.03
Nodes (64): @DriftDatabase, AppDatabase, InMemorySyncRepository, DriftJournalRepository, package:voyager/core/sync/synced_write_notifier.dart, package:voyager/domain/services/ordered_list_edit.dart, package:voyager/domain/services/weather_service.dart, _StalledSyncRepository (+56 more)

### Community 33 - "Journal Feature — journal_list_actions"
Cohesion: 0.03
Nodes (72): GlassButton, DriftSettingsRepository, ListView, package:voyager/core/tags/tag_palette.dart, package:voyager/data/database/app_database.dart, package:voyager/data/repositories/drift_repositories.dart, package:voyager/features/settings/dictionary_dialog.dart, package:voyager/features/settings/job_experience_snippets_dialog.dart (+64 more)
...
Cohesion: 0.02
Nodes (109): DreamEntry?, allDreamEntriesProvider, dreamRepositoryProvider, dreamWriteCoordinatorProvider, accentColor, _appliedSavedWidth, _bodyEditorKey, _bodyEntryId (+101 more)
...
Cohesion: 0.01
Nodes (155): LeafDesign, _AnalyticsToolbar, _EmptyTrackersCard, _GridView, _HeatmapGroupDivider, _HeatmapMonthTile, _MacroStatsRow, _SectionLabel (+147 more)

### Community 42 - "Test Suite — package:flutter_test/flutter"
Cohesion: 0.02
Nodes (99): class MockDocumentReference extends, DocumentReference, FirebaseFirestore, ../test/fakes/fake_weather_api_client.dart, addCustomWord, authStateChanges, batch, batchCreatedCount (+91 more)
...
Cohesion: 0.09
Nodes (25): customQuotesProvider, quotePoolProvider, CustomQuote, build, _add, build, _controller, createState (+17 more)
...
Cohesion: 0.02
Nodes (86): AnimatedContainer, package:flutter/gestures.dart, package:voyager/core/sync/crdt_document_resolver.dart, package:voyager/core/theme/voyager_list_item_surface.dart, package:voyager/domain/models/todo_models.dart, package:voyager/features/todo/todo_edit_panel.dart, package:voyager/features/todo/todo_list_search_bar.dart, support/todo_page_harness.dart (+78 more)
...
Cohesion: 0.04
Nodes (48): FinancialTransaction?, TransactionType, amountCents, _amountController, container, createState, _date, _datePopoverOpen (+40 more)
...
Cohesion: 0.04
Nodes (51): Finder get, package:voyager/features/dream_journal/dream_journal_page.dart, _bodyField, container, db, _delegate, getAllEntries, getAllEntriesCalls (+43 more)
...
Cohesion: 0.04
Nodes (44): package:voyager/core/widgets/voyager_time_picker_spinner.dart, package:voyager/features/jobs/jobs_company_field.dart, required List, company, controller, focusField, main, now (+36 more)
...
Cohesion: 0.06
Nodes (32): dart:ui, DecoratedBox, Error, package:voyager/core/vim/vim_anchored_chrome.dart, package:voyager/core/widgets/geometric_texture.dart, main, main, main (+24 more)
...
Cohesion: 0.05
Nodes (37): AppLifecycleListener?, buildOverscrollIndicator, buildScrollbar, createState, didChangeAppLifecycleState, dispose, _flushAllPendingEdits, _flushDeadline (+29 more)
...
Cohesion: 0.07
Nodes (32): ActivityAware, ActivityPluginBinding, FlutterFirebasePlugin, FlutterPlugin, FlutterPluginBinding, Task, FlutterFirebaseAuthPlugin, Activity (+24 more)
...
Cohesion: 0.03
Nodes (64): File, package:drift/native.dart, package:voyager/core/widgets/notification_urgency_dot.dart, package:voyager/features/analytics/tracker_entry_row.dart, close, customStatement, db, dir (+56 more)
...
Cohesion: 0.03
Nodes (79): BackgroundSyncOrchestrator, backoffMultiplier, _bucketListRepository, _calendarRepository, cancelScheduledDocumentSync, _crdtResolver, _debouncer, _debouncerFor (+71 more)

### Community 73 - "Shared Widgets — _State"
Cohesion: 0.02
Nodes (98): EditableTextState, loadDictionaryFromAssets, raw, createState, dispose, _entryIdController, _purgeEntry, _purging (+90 more)
...
Cohesion: 0.03
Nodes (70): Container, DateTime? dateApplied,
...
Cohesion: 0.01
Nodes (182): FinanceCategory?, financeRepositoryProvider, subscriptionsProvider, build, CompactBackBar, label, onBack, build (+174 more)
...
Cohesion: 0.04
Nodes (60): InMemorySyncRepository, currentUid, delete, download, message, toString, upload, android (+52 more)
...
Cohesion: 0.02
Nodes (85): CodeController, LeetCodeCodeController, build, code, _codeContentPadding, _codeDecoration, _codeEditorShortcuts, _codeFocusNode (+77 more)
...
Cohesion: 0.03
Nodes (76): colorPaletteProvider, build, _changeEventColor, _add, _changeEventColor, pickAccentColor, _addMinorPetalColor, _PetalSettings (+68 more)

### Community 87 - "Study Feature — ConsumerState"
Cohesion: 0.03
Nodes (104): leetCodeRepositoryProvider, remoteSyncServiceProvider, studyRepositoryProvider, todoListsProvider, todoRepositoryProvider, _syncServiceOrNull, _save, _save (+96 more)
...
Cohesion: 0.02
Nodes (99): fakes/fake_weather_api_client.dart, package:voyager/data/remote/in_memory_sync.dart, package:voyager/domain/models/enums.dart, package:voyager/features/finance/finance_analytics_view.dart, package:voyager/features/finance/finance_budget_panel.dart, package:voyager/features/finance/finance_net_flow_chart.dart, package:voyager/features/finance/finance_net_flow_hero.dart, package:voyager/features/finance/finance_page.dart (+91 more)

### Community 90 - "Test Suite — scroll_offset_isolate_test"
Cohesion: 0.02
Nodes (113): EdgeInsets, VoyagerSpellCheckService, srsMasteryColor, autofocus, build, child, CtrlEnterToSubmitScope, isSubmitChord (+105 more)
...
Cohesion: 0.06
Nodes (51): ConsumerState, ConsumerStatefulWidget, ColorPickerField, _ColorPickerFieldState, CalendarEventPanel, _CalendarEventPanelState, _CalendarManageDialog, _CalendarManageDialogState (+43 more)
...
Cohesion: 0.04
Nodes (53): DateTime? stamp,
  int, id, OutOfSyncJournalEntryPurge, OutOfSyncJournalEntryTarget, purgeAll, purgeOne, searchHint, targets (+45 more)

### Community 101 - "Test Suite — package:flutter_test/flutter"
Cohesion: 0.03
Nodes (74): Color?, accentColor, build, _canPop, createState, didUpdateWidget, dispose, _firstSelected (+66 more)

### Community 102 - "App Wiring & Providers — voyager_app"
Cohesion: 0.04
Nodes (50): leetcodeProblemsProvider, leetcodeQuestionCountsProvider, build, build, build, _kLeetCodeActivityBreakpoint, _kLeetCodeActivityCardWidth, _kLeetCodeSplitBreakpoint (+42 more)
...
Cohesion: 0.04
Nodes (52): package:voyager/core/soft_delete/restore_contract.dart, package:voyager/domain/models/ranking_models.dart, package:voyager/features/rankings/rankings_actions.dart, category, close, customStatement, db, dir (+44 more)
...
Cohesion: 0.05
Nodes (35): AnimationController, Curve, animateTo, controller, defaultSpring, dispose, jumpTo, _spring (+27 more)
...
Cohesion: 0.04
Nodes (51): dart:typed_data, FirebaseStorage, _auth, _classify, currentUid, delete, download, FirebaseMediaStorage (+43 more)

### Community 113 - "Runner — win32_window.cpp"
Cohesion: 0.03
Nodes (64): ClipRect, double? initial,
  int, _Host, VoyagerSpinnerWheel, RankingFieldValue, RankingScorePrecision, RankingTemplateField, accent (+56 more)

### Community 114 - "Firebase Auth (windows) — firebase_auth_plugin.cpp"
Cohesion: 0.15
Nodes (58): AuthError, Credential, FutureBase, AuthPigeonFirebaseApp, AuthResult, FlutterError, function, InternalActionCodeSettings (+50 more)
...
Cohesion: 0.06
Nodes (33): hasStartupBacklog, inFlight, inFlightLimit, isPaused, isStalled, limit, _maxProbeRejections, _onQueueDrained (+25 more)
...
Cohesion: 0.02
Nodes (102): int?, build, colorValue, tag, TagChip, accentColor, build, maxLines (+94 more)
...
Cohesion: 0.02
Nodes (92): InputCounterWidgetBuilder?, accentColor, alignLabelToTop, allowShortHeight, autocorrectAllowed, autofocus, borderRadius, build (+84 more)

### Community 134 - "Study Feature — ConsumerState"
Cohesion: 0.04
Nodes (48): LeetCodeProblem, confirmed, container, context, copyLeetCodeCode, current, deleteLeetCodeProblem, dismiss (+40 more)
...
Cohesion: 0.03
Nodes (70): Alignment, bool? enableDrag,
  BorderRadius, BorderRadius, alignment, autofocus, borderColor, borderOpacity, borderRadius (+62 more)
...
Cohesion: 0.04
Nodes (45): nextQuote, QuoteBank, _quotes, _random, _used, build, DevPerfStallLogSection, _logDialogOpen (+37 more)
...
Cohesion: 0.05
Nodes (43): StudySessionPage, package:voyager/features/settings/services/data_export_service.dart, package:voyager/features/settings/services/data_import_service.dart, _calendar, _collectionsFor, deletedAt, _event, id (+35 more)
...
Cohesion: 0.03
Nodes (62): CalendarTodoPanel, _CalendarTodoPanelState, _closingAfterSave, _completed, createState, didUpdateWidget, _discard, dispose (+54 more)
...
Cohesion: 0.03
Nodes (72): allSegments, buildExerciseHistory, byDay, colorValue, completed, completedAt, copyWith, count (+64 more)
...
Cohesion: 0.04
Nodes (42): package:voyager/domain/todo/todo_recurring_completion.dart, ProviderContainer, container, db, _journalA, _journalB, main, readMood (+34 more)
...
Cohesion: 0.05
Nodes (41): Completer, http.BaseClient, SettingsRepository, StreamedResponse, _StubSettingsRepository, db, ensureVisible, enterText (+33 more)
...
Cohesion: 0.03
Nodes (79): studyFolderByIdProvider, JobApplication, RankingStatus, display, divisions, _GeometricTextureSlider, label, max (+71 more)
...
Cohesion: 0.03
Nodes (98): AutomaticKeepAliveClientMixin, ChildIndexGetter?, EdgeInsetsGeometry?, IndexedWidgetBuilder, _VimFieldOverlay, _VimFieldOverlayState, VimTextScope, _VimTextScopeState (+90 more)
...
Cohesion: 0.04
Nodes (49): IconButton, RepeatIconButton, package:voyager/core/media/widgets/media_gallery_strip.dart, package:voyager/core/widgets/repeat_selector_popover.dart, package:voyager/domain/models/recurrence_rule.dart, _anchor, captured, _choose (+41 more)

### Community 205 - "Domain Models — SoftDeletable"
Cohesion: 0.05
Nodes (47): TrackerValue, ContributionRoom, AssetValuation, FinanceCategory, FinancialTransaction, GoalAllocation, applicationId, applicationUrl (+39 more)
...
Cohesion: 0.05
Nodes (38): fakes/input_order_random.dart, NavigatorState, package:voyager/features/study/study_cram_page.dart, _cardOffset, cards, container, _deckId, main (+30 more)

### Community 208 - "Prose Markup — prose_markup"
Cohesion: 0.03
Nodes (71): FirebaseException, SyncEngine, classifySyncFailure, describeSyncFailure, _permanentFirestoreCodes, SyncFailureKind, toString, byId (+63 more)

### Community 209 - "Sync Engine — outbox_sync_worker"
Cohesion: 0.04
Nodes (51): ChangeNotifier, Delay, FirestoreWriteGate, _authRepo, _beforeInitialize, clearFor, _clearPending, data (+43 more)
...
Cohesion: 0.06
Nodes (38): brightness, _categoryById, _closePanel, _ColumnMenu, _ColumnMenuState, _companyByKey, _CompanyColors, _confirmDelete (+30 more)
...
Cohesion: 0.02
Nodes (84): CustomPaint, empty, hasImage, hasText, imageBytes, _imageFormats, isEmpty, isImageOnly (+76 more)
...
Cohesion: 0.08
Nodes (23): applySettings, devForceConflictUi, DevSettingsController, disableCache, loadFromSettings, _persist, setDevForceConflictUi, setDisableCache (+15 more)
...
Cohesion: 0.03
Nodes (71): lifeTrackerStatsProvider, accentColor, BlossomStatPopup, build, _lineWidth, _padding, painter, stat (+63 more)
...
Cohesion: 0.04
Nodes (64): mediaDiskLowProvider, mediaServiceProvider, mediaStorageProvider, mediaStorageUsageProvider, build, _reload, build, _reload (+56 more)
...
Cohesion: 0.04
Nodes (50): Archive, dart:convert, list, loadQuotesFromAssets, raw, archive, backupFormatVersion, backupManifestFileName (+42 more)
...
Cohesion: 0.05
Nodes (42): journalsProvider, Journal, affectedEntryIds, allJournals, assigner, changeJournalListColor, choice, color (+34 more)
...
Cohesion: 0.06
Nodes (33): _auth, AuthNotifier, dispose, _isAuthenticated, _subscription, _auth, _authErrorMessage, authStateChanges (+25 more)
...
Cohesion: 0.06
Nodes (29): _authorizationEndpoint, DesktopGoogleOAuth, redirectUri, _tokenEndpoint, anchorRect, build, _close, _closing (+21 more)

### Community 251 - "Shared Widgets — notched_field_border"
Cohesion: 0.07
Nodes (30): _attach, back, build, controller, createState, _detach, didUpdateWidget, dispose (+22 more)

### Community 252 - "Leetcode Feature — leetcode_review_deck"
Cohesion: 0.10
Nodes (26): autocorrectScopeProvider, devGeometricTexturePanelOpenProvider, geometricDebugRowFadeProvider, geometricShaderProvider, geometricTextureParamsProvider, snippetScopeProvider, themeModeProvider, _AppBackground (+18 more)
...
Cohesion: 0.04
Nodes (45): JournalEntry?, current, entry, JournalEntryDeletion, media, mediaDeletedAt, remoteSync, repository (+37 more)
...
Cohesion: 0.05
Nodes (37): VoyagerMenuCatalogEntry, VoyagerMenuCatalogEntryLabels, build, _calendars, _counts, _createCalendar, _createdCalendarId, createdId (+29 more)
...
Cohesion: 0.06
Nodes (33): CharacterOperation, absorbRemote, allOps, CharacterOpRegistry, CharacterOpSession, clear, clientId, ensureSession (+25 more)
...
Cohesion: 0.08
Nodes (12): ActionCodeSettings, GetTokenResult, FirebaseUser, InternalActionCodeSettings, AuthCredential, AuthResult, FirebaseUser, InternalActionCodeSettings (+4 more)

### Community 271 - "Sync Engine — dart:async"
Cohesion: 0.07
Nodes (26): StatisticTracker, build, HeatmapCalendar, month, tracker, values, package:voyager/domain/models/analytics_models.dart, package:voyager/domain/services/analytics_service.dart (+18 more)
...
Cohesion: 0.04
Nodes (53): FadeTransition, build, QuickJournalPopup, QuickTodoPopup, getOrderedDestinations, icon, index, label (+45 more)

### Community 278 - "Shared Widgets — keep_alive_scroll"
Cohesion: 0.05
Nodes (38): dart:async, Exception, abortIfAlreadyRestored, floor, RestoreSuperseded, restoreVersionFrom, toString, SyncBackpressureException (+30 more)

### Community 279 - "Firebase Auth (android) — NonNull"
Cohesion: 0.13
Nodes (15): HotKey?, body, build, floatingActionButton, PlatformAdaptiveScaffold, createHotkeyService, dispose, HotkeyService (+7 more)
...
Cohesion: 0.05
Nodes (46): Directory, LeetCodeScratchSession? get, LeetCodeScratchSession, _chain, clear, _deleteQuietly, _file, FileLeetCodeScratchDraftStore (+38 more)
...
Cohesion: 0.02
Nodes (127): ProseSpanBuilder, _bleed, build, _buildPath, _cachedPath, _cachedSize, _clear, color (+119 more)

### Community 284 - "Shared Widgets — _State"
Cohesion: 0.07
Nodes (29): dispose, _handleLifecycleState, initState, _isVisible, _lifecycle, _lifecycleVisible, _minimized, onWindowBlur (+21 more)

### Community 285 - "Shared Widgets — date_selector_popover"
Cohesion: 0.09
Nodes (23): App, Auth, auth::AuthStateListener, auth::IdTokenListener, Future, mutex, StreamHandler<flutter::EncodableValue>, AuthStateStreamHandler (+15 more)
...
Cohesion: 0.11
Nodes (18): class, _addColor, build, _colorChip, createState, dispose, _hexController, _hexError (+10 more)
...
Cohesion: 0.08
Nodes (24): applyStyledRanges, at, base, buildStyledRuns, children, cursor, next, out (+16 more)
...
Cohesion: 0.06
Nodes (30): _, weatherForecastProvider, _advance, build, createState, dispose, _done, _frame (+22 more)
...
Cohesion: 0.05
Nodes (43): Animation, _animDuration, _barVisible, build, child, _controller, createState, DesktopWindowFrame (+35 more)
...
Cohesion: 0.03
Nodes (79): allTodoTasksProvider, calendarRepositoryProvider, calendarsProvider, calendarViewEventsProvider, settingsProvider, todoListStatsProvider, todoTasksProvider, workoutDaysProvider (+71 more)

### Community 303 - "Leetcode Feature — leetcode_activity_bubble"
Cohesion: 0.04
Nodes (48): ByteData, Image, package:voyager/domain/models/life_tracker_models.dart, package:voyager/domain/models/notification_models.dart, container, db, main, now (+40 more)
...
Cohesion: 0.03
Nodes (76): currentWeatherProvider, _Await, barrierDismissible, package:flutter_riverpod/flutter_riverpod.dart, package:voyager/app/providers.dart, package:voyager/core/theme/voyager_theme.dart, package:voyager/core/widgets/weather_icon.dart, package:voyager/features/jobs/jobs_page.dart (+68 more)
...
Cohesion: 0.03
Nodes (73): authRepositoryProvider, build, createState, dispose, _emailController, _error, _formatAuthError, _googleSignIn (+65 more)
...
Cohesion: 0.07
Nodes (22): calendar, debug, journal, manage, search, VoyagerIcons, kMinTouchTarget, isCompactWidth (+14 more)
...
Cohesion: 0.05
Nodes (41): accent, chars, formattedDate, formattedTime, paragraphs, readingTimeMin, sentences, showMoveToJournalDialog (+33 more)
...
Cohesion: 0.04
Nodes (52): AsyncNotifier, SettingsNotifier, AppSettings, LeetCodeScratchPad, package:voyager/core/widgets/tag_chip.dart, package:voyager/features/leetcode/leetcode_providers.dart, required String title,
  List, static AppSettings? (+44 more)

### Community 326 - "Uncategorized — crdt_scramble_test"
Cohesion: 0.09
Nodes (19): main, ops, pos, s, allOps, main, merger, opsA (+11 more)
...
Cohesion: 0.07
Nodes (26): MemoryFinanceUiPrefsStore? prefsStore,
  bool, SegmentedButton, centre, container, db, expense, main, mid (+18 more)
...
Cohesion: 0.05
Nodes (39): _activeEditRange, build, _cachedSpans, controller, createState, descenderClearance, didChangeDependencies, didUpdateWidget (+31 more)
...
Cohesion: 0.08
Nodes (21): Duration, cancel, DebouncedCallback, debounceDelay, Debouncer, delay, dispose, schedule (+13 more)
...
Cohesion: 0.10
Nodes (20): IconData? get, Iterable, buildCatalogMenu, calendarManageMenuEntries, configurableManageMenuEntries, defaultCalendarManageMenuEntries, defaultCatalogMenuChild, defaultConfigurableManageMenuEntries (+12 more)
...
Cohesion: 0.03
Nodes (99): studyCardImagesProvider, studyCardsProvider, studyDeckByIdProvider, studyDeckGraphProvider, studyDecksProvider, studyDeckStatsProvider, studyFoldersProvider, StudyDeckLink (+91 more)
...
Cohesion: 0.06
Nodes (34): _attempts, _downloadDraining, _downloadOne, _downloadWakeupPending, drain, drainDownloads, drainUploads, isTransferring (+26 more)

### Community 365 - "dev_fps_counter_tile.dart"
Cohesion: 0.05
Nodes (42): SpringMotion, ActiveWorkoutView, build, accent, build, color, createState, didChangeDependencies (+34 more)

### Community 366 - "Firebase Auth (ios) — CustomPigeonHeader"
Cohesion: 0.04
Nodes (47): int? initialColor,
  String, build, _canSave, _colorValue, container, createState, _datePopoverOpen, dispose (+39 more)
...
Cohesion: 0.10
Nodes (20): container, db, disposeJournalPage, harnessJournal, journalHarnessId, journalHarnessName, journalHarnessSecondId, journalHarnessSecondName (+12 more)

### Community 370 - "Analytics Feature — analytics_page"
Cohesion: 0.10
Nodes (36): build, customWordsProvider, dictionaryProvider, flaggedWordsProvider, saveJobExperienceSnippets, saveSettings, saveSnippets, settingsRepositoryProvider (+28 more)

### Community 371 - "Media Handling — media_clipboard"
Cohesion: 0.06
Nodes (35): _Repaint, CapsLockState, FpsMonitorController, JournalDebugLogger, PerfStallLogger, _append, applySettings, clearLog (+27 more)

### Community 372 - "Shared Widgets — create_name_color_dialog"
Cohesion: 0.04
Nodes (45): AnalyticsService, booleanTrueCount, completedTasks, countWords, heatmapIntensity, integerSeries, interpolateConsecutive, rollingMax (+37 more)
...
Cohesion: 0.13
Nodes (18): FederatedOAuthProvider, AdditionalUserInfo, EncodableMap, InternalAdditionalUserInfo, InternalSignInProvider, map, PhoneAuthCredential, Variant (+10 more)
...
Cohesion: 0.11
Nodes (28): rankingCategoriesProvider, rankingChildrenByParentProvider, rankingParentsProvider, RankingFilters, build, _createCategory, build, _CategoryBody (+20 more)

### Community 381 - "Shared Widgets — color_picker_field"
Cohesion: 0.01
Nodes (161): DateTime?, DailyFlow, NetFlowSeries, CalendarDayEntry, build, CalendarDayEntryBar, date, entry (+153 more)
...
Cohesion: 0.10
Nodes (19): package:voyager/core/constants/todo_sort_constants.dart, package:voyager/domain/todo/todo_task_sorting.dart, required String id,
  bool, db, journalRepo, main, todoRepo, trackerRepo (+11 more)
...
Cohesion: 0.11
Nodes (26): syncActivityProvider, build, devDisablePetalFieldProvider, devForceOfflineProvider, DevPage, devShowTimeSelectorHitboxesProvider, devSlowHeatmapPopoverAnimationProvider, devSlowTodoEditPanelAnimationProvider (+18 more)
...
Cohesion: 0.04
Nodes (44): CrdtDocumentResolver, _merger, _mergeSyncOperations, resolvePayload, reconcileTagPalette, records, rewritten, appSettingsWithGeometricTextureParams (+36 more)
...
Cohesion: 0.14
Nodes (10): AuthStateListener, FirebaseAuth, FirebasePluginPlatform, FirebaseService, IdTokenListener, AuthStateChannelStreamHandler, Override, IdTokenChannelStreamHandler (+2 more)
...
Cohesion: 0.11
Nodes (18): Icon, package:voyager/features/calendar/calendar_event_panel.dart, required CalendarEvent? event,
  double, container, db, id, kEventPopupWidth, main (+10 more)
...
Cohesion: 0.05
Nodes (58): financeUiPrefsProvider, HotkeyService, authNotifierProvider, backgroundSyncOrchestratorProvider, connectivityStatusProvider, databaseProvider, deviceIdProvider, firestoreWriteGateProvider (+50 more)

### Community 412 - "Demo Feature"
Cohesion: 0.05
Nodes (41): GoRouter, Key? get, auth, _preloadedShellPaths, routerProvider, settingsRepo, package:go_router/go_router.dart, package:voyager/core/widgets/desktop_window_frame.dart (+33 more)
...
Cohesion: 0.02
Nodes (93): all, CalendarEventDeletion, confirmed, deleteCalendarEventInteractive, deletion, events, message, _orphanedOverrideIds (+85 more)

### Community 419 - "Ephemeral — string"
Cohesion: 0.14
Nodes (13): DateTime? recurrenceEndDate,
  List, package:voyager/domain/services/calendar_recurrence.dart, coveredDays, d, end, event, exceptionDates, main (+5 more)
...
Cohesion: 0.03
Nodes (74): BackdropFilter, BuildContext, ColoredBox, firestoreId, legacyTodoListFirestoreId, legacyTodoListId, localId, todoListDocumentIdForFirestore (+66 more)
...
Cohesion: 0.05
Nodes (51): ConsumerWidget, cacheStatusSnapshotProvider, devLeafGalleryPanelOpenProvider, devSettingsProvider, fpsMonitorProvider, paperShaderProvider, petalFieldParamsProvider, _PaperBackground (+43 more)
...
Cohesion: 0.03
Nodes (68): DateTime? deletedAt,
  int, MoodGradientSlider, OverlayState, package:drift/drift.dart, package:flutter_test/flutter_test.dart, package:voyager/core/constants/google_auth_config.dart, package:voyager/core/constants/journal_constants.dart, package:voyager/core/constants/todo_constants.dart (+60 more)
...
Cohesion: 0.07
Nodes (20): ForceResendingToken, Locale?, PhoneMultiFactorInfo, InternalVerifyPhoneNumberRequest, InternalVerifyPhoneNumberRequest, Activity, AuthPigeonFirebaseApp, InternalVerifyPhoneNumberRequest (+12 more)
...
Cohesion: 0.18
Nodes (11): package:flutter/scheduler.dart, package:voyager/core/motion/modal_scrim_observer.dart, build, context, _controller, createState, dispose, main (+3 more)
...
Cohesion: 0.04
Nodes (55): LeetCodeSolution, _BackSolution, _backTitleKey, _cardRadius, controller, createState, _frontTitleKey, _glassContainer (+47 more)
...
Cohesion: 0.03
Nodes (60): GenerateInterfaces, FlutterError, MultiFactoResolverHostApi, MultiFactorTotpHostApi, MultiFactorTotpSecretHostApi, MultiFactorUserHostApi, CreateConnectionError(), WrapError (+52 more)
...
Cohesion: 0.06
Nodes (32): build, caption, child, deviatesFromPlan, itemHeight, onInteraction, onRepsChanged, onWeightChanged (+24 more)
...
Cohesion: 0.07
Nodes (28): clear, container, db, draft, drafts, ensureSeeded, enterText, fieldLabelled (+20 more)
...
Cohesion: 0.07
Nodes (27): double get, WeightUnit, build, createState, dispose, exercise, ExerciseTarget, _reps (+19 more)

### Community 496 - "Core Utilities — journal_tags"
Cohesion: 0.05
Nodes (43): double?, double? contentWidth,
  bool, build, _CreateNameColorDialog, _CreateNameColorDialogState, createState, dispose, initialColor (+35 more)
...
Cohesion: 0.03
Nodes (80): Brightness, DateTimeRange, goalAllocationsProvider, savingsGoalsProvider, formatTime12Hour, formatTimeOfDay12Hour, jm, local (+72 more)
...
Cohesion: 0.08
Nodes (32): allJournalEntriesProvider, analyticsServiceProvider, periodicPromptServiceProvider, trackerCacheInvalidatorProvider, trackersProvider, trackerValuesProvider, AnalyticsPage, build (+24 more)
...
Cohesion: 0.40
Nodes (4): package:voyager/features/settings/settings_color_palette_section.dart, dragSwatch, main, palette
...
Cohesion: 0.06
Nodes (29): searchEntries, SearchService, package:voyager/core/sync/soft_delete_policy.dart, package:voyager/domain/models/journal_models.dart, package:voyager/domain/services/periodic_prompt_service.dart, package:voyager/domain/services/search_service.dart, package:voyager/domain/services/sequence_crdt_merger.dart, required String title,
  String (+21 more)
...
Cohesion: 0.14
Nodes (12): dart:math, indices, main, r, sorted, package:voyager/domain/services/fractional_index.dart, chars, digits (+4 more)
...
Cohesion: 0.04
Nodes (52): IconData?, _bucket, build, child, createState, accentColor, build, child (+44 more)
...
Cohesion: 0.18
Nodes (23): jobApplicationsProvider, jobCategoriesProvider, jobCompaniesProvider, jobSeasonsProvider, jobStagesProvider, build, _CategoriesTab, _CategoriesTabState (+15 more)
...
Cohesion: 0.07
Nodes (26): _Device, _buffered, notify, notifyOne, onWrite, SyncedWriteNotifier, bucketList, calendar (+18 more)
...
### Community 1017 - "_CalendarMorphWarmupState"
Cohesion: 0.29
Nodes (7): CalendarMorphWarmup, _CalendarMorphWarmupState, _MonthWeekMorphLayer, _MonthWeekMorphLayerState, _MorphAnimationLayer, _MorphAnimationLayerState, State

## Knowledge Gaps
- **19297 isolated node(s):** `Non-goals (v1)`, `2. Product behavior (summary)`, `3.1 Cascade (per-step uniqueness)`, `3.2 Applying the correction`, `4.1 Field and mode` (+19292 more)
...
- **Why does `ActionCodeInfoOperation` connect `Firebase Auth (windows) — firebase_auth_plugin.cpp` to `Firebase Auth (ios) — firebase_auth_messages.g`, `Firebase Auth (macos) — firebase_auth_messages.g`, `Firebase Auth (android) — NonNull`, `Firebase Auth (android) — NonNull`, `Firebase Auth (windows) — messages.g.cpp`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `InternalActionCodeInfo` connect `Firebase Auth (macos) — firebase_auth_messages.g` to `Firebase Auth (windows) — firebase_auth_plugin.cpp`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `ActionCodeInfoOperationBox` connect `Firebase Auth (macos) — firebase_auth_messages.g` to `Firebase Auth (windows) — firebase_auth_plugin.cpp`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **What connects `Non-goals (v1)`, `2. Product behavior (summary)`, `3.1 Cascade (per-step uniqueness)` to the rest of the system?**
  _19298 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Drift Database Schema — app_database` be split into smaller, more focused modules?**
  _Cohesion score 0.0017497812773403325 - nodes in this community are weakly interconnected._
