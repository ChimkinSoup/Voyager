# Graph Report - Voyager  (2026-09-16)

## Corpus Check
- 1039 files · ~1,453,280 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 25851 nodes · 40812 edges · 1002 communities (619 shown, 383 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 297 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `de96fabd`
...
1. `_State` - 139 edges
2. `settingsProvider` - 98 edges
3. `remoteSyncServiceProvider` - 92 edges
...
## Communities (1002 total, 383 thin omitted)

### Community 0 - "Drift Database Schema — app_database"
Cohesion: 0.00
Nodes (801): BoolColumn get, _, _accentColorMeta, actualTableName, _addedAtMeta, _alertOnPeriodicPromptsMeta, _alertTimeHourMeta, _algorithmMeta (+793 more)
...
Cohesion: 0.01
Nodes (325): addCustomWord, _applicationCompanion, applyJobExperienceSnippetEdit, applySnippetEdit, _categoryCompanion, _childCompanion, _companyCompanion, countCardsReviewedToday (+317 more)

### Community 3 - "Calendar Feature — calendar_page"
Cohesion: 0.01
Nodes (274): AnimationStatusListener?, _, _abortMorphAnimation, accentColor, adjacentColor, _advanceWarmup, _appliedSavedCalendarView, _applySavedCalendarPreferences (+266 more)

### Community 4 - "Repository Interfaces"
Cohesion: 0.01
Nodes (290): addCustomWord, appendOperation, appendOperationGroup, appendOperationsBatch, applyJobExperienceSnippetEdit, applySnippetEdit, authStateChanges, claimCalendarLock (+282 more)
...
Cohesion: 0.01
Nodes (240): CharacterOpRegistry get, _activeDebouncers, _activelyEditedDocuments, addPendingTextMergeListener, _adoptLegacySnippets, applyPendingDreamEntryTextMerge, applyPendingJournalEntryTextMerge, applyPendingTodoTaskNotesMerge (+232 more)
...
Cohesion: 0.01
Nodes (174): accent, accentColor, allEntriesCount, _appliedSavedPreferences, _applySavedPreferencesIfReady, _attachedEntryId, _bodyEntryId, _bodyFocusNode (+166 more)

### Community 10 - "Firebase Auth (windows) — messages.g.cpp"
Cohesion: 0.03
Nodes (182): string_view, AuthPigeonFirebaseApp, app_name_, AuthPigeonFirebaseApp::AuthPigeonFirebaseApp(), custom_auth_domain, FromEncodableList, Hash, operator== (+174 more)

### Community 11 - "Finance Feature — finance_transaction_modal"
Cohesion: 0.02
Nodes (108): EditableText, EditableTextState, context, focus, isTextInputFocused, subtreeIsVisible, build, canManage (+100 more)
...
Cohesion: 0.01
Nodes (168): accentColor, alertOnPeriodicPrompts, alertTimeHour, autocorrectEnabled, birthDate, birthYear, calendarNavigateLeftKey, calendarNavigateRightKey (+160 more)

### Community 14 - "Test Suite — study_card_editor_images_tes"
Cohesion: 0.03
Nodes (79): dart:io, Directory, _NoScrollbarScrollBehavior, MediaService, MediaFileStore, MaterialScrollBehavior, package:image/image.dart, package:voyager/core/media/media_service.dart (+71 more)

### Community 15 - "Sync Engine — firestore_document_mapper"
Cohesion: 0.01
Nodes (202): applicationUrl, assetRoomEventToFirestore, assetToFirestore, assetValuationToFirestore, body, bucketListItemToFirestore, budgetToFirestore, calendarEventToFirestore (+194 more)
...
Cohesion: 0.01
Nodes (150): hiddenNotificationFeedProvider, notificationRepositoryProvider, pinnedNotesProvider, trackersProvider, visibleNotificationFeedProvider, accent, _addNote, _AnalyticsSection (+142 more)

### Community 19 - "Journal Feature — journal_page"
Cohesion: 0.01
Nodes (136): ChangeNotifierProvider, activeWorkoutSessionProvider, all, allJournalEntriesScope, backupCollectionsProvider, bills, brightness, buildBackupCollections (+128 more)
...
Cohesion: 0.04
Nodes (71): rankingCategoriesProvider, rankingChildrenByParentProvider, rankingParentsProvider, RankingFilters, _createCategory, actionLabel, _ArchivedBanner, build (+63 more)

### Community 25 - "Jobs Feature — StatelessWidget"
Cohesion: 0.08
Nodes (31): activeWorkoutPlanProvider, exercisesProvider, workoutPlanEntriesProvider, workoutPlansProvider, WorkoutPlan, build, _CycleAnchorControl, _dateForDay (+23 more)
...
Cohesion: 0.02
Nodes (99): _applyPendingNotesMerge, _beginEditingSession, _buildFields, _buildSubtaskList, _clearDueDate, _close, color, _container (+91 more)

### Community 28 - "Study Feature — ConsumerState"
Cohesion: 0.03
Nodes (64): _accentColor, _activeQuery, _baseline, body, _bodyController, _bodyFocusNode, _changeEntryDateAndTime, _coordinator (+56 more)

### Community 29 - "Test Suite — journal_settings_dialog_test"
Cohesion: 0.02
Nodes (118): AssetRoomEvent? get, assetRoomEventsProvider, assetsProvider, assetValuationsProvider, budgetsProvider, contributionRoomsProvider, financeCategoriesProvider, tagColorsProvider (+110 more)

### Community 30 - "Finance Feature — finance_analytics_view"
Cohesion: 0.03
Nodes (80): abs, accent, anchor, _arcMidpoint, asset, _AssetRow, _AssetRowState, _barsSpace (+72 more)

### Community 31 - "Firebase Auth (windows) — messages.g.cpp"
Cohesion: 0.03
Nodes (103): InternalAuthCredentialInput, K, EncodableList, InternalActionCodeSettings, InternalAdditionalUserInfo, InternalAuthCredential, InternalFirebaseAuthSettings, InternalIdTokenResult (+95 more)

### Community 32 - "Test Suite — jobs_track_flow_test"
Cohesion: 0.01
Nodes (200): @DriftDatabase, dart:convert, DateTime? stamp,
  int, _Device, FirebaseException, _FlakySyncRepository, FirestorePullService, RemoteSyncService (+192 more)

### Community 33 - "Journal Feature — journal_list_actions"
Cohesion: 0.05
Nodes (41): JournalRepository, package:voyager/features/settings/job_experience_snippets_dialog.dart, button, db, descriptionField, descriptionText, main, nameField (+33 more)
...
Cohesion: 0.05
Nodes (33): FlutterDesktopMessage, TextureVariant, ErrorOr, v_, FlutterError, code_, details_, message_ (+25 more)
...
Cohesion: 0.04
Nodes (109): AssetRoomEventsTableCompanion, AssetRoomEventsTableData, AssetsTableCompanion, AssetsTableData, AssetValuationsTableCompanion, AssetValuationsTableData, BucketListItemsTableCompanion, BucketListItemsTableData (+101 more)

### Community 40 - "Media Handling — media_fan_stack"
Cohesion: 0.04
Nodes (64): studyStatsProvider, borderColor, build, child, _closeGeneration, _closing, _create, _createFolderOrDeck (+56 more)

### Community 41 - "Test Suite — package:voyager/domain/repos"
Cohesion: 0.02
Nodes (148): body, build, floatingActionButton, PlatformAdaptiveScaffold, _AnalyticsToolbar, _EmptyTrackersCard, _GridView, _HeatmapGroupDivider (+140 more)

### Community 42 - "Test Suite — package:flutter_test/flutter"
Cohesion: 0.02
Nodes (92): class MockDocumentReference extends, ../test/fakes/fake_weather_api_client.dart, addCustomWord, authStateChanges, batch, batchCreatedCount, batches, bucketListRepo (+84 more)

### Community 43 - "Test Suite — package:flutter_test/flutter"
Cohesion: 0.06
Nodes (33): int get, copyWith, description, fromJson, hashCode, id, JobExperienceSnippet, listFromJson (+25 more)
...
Cohesion: 0.06
Nodes (51): journalAllEntryIdsProvider, journalDebugLoggerProvider, journalEntryCacheInvalidatorProvider, journalEntryCountsProvider, journalListEntriesProvider, journalRepositoryProvider, journalsProvider, journalWriteCoordinatorProvider (+43 more)
...
Cohesion: 0.03
Nodes (64): AnimatedContainer, package:flutter/gestures.dart, package:voyager/features/todo/todo_edit_panel.dart, package:voyager/features/todo/todo_list_search_bar.dart, support/todo_page_harness.dart, deleteTaskFromRow, gesture, main (+56 more)

### Community 49 - "Test Suite — package:flutter/services"
Cohesion: 0.06
Nodes (37): _ActivityDetailCard, _ActivityDetailCardState, anchorRect, _close, _closing, _controller, createState, dispose (+29 more)

### Community 50 - "Finance Feature — finance_analytics_view"
Cohesion: 0.04
Nodes (47): TransactionType, amountCents, _amountController, container, createState, _date, _datePopoverOpen, dispose (+39 more)
...
Cohesion: 0.03
Nodes (64): Finder get, _dreamRepository, DreamWriteCoordinator, _findTask, _journalRepository, _remoteSync, saveEntry, saveTask (+56 more)
...
Cohesion: 0.03
Nodes (72): defaultColorPalette, firestoreId, legacyTodoListFirestoreId, legacyTodoListId, localId, todoListDocumentIdForFirestore, todoListDocumentIdFromFirestore, reconcileTagPalette (+64 more)
...
Cohesion: 0.04
Nodes (45): DecoratedBox, GlobalKey, GlobalKey get, _RenderCapsLockCaret, RenderVimAnchoredChrome, attach, createRenderObject, detach (+37 more)
...
Cohesion: 0.05
Nodes (27): Retention, Target, AuthPigeonFirebaseApp, FirebaseAuthHostApi, FirebaseAuthUserHostApi, FlutterError, GenerateInterfaces, InternalUserCredential (+19 more)

### Community 63 - "Shared Widgets — settingsProvider"
Cohesion: 0.04
Nodes (44): buildOverscrollIndicator, buildScrollbar, createState, didChangeAppLifecycleState, dispose, _flushAllPendingEdits, _flushDeadline, getScrollPhysics (+36 more)
...
Cohesion: 0.04
Nodes (10): ByteBuffer, GeneratedAndroidFirebaseAuth, InternalAuthCredentialInput, InternalMultiFactorSession, InternalPhoneMultiFactorAssertion, InternalSignInProvider, InternalUserProfile, Override (+2 more)
...
Cohesion: 0.03
Nodes (59): accentColor, animates, _animating, baseColor, build, _clock, copyWith, createState (+51 more)

### Community 72 - "Test Suite — package:flutter_test/flutter"
Cohesion: 0.03
Nodes (66): BackgroundSyncOrchestrator, backoffMultiplier, _bucketListRepository, _calendarRepository, cancelScheduledDocumentSync, _crdtResolver, _debouncer, _debouncerFor (+58 more)

### Community 73 - "Shared Widgets — _State"
Cohesion: 0.03
Nodes (78): loadDictionaryFromAssets, raw, VimSession, createState, dispose, _entryIdController, _purgeEntry, _purging (+70 more)
...
Cohesion: 0.02
Nodes (98): package:voyager/core/constants/job_constants.dart, package:voyager/domain/models/job_models.dart, package:voyager/features/jobs/job_clipboard_parser.dart, package:voyager/features/jobs/jobs_actions.dart, package:voyager/features/jobs/jobs_page.dart, package:voyager/features/jobs/jobs_stage_colors.dart, ReorderableListView, required String company,
  List (+90 more)

### Community 76 - "Workout Feature — exercise_detail_view"
Cohesion: 0.03
Nodes (72): exerciseSetLogsProvider, workoutCacheInvalidatorProvider, workoutRepositoryProvider, workoutSessionsProvider, anchorRect, anchorRectFor, box, build (+64 more)

### Community 77 - "Shared Widgets — _State"
Cohesion: 0.10
Nodes (24): authRepositoryProvider, mediaDiskLowProvider, mediaStorageUsageProvider, build, createState, dispose, _emailController, _error (+16 more)
...
Cohesion: 0.03
Nodes (70): id, OutOfSyncJournalEntryPurge, OutOfSyncJournalEntryTarget, purgeAll, purgeOne, searchHint, targets, title (+62 more)

### Community 81 - "Leetcode Feature — leetcode_code_controller"
Cohesion: 0.03
Nodes (64): 0, apostrophe, at, backspace, bare, base, caret, char (+56 more)
...
Cohesion: 0.02
Nodes (115): financeRepositoryProvider, subscriptionsProvider, Budget, Subscription, _detach, _delete, _save, BillRadarPanel (+107 more)
...
Cohesion: 0.04
Nodes (54): card, cards, childDecks, childFolders, color, confirmed, container, contents (+46 more)
...
Cohesion: 0.01
Nodes (163): DriftFinanceRepository, FinanceRepository, deleteBudgetWithUndo, deleteSubscriptionWithUndo, softDeleteWithUndo, MemoryFinanceUiPrefsStore? prefsStore,
  bool, package:flutter_riverpod/flutter_riverpod.dart, package:voyager/app/providers.dart (+155 more)
...
Cohesion: 0.04
Nodes (74): ConsumerWidget, allJournalEntriesProvider, allTodoTasksProvider, analyticsServiceProvider, calendarViewEventsProvider, googleCalendarSyncProvider, lifeTrackerStatsProvider, paperShaderProvider (+66 more)
...
Cohesion: 0.03
Nodes (67): _addMonths, allocatedAt, amountCents, anchorDueDate, annualCents, annualCentsFor, asOf, assetId (+59 more)
...
Cohesion: 0.05
Nodes (39): build, LeetCodePage, _LeetCodeViewMode, _leetCodeViewModeProvider, after, before, _canRedo, _canUndo (+31 more)
...
Cohesion: 0.05
Nodes (39): RankingStatus, accent, build, category, children, createState, _decoration, _hasProgress (+31 more)

### Community 109 - "Study Feature — ConsumerState"
Cohesion: 0.04
Nodes (61): sessionShuffleRandomProvider, studyAllCardsProvider, studyAllDecksProvider, _syncProblems, _syncQueue, _applyDecision, bucket0, bucket1 (+53 more)
...
Cohesion: 0.03
Nodes (59): assetRoomEvents, assets, assetValuations, bucketListItems, budgets, calendarEvents, calendars, contributionRooms (+51 more)

### Community 112 - "Study Feature — ConsumerState"
Cohesion: 0.03
Nodes (58): dart:typed_data, FirebaseStorage, googleOAuthClientId, _googleOAuthClientIdRaw, googleOAuthClientSecret, _googleOAuthClientSecretRaw, googleOAuthRedirectPort, id (+50 more)

### Community 113 - "Runner — win32_window.cpp"
Cohesion: 0.05
Nodes (41): ClipRect, VoyagerSpinnerWheel, RankingFieldValue, RankingTemplateField, accent, accentColor, build, child (+33 more)

### Community 114 - "Firebase Auth (windows) — firebase_auth_plugin.cpp"
Cohesion: 0.14
Nodes (58): AuthError, FutureBase, AuthPigeonFirebaseApp, AuthResult, FlutterError, function, InternalActionCodeSettings, InternalFirebaseAuthSettings (+50 more)
...
Cohesion: 0.01
Nodes (162): Completer, _FakeLeetCodeApi, http.BaseClient, LeetCodeTrackDraft? draft,
  String?, close, _endpoint, fetchBySlug, fetchMostRecentAcceptedSubmission (+154 more)

### Community 122 - "Study Feature — ConsumerState"
Cohesion: 0.04
Nodes (55): cachedCurrentWeatherProvider, accent, axis, _bottomFade, branchIndex, build, child, _ClockText (+47 more)

### Community 123 - "Constants — leetcode_constants"
Cohesion: 0.06
Nodes (33): bool get, _auth, AuthNotifier, dispose, _isAuthenticated, _subscription, isCompactWidth, kCompactWidthBreakpoint (+25 more)

### Community 124 - "Remote API Clients — firestore_sync_repository"
Cohesion: 0.05
Nodes (37): appendOperation, appendOperationGroup, appendOperationsBatch, claimCalendarLock, claimWeatherFetchLock, _collection, deleteDocument, deleteOperations (+29 more)
...
Cohesion: 0.04
Nodes (53): , studyDeckGraphProvider, studyDecksProvider, studyFoldersProvider, _linkTile, _blocked, build, createState (+45 more)

### Community 128 - "Leetcode Feature — leetcode_inline_code"
Cohesion: 0.02
Nodes (86): int?, build, colorValue, tag, TagChip, accentColor, build, maxLines (+78 more)
...
Cohesion: 0.04
Nodes (56): @DataClassName, @TableIndex, AssetRoomEventsTable, AssetsTable, AssetValuationsTable, BucketListItemsTable, BudgetsTable, CalendarEventsTable (+48 more)

### Community 133 - "Test Suite — leetcode_sync_durability_tes"
Cohesion: 0.02
Nodes (124): FocusNode get, InputCounterWidgetBuilder?, accentColor, alignLabelToTop, allowShortHeight, autocorrectAllowed, autofocus, borderRadius (+116 more)
...
Cohesion: 0.03
Nodes (65): accent, _actions, _active, affected, _all, busy, categories, category (+57 more)
...
Cohesion: 0.06
Nodes (49): ConsumerState, ConsumerStatefulWidget, _QuickAddSnippetPanel, _QuickAddSnippetPanelState, VoyagerCheckbox, _VoyagerCheckboxState, CalendarEventPanel, _CalendarEventPanelState (+41 more)
...
Cohesion: 0.03
Nodes (59): formatTime12Hour, formatTimeOfDay12Hour, jm, local, now, build, _closingAfterSave, _completed (+51 more)
...
Cohesion: 0.03
Nodes (66): allSegments, buildExerciseHistory, byDay, colorValue, completed, completedAt, copyWith, count (+58 more)
...
Cohesion: 0.07
Nodes (29): RankingFieldEditor, _RankingFieldEditorState, RankingScoreHold, accentColor, build, createState, emptyColor, fill (+21 more)
...
Cohesion: 0.06
Nodes (37): _controller, createState, dispose, divisions, _field, _focusNode, _formatBytes, _gitHubController (+29 more)
...
Cohesion: 0.05
Nodes (43): addDropToCurrentSet, cancelRest, collapse, completeCurrentSet, completedCount, copyWith, currentSet, cursor (+35 more)

### Community 175 - "Test Suite — package:voyager/domain/repos"
Cohesion: 0.06
Nodes (36): SetPrescription, SetSegment, _addDrop, _addSet, build, canRemoveSet, _clearToInherit, createState (+28 more)

### Community 176 - "Workout Feature — workout_island"
Cohesion: 0.03
Nodes (78): Color? highlightColor,
  List, color, createRenderObject, paint, _paintFill, _paragraphOf, updateRenderObject, applyStyledRanges (+70 more)
...
Cohesion: 0.05
Nodes (37): DateTime? recurrenceEndDate,
  List, DateTime? recurrenceEndDate,
  String, package:voyager/domain/services/recurrence_engine.dart, package:voyager/features/calendar/calendar_overlap_engine.dart, required DateTime end,
  RecurrenceRule, _d, end, false (+29 more)
...
Cohesion: 0.15
Nodes (15): cacheStatusSnapshotProvider, devSettingsProvider, CacheStatusSnapshot, _scaledMorphDuration, build, _CacheStatusItemList, CacheStatusOverlay, _CacheStatusSummary (+7 more)

### Community 183 - "Jobs Feature — jobs_edit_panel"
Cohesion: 0.03
Nodes (60): jobStatusEventsProvider, JobApplication, accentColor, application, applicationId, build, _commit, companies (+52 more)
...
Cohesion: 0.10
Nodes (33): studyCardImagesProvider, studyCardsProvider, studyDeckByIdProvider, studyDeckStatsProvider, StudyDeckLink, build, _StudyDeckWorkbenchPageState, _toggleSelected (+25 more)
...
Cohesion: 0.03
Nodes (73): DailyFlow, NetFlowSeries, 1, build, busiest, _CalendarHover, _columnsFor, createState (+65 more)

### Community 198 - "Test Suite — package:voyager/core/vim/vim"
Cohesion: 0.04
Nodes (78): CapsLockCaretIndicator, _CapsLockCaretIndicatorState, _Thumbnail, _ThumbnailState, WindowVisibility, VimTextOverlay, _VimTextOverlayState, _VimFieldOverlay (+70 more)
...
Cohesion: 0.04
Nodes (55): IconButton, RepeatIconButton, package:voyager/core/widgets/repeat_selector_popover.dart, package:voyager/domain/models/recurrence_rule.dart, _anchor, captured, _choose, initial (+47 more)

### Community 205 - "Domain Models — SoftDeletable"
Cohesion: 0.05
Nodes (44): ContributionRoom, AssetValuation, FinancialTransaction, GoalAllocation, applicationId, applicationUrl, archivedAt, categoryId (+36 more)

### Community 206 - "Rankings Feature — rankings_score_stars"
Cohesion: 0.06
Nodes (35): accentColor, _attach, build, controller, createState, _detach, didUpdateWidget, dispose (+27 more)
...
Cohesion: 0.07
Nodes (28): classifySyncFailure, describeSyncFailure, _permanentFirestoreCodes, SyncFailureKind, toString, byId, main, merger (+20 more)

### Community 209 - "Sync Engine — outbox_sync_worker"
Cohesion: 0.05
Nodes (38): Delay, _authRepo, clearFor, _clearPending, data, _db, drainableCollections, _drainIndividually (+30 more)
...
Cohesion: 0.08
Nodes (21): FLTAuthStateChannelStreamHandler, -initWithAuth, -onCancelWithArguments, -onListenWithArgumentseventSink, FLTIdTokenChannelStreamHandler, -initWithAuth, -onCancelWithArguments, -onListenWithArgumentseventSink (+13 more)

### Community 218 - "Dev — ChangeNotifier"
Cohesion: 0.05
Nodes (40): brightness, _categoryById, _closePanel, _ColumnMenu, _ColumnMenuState, _companyByKey, _CompanyColors, _confirmDelete (+32 more)
...
Cohesion: 0.02
Nodes (106): CustomPaint, dart:ui, Error, colorForTag, extractTags, index, journalTagPattern, kTagPaletteDark (+98 more)
...
Cohesion: 0.05
Nodes (40): FirebaseAuthMultiFactorException, FirebaseAuthException, accent, build, color, count, items, label (+32 more)

### Community 236 - "Shell Feature — weather_chart_plot_cache"
Cohesion: 0.06
Nodes (30): Archive, archive, BackupImportSummary, BackupRecordUploader, BackupSettingsUploader, _collections, DataImportService, _db (+22 more)
...
Cohesion: 0.12
Nodes (18): EncodableValue, unique_ptr, EventSink, EndOfStreamInternal, ErrorInternal, SuccessInternal, string, T (+10 more)

### Community 241 - "Domain Models — leetcode_api_models"
Cohesion: 0.05
Nodes (37): Client, DocumentReference, FirebaseFirestore, FirebaseFunctions?, _call, _firestore, FirestoreWeatherReader, _functions (+29 more)
...
Cohesion: 0.03
Nodes (62): colorPaletteProvider, build, Journal, _changeEventColor, _add, affectedEntryIds, allJournals, assigner (+54 more)
...
Cohesion: 0.07
Nodes (27): _Repaint, CapsLockState, DevSettingsController, FpsMonitorController, JournalDebugLogger, PerfStallLogger, TodoSortDebugLogger, begin (+19 more)

### Community 247 - "Test Suite — vim_text_scope_test"
Cohesion: 0.12
Nodes (20): InternalActionCodeInfoData, InternalActionCodeInfo, InternalActionCodeInfo, data_, FromEncodableList, Hash, operation_, operator== (+12 more)

### Community 248 - "Domain Models — int?"
Cohesion: 0.05
Nodes (39): calendar, debug, journal, manage, search, VoyagerIcons, kMinTouchTarget, SnippetSettingsLauncher (+31 more)
...
Cohesion: 0.07
Nodes (26): _auth, _authErrorMessage, authStateChanges, _controller, currentUserId, dispose, fallback, FirebaseAuthRepository (+18 more)
...
Cohesion: 0.11
Nodes (25): autocorrectScopeProvider, devGeometricTexturePanelOpenProvider, geometricDebugRowFadeProvider, geometricShaderProvider, geometricTextureParamsProvider, snippetScopeProvider, themeModeProvider, _AppBackground (+17 more)

### Community 253 - "Firebase Auth (ios) — FLTFirebaseAuthPlugin"
Cohesion: 0.05
Nodes (36): RankingsActions, _accent, _actions, build, category, children, _commitText, createState (+28 more)
...
Cohesion: 0.08
Nodes (23): SettingsRepository, archive, backupFormatVersion, backupManifestFileName, backupMediaDirectory, buildArchiveContents, _collections, DataExportService (+15 more)

### Community 258 - "Test Suite — study_card_editor_images_tes"
Cohesion: 0.04
Nodes (44): IconData? get, Iterable, buildCatalogMenu, calendarManageMenuEntries, configurableManageMenuEntries, defaultCalendarManageMenuEntries, defaultCatalogMenuChild, defaultConfigurableManageMenuEntries (+36 more)
...
Cohesion: 0.03
Nodes (73): FadeTransition, build, QuickJournalPopup, QuickTodoPopup, getOrderedDestinations, icon, index, label (+65 more)

### Community 278 - "Shared Widgets — keep_alive_scroll"
Cohesion: 0.08
Nodes (23): databaseProvider, syncRepositoryProvider, FirestoreWriteGate, build, db, DevSyncBacklogSection, gate, _OutboxSummary (+15 more)
...
Cohesion: 0.05
Nodes (39): LeetCodeScratchSession? get, LeetCodeScratchSession, _chain, clear, _deleteQuietly, _file, FileLeetCodeScratchDraftStore, LeetCodeScratchDraftStore (+31 more)
...
Cohesion: 0.01
Nodes (164): Color, VoyagerSpellCheckService, ProseSpanBuilder, _bleed, build, _buildPath, _cachedPath, _cachedSize (+156 more)
...
Nodes (21): int? integerCap,
  int, AppThemeMode, BillingPeriod, CalendarViewMode, HeatmapMode, StartupPageMode, TrackerCadence, TrackerStyle (+13 more)
...
Cohesion: 0.07
Nodes (28): addExerciseToDay, clearPlacementPrescription, createExercise, currentExercise, deleted, deletePlanEntry, exercise, ExerciseDeletion (+20 more)
...
Cohesion: 0.12
Nodes (17): _addColor, build, _colorChip, createState, dispose, _hexController, _hexError, _hexFocusNode (+9 more)
...
Cohesion: 0.33
Nodes (5): nextQuote, QuoteBank, _quotes, _random, _used
...
Cohesion: 0.06
Nodes (34): AnimationController, BuildContext, WindowSizeClassX, accentColor, _boxKey, build, _celebrate, celebrateOnComplete (+26 more)
...
Cohesion: 0.02
Nodes (99): ByteData, Image, _Await, package:voyager/domain/models/notification_models.dart, package:voyager/features/notifications/notification_inbox_popover.dart, daily, deletedAt, end (+91 more)
...
Cohesion: 0.06
Nodes (35): LeetCodeCramPage, LeetCodeSessionPage, package:voyager/features/leetcode/leetcode_cram_page.dart, package:voyager/features/leetcode/leetcode_session_page.dart, _button, enterText, getProblem, listProblems (+27 more)
...
Cohesion: 0.09
Nodes (21): AppLifecycleListener?, configureDesktopWindow, desktopWindowChromeActive, _desktopWindowConfigured, _away, _controller, dispose, _focusedSingleLineEditable (+13 more)
...
Cohesion: 0.05
Nodes (37): InheritedWidget, CapsLockIndicatorScope, enabled, of, updateShouldNotify, MediaPasteOwnerScope, active, data (+29 more)
...
Cohesion: 0.09
Nodes (20): dart:async, _callbacks, flushAll, instance, PendingFlushRegistry, register, unregister, _activeUntil (+12 more)
...
Cohesion: 0.09
Nodes (21): Alignment, bool? enableDrag,
  BorderRadius, BorderRadius, accentBorder, alignment, blurSigma, borderRadius, build (+13 more)
...
Cohesion: 0.06
Nodes (59): remoteSyncServiceProvider, studyRepositoryProvider, todoListsProvider, todoRepositoryProvider, todoSortDebugLoggerProvider, build, DevTodoSortDebugSection, _logDialogOpen (+51 more)

### Community 358 - "trackerRepositoryProvider"
Cohesion: 0.09
Nodes (22): devLeafGalleryPanelOpenProvider, petalFieldParamsProvider, _PaperBackground, LeafDesign, _angles, build, color, _count (+14 more)
...
Cohesion: 0.05
Nodes (45): barrierDismissible, _cramSession, createState, deckId, deckNameHint, _delete, _flipped, folderStack (+37 more)
...
Cohesion: 0.06
Nodes (33): accent, color, createState, didChangeDependencies, dispose, _formatRemaining, _LiveDot, _LiveDotState (+25 more)

### Community 366 - "Firebase Auth (ios) — CustomPigeonHeader"
Cohesion: 0.03
Nodes (66): package:voyager/core/soft_delete/restore_contract.dart, package:voyager/domain/models/ranking_models.dart, package:voyager/features/rankings/rankings_actions.dart, package:voyager/features/rankings/rankings_edit_panel.dart, package:voyager/features/rankings/rankings_header.dart, package:voyager/features/rankings/rankings_providers.dart, package:voyager/features/rankings/rankings_row.dart, container (+58 more)
...
Cohesion: 0.06
Nodes (33): clearLog, _enqueue, log, _logFileName, logFilePath, _maxLogBytes, readLog, SyncCompareLogger (+25 more)

### Community 372 - "Shared Widgets — create_name_color_dialog"
Cohesion: 0.04
Nodes (46): AnalyticsService, booleanTrueCount, completedTasks, countWords, heatmapIntensity, integerSeries, interpolateConsecutive, rollingMax (+38 more)
...
Cohesion: 0.02
Nodes (94): CustomPainter, dart:math, indices, main, r, sorted, _ConfettiPainter, _VimOverlayPainter (+86 more)

### Community 376 - "Workout Feature — workout_day_column"
Cohesion: 0.10
Nodes (30): App, User, Credential, FederatedOAuthProvider, Future, EncodableList, EncodableMap, InternalUserCredential (+22 more)
...
Cohesion: 0.11
Nodes (19): build, saveJobExperienceSnippets, saveSettings, saveSnippets, settingsRepositoryProvider, _persistCalendarView, _persistSplitWidth, _persistEditSidePanelWidth (+11 more)

### Community 381 - "Shared Widgets — color_picker_field"
Cohesion: 0.02
Nodes (97): LeetCodeDifficulty, description, difficulty, easy, examples, hard, LeetCodeApiQuestion, LeetCodeQuestionCounts (+89 more)
...
Cohesion: 0.08
Nodes (25): Axis, createState, DevOutOfSyncPurgeSection, _DevOutOfSyncPurgeSectionState, _lastResults, _purging, AddExerciseButton, axis (+17 more)
...
Cohesion: 0.11
Nodes (27): syncActivityProvider, build, devDisablePetalFieldProvider, devForceOfflineProvider, DevPage, devShowTimeSelectorHitboxesProvider, devSlowHeatmapPopoverAnimationProvider, devSlowTodoEditPanelAnimationProvider (+19 more)
...
Cohesion: 0.09
Nodes (23): PreserveSelectionOnAppResume, build, buttonHeight, buttonRadius, buttonWidth, createState, DesktopWindowTitleBar, _DesktopWindowTitleBarState (+15 more)
...
Cohesion: 0.09
Nodes (24): AsyncNotifier, SettingsNotifier, AppSettings, package:voyager/features/leetcode/leetcode_providers.dart, static AppSettings?, _ThemedSettings, _FixedSettings, _FixedSettings (+16 more)
...
Cohesion: 0.11
Nodes (17): active, anchor, batch, completeTodoTask, due, latest, listId, next (+9 more)
...
Cohesion: 0.11
Nodes (16): DateTime? dueAt,
  int, package:voyager/domain/models/leetcode_models.dart, package:voyager/domain/services/leetcode_srs_engine.dart, dueAt, ease, id, interval, main (+8 more)
...
Cohesion: 0.12
Nodes (17): leetcodeProblemsProvider, leetcodeQuestionCountsProvider, build, build, build, _kLeetCodeActivityBreakpoint, _kLeetCodeActivityCardWidth, _kLeetCodeSplitBreakpoint (+9 more)
...
Cohesion: 0.06
Nodes (47): authNotifierProvider, backgroundSyncOrchestratorProvider, connectivityStatusProvider, deviceIdProvider, firestoreWriteGateProvider, lazyLoadProvider, liveSyncProvider, quoteBankProvider (+39 more)

### Community 412 - "Demo Feature"
Cohesion: 0.03
Nodes (58): GoRouter, Key? get, auth, _preloadedShellPaths, settingsRepo, package:go_router/go_router.dart, package:voyager/core/motion/modal_scrim_observer.dart, package:voyager/core/widgets/desktop_window_frame.dart (+50 more)
...
Cohesion: 0.02
Nodes (96): fakes/fake_weather_api_client.dart, Icon, package:voyager/app/voyager_app.dart, package:voyager/core/constants/calendar_constants.dart, package:voyager/domain/models/calendar_models.dart, package:voyager/features/calendar/calendar_event_panel.dart, package:voyager/features/calendar/calendar_manage_sheet.dart, package:voyager/features/calendar/calendar_page.dart (+88 more)
...
Cohesion: 0.12
Nodes (16): build, count, _countRebuilds, difficulty, _FixedSettings, id, main, _now (+8 more)
...
Nodes (96): DateTime? deletedAt,
  int, MoodGradientSlider, DriftTodoRepository, DriftTrackerRepository, TodoRepository, TrackerRepository, searchEntries, SearchService (+88 more)
...
Cohesion: 0.06
Nodes (22): AuthStateListener, FirebaseAuth, FirebasePluginPlatform, FirebaseService, ForceResendingToken, IdTokenListener, Locale?, PhoneMultiFactorInfo (+14 more)

### Community 435 - "heatmap_calendar.dart"
Cohesion: 0.02
Nodes (74): AutocorrectScopeData, data, disabled, enabled, hashCode, of, operator, service (+66 more)
...
Cohesion: 0.02
Nodes (100): double? contentWidth,
  bool, int? initialColor,
  String, build, createState, dispose, initialColor, initState, _nameController (+92 more)
...
Cohesion: 0.08
Nodes (22): accentColor, _lineWidth, _padding, painter, stat, statPopupMaxWidth, statPopupWidth, width (+14 more)
...
Cohesion: 0.14
Nodes (16): notificationBadgeStateProvider, accent, _anchorKey, _bellHeight, _bellWidth, build, _controller, createState (+8 more)
...
Cohesion: 0.04
Nodes (56): LeetCodeProblem, LeetCodeSolution, anchorRect, build, _close, _closing, _ComplexityTile, _controller (+48 more)
...
Cohesion: 0.16
Nodes (17): FlutterWindow, flutter_controller_, FlutterWindow::FlutterWindow(), OnCreate, OnDestroy, project_, unique_ptr, RECT (+9 more)
...
Cohesion: 0.13
Nodes (14): package:voyager/features/leetcode/leetcode_detail_view.dart, package:voyager/features/leetcode/leetcode_flashcard.dart, _bruteForce, flip, _hashMap, main, now, _problem (+6 more)
...
Cohesion: 0.05
Nodes (45): double get, WeightUnit, formatDisplay, formatKilograms, formatKilogramsWithUnit, fromKilograms, kilogramsForWheelIndex, label (+37 more)
...
Cohesion: 0.13
Nodes (14): package:voyager/features/leetcode/leetcode_inline_code.dart, String? description,
...
Cohesion: 0.12
Nodes (15): 1. A save whose target and payload came from different owners, 2. A wedged Firestore write queue held the window open, Fixed, Fixed: nothing resumed the drain when the gate reopened, Fixed: the default calendar could never sync, Fixed: the gate had no way back — 2026-09-16, Fixed: the stale-buffer read, Fixed: todo writes that failed in silence (+7 more)
...
Cohesion: 0.06
Nodes (32): crossfade, reduced, VoyagerMotion, AppFonts, applyTo, family, leadingFor, monoFamily (+24 more)

### Community 508 - "Shared Widgets — voyager_scroll_view"
Cohesion: 0.15
Nodes (13): build, _controller, createState, didUpdateWidget, dispose, _error, initState, _lastUpdatedLabel (+5 more)
...
Cohesion: 0.08
Nodes (22): applyStyledRanges, at, base, buildStyledRuns, children, cursor, next, out (+14 more)
...
### Community 533 - "Constants — calendar_constants"
Cohesion: 0.18
...
Cohesion: 0.20
Nodes (9): 0. What was run, 1. Executive summary — worst first, 2. Workstream A — postmortem claims, 4. Cross-cutting systemic issues, 5. Proposed fixes, in priority order, 6. Test gaps and recommended harnesses, 7. What was audited, and what was not fully covered, 8. Decision needed — the settings document (P1-1) (+1 more)
...
Cohesion: 0.01
Nodes (179): Brightness, DateTimeRange, goalAllocationsProvider, savingsGoalsProvider, build, CompactBackBar, label, onBack (+171 more)
...
Cohesion: 0.17
Nodes (12): trackerCacheInvalidatorProvider, _HeatmapDayCell, _HeatmapDayCellState, _HeatmapSquare, _HeatmapSquareState, _HeatmapWeekBlock, _HeatmapWeekBlockState, _MonthGridBox (+4 more)
...
### Community 550 - "voyager_spacing.dart"
Cohesion: 0.18
...
Cohesion: 0.03
Nodes (73): IconData, autofocus, build, child, CtrlEnterToSubmitScope, isSubmitChord, key, keyboard (+65 more)
...
### Community 573 - "fractional_index_test.dart"
Cohesion: 0.27
...
### Community 575 - "notificationRepositoryProvider"
Cohesion: 0.18
...
Cohesion: 0.20
Nodes (9): DateTime? asOf,
  List, package:voyager/domain/models/contribution_room_models.dart, _event, limits, main, remaining, _room, _seq (+1 more)
...
Cohesion: 0.05
Nodes (38): _darkRestingAlpha, decoration, focusBorderColor, focusShape, hoverColor, _isDark, _restingBorderColor, restingColor (+30 more)
...
Cohesion: 0.07
Nodes (30): _accept, active, allEntries, build, createState, dayIndex, _edit, _editCustom (+22 more)

### Community 585 - "TextureRegistrarImpl"
Cohesion: 0.05
Nodes (40): Container, DateTime? dateApplied,
  List, package:voyager/domain/services/search_service.dart, package:voyager/features/jobs/jobs_edit_panel.dart, package:voyager/features/jobs/jobs_providers.dart, package:voyager/features/jobs/jobs_table.dart, required String title,
  String, support/search_page_harness.dart (+32 more)
...
### Community 588 - "char_ops_encoder.dart"
Cohesion: 0.20
...
Cohesion: 0.11
Nodes (20): Auth, auth::AuthStateListener, auth::IdTokenListener, mutex, StreamHandler<flutter::EncodableValue>, AuthStateStreamHandler, auth_, listener_ (+12 more)

### Community 590 - "leetcode_constants.dart"
Cohesion: 0.25
Nodes (7): currentWeatherProvider, package:voyager/core/widgets/weather_icon.dart, PhosphorIcon, build, main, _WeatherRailProbe, main

### Community 591 - "Timer?"
Cohesion: 0.05
Nodes (37): class ConnectivityStatusController extends, Duration, _consecutiveFailures, didChangeAppLifecycleState, dispose, _disposed, _failuresBeforeOffline, _isOnline (+29 more)
...
### Community 594 - "voyager_icons.dart"
Cohesion: 0.03
Nodes (66): package:voyager/core/media/widgets/media_gallery_strip.dart, package:voyager/domain/models/todo_models.dart, package:voyager/features/todo/todo_list_search.dart, required int done,
  bool, required int done,
  Set, String? defaultTodoListId,
  bool, container, db (+58 more)

### Community 595 - "MorphDayEventStack"
Cohesion: 0.29
...
### Community 596 - "StateNotifier"
Cohesion: 0.22
Nodes (8): package:voyager/core/widgets/voyager_toast.dart, contrast, ctx, main, pumpHost, pumpWidget, x, y
...
Cohesion: 0.33
Nodes (5): isExpired, purgeCutoff, purgeEligibleAfter, SoftDeletePolicy, package:voyager/core/constants/app_constants.dart
...
Cohesion: 0.28
Nodes (17): jobApplicationsProvider, jobCategoriesProvider, jobCompaniesProvider, jobSeasonsProvider, jobStagesProvider, build, _SeasonsTabState, _StagesTab (+9 more)
...
### Community 602 - "newline_normalization_test.dart"
Cohesion: 0.20
...
### Community 609 - "package:voyager/domain/services/color_palette_codec.dart"
Cohesion: 0.43
Nodes (5): Component, ComponentRegistrar, FlutterFirebaseAuthRegistrar, Keep, Override

### Community 610 - "Iterable"
Cohesion: 0.29
...
### Community 616 - "_CalendarMorphWarmupState"
Cohesion: 0.29
Nodes (6): _buffered, _maxBuffered, notify, notifyOne, onWrite, SyncedWriteNotifier

### Community 617 - "FLTPhoneNumberVerificationStreamHandler"
Cohesion: 0.40
...
### Community 618 - "-checkActionCodeAppcodecompletion"
Cohesion: 0.50
Nodes (4): -checkActionCodeAppcodecompletion, +operationFromRequestType, -parseActionCode, -resolveActionCodeOperationForAppcodefallbackInfocompletion

### Community 633 - "MultiFactorUserHostApi"
Cohesion: 0.22
...
### Community 639 - "package:voyager/core/utils/all_view_destination.dart"
Cohesion: 0.33
...
Cohesion: 0.40
Nodes (5): AdditionalUserInfo, InternalAdditionalUserInfo, firebase_auth_windows::FirebaseAuthPlugin::ConvertToEncodableValue(), ConvertToEncodableMap, ParseAdditionalUserInfo

### Community 988 - "DriftRankingRepository"
Cohesion: 0.50
Nodes (4): DriftRankingRepository, RankingRepository, _CountingRankingRepository, _SlowRankingRepository

### Community 989 - "package:voyager/core/widgets/edit_side_panel_host.dart"
Cohesion: 0.50
...
- **Why does `ActionCodeInfoOperation` connect `Firebase Auth (windows) — firebase_auth_plugin.cpp` to `Firebase Auth (ios) — firebase_auth_messages.g`, `Firebase Auth (macos) — firebase_auth_messages.g`, `Firebase Auth (android) — NonNull`, `Test Suite — vim_text_scope_test`, `Firebase Auth (android) — NonNull`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `class` connect `Test Suite — package:voyager/domain/repos` to `Drift Database Schema — app_database`, `Domain Models — SoftDeletable`, `Calendar Feature — calendar_day_grid`, `Study Feature — ConsumerState`, `Journal Feature — journal_page`, `Shared Widgets — date_selector_popover`, `Sync Feature`, `Test Suite — scroll_offset_isolate_test`, `Test Suite — package:voyager/domain/repos`, `Dev — dev_flags`, `Test Suite — package:voyager/domain/repos`, `Firebase Auth (android) — NonNull`, `Snippets — snippet_index`, `@immutable`, `Shell Feature — weather_forecast_chart_trans`, `Remote API Clients — leetcode_content`, `Study Feature — ConsumerState`, `Leetcode Feature — leetcode_review_deck`, `Shared Widgets — color_picker_field`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **What connects `s`, `ops`, `pos` to the rest of the system?**
  _19255 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `Calendar Feature — calendar_page` be split into smaller, more focused modules?**
  _Cohesion score 0.007352355673523557 - nodes in this community are weakly interconnected._