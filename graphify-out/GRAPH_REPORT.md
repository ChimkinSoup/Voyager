...
## Summary
- 6474 nodes · 9112 edges · 361 communities (222 shown, 139 thin omitted)
...
## Communities (361 total, 139 thin omitted)

### Community 0 - "Database Data"
Cohesion: 0.01
Nodes (283): BoolColumn get, _, _accentColorMeta, actualTableName, _addedAtMeta, _alertOnPeriodicPromptsMeta, _alertTimeHourMeta, _alias (+275 more)
...
Cohesion: 0.03
Nodes (67): countEntriesByJournal, _db, deleteAllEntries, deleteAllEvents, deleteAllJournals, deleteConflict, deleteConflictsForDocument, getAllEntries (+59 more)

### Community 16 - "Sync Weather"
Cohesion: 0.05
Nodes (54): _, @DriftDatabase, fakes/fake_weather_api_client.dart, SyncEngine, AppDatabase, InMemorySyncRepository, package:drift/native.dart, package:flutter_test/flutter_test.dart (+46 more)
...
Cohesion: 0.03
Nodes (68): AsyncValue, all, allJournalEntriesScope, buildCalendarTodoMarkers, calendarEventsProvider, calendarTodoMarkersProvider, controller, dailyTrackers (+60 more)

### Community 19 - "Analytics Features"
Cohesion: 0.01
Nodes (146): DateTime get, Key? dateKey,
  double, accent, _addOption, analytics, _AnalyticsViewMode, anchorDateRect, anchorRect (+138 more)
...
Cohesion: 0.05
Nodes (36): ColorScheme, build, _ClockDial, _ClockTimeMode, colorScheme, createState, _date, _end (+28 more)
...
Cohesion: 0.04
Nodes (54): cachedCurrentWeatherProvider, currentWeatherProvider, settingsRepositoryProvider, _save, _ensureDefaultJournal, _persistEntryListWidth, _persistLastViewedJournal, _save (+46 more)
...
Cohesion: 0.08
Nodes (25): calendarsProvider, allCalendars, assigner, changeCalendarListColor, choice, color, controller, createCalendarList (+17 more)
...
Cohesion: 0.07
Nodes (28): StatisticTracker, build, HeatmapCalendar, month, tracker, values, _buildEditor, createState (+20 more)
...
Cohesion: 0.25
Nodes (10): string, T, unique_ptr, StreamHandler, OnCancelInternal, OnListenInternal, StreamHandlerError, error_code (+2 more)
...
Cohesion: 0.06
Nodes (30): dart:ui, cacheGeneration, clear, degreeGridArgb, _entries, from, generation, gradientStartHour (+22 more)
...
Cohesion: 0.10
Nodes (19): build, _CreateNameColorDialog, _CreateNameColorDialogState, createState, dispose, initialColor, initState, _nameController (+11 more)
...
Cohesion: 0.07
Nodes (43): AutomaticKeepAliveClientMixin, EdgeInsetsGeometry, IndexedWidgetBuilder, _PalettePickDialog, _PalettePickDialogState, DateSelectorPopover, _DateSelectorPopoverState, _ClockTimePicker (+35 more)
...
Cohesion: 0.10
Nodes (20): _advance, build, createState, dispose, _done, _frame, initState, plotSize (+12 more)

### Community 94 - "Dev Features"
Cohesion: 0.11
Nodes (25): calendarRepositoryProvider, deviceIdProvider, syncActivityProvider, _ensureDefaultCalendar, _saveSidebarEvent, build, _confirmDeleteAllCalendarEvents, _confirmDeleteAllEntries (+17 more)
...
Cohesion: 0.13
Nodes (11): MessageHandler, BasicMessageChannel, codec_, messenger_, name_, BinaryReply, string, T (+3 more)
...
Cohesion: 0.11
Nodes (18): FormField, FormFieldState, InputDecoration?, accentColor, build, createState, decoration, enabled (+10 more)
...
Cohesion: 0.10
Nodes (19): EditableText, IconData, build, child, EnterToSubmitScope, onSubmit, _textFieldHasFocus, accentColor (+11 more)

### Community 124 - "Shell Features"
Cohesion: 0.06
Nodes (31): calendar, debug, journal, manage, search, VoyagerIcons, build, QuickJournalPopup (+23 more)

### Community 125 - "Windows Ephemeral"
Cohesion: 0.14
Nodes (17): EventChannel, codec_, messenger_, name_, string, T, unique_ptr, string (+9 more)
...
Cohesion: 0.11
Nodes (16): bool get, _auth, AuthNotifier, dispose, _isAuthenticated, _subscription, isAndroid, isWindows (+8 more)
...
Cohesion: 0.08
Nodes (23): BaseSliderTrackShape, Color, decoration, restingColor, selectedColor, VoyagerListItemSurface, accent, build (+15 more)
...
Cohesion: 0.07
Nodes (50): ConsumerState, allTodoTasksProvider, remoteSyncServiceProvider, todoListsProvider, todoListStatsProvider, todoRepositoryProvider, todoTasksProvider, _CalendarPageState (+42 more)
...
Cohesion: 0.08
Nodes (22): DriftTrackerRepository, TrackerRepository, package:voyager/core/constants/todo_sort_constants.dart, package:voyager/domain/todo/todo_task_sorting.dart, required String id,
  bool, db, journalRepo, main (+14 more)

### Community 142 - "Windows Ephemeral"
Cohesion: 0.06
Nodes (29): Delay, Duration, Duration get, cancel, DebouncedCallback, debounceDelay, Debouncer, delay (+21 more)
...
Cohesion: 0.13
Nodes (16): pendingStatEntriesProvider, todoSortDebugLoggerProvider, build, StatisticsActionFab, _CacheStatusItemList, _CacheStatusSummary, compact, snapshot (+8 more)
...
Cohesion: 0.25
Nodes (8): TrackerValue, Calendar, CalendarEvent, Journal, JournalEntry, SoftDeletable, TodoListModel, TodoTask
...
Cohesion: 0.08
Nodes (24): colorPaletteProvider, build, weatherIconData, createJournalList, build, created, _createJournal, createState (+16 more)
...
Cohesion: 0.05
Nodes (38): BinaryMessengerImpl, handlers_, messenger_, Send, SetMessageHandler, BinaryMessageHandler, FlutterDesktopMessengerRef, map (+30 more)
...
Cohesion: 0.12
Nodes (29): ConsumerWidget, allJournalEntriesProvider, analyticsServiceProvider, periodicPromptServiceProvider, trackersProvider, trackerValuesProvider, AnalyticsPage, _AnalyticsToolbar (+21 more)
...
Cohesion: 0.50
Nodes (4): CustomClipper, _RevealClipper, _WeekTimedViewportClipper, Path
...
Cohesion: 0.04
Nodes (51): dart:convert, CrdtDocumentResolver, _merger, _mergeSyncOperations, resolvePayload, _apiKey, _http, _periodFromForecastItem (+43 more)

## Knowledge Gaps
- **4608 isolated node(s):** `s`, `ops`, `pos`, `main`, `s1` (+4603 more)
...
- **Why does `FlutterEngine` connect `Windows Ephemeral` to `Registrar Windows`, `Windows Ephemeral`, `Sync Outbox`, `Windows Runner`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `MessageCodec` connect `trackerRepositoryProvider` to `Registrar Windows`, `Windows Cpp`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **What connects `s`, `ops`, `pos` to the rest of the system?**
  _4608 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Database Data` be split into smaller, more focused modules?**
  _Cohesion score 0.007042253521126761 - nodes in this community are weakly interconnected._
