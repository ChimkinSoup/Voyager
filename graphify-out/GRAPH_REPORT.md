...
## Corpus Check
- 749 files · ~977,746 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 18835 nodes · 30127 edges · 544 communities (471 shown, 73 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 296 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c8e2f6c9`
...
## Communities (544 total, 73 thin omitted)
...
Cohesion: 0.01
Nodes (204): JournalDebugLogger, journalAllEntryIdsProvider, journalDebugLoggerProvider, journalEntryCacheInvalidatorProvider, journalEntryCountsProvider, journalListEntriesProvider, journalRepositoryProvider, journalsProvider (+196 more)
...
Cohesion: 0.01
Nodes (174): AuthNotifier, CacheStatusSnapshot, ConnectivityStatusController, DataExportService, DataImportService, DevSettingsController, DreamWriteCoordinator, FpsMonitorController (+166 more)

### Community 19 - "Analytics Features"
Cohesion: 0.01
Nodes (228): await, accent, _addOption, all, analytics, anchor, anchorDateRect, anchorIndex (+220 more)
...
Cohesion: 0.02
Nodes (100): _FakeLeetCodeApi, LeetCodeTrackDraft? draft,
  String?, _endpoint, fetchBySlug, fetchMostRecentAcceptedSubmission, fetchQuestionCounts, _http, LeetCodeApiClient (+92 more)

### Community 34 - "Shell Features"
Cohesion: 0.04
Nodes (107): ConsumerState, ConsumerStatefulWidget, leetCodeRepositoryProvider, remoteSyncServiceProvider, studyCardsProvider, studyDeckByIdProvider, studyDeckStatsProvider, studyRepositoryProvider (+99 more)

### Community 35 - "Import Export"
Cohesion: 0.05
Nodes (42): FocusOnKeyEventCallback?, InputCounterWidgetBuilder?, accentColor, autofocus, borderRadius, build, buildCounter, _buildField (+34 more)
...
Cohesion: 0.04
Nodes (53): dart:async, _auth, dispose, _isAuthenticated, _subscription, applySettings, devForceConflictUi, disableCache (+45 more)
...
Cohesion: 0.02
Nodes (87): build, color, ColorCornerFlag, colorValue, _CornerFlagPainter, JournalBookmarkFlag, JournalTitleCornerFlag, onSelected (+79 more)
...
Cohesion: 0.03
Nodes (62): ByteData, Image?, notificationBadgeStateProvider, _Await, accent, _anchorKey, _bellHeight, _bellWidth (+54 more)
...
Cohesion: 0.03
Nodes (76): dart:convert, FirebaseException, detectDreamEntryConflict, detectJournalEntryConflict, detectTodoTaskConflict, isConflict, _isCorruptedOpChain, _isHardDreamMetadataCollision (+68 more)
...
Cohesion: 0.03
Nodes (66): LeetCodeCramPage, LeetCodeSessionPage, package:voyager/domain/models/enums.dart, package:voyager/domain/models/leetcode_models.dart, package:voyager/features/leetcode/leetcode_cram_page.dart, package:voyager/features/leetcode/leetcode_inline_code.dart, package:voyager/features/leetcode/leetcode_mini_flashcard.dart, package:voyager/features/leetcode/leetcode_recent_completions.dart (+58 more)
...
Cohesion: 0.06
Nodes (36): dictionaryProvider, build, _buildResults, _bundledSeen, _BundledWordRow, _candidateQuery, _candidates, _controller (+28 more)
...
Cohesion: 0.40
Nodes (4): dart:ui, Error, main, main
...
Cohesion: 0.03
Nodes (63): DateTime? deletedAt,
  int, Finder get, MoodGradientSlider, package:voyager/core/widgets/keep_alive_scroll.dart, package:voyager/core/widgets/mood_gradient_slider.dart, support/journal_page_harness.dart, _bodyField, container (+55 more)
...
Cohesion: 0.07
Nodes (37): geometricDebugRowFadeProvider, geometricShaderProvider, geometricTextureParamsProvider, geometricWaveParamsProvider, _AppBackground, build, buildOverscrollIndicator, buildScrollbar (+29 more)
...
Cohesion: 0.06
Nodes (30): EditableText, context, focus, isTextInputFocused, subtreeIsVisible, _addSolution, _algorithmField, _algorithmHint (+22 more)
...
Cohesion: 0.06
Nodes (47): authNotifierProvider, authRepositoryProvider, backgroundSyncOrchestratorProvider, bool?, connectivityStatusProvider, databaseProvider, deviceIdProvider, HotkeyService (+39 more)
...
Cohesion: 0.04
Nodes (47): contains, embedded, firebaseAuthErrorMessage, invalidCredentialHints, _isGenericInternalMessage, lower, _messageFromEmbeddedDetails, normalizedCode (+39 more)
...
Cohesion: 0.03
Nodes (72): insideTag, tagRanges, tokenizeWords, FirestorePullService, ActiveTagToken, counts, end, filterTagSuggestions (+64 more)
...
Cohesion: 0.03
Nodes (79): DateTimeRange, goalAllocationsProvider, savingsGoalsProvider, build, CompactBackBar, label, onBack, SavingsGoal (+71 more)
...
Cohesion: 0.05
Nodes (39): studyAllCardsProvider, accent, after, before, build, _canRedo, _canUndo, cardIds (+31 more)

### Community 117 - "Sync Debouncer"
Cohesion: 0.03
Nodes (68): CodeController, LeetCodeCodeController, build, _buildEditor, code, _codeContentPadding, _codeDecoration, _codeEditorShortcuts (+60 more)
...
Cohesion: 0.07
Nodes (28): DateTime get, TrackerValue, Journal, JournalEntry, colorValue, completed, copyWith, dueDate (+20 more)
...
Cohesion: 0.04
Nodes (49): srsMasteryColor, decoration, focusBorderColor, focusShape, hoverColor, _restingBorderColor, restingColor, selectedColor (+41 more)
...
Cohesion: 0.10
Nodes (28): VimTextOverlay, _VimTextOverlayState, _VimFieldOverlay, _VimFieldOverlayState, VimTextScope, _VimTextScopeState, LabeledTextField, _LabeledTextFieldState (+20 more)
...
Cohesion: 0.05
Nodes (36): IconData, body, build, floatingActionButton, PlatformAdaptiveScaffold, build, child, EnterToSubmitScope (+28 more)
...
Cohesion: 0.08
Nodes (26): _buildEditor, _clampInt, commit, createState, date, didUpdateWidget, _dirty, dispose (+18 more)
...
Cohesion: 0.02
Nodes (130): @DriftDatabase, DriftBucketListRepository, DriftCalendarRepository, DriftFinanceRepository, DriftNotificationRepository, DriftSettingsRepository, DriftTrackerRepository, fakes/fake_weather_api_client.dart (+122 more)
...
Cohesion: 0.04
Nodes (53): Axis, _accept, active, allEntries, build, createState, dayIndex, _edit (+45 more)
...
Cohesion: 0.07
Nodes (33): Asset, AssetValuation, FinancialTransaction, GoalAllocation, applicationId, applicationUrl, categoryId, changedAt (+25 more)
...
Cohesion: 0.06
Nodes (33): bool get, BuildContext, dart:collection, _current, currentFps, dispose, _fps, _history (+25 more)

### Community 161 - "Windows Ephemeral"
Cohesion: 0.06
Nodes (36): AppThemeMode, _controller, createState, dispose, divisions, _focusNode, initialUsername, label (+28 more)
...
Cohesion: 0.03
Nodes (63): accentColor, _active, _badge, _beginSuspension, blockCaret, build, builder, _canCreateSnippets (+55 more)
...
Cohesion: 0.03
Nodes (80): WeightUnit, Exercise, controller, count, createState, _CurrentExerciseTitle, didUpdateWidget, _discard (+72 more)
...
Cohesion: 0.05
Nodes (41): StudyCard, _back, build, _canSave, createState, deckId, dispose, existing (+33 more)

### Community 177 - "dart:math"
Cohesion: 0.04
Nodes (54): affectedEntryIds, allJournals, assigner, choice, color, context, created, defaultColor (+46 more)
...
Cohesion: 0.04
Nodes (46): JournalWriteCoordinator, searchEntries, SearchService, coordinator, journalRepository, remoteSync, saveEntry, SearchEntrySaveHelper (+38 more)

### Community 180 - "@visibleForTesting"
Cohesion: 0.05
Nodes (36): int? integerCap,
  int, StatisticTracker, build, HeatmapCalendar, month, tracker, values, package:voyager/domain/models/analytics_models.dart (+28 more)
...
Cohesion: 0.06
Nodes (31): dart:math, indices, main, r, sorted, int? current,
  Set, assign, nextColor (+23 more)
...
Cohesion: 0.06
Nodes (44): assetsProvider, assetValuationsProvider, budgetsProvider, financeCategoriesProvider, tagColorsProvider, transactionsProvider, Budget, _BreakdownCard (+36 more)
...
### Community 203 - "Color"
Cohesion: 0.04
Nodes (53): _PalettePickDialog, _PalettePickDialogState, _State, accent, axis, _bottomFade, branchIndex, child (+45 more)
...
Cohesion: 0.06
Nodes (33): _boundaryBackward, _boundaryChar, _boundaryForwardPad, checkIncremental, checkTextSync, _customWords, _dictionary, _fetchLastSpans (+25 more)
...
Cohesion: 0.03
Nodes (75): int?, build, colorValue, tag, TagChip, bodyStyle, build, examples (+67 more)
...
Cohesion: 0.04
Nodes (49): financeRepositoryProvider, FinanceCategory, _save, _delete, _save, _delete, _save, build (+41 more)

### Community 236 - "sync_conflict.dart"
Cohesion: 0.06
Nodes (35): _, allDay, allDayEvent, available, calendarDayEntriesForDay, CalendarDayEntry, CalendarDayEntryKind, calendarVisibleEntryCount (+27 more)
...
Cohesion: 0.05
Nodes (47): bucketListItemsProvider, bucketListRepositoryProvider, accentColor, _addItem, BucketListPopup, _BucketListPopupState, _BucketListRow, _BucketNoteDialog (+39 more)
...
Cohesion: 0.05
Nodes (45): leetcodeProblemsProvider, leetcodeQuestionCountsProvider, _ActivityDetailCard, _ActivityDetailCardState, anchorRect, build, _close, _closing (+37 more)
...
Cohesion: 0.02
Nodes (99): id, OutOfSyncJournalEntryPurge, OutOfSyncJournalEntryTarget, purgeAll, purgeOne, searchHint, targets, title (+91 more)
...
Cohesion: 0.09
Nodes (21): VimSession, package:voyager/core/caps_lock/caps_lock_caret_indicator.dart, package:voyager/core/caps_lock/caps_lock_indicator_scope.dart, package:voyager/core/vim/vim_session.dart, box, _caretRight, main, render (+13 more)
...
Cohesion: 0.09
Nodes (20): package:voyager/features/analytics/tracker_entry_row.dart, ProviderContainer, container, db, _journalA, _journalB, main, readMood (+12 more)
...
Cohesion: 0.05
Nodes (59): ConsumerWidget, cacheStatusSnapshotProvider, devSettingsProvider, fpsMonitorProvider, CacheStatusSnapshot, _HeatmapGrid, _scaledMorphDuration, build (+51 more)
...
Cohesion: 0.06
Nodes (34): accent, color, createState, didChangeDependencies, dispose, _formatRemaining, _LiveDot, _LiveDotState (+26 more)
...
Cohesion: 0.06
Nodes (37): authRepositoryProvider, _authorizationEndpoint, DesktopGoogleOAuth, redirectUri, _tokenEndpoint, build, createState, dispose (+29 more)
...
Cohesion: 0.05
Nodes (52): AppSettings, AsyncNotifier, build, customQuotesProvider, customWordsProvider, quotePoolProvider, saveSettings, SettingsNotifier (+44 more)
...
Cohesion: 0.04
Nodes (48): allLists, assigner, choice, color, context, deletedList, deleteTodoList, destActive (+40 more)
...
Cohesion: 0.06
Nodes (35): vector, ReplyManager::SendResponseData(), EngineMethodResult, codec_, reply_manager_, BinaryReply, string, T (+27 more)
...
Cohesion: 0.02
Nodes (108): dart:io, Directory, File, Icon, DriftSettingsRepository, ListView, package:drift/native.dart, package:path/path.dart (+100 more)
...
Cohesion: 0.10
Nodes (19): package:voyager/core/spellcheck/voyager_spell_check_service.dart, package:voyager/core/widgets/spell_check_squiggle_layer.dart, RichText, combined, count, false, main, out (+11 more)
...
### Community 308 - "body"
Cohesion: 0.02
Nodes (87): currentWeatherProvider, AppSettings, _apiKeyController, build, createState, didUpdateWidget, dispose, initState (+79 more)
...
Cohesion: 0.04
Nodes (48): FlutterDesktopMessage, variant, TextureVariant, FlutterDesktopPluginRegistrarRef, FirebaseAuthPluginCApiRegisterWithRegistrar(), ErrorOr, v_, FlutterError (+40 more)

### Community 313 - "InternalAuthCredentialInput"
Cohesion: 0.05
Nodes (52): activeWorkoutPlanProvider, exercisesProvider, workoutPlanEntriesProvider, workoutPlansProvider, SpringMotion, ActiveWorkoutView, build, build (+44 more)
...
Cohesion: 0.06
Nodes (32): cards, childDecks, childFolders, color, confirmed, contents, decks, deleted (+24 more)
...
Cohesion: 0.06
Nodes (32): JobRepository get, addCategory, addSeason, addStage, createApplication, deleteApplication, deleteCategory, deleteCompany (+24 more)
...
Cohesion: 0.11
Nodes (18): AuthNotifier, DevSettingsController, FpsMonitorController, JournalDebugLogger, begin, complete, fail, stateFor (+10 more)
...
Cohesion: 0.04
Nodes (45): anchor, _BreakdownRow, build, child, count, counts, date, difficulty (+37 more)
...
Cohesion: 0.11
Nodes (17): GlobalKey, GlobalKey get, _RenderCapsLockCaret, RenderVimAnchoredChrome, attach, createRenderObject, detach, _handleScroll (+9 more)
...
Cohesion: 0.12
Nodes (15): AnimationController, animateTo, controller, defaultSpring, dispose, jumpTo, _spring, stop (+7 more)
...
Cohesion: 0.17
Nodes (11): AppThemeMode, BillingPeriod, CalendarViewMode, HeatmapMode, LeetCodeDifficulty, StartupPageMode, TrackerCadence, TrackerStyle (+3 more)
...
Nodes (49): double? contentWidth,
  bool, build, _CreateNameColorDialog, _CreateNameColorDialogState, createState, dispose, initialColor, initState (+41 more)
...
Cohesion: 0.04
Nodes (48): colorPaletteProvider, build, _changeEventColor, _changeEventColor, _addColor, build, createState, dispose (+40 more)

### Community 368 - "TEST"
Cohesion: 0.11
Nodes (29): calendarRepositoryProvider, devSettingsProvider, build, _confirmDeleteAllCalendarEvents, devDisablePetalFieldProvider, devForceOfflineProvider, DevPage, devShowTimeSelectorHitboxesProvider (+21 more)
...
Cohesion: 0.11
Nodes (19): trackerRepositoryProvider, _createTracker, _delete, _deleteTracker, _editTracker, _handleTap, _HeatmapBucket, _HeatmapBucketState (+11 more)
...
Cohesion: 0.04
Nodes (57): FocusNode, loadDictionaryFromAssets, raw, package:flutter/rendering.dart, package:flutter/services.dart, package:voyager/core/snippets/snippet_session.dart, package:voyager/core/vim/vim_enabled_scope.dart, package:voyager/core/vim/vim_text_overlay.dart (+49 more)
...
Cohesion: 0.12
Nodes (15): CloudFunctionWeatherClient, DevOpenWeatherClient, WeatherForecast, WeatherSnapshot, WeatherApiClient, FakeWeatherApiClient, forecastCalls, forecastResult (+7 more)
...
Cohesion: 0.67
Nodes (3): LeetCodeRepository, DriftLeetCodeRepository, _RecordingLeetCodeRepository
...
Cohesion: 0.04
Nodes (47): studyFolderByIdProvider, display, divisions, _GeometricTextureSlider, label, max, min, onChanged (+39 more)
...
### Community 398 - "asOf"
Cohesion: 0.04
Nodes (44): EditableTextState, _addSnippet, anchor, _applySuggestion, build, createState, editableTextState, getConstraintsForChild (+36 more)

### Community 399 - "assetId"
Cohesion: 0.06
Nodes (34): _, GoRouter, Key? get, auth, child, _preloadedShellPaths, routerProvider, settingsRepo (+26 more)
...
Cohesion: 0.05
Nodes (40): Alignment, BorderRadius, Color, Key? dateKey,
  double, alphaBlend, base, build, ChartHoverBubble (+32 more)
...
Cohesion: 0.04
Nodes (53): BackdropFilter, build, _canImport, _controller, createState, deckId, dispose, importedCount (+45 more)
...
Cohesion: 0.18
Nodes (8): unique_ptr, PluginRegistrar, AddPlugin, plugins_, TextureRegistrar, MarkTextureFrameAvailable, RegisterTexture, UnregisterTexture
...
### Community 425 - "body"
Cohesion: 0.22
Nodes (8): CalendarEvent, event, RevealRequest, revealRequestProvider, RevealTargetType, task, type, package:voyager/domain/models/calendar_models.dart
...
Cohesion: 0.04
Nodes (87): K, FromEncodableList, operator==, AuthPigeonFirebaseApp, EncodableList, InternalActionCodeSettings, InternalAdditionalUserInfo, InternalAuthCredential (+79 more)

### Community 440 - "study_keyboard_shortcuts.dart"
Cohesion: 0.06
Nodes (31): _, geometricShaderProvider, _advance, build, createState, _done, _frame, GeometricTextureWarmup (+23 more)
...
Cohesion: 0.05
Nodes (54): allDreamEntriesProvider, allTodoTasksProvider, calendarEventsProvider, calendarTodoMarkersProvider, dreamRepositoryProvider, dreamWriteCoordinatorProvider, settingsProvider, todoListStatsProvider (+46 more)
...
Cohesion: 0.33
Nodes (6): ChangeNotifier, _Repaint, CapsLockState, TodoSortDebugLogger, CalendarEventTapState, LifeTreeCanvasController
...
### Community 504 - "SyncPayloadTooLargeException"
Cohesion: 0.67
Nodes (3): Exception, SyncPayloadTooLargeException, BackupFormatException
...
## Knowledge Gaps
- **13354 isolated node(s):** `LifeTrackerCachedStats`, `_fallbackDeviceId`, `_useCloudFunctions`, `_openWeatherApiKey`, `databaseProvider` (+13349 more)
...
- **Why does `ActionCodeInfoOperation` connect `FLTAuthStateChannelStreamHandler` to `Todo Task`, `Windows Ephemeral`, `Constants Google`, `Features Settings`, `calendarNavigateLeftKey`?**
