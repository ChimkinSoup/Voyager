# Graph Report - Voyager  (2026-09-21)

## Corpus Check
- 1123 files · ~1,588,769 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 28172 nodes · 44207 edges · 1063 communities (648 shown, 415 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 297 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2f40f5db`
...
## Communities (1063 total, 415 thin omitted)
...
Cohesion: 0.01
Nodes (255): trackerRepositoryProvider, accent, _addOption, all, analytics, anchor, anchorDateRect, anchorIndex (+247 more)
...
Cohesion: 0.01
Nodes (177): JournalDebugLogger?, accent, accentColor, allEntriesCount, _appliedSavedPreferences, _applySavedPreferencesIfReady, _attachedEntryId, _bodyEntryId (+169 more)
...
Cohesion: 0.06
Nodes (38): studyDecksProvider, studyFoldersProvider, _blocked, build, createState, _link, _linking, parentDeckId (+30 more)
...
Cohesion: 0.02
Nodes (102): MediaService, publishAsset, publishReference, _remoteSync, MediaFileStore, package:image/image.dart, package:voyager/core/media/media_service.dart, package:voyager/core/media/widgets/media_drop_target.dart (+94 more)
...
Cohesion: 0.02
Nodes (136): class, hiddenNotificationFeedProvider, accent, _addNote, build, child, _clearAll, color (+128 more)

### Community 19 - "Journal Feature — journal_page"
Cohesion: 0.01
Nodes (166): ChangeNotifierProvider, activeWorkoutPlanProvider, activeWorkoutSessionProvider, all, allJournalEntriesScope, backupCollectionsProvider, bills, brightness (+158 more)

### Community 20 - "Shell Feature — weather_forecast_chart"
Cohesion: 0.02
Nodes (129): DayForecastChartSeries, allowOverflow, allowVerticalOverflow, axisMaxY, axisMinY, belowPath, bottom, bottomAxisHeight (+121 more)
...
Cohesion: 0.02
Nodes (89): allDreamEntriesProvider, analyticsServiceProvider, DismissIntent, DreamEntry, DreamWriteCoordinator?, JournalEntry, JournalRepository?, JournalWriteCoordinator? (+81 more)
...
Cohesion: 0.01
Nodes (284): @DriftDatabase, DateTime? stamp,
  int, _Device, _FlakySyncRepository, SyncEngine, _buffered, notify, notifyOne (+276 more)
...
Cohesion: 0.02
Nodes (83): Icon, IconButton, RepeatIconButton, package:voyager/core/constants/journal_constants.dart, package:voyager/core/media/widgets/media_gallery_strip.dart, package:voyager/domain/models/todo_models.dart, package:voyager/domain/todo/todo_recurring_completion.dart, package:voyager/features/calendar/calendar_event_panel.dart (+75 more)

### Community 42 - "Test Suite — package:flutter_test/flutter"
Cohesion: 0.02
Nodes (111): class MockDocumentReference extends, DocumentReference, FirebaseFirestore, StatefulNavigationShell, ../test/fakes/fake_weather_api_client.dart, addCustomWord, authStateChanges, batch (+103 more)

### Community 43 - "Test Suite — package:flutter_test/flutter"
Cohesion: 0.06
Nodes (30): byDay, colorForLeetCodeActivitySeries, countFor, countForSeries, days, difficulty, easy, forDifficulty (+22 more)
...
Cohesion: 0.02
Nodes (108): AnimatedContainer, package:drift/drift.dart, package:flutter/gestures.dart, package:voyager/core/constants/todo_constants.dart, package:voyager/core/theme/voyager_list_item_surface.dart, package:voyager/features/todo/todo_edit_panel.dart, package:voyager/features/todo/todo_list_search_bar.dart, support/todo_page_harness.dart (+100 more)
...
Cohesion: 0.03
Nodes (83): Budget, budgetsProvider, financeCaptureDraftProvider, financeLedgerTagFilterProvider, financeRepositoryProvider, financeUiPrefsProvider, FinanceViewMode, FinancialTransaction (+75 more)

### Community 49 - "Test Suite — package:flutter/services"
Cohesion: 0.05
Nodes (43): package:voyager/features/leetcode/leetcode_code_controller.dart, package:voyager/features/leetcode/leetcode_scratch_pad.dart, container, _contentOffset, db, _dragBy, _entryCommands, gesture (+35 more)
...
Cohesion: 0.04
Nodes (45): GlassButton, _GlassButtonState, Journal, ListView, package:voyager/features/settings/dictionary_dialog.dart, package:voyager/features/settings/job_experience_snippets_dialog.dart, package:voyager/features/settings/services/color_replacement_service.dart, package:voyager/features/settings/settings_color_palette_section.dart (+37 more)
...
Cohesion: 0.03
Nodes (75): accentColor, _active, _autocorrectActive, autocorrectAllowed, _autocorrectScope, autocorrectSession, _badge, _beginSuspension (+67 more)
...
Cohesion: 0.02
Nodes (126): JobExperienceSnippet, _AnalyticsToolbar, _EmptyTrackersCard, _GridView, _HeatmapGroupDivider, _HeatmapMonthTile, _MacroStatsRow, _SectionLabel (+118 more)
...
Cohesion: 0.02
Nodes (127): LeetCodeCheatActions get, _actions, activeTabId, allCollapsed, _beginEditingAt, _buildBody, _buildTabBody, child (+119 more)
...
Cohesion: 0.04
Nodes (60): activeWorkoutPlanProvider, exercisesProvider, _defaultEventColor, initState, _persistCalendarView, build, _persistEntryListWidth, build (+52 more)
...
Cohesion: 0.03
Nodes (76): exerciseSetLogsProvider, anchorRect, anchorRectFor, box, build, _ChartPlaceholder, _close, _controller (+68 more)
...
Cohesion: 0.05
Nodes (47): financeRepositoryProvider, subscriptionsProvider, Budget, Subscription, _save, _detach, _delete, _save (+39 more)
...
Cohesion: 0.08
Nodes (24): CrdtDocumentResolver, _merger, _mergeSyncOperations, resolvePayload, detectDreamEntryConflict, detectJournalEntryConflict, detectTodoTaskConflict, isConflict (+16 more)

### Community 89 - "Firebase Auth (android) — NonNull"
Cohesion: 0.01
Nodes (150): MemoryFinanceUiPrefsStore? prefsStore,
  bool, package:voyager/core/utils/ids.dart, package:voyager/domain/models/enums.dart, package:voyager/domain/models/finance_models.dart, package:voyager/domain/services/contribution_room_writer.dart, package:voyager/features/finance/finance_analytics_view.dart, package:voyager/features/finance/finance_budget_panel.dart, package:voyager/features/finance/finance_net_flow_chart.dart (+142 more)

### Community 90 - "Test Suite — scroll_offset_isolate_test"
Cohesion: 0.02
Nodes (99): BoxFit, accent, accentColor, asset, build, collection, count, createState (+91 more)
...
Cohesion: 0.04
Nodes (55): Delay, databaseProvider, syncRepositoryProvider, FirestoreWriteGate, _authRepo, _beforeInitialize, clearFor, _clearPending (+47 more)
...
Cohesion: 0.05
Nodes (46): leetcodeProblemsProvider, leetcodeReviewLogProvider, _ActivityDetailCard, _ActivityDetailCardState, anchorRect, build, _close, _closing (+38 more)
...
Nodes (49): Alignment, bool? enableDrag,
  BorderRadius, BorderRadius?, body, build, floatingActionButton, PlatformAdaptiveScaffold, autofocus (+41 more)
...
Cohesion: 0.04
Nodes (53): _ArrivingCheatSheetButton, build, LeetCodePage, _LeetCodeViewMode, _leetCodeViewModeProvider, mode, after, before (+45 more)
...
Cohesion: 0.02
Nodes (80): studyFolderByIdProvider, showSessionResumeToast, build, CompactBackBar, label, onBack, build, color (+72 more)

### Community 122 - "Study Feature — ConsumerState"
Cohesion: 0.04
Nodes (50): accent, AppShell, axis, _bottomFade, branchIndex, child, _ClockText, _ClockTextState (+42 more)
...
Cohesion: 0.04
Nodes (69): customWordsProvider, dictionaryProvider, DictionarySearchResult, flaggedWordsProvider, build, _flag, _FlagWordPanelState, _persistLastViewedJournal (+61 more)
...
Cohesion: 0.05
Nodes (42): leetCodeRepositoryProvider, confirmed, container, context, copyLeetCodeCode, current, deleteLeetCodeProblem, dismiss (+34 more)
...
Cohesion: 0.08
Nodes (46): dreamWriteCoordinatorProvider, journalAllEntryIdsProvider, journalDebugLoggerProvider, journalEntryCacheInvalidatorProvider, journalEntryCountsProvider, journalListEntriesProvider, journalRepositoryProvider, journalsProvider (+38 more)
...
Cohesion: 0.03
Nodes (58): formatTime12Hour, formatTimeOfDay12Hour, jm, local, now, CalendarTodoPanel, _CalendarTodoPanelState, _closingAfterSave (+50 more)
...
Cohesion: 0.05
Nodes (48): colorPaletteProvider, build, _add, pickAccentColor, _addMinorPetalColor, _controller, createState, dispose (+40 more)
...
Cohesion: 0.05
Nodes (64): remoteSyncServiceProvider, studyCardsProvider, studyDeckByIdProvider, studyDeckGraphProvider, studyDeckStatsProvider, studyRepositoryProvider, changeStudyDeckColor, changeStudyFolderColor (+56 more)
...
Cohesion: 0.05
Nodes (52): todoListsProvider, todoRepositoryProvider, todoSortDebugLoggerProvider, build, DevTodoSortDebugSection, _logDialogOpen, _showLogDialog, _addSubtask (+44 more)
...
Cohesion: 0.04
Nodes (52): Drag?, _attachedToastDwell, attachImagesForOwner, count, facet, fileStore, images, pickImageFiles (+44 more)
...
Cohesion: 0.03
Nodes (64): FirebaseAuthMultiFactorException, Color, FirebaseAuthException, build, color, DreamBranchOverlay, _DreamBranchPainter, minorColors (+56 more)
...
Cohesion: 0.06
Nodes (32): journalEntryCacheInvalidatorProvider, journalWriteCoordinatorProvider, _bind, build, _controller, _coordinator, createState, _delete (+24 more)
...
Cohesion: 0.04
Nodes (50): TrackerValue, AssetValuation, FinancialTransaction, GoalAllocation, applicationId, applicationUrl, archivedAt, categoryId (+42 more)
...
Cohesion: 0.02
Nodes (116): DateTime? deletedAt,
  int, MoodGradientSlider, DriftJournalRepository, searchEntries, SearchService, build, journalId, _saveDefaultJournal (+108 more)
...
Cohesion: 0.03
Nodes (70): dart:io, Directory, File, package:voyager/domain/models/leetcode_cheat_models.dart, close, customStatement, db, dir (+62 more)
...
Cohesion: 0.05
Nodes (66): jobApplicationsProvider, jobCategoriesProvider, jobCompaniesProvider, jobSeasonsProvider, jobStagesProvider, build, _CategoriesTabState, _SeasonsTabState (+58 more)
...
Cohesion: 0.04
Nodes (54): devGeometricTexturePanelOpenProvider, devGeometricWavePanelOpenProvider, geometricDebugRowFadeProvider, geometricShaderProvider, geometricTextureParamsProvider, geometricWaveParamsProvider, _GeometricBackground, applySettings (+46 more)
...
Cohesion: 0.06
Nodes (34): dart:async, journalDebugLoggerProvider, DevFlags, disableCache, disablePetalField, forceOffline, showLifeTrackerRestore, showLifeTreeSegmentDebug (+26 more)

### Community 231 - "Shell Feature — shell_keyboard_shortcuts"
Cohesion: 0.05
Nodes (48): @visibleForTesting, Intent, renderEditableOf, sync, _PasteImageIntent, _PasteMediaIntent, reconcile, restoreIfSelectAll (+40 more)
...
Cohesion: 0.05
Nodes (37): LeetCodeApiQuestion, LeetCodeSolution, _BackSolution, _backTitleKey, _cardRadius, controller, createState, _frontTitleKey (+29 more)
...
Cohesion: 0.04
Nodes (55): 1, build, busiest, byDay, _CalendarHover, _columnsFor, counts, createState (+47 more)
...
Cohesion: 0.07
Nodes (28): JobApplication, application, build, _cell, color, _colorColumnWidth, _columnFlex, columns (+20 more)
...
Cohesion: 0.07
Nodes (26): anchorRect, build, _close, _closing, _ComplexityTile, _controller, createState, _DetailCard (+18 more)
...
Cohesion: 0.06
Nodes (31): RankingCategory, RankingsActions, _accent, _actions, build, category, children, _commitText (+23 more)
...
Cohesion: 0.04
Nodes (54): mediaServiceProvider, mediaStorageProvider, MediaAsset, assets, captions, collect, context, messenger (+46 more)
...
Cohesion: 0.08
Nodes (26): Quote, container, entry, _file, FileQuickJournalPointerStore, journalId, journals, _localDayKey (+18 more)
...
Cohesion: 0.06
Nodes (36): build, _buildEditor, _capLabelExtent, _capLabelFontSize, _capLabelGap, _clampInt, commit, _commitPendingForDateChange (+28 more)
...
Cohesion: 0.04
Nodes (57): dart:convert, _FakeLeetCodeApi, LeetCodeTrackDraft? draft,
  String?, list, loadQuotesFromAssets, raw, LeetCodeTrackDraft, _chain (+49 more)
...
Cohesion: 0.01
Nodes (161): DateTimeRange, FinanceCategory, SavingsGoal, _amountController, _canSave, container, createState, _date (+153 more)
...
Cohesion: 0.07
Nodes (31): FocusNode get, ProseEditingController, accentColor, build, color, controller, createState, didUpdateWidget (+23 more)
...
Cohesion: 0.04
Nodes (45): LeetCodeProblem? get, LeetCodeScratchSession? get, buffer, leetCodeCheatSheetMarkdown, toString, code, copyWith, expanded (+37 more)
...
Cohesion: 0.04
Nodes (55): CalendarEvent?, entityRemindersProvider, _allDayFocusNode, build, _buildPayload, CalendarEventPanel, _CalendarEventPanelState, _calendarFlagColor (+47 more)
...
Cohesion: 0.06
Nodes (64): ConsumerWidget, allDreamEntriesProvider, allJournalEntriesProvider, allTodoTasksProvider, analyticsServiceProvider, build, dreamRepositoryProvider, dreamWriteCoordinatorProvider (+56 more)
...
Cohesion: 0.06
Nodes (38): customWordsProvider, dictionaryProvider, flaggedWordsProvider, mediaDiskLowProvider, mediaStorageUsageProvider, voyagerSpellCheckServiceProvider, AutocorrectSession, _addSnippet (+30 more)
...
Cohesion: 0.05
Nodes (40): , build, child, createState, _currentLocation, dense, dispose, initState (+32 more)
...
Cohesion: 0.01
Nodes (271): EditableText, EditableTextState, Finder get, FocusNode, loadDictionaryFromAssets, raw, VoyagerSpellCheckService, srsMasteryColor (+263 more)

### Community 358 - "trackerRepositoryProvider"
Cohesion: 0.04
Nodes (38): calendar, debug, journal, manage, search, VoyagerIcons, kMinTouchTarget, isCompactWidth (+30 more)
...
Cohesion: 0.03
Nodes (66): Card, ContextMenuRegionState, DateTime? dueAt,
  int, LeetCodeProblem, _back, build, createState, _face (+58 more)

### Community 365 - "dev_fps_counter_tile.dart"
Cohesion: 0.04
Nodes (47): DateTime? recurrenceEndDate,
  List, CalendarEvent, day, event, RevealRequest, RevealTargetType, task, type (+39 more)
...
Cohesion: 0.10
Nodes (23): allTodoTasksProvider, calendarsProvider, calendarTodoMarkersProvider, calendarViewEventsProvider, colorPaletteProvider, devSettingsProvider, googleCalendarSyncProvider, build (+15 more)
...
Cohesion: 0.03
Nodes (69): package:voyager/core/constants/calendar_constants.dart, package:voyager/features/calendar/calendar_manage_sheet.dart, package:voyager/features/calendar/calendar_page.dart, calendars, container, db, main, now (+61 more)
...
Cohesion: 0.10
Nodes (22): CustomQuote, customQuotesProvider, _add, build, _controller, createState, _CustomQuotesDialog, _CustomQuotesDialogState (+14 more)
...
Cohesion: 0.08
Nodes (34): AutomaticKeepAliveClientMixin, ChildIndexGetter?, EdgeInsetsGeometry, _Host, IndexedWidgetBuilder, WindowVisibility, GeometricTexture, _GeometricTextureState (+26 more)
...
Cohesion: 0.04
Nodes (56): DailyFlow, 90, active, _BubbleRow, build, _clearHover, color, compact (+48 more)
...
Cohesion: 0.05
Nodes (40): Axis, Brightness, brightness, _count, derivedColor, fallback, forStage, _indexByName (+32 more)
...
Cohesion: 0.06
Nodes (33): journalsProvider, affectedEntryIds, allJournals, assigner, changeJournalListColor, choice, color, context (+25 more)
...
Cohesion: 0.07
Nodes (25): id, OutOfSyncJournalEntryPurge, OutOfSyncJournalEntryTarget, purgeAll, purgeOne, searchHint, targets, title (+17 more)
...
Cohesion: 0.07
Nodes (27): firestoreId, firestoreJournalId, journalDocumentIdForFirestore, journalDocumentIdFromFirestore, journalReferenceIdForFirestore, journalReferenceIdFromFirestore, legacyJournalFirestoreId, legacyJournalId (+19 more)
...
Cohesion: 0.05
Nodes (42): class ConnectivityStatusController extends, _auth, AuthNotifier, dispose, _isAuthenticated, _subscription, _Repaint, CapsLockState (+34 more)

### Community 411 - "Shared Widgets — confirm_dialog"
Cohesion: 0.11
Nodes (33): assetRoomEventsProvider, assetsProvider, assetValuationsProvider, contributionRoomsProvider, financeCategoriesProvider, tagColorsProvider, transactionsProvider, _BreakdownCard (+25 more)
...
Cohesion: 0.05
Nodes (46): autocorrectScopeProvider, devLeafGalleryPanelOpenProvider, paperShaderProvider, petalFieldParamsProvider, snippetScopeProvider, themeModeProvider, _AppBackground, build (+38 more)

### Community 417 - "Settings Feature — package:voyager/domain/model"
Cohesion: 0.01
Nodes (137): dart:ui, Error, appSettingsWithGeometricTextureParams, appSettingsWithGeometricWaveParams, copyWith, geometricTextureParamsFromSettings, geometricWaveParamsFromSettings, package:voyager/core/spellcheck/voyager_spell_check_service.dart (+129 more)
...
Cohesion: 0.02
Nodes (104): BackdropFilter, BuildContext, ColoredBox, firestoreId, legacyTodoListFirestoreId, legacyTodoListId, localId, todoListDocumentIdForFirestore (+96 more)
...
Cohesion: 0.12
Nodes (15): AssetRoomEvent, Asset, asset, assets, container, counterName, deleteRoomEventWithUndo, _edit (+7 more)
...
Cohesion: 0.03
Nodes (70): LabeledTextField, _LabeledTextFieldState, autoExpand, build, card, createState, dispose, error (+62 more)
...
### Community 447 - "Jobs"
Cohesion: 0.08
Nodes (26): ActiveWorkoutState, Exercise, controller, count, createState, _CurrentExerciseTitle, didUpdateWidget, _discard (+18 more)
...
Cohesion: 0.15
Nodes (14): notificationBadgeStateProvider, accent, _anchorKey, _bellHeight, _bellWidth, build, createState, _GlowDot (+6 more)
...
Cohesion: 0.13
Nodes (14): WeightUnit, formatDisplay, formatKilograms, formatKilogramsWithUnit, fromKilograms, kilogramsForWheelIndex, label, max (+6 more)

### Community 470 - "Test Suite — todo_list_search_test"
Cohesion: 0.06
Nodes (31): createState, DevOutOfSyncPurgeSection, _DevOutOfSyncPurgeSectionState, _lastResults, _purging, package:voyager/core/dev/out_of_sync_journal_entry_purge.dart, package:voyager/core/widgets/confirm_dialog.dart, package:voyager/core/widgets/datetime_picker_dialog.dart (+23 more)
...
Cohesion: 0.10
Nodes (18): package:voyager/core/tags/tag_suggestions.dart, db, ensureVisible, listProblems, main, _NoopRemoteSync, now, _openModal (+10 more)
...
Nodes (48): double? contentWidth,
  bool, build, _CreateNameColorDialog, _CreateNameColorDialogState, createState, dispose, initialColor, initState (+40 more)

### Community 523 - "InternalPhoneMultiFactorAssertion"
Cohesion: 0.01
Nodes (163): ByteData, fakes/fake_weather_api_client.dart, Image, currentWeatherProvider, _Await, barrierDismissible, deleteBudgetWithUndo, deleteSubscriptionWithUndo (+155 more)
...
Cohesion: 0.06
Nodes (37): SpringMotion, accent, build, color, createState, didChangeDependencies, dispose, _formatRemaining (+29 more)
...
Cohesion: 0.04
Nodes (69): ConsumerState, ConsumerStatefulWidget, cachedCurrentWeatherProvider, _MediaLightbox, _MediaLightboxState, _HeatmapDayCell, _HeatmapDayCellState, _HeatmapSquare (+61 more)

### Community 544 - "Todo Feature — todo_page"
Cohesion: 0.14
Nodes (12): StatisticTracker, build, HeatmapCalendar, month, tracker, values, package:voyager/domain/services/analytics_service.dart, analytics (+4 more)
...
Cohesion: 0.07
Nodes (28): copyWith, EventRecurrence, frequency, hashCode, interval, isCustom, none, operator (+20 more)
...
Cohesion: 0.05
Nodes (43): buildTextSpan, dispose, _emphasis, focusNode, _forward, _markupFor, overlaySpan, source (+35 more)
...
Cohesion: 0.08
Nodes (38): journalRepositoryProvider, syncActivityProvider, _purgeAll, build, _confirmDeleteAllEntries, _confirmResetJournals, devDisablePetalFieldProvider, devForceOfflineProvider (+30 more)
...
Cohesion: 0.04
Nodes (51): FirebaseException, charOpEncodeIsolateThreshold, charOps, CharOpsEncodeRequest, chunks, compute, encodeCharOpPayloads, encodeCharOpPayloadsSync (+43 more)
...
Cohesion: 0.03
Nodes (58): EventRecurrence, IconData, _accent, accentColor, anchor, build, _buildCustomPage, _buildPresetPage (+50 more)
...
Cohesion: 0.04
Nodes (54): defaultColorPalette, FirestorePullService, _dreamRepository, DreamWriteCoordinator, _findTask, _journalRepository, JournalWriteCoordinator, _remoteSync (+46 more)
...
Cohesion: 0.06
Nodes (36): build, createState, _datePanelHeight, dispose, initState, _keepTitleInDraft, _lastTouchedId, _listRowHeight (+28 more)
...
Cohesion: 0.04
Nodes (50): package:drift/native.dart, package:voyager/domain/models/job_experience_snippet.dart, package:voyager/features/analytics/tracker_entry_row.dart, package:voyager/features/jobs/jobs_charts.dart, package:voyager/features/jobs/jobs_header.dart, _grey, _ignoreBool, _ignoreString (+42 more)
...
Cohesion: 0.06
Nodes (47): bool?, authNotifierProvider, backgroundSyncOrchestratorProvider, connectivityStatusProvider, firestoreWriteGateProvider, lazyLoadProvider, liveSyncProvider, mediaTransferWorkerProvider (+39 more)
...
## Knowledge Gaps
- **21044 isolated node(s):** `collection`, `documentId`, `facet`, `accentColor`, `thumbnailSize` (+21039 more)
...
- **Why does `ActionCodeInfoOperation` connect `Shared Widgets — voyager_text_field` to `Firebase Auth (ios) — firebase_auth_messages.g`, `Firebase Auth (macos) — firebase_auth_messages.g`, `Firebase Auth (android) — NonNull`, `Firebase Auth (windows) — messages.g.cpp`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `InternalActionCodeInfo` connect `Firebase Auth (macos) — firebase_auth_messages.g` to `InternalUserDetails`, `Shared Widgets — voyager_text_field`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `ActionCodeInfoOperationBox` connect `Firebase Auth (macos) — firebase_auth_messages.g` to `InternalUserDetails`, `Shared Widgets — voyager_text_field`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **What connects `collection`, `documentId`, `facet` to the rest of the system?**
  _21045 weakly-connected nodes found - possible documentation gaps or missing edges._
