# Graph Report - Voyager  (2026-09-13)

## Corpus Check
- 985 files · ~1,354,052 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 24508 nodes · 38691 edges · 970 communities (603 shown, 367 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 297 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3279dceb`
...
- Drift Database Schema — app_database
- ranking_precision_change_test.dart
- app_fonts.dart
- Drift Database Schema — app_database
- Drift Database Schema — app_database
- Drift Database Schema — app_database
...
- -randomNonce
- job_clipboard_parser_test.dart
...
- -registerAuthStateListenerAppcompletion
- -verifyPhoneNumberApprequestcompletion
- life_tracker_stat_popup_width_test.dart
- leetcode_srs_test.dart
- autocorrect_enabled_scope.dart
...
1. `_State` - 134 edges
2. `settingsProvider` - 94 edges
3. `remoteSyncServiceProvider` - 91 edges
...
## Communities (970 total, 367 thin omitted)

### Community 0 - "Drift Database Schema — app_database"
Cohesion: 0.00
Nodes (749): BoolColumn get, _, _accentColorMeta, actualTableName, _addedAtMeta, _alertOnPeriodicPromptsMeta, _alertTimeHourMeta, _algorithmMeta (+741 more)
...
Cohesion: 0.01
Nodes (296): addCustomWord, _applicationCompanion, _categoryCompanion, _childCompanion, _companyCompanion, countCardsReviewedToday, countCardsReviewedTotal, countDueCards (+288 more)
...
Cohesion: 0.01
Nodes (267): addCustomWord, appendOperation, appendOperationGroup, appendOperationsBatch, authStateChanges, claimCalendarLock, claimWeatherFetchLock, countCardsReviewedToday (+259 more)
...
Cohesion: 0.01
Nodes (222): CharacterOpRegistry get, _activeDebouncers, _activelyEditedDocuments, addPendingTextMergeListener, applyPendingDreamEntryTextMerge, applyPendingJournalEntryTextMerge, applyPendingTodoTaskNotesMerge, at (+214 more)

### Community 8 - "Todo Feature — todo_page"
Cohesion: 0.01
Nodes (206): AsyncValue, accent, accentColor, activeCount, _activeInList, _activeMatchKey, _activeSectionHeight, _addingTask (+198 more)

### Community 9 - "Journal Feature — journal_page"
Cohesion: 0.01
Nodes (168): accent, accentColor, allEntriesCount, _appliedSavedPreferences, _applySavedPreferencesIfReady, _attachedEntryId, _bodyFocusNode, bodyPreview (+160 more)

### Community 10 - "Firebase Auth (windows) — messages.g.cpp"
Cohesion: 0.02
Nodes (247): flutter::StandardCodecSerializer, GenerateInterfaces, string_view, AuthPigeonFirebaseApp, app_name_, AuthPigeonFirebaseApp::AuthPigeonFirebaseApp(), custom_auth_domain, FromEncodableList (+239 more)

### Community 11 - "Finance Feature — finance_transaction_modal"
Cohesion: 0.04
Nodes (48): TransactionType, amountCents, _amountController, container, createState, _date, _datePopoverOpen, dispose (+40 more)
...
Cohesion: 0.02
Nodes (104): dart:io, Directory, MediaService, MediaFileStore, package:image/image.dart, package:voyager/core/media/media_clipboard.dart, package:voyager/core/media/media_service.dart, package:voyager/core/media/widgets/media_drop_target.dart (+96 more)

### Community 15 - "Sync Engine — firestore_document_mapper"
Cohesion: 0.01
Nodes (155): assetToFirestore, assetValuationToFirestore, body, bucketListItemToFirestore, budgetToFirestore, calendarEventToFirestore, calendarToFirestore, collection (+147 more)
...
Cohesion: 0.02
Nodes (122): accent, child, color, _completingNow, _controller, copyWith, createState, _dateLabel (+114 more)

### Community 19 - "Journal Feature — journal_page"
Cohesion: 0.02
Nodes (130): ChangeNotifierProvider, activeWorkoutSessionProvider, all, allJournalEntriesScope, backupCollectionsProvider, bills, brightness, buildBackupCollections (+122 more)
...
Cohesion: 0.02
Nodes (95): _applyPendingNotesMerge, _beginEditingSession, _buildFields, _buildSubtaskList, _clearDueDate, _close, color, _container (+87 more)

### Community 28 - "Study Feature — ConsumerState"
Cohesion: 0.03
Nodes (60): _accentColor, _activeQuery, _baseline, body, _bodyController, _bodyFocusNode, _changeEntryDateAndTime, _coordinator (+52 more)

### Community 29 - "Test Suite — journal_settings_dialog_test"
Cohesion: 0.03
Nodes (56): build, _counts, createdId, _createdJournalId, _createJournal, createState, _deleteJournal, initState (+48 more)
...
Cohesion: 0.02
Nodes (83): defaultColorPalette, id, OutOfSyncJournalEntryPurge, OutOfSyncJournalEntryTarget, purgeAll, purgeOne, searchHint, targets (+75 more)
...
Cohesion: 0.02
Nodes (109): allDreamEntriesProvider, dreamRepositoryProvider, dreamWriteCoordinatorProvider, accentColor, _appliedSavedWidth, _bodyEditorKey, _bodyFocusNode, bodyPreview (+101 more)

### Community 37 - "Firebase Auth (windows) — messages.g.cpp"
Cohesion: 0.03
Nodes (62): FlutterDesktopMessage, nanoseconds, TextureVariant, ErrorOr, v_, FlutterError, code_, details_ (+54 more)
...
Cohesion: 0.04
Nodes (59): borderColor, child, _closeGeneration, _closing, _create, _createFolderOrDeck, _CreateMenu, createState (+51 more)

### Community 41 - "Test Suite — package:voyager/domain/repos"
Cohesion: 0.04
Nodes (49): build, CalendarTodoPanel, _CalendarTodoPanelState, _closingAfterSave, _completed, createState, didUpdateWidget, _discard (+41 more)

### Community 42 - "Test Suite — package:flutter_test/flutter"
Cohesion: 0.02
Nodes (97): class MockDocumentReference extends, package:fake_cloud_firestore/fake_cloud_firestore.dart, package:voyager/core/sync/outbox_sync_worker.dart, package:voyager/data/remote/firestore_sync_repository.dart, ../test/fakes/fake_weather_api_client.dart, addCustomWord, authStateChanges, batch (+89 more)
...
Cohesion: 0.08
Nodes (25): DocumentReference, FirebaseFirestore, FirebaseFunctions?, _call, _firestore, FirestoreWeatherReader, _functions, getCurrentWeather (+17 more)

### Community 46 - "Shared Widgets — petal_field"
Cohesion: 0.02
Nodes (91): _advance, _advancePetal, approachLogDt, baseOpacity, build, burstAt, center, _clock (+83 more)
...
Cohesion: 0.03
Nodes (65): AnimatedContainer, package:flutter/gestures.dart, package:voyager/core/theme/voyager_list_item_surface.dart, package:voyager/features/todo/todo_edit_panel.dart, package:voyager/features/todo/todo_list_search_bar.dart, support/todo_page_harness.dart, deleteTaskFromRow, gesture (+57 more)

### Community 49 - "Test Suite — package:flutter/services"
Cohesion: 0.07
Nodes (41): assetsProvider, assetValuationsProvider, budgetsProvider, financeCategoriesProvider, tagColorsProvider, transactionsProvider, Budget, _BreakdownCard (+33 more)

### Community 50 - "Finance Feature — finance_analytics_view"
Cohesion: 0.04
Nodes (44): AppLifecycleListener?, buildOverscrollIndicator, buildScrollbar, createState, didChangeAppLifecycleState, dispose, _flushAllPendingEdits, getScrollPhysics (+36 more)
...
Cohesion: 0.04
Nodes (56): Finder get, _dreamRepository, DreamWriteCoordinator, _findTask, _journalRepository, _remoteSync, saveEntry, saveTask (+48 more)

### Community 53 - "Calendar Feature — calendar_grid"
Cohesion: 0.02
Nodes (80): calendar_day_entries.dart, calendar_day_grid.dart, calendar_todo_markers.dart, calendar_week_timeline.dart, CalendarEntryMenuBuilder, accentColor, allDay, base (+72 more)

### Community 54 - "Study Feature — ConsumerState"
Cohesion: 0.06
Nodes (42): studyDeckGraphProvider, studyDecksProvider, studyFoldersProvider, studyStatsProvider, _linkTile, _blocked, build, createState (+34 more)

### Community 55 - "Ephemeral — string"
Cohesion: 0.05
Nodes (65): colorPaletteProvider, remoteSyncServiceProvider, todoListsProvider, todoRepositoryProvider, build, _changeEventColor, _add, createJournalList (+57 more)
...
Cohesion: 0.03
Nodes (67): DecoratedBox, FocusNode, buildTextSpan, dispose, _emphasis, focusNode, _forward, _markupFor (+59 more)

### Community 58 - "Rankings"
Cohesion: 0.03
Nodes (75): applyRankingEditRules, ascending, byKey, _compareNullableDesc, copyWith, counts, documentIdsWithImages, every (+67 more)
...
Cohesion: 0.02
Nodes (82): VimSession, accentColor, _active, _autocorrectActive, autocorrectAllowed, _autocorrectScope, autocorrectSession, _badge (+74 more)
...
Cohesion: 0.06
Nodes (18): Retention, Target, AuthPigeonFirebaseApp, FirebaseAuthHostApi, FirebaseAuthUserHostApi, FlutterError, GenerateInterfaces, InternalUserCredential (+10 more)
...
Cohesion: 0.04
Nodes (54): 90, active, _BubbleRow, build, _clearHover, color, compact, createState (+46 more)
...
Cohesion: 0.03
Nodes (66): GeometricTextureParamsNotifier, GeometricWaveParamsNotifier, accentColor, animates, _animating, baseColor, build, _clock (+58 more)
...
Cohesion: 0.12
Nodes (17): HotKey?, key, keyToken, modifiers, parseHotKey, parts, _physicalKey, createHotkeyService (+9 more)

### Community 74 - "Rankings Feature — rankings_edit_panel"
Cohesion: 0.06
Nodes (35): _accent, build, category, children, _commitText, createState, _current, didUpdateWidget (+27 more)

### Community 75 - "Test Suite — dart:ui"
Cohesion: 0.05
Nodes (39): int? current,
  Set, assign, nextColor, palette, PaletteAssigner, paletteFromItems, pickColorFromPalette, pickPaletteColorWithRef (+31 more)
...
Cohesion: 0.11
Nodes (19): arrowsNavigateHistory, build, child, createState, dispose, _enabled, _handleGradeKey, _handleHistoryKey (+11 more)

### Community 78 - "Study Feature — ConsumerState"
Cohesion: 0.03
Nodes (79): EditableTextState, loadDictionaryFromAssets, raw, package:flutter/services.dart, package:voyager/core/caps_lock/caps_lock_caret_indicator.dart, package:voyager/core/caps_lock/caps_lock_indicator_scope.dart, package:voyager/core/theme/voyager_theme.dart, package:voyager/core/vim/vim_enabled_scope.dart (+71 more)
...
Cohesion: 0.03
Nodes (58): CodeController, LeetCodeCodeController, anchorRect, build, _close, _closing, _comparing, controller (+50 more)

### Community 84 - "Caps Lock — caps_lock_caret_indicator"
Cohesion: 0.03
Nodes (58): CurvedAnimation, accentColor, allowed, attach, _blockCaret, build, capsLockBadgeVisible, capsLockMarkInk (+50 more)
...
Cohesion: 0.04
Nodes (54): abortIfAlreadyRestored, floor, RestoreSuperseded, restoreVersionFrom, toString, allLists, assigner, choice (+46 more)

### Community 87 - "Study Feature — ConsumerState"
Cohesion: 0.03
Nodes (69): studyRepositoryProvider, card, cards, changeStudyDeckColor, changeStudyFolderColor, childDecks, childFolders, color (+61 more)

### Community 88 - "Test Suite — leetcode_session_hides_test"
Cohesion: 0.03
Nodes (66): EditableText, context, focus, isTextInputFocused, subtreeIsVisible, package:voyager/core/snippets/snippet_enabled_scope.dart, package:voyager/core/snippets/snippet_index.dart, package:voyager/core/snippets/snippet_session.dart (+58 more)

### Community 89 - "Firebase Auth (android) — NonNull"
Cohesion: 0.02
Nodes (121): DriftFinanceRepository, FinanceRepository, deleteBudgetWithUndo, deleteSubscriptionWithUndo, softDeleteWithUndo, MemoryFinanceUiPrefsStore? prefsStore,
  bool, package:voyager/core/utils/ids.dart, package:voyager/domain/models/enums.dart (+113 more)
...
Cohesion: 0.04
Nodes (45): _set, WindowProcDelegate, function, TextureRegistrarImpl::UnregisterTexture(), GetRegistrar(), FlutterDesktopPluginRegistrarRef, T, unique_ptr (+37 more)
...
Cohesion: 0.05
Nodes (37): brightness, _categoryById, _ColumnMenu, _ColumnMenuState, _companyByKey, _CompanyColors, _createApplication, createState (+29 more)
...
Cohesion: 0.06
Nodes (42): authNotifierProvider, backgroundSyncOrchestratorProvider, connectivityStatusProvider, databaseProvider, lazyLoadProvider, liveSyncProvider, quotesLoadedProvider, shellDataWarmupProvider (+34 more)
...
Cohesion: 0.03
Nodes (62): Completer, http.BaseClient, applySettings, devForceConflictUi, disableCache, loadFromSettings, _persist, setDevForceConflictUi (+54 more)

### Community 102 - "App Wiring & Providers — voyager_app"
Cohesion: 0.02
Nodes (87): File, package:drift/native.dart, package:voyager/core/widgets/notification_urgency_dot.dart, package:voyager/domain/models/analytics_models.dart, package:voyager/domain/models/life_tracker_models.dart, package:voyager/features/analytics/tracker_entry_row.dart, close, customStatement (+79 more)
...
Cohesion: 0.04
Nodes (40): GeneratedPluginRegistrant, Keep, FlutterDesktopViewControllerRef, FlutterDesktopViewRef, FlutterDesktopPluginRegistrarRef, FirebaseAuthPluginCApiRegisterWithRegistrar(), FlutterEngine::FlutterEngine(), FlutterEngine::Run() (+32 more)

### Community 105 - "Test Suite — rankings_page_test"
Cohesion: 0.07
Nodes (29): FinanceCategory, build, _canSave, _CategoryModal, _CategoryModalState, _colorValue, container, createState (+21 more)

### Community 106 - "Domain Models — SoftDeletable"
Cohesion: 0.03
Nodes (70): integers,
  half,, activeChildTemplate, activeParentTemplate, archivedAt, categoryId, childScoreMax, childScorePrecision, childTemplate (+62 more)
...
Cohesion: 0.05
Nodes (37): build, _canSave, _colorValue, container, createState, _datePopoverOpen, dispose, existing (+29 more)

### Community 109 - "Study Feature — ConsumerState"
Cohesion: 0.04
Nodes (58): sessionShuffleRandomProvider, studyAllCardsProvider, studyAllDecksProvider, studyCardImagesProvider, _syncProblems, _syncQueue, build, build (+50 more)

### Community 110 - "Sync Engine — sync_conflict_detector"
Cohesion: 0.09
Nodes (20): bool get, isAndroid, isLinux, isWindows, VoyagerPlatform, applicationUrl, company, dateApplied (+12 more)
...
Cohesion: 0.03
Nodes (89): ConsumerWidget, activeWorkoutPlanProvider, allJournalEntriesProvider, analyticsServiceProvider, devLeafGalleryPanelOpenProvider, exercisesProvider, leetcodeQuestionCountsProvider, lifeTrackerStatsProvider (+81 more)
...
Cohesion: 0.07
Nodes (21): ByteBuffer, MessageHandler, PigeonCodec, BasicMessageChannel, codec_, messenger_, name_, BinaryReply (+13 more)

### Community 116 - "Test Suite — package:voyager/domain/repos"
Cohesion: 0.02
Nodes (89): _FakeLeetCodeApi, LeetCodeTrackDraft? draft,
  String?, close, _endpoint, fetchBySlug, fetchMostRecentAcceptedSubmission, fetchQuestionCounts, _http (+81 more)
...
Cohesion: 0.04
Nodes (53): financeRepositoryProvider, subscriptionsProvider, Subscription, _save, _delete, _save, BillRadarPanel, build (+45 more)

### Community 121 - "Test Suite — todo_page_perf_test"
Cohesion: 0.03
Nodes (65): build, QuickJournalPopup, QuickTodoPopup, getOrderedDestinations, icon, index, label, order (+57 more)

### Community 122 - "Study Feature — ConsumerState"
Cohesion: 0.04
Nodes (44): accent, axis, _bottomFade, branchIndex, child, color, _CompactShell, _CompactStatusStrip (+36 more)

### Community 123 - "Constants — leetcode_constants"
Cohesion: 0.06
Nodes (38): JobsActions get, _actions, _CategoriesTab, _CategoriesTabState, category, _CategoryTile, color, companies (+30 more)

### Community 124 - "Remote API Clients — firestore_sync_repository"
Cohesion: 0.06
Nodes (34): appendOperation, appendOperationGroup, appendOperationsBatch, claimCalendarLock, claimWeatherFetchLock, _collection, deleteDocument, deleteOperations (+26 more)
...
Cohesion: 0.04
Nodes (52): autofocus, build, child, CtrlEnterToSubmitScope, isSubmitChord, key, keyboard, onSubmit (+44 more)
...
Cohesion: 0.18
Nodes (10): from typing import List, package:voyager/features/leetcode/leetcode_scratch_starter.dart, CACHE, main, now, _problem, Solution, solutions (+2 more)

### Community 134 - "Study Feature — ConsumerState"
Cohesion: 0.06
Nodes (34): confirmed, container, context, copyLeetCodeCode, current, deleteLeetCodeProblem, dismiss, draft (+26 more)

### Community 135 - "Test Suite — package:voyager/domain/repos"
Cohesion: 0.05
Nodes (36): BackdropFilter, build, child, EnterToSubmitScope, onSubmit, _textFieldHasFocus, build, _controller (+28 more)

### Community 136 - "Study Feature — ConsumerState"
Cohesion: 0.03
Nodes (60): accent, _actions, _active, affected, _all, categories, category, _CategoryList (+52 more)
...
Cohesion: 0.04
Nodes (46): alignment, autofocus, blurSigma, borderColor, borderOpacity, borderRadius, borderWidth, build (+38 more)
...
Cohesion: 0.07
Nodes (29): WorkoutPlanEntry, _accept, active, allEntries, build, createState, dayIndex, _edit (+21 more)

### Community 144 - "Media Handling — media_paste_scope"
Cohesion: 0.05
Nodes (37): MediaClipboard, build, child, collection, documentId, _dropTargetsSupported, facet, _formats (+29 more)
...
Cohesion: 0.04
Nodes (47): _applyDecision, bucket0, bucket1, bucket2, _BucketProgressBar, _canRedo, _canUndo, _cardKey (+39 more)

### Community 147 - "Shared Widgets — _State"
Cohesion: 0.01
Nodes (157): AsyncNotifier, SettingsNotifier, DriftLeetCodeRepository, AppSettings, LeetCodeRepository, LeetCodeScratchPad, NavigatorState, package:voyager/domain/models/leetcode_models.dart (+149 more)

### Community 148 - "Study Feature — ConsumerState"
Cohesion: 0.04
Nodes (46): _allDayFocusNode, build, _buildPayload, _calendarFlagColor, _calendarId, calendars, _closingAfterSave, _colorValue (+38 more)

### Community 149 - "Test Suite — journal_autosave_provider_re"
Cohesion: 0.04
Nodes (46): Archive, DriftMediaRepository, MediaRepository, archive, backupFormatVersion, backupManifestFileName, backupMediaDirectory, buildArchiveContents (+38 more)
...
Cohesion: 0.04
Nodes (52): actions, averageFromChildren, confirmDeleteRankingCategory, confirmDeleteRankingChild, confirmDeleteRankingParent, confirmed, _container, countScoresOffStep (+44 more)
...
Cohesion: 0.09
Nodes (22): accentColor, build, createState, emptyColor, fill, filledColor, fraction, _gap (+14 more)

### Community 157 - "Firebase Auth (windows) — firebase_auth_plugin.cpp"
Cohesion: 0.05
Nodes (43): package:voyager/features/settings/services/backup_collections.dart, package:voyager/features/settings/services/data_export_service.dart, package:voyager/features/settings/services/data_import_service.dart, _calendar, _collectionsFor, deletedAt, _event, id (+35 more)
...
Cohesion: 0.04
Nodes (47): _applyDecision, bucket0, bucket1, bucket2, _BucketProgressBar, _canRedo, _canUndo, cardIds (+39 more)
...
Cohesion: 0.08
Nodes (39): studyCardsProvider, studyDeckByIdProvider, studyDeckStatsProvider, build, _cramSession, createState, deckId, deckNameHint (+31 more)
...
Cohesion: 0.05
Nodes (48): mediaDiskLowProvider, mediaStorageUsageProvider, todoListStatsProvider, build, build, _controller, createState, dispose (+40 more)

### Community 170 - "Theming — voyager_theme"
Cohesion: 0.05
Nodes (41): Brightness, accentLineAmount, accentLineTarget, appBar, blurScale, brightness, _build, card (+33 more)

### Community 171 - "Analytics Feature — analytics_page"
Cohesion: 0.04
Nodes (90): CapsLockCaretIndicator, _CapsLockCaretIndicatorState, _ConfettiBurst, _ConfettiBurstState, _VimFieldOverlay, _VimFieldOverlayState, VimTextScope, _VimTextScopeState (+82 more)
...
Cohesion: 0.05
Nodes (40): accent, _add, _addController, _addFocusNode, build, category, child, _ChildEditorDialog (+32 more)
...
Cohesion: 0.11
Nodes (16): dart:async, _callbacks, flushAll, instance, PendingFlushRegistry, register, unregister, package:fake_async/fake_async.dart (+8 more)
...
Cohesion: 0.05
Nodes (39): addReference, asset, assetsFor, attachBytes, bytesFor, _decodeHeic, deleteAssetEverywhere, _downloadScheduler (+31 more)
...
Cohesion: 0.06
Nodes (35): JobRepository get, addCategory, addSeason, addStage, application, _container, createApplication, deleteApplication (+27 more)
...
Cohesion: 0.06
Nodes (32): VoyagerSpellCheckService, package:flutter_code_editor/flutter_code_editor.dart, package:voyager/core/tags/tag_suggestions.dart, package:voyager/core/widgets/field_scroll_padding.dart, package:voyager/core/widgets/tag_highlighted_text_field.dart, SpellCheckService, bottom, _columnSpan (+24 more)

### Community 194 - "Shared Widgets — _State"
Cohesion: 0.06
Nodes (30): build, CompactBackBar, label, onBack, accent, build, color, count (+22 more)
...
Cohesion: 0.03
Nodes (59): ClipRect, double? initial,
  int, VoyagerSpinnerWheel, RankingFieldValue, RankingScorePrecision, RankingTemplateField, accent, accentColor (+51 more)
...
Cohesion: 0.04
Nodes (51): fakes/input_order_random.dart, package:voyager/features/study/study_cram_page.dart, container, db, _deckId, _deleteShownCard, gesture, main (+43 more)

### Community 204 - "Dev Feature — dev_geometric_wave_tile"
Cohesion: 0.03
Nodes (77): Icon, IconButton, firestoreId, legacyTodoListFirestoreId, legacyTodoListId, localId, todoListDocumentIdForFirestore, todoListDocumentIdFromFirestore (+69 more)

### Community 205 - "Domain Models — SoftDeletable"
Cohesion: 0.06
Nodes (38): TrackerValue, AssetValuation, FinancialTransaction, GoalAllocation, applicationId, applicationUrl, archivedAt, categoryId (+30 more)
...
Cohesion: 0.09
Nodes (20): Curve, dampen, drawer, drawerCurve, _findSettleSeconds, momentum, momentumCurve, move (+12 more)
...
Cohesion: 0.05
Nodes (37): _boundaryBackward, _boundaryChar, _boundaryForwardPad, checkIncremental, checkTextSync, _customWords, _dictionary, dictionaryLoaded (+29 more)

### Community 211 - "Shared Widgets — spell_check_squiggle_layer"
Cohesion: 0.04
Nodes (53): _builtMode, createState, day, _DayHeader, dispose, _EmptyDayRow, _emptyJumpDay, _EmptyLedger (+45 more)
...
Cohesion: 0.03
Nodes (59): IconData, int? initialColor,
  String, accentColor, build, child, dense, ellipsize, fillWhenActive (+51 more)
...
Cohesion: 0.07
Nodes (32): leetcodeProblemsProvider, _ActivityDetailCard, _ActivityDetailCardState, anchorRect, build, _close, _closing, _controller (+24 more)
...
### Community 224 - "Jobs"
Cohesion: 0.06
Nodes (33): byDate, byKey, compareJobApplications, counts, days, every, filterJobApplications, filterJobCompanies (+25 more)
...
Cohesion: 0.05
Nodes (45): mediaServiceProvider, build, _reload, accent, accentColor, _AddButton, asset, _assets (+37 more)
...
Cohesion: 0.03
Nodes (78): build, customWordsProvider, dictionaryProvider, flaggedWordsProvider, saveSettings, settingsRepositoryProvider, voyagerSpellCheckServiceProvider, AutocorrectSession (+70 more)

### Community 236 - "Shell Feature — weather_chart_plot_cache"
Cohesion: 0.07
Nodes (35): App, Auth, auth::AuthStateListener, auth::IdTokenListener, User, Future, mutex, StreamHandler<flutter::EncodableValue> (+27 more)

### Community 237 - "Study Feature — study_flip_card"
Cohesion: 0.07
Nodes (29): Animation, Duration get, cancel, DebouncedCallback, debounceDelay, Debouncer, delay, dispose (+21 more)
...
Cohesion: 0.08
Nodes (25): 1, busiest, byDay, _CalendarHover, _columnsFor, counts, createState, date (+17 more)

### Community 241 - "Domain Models — leetcode_api_models"
Cohesion: 0.05
Nodes (43): cachedCurrentWeatherProvider, currentWeatherProvider, CloudFunctionWeatherClient, DevOpenWeatherClient, refreshForecast, refreshWeather, WeatherApiClient, _deviceId (+35 more)
...
Cohesion: 0.06
Nodes (31): Opacity, package:voyager/features/study/study_deck_workbench_page.dart, _cards, cardsByDeck, container, _controlBar, countCardsReviewedToday, countCardsReviewedTotal (+23 more)

### Community 245 - "Ephemeral — string"
Cohesion: 0.10
Nodes (18): crossfade, reduced, VoyagerMotion, _buffered, _maxBuffered, notify, notifyOne, onWrite (+10 more)

### Community 246 - "Shared Widgets — search_highlight_text"
Cohesion: 0.10
Nodes (19): class ConnectivityStatusController extends, _consecutiveFailures, didChangeAppLifecycleState, dispose, _disposed, _failuresBeforeOffline, _isOnline, offlineInterval (+11 more)
...
Cohesion: 0.09
Nodes (24): clearLog, _enqueue, log, _logFileName, logFilePath, _maxLogBytes, readLog, SyncCompareLogger (+16 more)
...
Cohesion: 0.04
Nodes (49): DateTimeRange, goalAllocationsProvider, savingsGoalsProvider, formatTime12Hour, formatTimeOfDay12Hour, jm, local, now (+41 more)

### Community 261 - "Shared Widgets — spell_check_field_support"
Cohesion: 0.04
Nodes (46): flaggedWordShapeError, hits, naming, null, pairsPointingAt, pointing, validateFlagReplacement, validateFlagWord (+38 more)

### Community 262 - "Analytics Feature — ConsumerWidget"
Cohesion: 0.05
Nodes (40): StatisticTracker, build, HeatmapCalendar, month, tracker, values, _buildEditor, _capLabelExtent (+32 more)
...
Cohesion: 0.07
Nodes (27): DriftRankingRepository, RankingRepository, package:voyager/features/rankings/rankings_edit_panel.dart, package:voyager/features/rankings/rankings_header.dart, package:voyager/features/rankings/rankings_providers.dart, package:voyager/features/rankings/rankings_row.dart, categories, chipText (+19 more)
...
Cohesion: 0.08
Nodes (26): bool?, LeetCodeProblem? get, leetCodeScratchDraftStoreProvider, buildScratchArea, dispose, _expanding, _expandScratch, flushScratch (+18 more)

### Community 268 - "Study Feature — ConsumerState"
Cohesion: 0.05
Nodes (34): package:voyager/core/spellcheck/flagged_word_rules.dart, package:voyager/core/spellcheck/voyager_spell_check_service.dart, package:voyager/core/widgets/spell_check_squiggle_layer.dart, main, _accent, _expectRoundedCorners, _fillProfile, _fillRows (+26 more)
...
Cohesion: 0.06
Nodes (32): active, _barFor, build, _clearHover, compact, createState, difficulty, dimmed (+24 more)

### Community 271 - "Sync Engine — dart:async"
Cohesion: 0.02
Nodes (102): DriftSettingsRepository, ListView, package:flutter_test/flutter_test.dart, package:voyager/core/sync/firestore_document_mapper.dart, package:voyager/core/sync/sync_conflict_detector.dart, package:voyager/core/tags/tag_palette.dart, package:voyager/data/database/app_database.dart, package:voyager/data/repositories/drift_repositories.dart (+94 more)
...
Cohesion: 0.06
Nodes (35): after, before, _canRedo, _canUndo, _cardKey, _clearHistory, createState, _deleteAndAdvance (+27 more)
...
Cohesion: 0.05
Nodes (40): LeetCodeScratchSession? get, LeetCodeScratchSession, _chain, clear, _deleteQuietly, _file, FileLeetCodeScratchDraftStore, LeetCodeScratchDraftStore (+32 more)

### Community 282 - "Auth Feature"
Cohesion: 0.05
Nodes (36): SpringMotion, barrierColor, barrierDismissible, accent, color, createState, didChangeDependencies, dispose (+28 more)
...
Cohesion: 0.33
Nodes (6): _RenderCapsLockCaret, RenderVimAnchoredChrome, RenderClampToTargetBounds, _RenderTapThroughBarrier, RenderProseHighlightUnderlay, RenderProxyBox
...
Cohesion: 0.08
Nodes (23): package:voyager/core/sync/pending_flush_registry.dart, package:voyager/domain/services/search_service.dart, required String title,
  String, support/search_page_harness.dart, entry, _entryId, main, _openEntryDialog (+15 more)
...
Cohesion: 0.22
Nodes (11): hiddenNotificationFeedProvider, pinnedNotesProvider, visibleNotificationFeedProvider, build, _clearAll, _FeedSection, _Header, _HiddenSection (+3 more)
...
Cohesion: 0.11
Nodes (28): deviceIdProvider, syncActivityProvider, build, devDisablePetalFieldProvider, devForceOfflineProvider, DevPage, devShowTimeSelectorHitboxesProvider, devSlowHeatmapPopoverAnimationProvider (+20 more)

### Community 304 - "Study Feature — ConsumerState"
Cohesion: 0.09
Nodes (23): build, LeetCodePage, _LeetCodeViewMode, _leetCodeViewModeProvider, package:voyager/core/widgets/tag_chip.dart, package:voyager/features/leetcode/leetcode_actions.dart, package:voyager/features/leetcode/leetcode_dashboard.dart, package:voyager/features/leetcode/leetcode_providers.dart (+15 more)
...
Cohesion: 0.02
Nodes (144): @DriftDatabase, DateTime? stamp,
  int, _Device, FirestorePullService, RemoteSyncService, SyncEngine, AppDatabase, InMemorySyncRepository (+136 more)

### Community 308 - "Test Suite — shell_destinations"
Cohesion: 0.02
Nodes (141): _, fakes/fake_weather_api_client.dart, GoRouter, Key? get, notificationBadgeStateProvider, _Await, accent, _anchorKey (+133 more)
...
Cohesion: 0.08
Nodes (22): int?, build, colorValue, tag, TagChip, i, j, kind (+14 more)
...
Cohesion: 0.04
Nodes (42): Color, Key? dateKey,
  double, alphaBlend, base, build, ChartHoverBubble, chartTooltipBubbleColor, chartTooltipDateStyle (+34 more)
...
Cohesion: 0.03
Nodes (68): dart:typed_data, FirebaseStorage, googleOAuthClientId, _googleOAuthClientIdRaw, googleOAuthClientSecret, _googleOAuthClientSecretRaw, googleOAuthRedirectPort, id (+60 more)
...
Cohesion: 0.06
Nodes (31): createState, DevRemotePurgeSection, _DevRemotePurgeSectionState, dispose, _entryIdController, _purgeEntry, _purging, build (+23 more)

### Community 325 - "Shared Widgets — settingsProvider"
Cohesion: 0.07
Nodes (28): weatherForecastProvider, _advance, build, createState, dispose, _done, _frame, initState (+20 more)
...
Cohesion: 0.06
Nodes (35): cacheStatusSnapshotProvider, devSettingsProvider, attempted, attemptedFraction, attemptedPercent, CacheItemState, cacheStateColor, cacheStateLabel (+27 more)

### Community 328 - "Life Tracker Feature — List"
Cohesion: 0.07
Nodes (45): ConsumerState, ConsumerStatefulWidget, trackerCacheInvalidatorProvider, trackerRepositoryProvider, _createTracker, _editTracker, _handleTap, _HeatmapBucket (+37 more)
...
Cohesion: 0.11
Nodes (19): todoSortDebugLoggerProvider, todoTasksProvider, build, DevTodoSortDebugSection, _logDialogOpen, _showLogDialog, _promoteSubtask, _addTask (+11 more)
...
Cohesion: 0.02
Nodes (96): Container, DateTime? dateApplied,
  List, package:voyager/core/constants/job_constants.dart, package:voyager/domain/models/job_models.dart, package:voyager/features/jobs/jobs_page.dart, package:voyager/features/jobs/jobs_table.dart, package:voyager/features/jobs/jobs_track_draft_store.dart, required String company,
  List (+88 more)

### Community 333 - "Calendar Feature — calendar_overlap_engine"
Cohesion: 0.06
Nodes (33): ProseSpanBuilder, build, color, controller, createState, didUpdateWidget, dispose, em (+25 more)
...
Cohesion: 0.06
Nodes (33): MediaAsset, assets, captions, collect, context, messenger, ordered, rankingsLightboxViewportFraction (+25 more)
...
Cohesion: 0.04
Nodes (45): AnimationController, Duration, build, _buildLayer, children, createState, didChangeDependencies, didUpdateWidget (+37 more)

### Community 346 - "Theming — voyager_menu_theme"
Cohesion: 0.05
Nodes (38): at, buffer, composing, formatEditUpdate, i, mapped, normalizeNewlines, NormalizeNewlinesFormatter (+30 more)

### Community 347 - "Shared Widgets — desktop_window_frame"
Cohesion: 0.04
Nodes (50): FocusNode get, GlobalKey, GlobalKey get, attach, createRenderObject, detach, _handleScroll, _hasAttemptedScrollLookup (+42 more)
...
Cohesion: 0.08
Nodes (31): , autocorrectScopeProvider, devGeometricTexturePanelOpenProvider, geometricDebugRowFadeProvider, geometricShaderProvider, geometricTextureParamsProvider, snippetScopeProvider, themeModeProvider (+23 more)
...
Cohesion: 0.07
Nodes (26): double?, fpsMonitorProvider, build, dark, fill, icon, size, stroke (+18 more)

### Community 361 - "Calendar Feature — calendar_keyboard_shortcuts"
Cohesion: 0.12
Nodes (17): build, CalendarKeyboardShortcuts, _CalendarKeyboardShortcutsState, calendarNavShortcutsEnabled, child, createState, dispose, _handleKeyEvent (+9 more)
...
Cohesion: 0.10
Nodes (30): rankingCategoriesProvider, rankingChildrenByParentProvider, rankingParentsProvider, RankingFilters, build, _CategoryMenu, _FilterMenu, _SortMenu (+22 more)

### Community 365 - "Firebase Auth (ios) — CustomPigeonHeader"
Cohesion: 0.02
Nodes (96): CustomPaint, dart:ui, Error, empty, hasImage, hasText, imageBytes, _imageFormats (+88 more)
...
Cohesion: 0.06
Nodes (18): ActionCodeSettings, GetTokenResult, MultiFactorInfo, Override, Activity, FirebaseUser, InternalMultiFactorInfo, Override (+10 more)

### Community 370 - "Analytics Feature — analytics_page"
Cohesion: 0.09
Nodes (22): anchorRect, build, _close, _closing, _ComplexityTile, _controller, createState, _DetailCard (+14 more)

### Community 371 - "Media Handling — media_clipboard"
Cohesion: 0.07
Nodes (28): ByteData, Image, background, bands, bottom, _boundary, _broken, bytes (+20 more)
...
Cohesion: 0.08
Nodes (26): build, color, controller, createState, didUpdateWidget, dispose, initState, locale (+18 more)

### Community 376 - "Workout Feature — workout_day_column"
Cohesion: 0.02
Nodes (83): DateTime? deletedAt,
  int, MoodGradientSlider, searchEntries, SearchService, package:drift/drift.dart, package:voyager/core/constants/journal_constants.dart, package:voyager/core/widgets/keep_alive_scroll.dart, package:voyager/core/widgets/mood_gradient_slider.dart (+75 more)

### Community 377 - "Test Suite — package:flutter_riverpod/flu"
Cohesion: 0.08
Nodes (24): package:voyager/core/widgets/selection_highlight_layer.dart, package:voyager/features/leetcode/leetcode_code_controller.dart, package:voyager/features/leetcode/leetcode_code_field.dart, base, _code, _codeLineStarts, copyWith, _divergedTypeScale (+16 more)
...
Cohesion: 0.04
Nodes (43): build, _kLeetCodeActivityBreakpoint, _kLeetCodeActivityCardWidth, _kLeetCodeSplitBreakpoint, LeetCodeDashboardHeader, package:voyager/features/leetcode/leetcode_activity_calendar.dart, package:voyager/features/leetcode/leetcode_activity_card.dart, package:voyager/features/leetcode/leetcode_activity_chart.dart (+35 more)
...
Cohesion: 0.16
Nodes (24): jobApplicationsProvider, jobCategoriesProvider, jobCompaniesProvider, jobSeasonsProvider, jobStagesProvider, build, _SeasonsTab, _StagesTab (+16 more)
...
Cohesion: 0.10
Nodes (20): _attempts, _downloadDraining, _downloadOne, _downloadWakeupPending, drain, drainDownloads, drainUploads, isTransferring (+12 more)
...
Cohesion: 0.13
Nodes (15): @visibleForTesting, renderEditableOf, sync, reconcile, restoreIfSelectAll, handleCharacter, calendarNavDeltaForEvent, calendarNavShortcutsEnabledForState (+7 more)
...
Cohesion: 0.06
Nodes (32): _attach, back, build, controller, createState, _detach, didUpdateWidget, dispose (+24 more)
...
Cohesion: 0.08
Nodes (23): JobApplication, application, build, _cell, color, _colorColumnWidth, _columnFlex, columns (+15 more)
...
Cohesion: 0.09
Nodes (22): accent, build, _buildResults, _controller, createState, dispose, _results, _resultsQuery (+14 more)
...
Cohesion: 0.07
Nodes (25): BackupCollection, backupContentEquals, backupLiveCalendarIds, BackupRecord, buildBackupCollections, content, data, fromJson (+17 more)

### Community 412 - "Demo Feature"
Cohesion: 0.07
Nodes (28): _auth, AuthNotifier, dispose, _isAuthenticated, _subscription, _Repaint, CapsLockState, DevSettingsController (+20 more)
...
### Community 415 - "Auth"
Cohesion: 0.10
Nodes (21): mediaStorageProvider, asset, _busy, createState, _deleteAll, _deleteOne, _entries, entry (+13 more)
...
Cohesion: 0.09
Nodes (18): calendar, debug, journal, manage, search, VoyagerIcons, kMinTouchTarget, didChangeAppLifecycleState (+10 more)

### Community 427 - "Shared Widgets — double?"
Cohesion: 0.06
Nodes (34): double? contentWidth,
  bool, build, _CreateNameColorDialog, _CreateNameColorDialogState, createState, dispose, initialColor, initState (+26 more)
...
Nodes (21): int? integerCap,
  int, AppThemeMode, BillingPeriod, CalendarViewMode, HeatmapMode, LeetCodeDifficulty, StartupPageMode, TrackerCadence (+13 more)
...
Cohesion: 0.10
Nodes (21): LeetCodeSolution, _BackSolution, _backTitleKey, _cardRadius, controller, createState, _frontTitleKey, _glassContainer (+13 more)
...
### Community 447 - "Jobs"
Cohesion: 0.06
Nodes (28): dart:convert, CrdtDocumentResolver, _merger, _mergeSyncOperations, resolvePayload, list, loadQuotesFromAssets, raw (+20 more)
...
Cohesion: 0.09
Nodes (25): AuthStateListener, FirebaseAuth, FirebasePluginPlatform, FirebaseService, IdTokenListener, AuthStateChannelStreamHandler, IdTokenChannelStreamHandler, EncodableValue (+17 more)

### Community 452 - "Firebase Auth (ios) — CustomPigeonHeader"
Cohesion: 0.04
Nodes (48): FirebaseException, classifySyncFailure, describeSyncFailure, _permanentFirestoreCodes, SyncFailureKind, toString, android, DefaultFirebaseOptions (+40 more)
...
Cohesion: 0.09
Nodes (20): package:voyager/core/widgets/voyager_prose_text.dart, package:voyager/features/leetcode/leetcode_flashcard.dart, package:voyager/features/leetcode/leetcode_inline_code.dart, package:voyager/features/study/study_rich_text.dart, RichText, String? description,
  String, algorithm, _allText (+12 more)
...
Cohesion: 0.10
Nodes (20): FadeTransition, DriftStudyRepository, StudyRepository, package:voyager/features/study/study_page.dart, _RecordingStudyRepository, countCardsReviewedToday, countCardsReviewedTotal, countDueCards (+12 more)

### Community 474 - "Shared Widgets — tag_suggestion_overlay"
Cohesion: 0.04
Nodes (45): FirebaseAuthMultiFactorException, Component, ComponentRegistrar, FirebaseAuthException, kCycleWorkoutPlanId, kMaxReps, kMaxSets, kMaxWeightKg (+37 more)
...
Cohesion: 0.10
Nodes (19): package:voyager/core/widgets/voyager_time_picker_spinner.dart, package:voyager/features/jobs/jobs_company_field.dart, required List, company, controller, focusField, main, now (+11 more)
...
Nodes (37): Alignment, bool? enableDrag,
  BorderRadius, BorderRadius, accentBorder, alignment, blurSigma, borderRadius, build (+29 more)
...
Cohesion: 0.07
Nodes (30): WeightUnit, formatDisplay, formatKilograms, formatKilogramsWithUnit, fromKilograms, kilogramsForWheelIndex, label, max (+22 more)
...
Cohesion: 0.10
Nodes (18): publishAsset, publishReference, RemoteMediaSyncPublisher, _remoteSync, _attachedToastDwell, attachImagesForOwner, count, facet (+10 more)
...
Cohesion: 0.03
Nodes (66): active, anchor, batch, completeTodoTask, due, latest, listId, next (+58 more)

### Community 508 - "Shared Widgets — voyager_scroll_view"
Cohesion: 0.11
Nodes (18): _addColor, build, createState, dispose, _hexController, _hexError, _hexFocusNode, palette (+10 more)
...
Cohesion: 0.06
Nodes (34): @immutable, CacheItemStatus get, CacheItemStatus, ConfettiEffect, SnippetMarks, AutocorrectFlash, EmphasisSpan, ProseMarkup (+26 more)
...
Cohesion: 0.20
Nodes (10): leetCodeApiClientProvider, leetCodeRepositoryProvider, _save, startLeetCodeTrackFlow, leetCodeTrackDraftStoreProvider, _fetchByTypedTitle, initState, _save (+2 more)
...
Cohesion: 0.22
Nodes (8): 1. Restore all / Restore (N) can undismiss on disk but leave the feed stale — FIXED, 2. Clear all aborts the Undo offer if any single dismiss throws — OPEN, 3. Dismiss bailed on `!mounted` after the exit animation — FIXED, 4. Hidden task glyph does not match the live feed — RESOLVED IN HLD, 5. Doc debt: `INBOX_POPOVER_HLD.md` not superseded in-tree — OPEN, Inbox Hidden Restore — Implementation Audit, Not filed as bugs, Status
...
Cohesion: 0.03
Nodes (57): colorForLeetCodeDifficulty, key, kLeetCodeEasyColor, kLeetCodeHardColor, kLeetCodeMediumColor, labelForLeetCodeDifficulty, labelForLeetCodeLanguage, leetCodeCodeLanguages (+49 more)
...
### Community 569 - "Drift Database Schema — app_database"
Cohesion: 0.13
Nodes (15): build, canManage, createState, _error, initialTrigger, messenger, openSettings, outcome (+7 more)

### Community 570 - "Drift Database Schema — app_database"
Cohesion: 0.13
...
### Community 573 - "ranking_precision_change_test.dart"
Cohesion: 0.10
Nodes (18): double get, animateTo, controller, defaultSpring, dispose, jumpTo, _spring, stop (+10 more)

### Community 574 - "app_fonts.dart"
Cohesion: 0.14
...
### Community 575 - "Drift Database Schema — app_database"
Cohesion: 0.14
...
### Community 582 - "calendar_event_layout_test.dart"
Cohesion: 0.67
Nodes (3): calendarTodoMarkersProvider, build, CalendarDayTodoPopover

### Community 584 - "googleCalendarSyncProvider"
Cohesion: 0.22
Nodes (11): allTodoTasksProvider, calendarViewEventsProvider, googleCalendarSyncProvider, workoutDaysProvider, build, CalendarPage, _CalendarPageState, _deleteTodoTask (+3 more)

### Community 589 - "_CalendarMorphWarmupState"
Cohesion: 0.14
...
Cohesion: 0.14
Nodes (13): caption, color, gradientColors, label, onTap, progress, _progressFor, _RingTile (+5 more)

### Community 604 - "PopupRoute"
Cohesion: 0.14
...
### Community 939 - "SyncConflictRepository"
Cohesion: 0.15
Nodes (11): BuildContext, isCompactWidth, kCompactWidthBreakpoint, WindowSizeClass, WindowSizeClassX, package:voyager/core/widgets/voyager_toast.dart, ctx, main (+3 more)

### Community 942 - "_DreamBodyEditorState"
Cohesion: 0.17
...
### Community 943 - "_TagFlow"
Cohesion: 0.22
Nodes (8): MethodCallHandler, string, T, unique_ptr, MethodChannel, codec_, messenger_, name_

### Community 944 - "_CalendarInteractiveEventTapState"
Cohesion: 0.17
Nodes (10): dart:math, indices, main, r, sorted, nextQuote, QuoteBank, _quotes (+2 more)

### Community 951 - "life_tracker_stat_popup_width_test.dart"
Cohesion: 0.17
...
### Community 952 - "leetcode_srs_test.dart"
Cohesion: 0.18
...
### Community 956 - "fractional_index.dart"
Cohesion: 0.20
...
### Community 960 - "app_fonts.dart"
Cohesion: 0.22
Nodes (8): AppFonts, applyTo, family, leadingFor, monoFamily, style, trackingFor, _tuned

### Community 961 - "JobsActions"
Cohesion: 0.67
Nodes (3): JobsActions, RankingsActions, provider

### Community 962 - "BinaryMessengerImpl"
Cohesion: 0.22
...
### Community 968 - "MultiFactorTotpSecretHostApi"
Cohesion: 0.50
Nodes (3): MultiFactorTotpSecretHostApi, GenerateQrCodeUrl, OpenInOtpApp

## Knowledge Gaps
- **18128 isolated node(s):** `s`, `ops`, `pos`, `main`, `s1` (+18123 more)
...
- **Why does `ActionCodeInfoOperation` connect `Domain Models — sync_conflict` to `Firebase Auth (ios) — firebase_auth_messages.g`, `Firebase Auth (macos) — firebase_auth_messages.g`, `Firebase Auth (android) — NonNull`, `Firebase Auth (android) — NonNull`, `Firebase Auth (windows) — messages.g.cpp`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `InternalActionCodeInfo` connect `Firebase Auth (macos) — firebase_auth_messages.g` to `Firebase Auth (macos) — CustomPigeonHeader`, `Domain Models — sync_conflict`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `ActionCodeInfoOperationBox` connect `Firebase Auth (macos) — firebase_auth_messages.g` to `Firebase Auth (macos) — CustomPigeonHeader`, `Domain Models — sync_conflict`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **What connects `s`, `ops`, `pos` to the rest of the system?**
  _18129 weakly-connected nodes found - possible documentation gaps or missing edges._
