...
## Corpus Check
- 1123 files · ~1,588,685 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 28020 nodes · 44134 edges · 1076 communities (652 shown, 424 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 297 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `017ddc79`
...
## Communities (1076 total, 424 thin omitted)
...
Cohesion: 0.03
Nodes (69): studyDecksProvider, studyFoldersProvider, _cardPool, cards, colors, deck, deckId, deckName (+61 more)
...
Cohesion: 0.03
Nodes (72): dart:io, Directory, MediaService, MediaFileStore, package:image/image.dart, package:voyager/core/media/media_clipboard.dart, package:voyager/core/media/media_service.dart, package:voyager/data/services/media_file_store.dart (+64 more)
...
Cohesion: 0.02
Nodes (126): accent, _body, child, color, _completingNow, _controller, copyWith, createState (+118 more)

### Community 19 - "Journal Feature — journal_page"
Cohesion: 0.01
Nodes (160): ChangeNotifierProvider, activeWorkoutSessionProvider, all, allJournalEntriesScope, backupCollectionsProvider, bills, brightness, build (+152 more)
...
Cohesion: 0.02
Nodes (122): _alwaysFocused, _applyCaseOverRange, _applyMotion, _applyOperatorRange, _applyValue, _autoIndent, _blockVisualLineHorizontal, _cachedMatches (+114 more)
...
Cohesion: 0.02
Nodes (80): accentColor, _activeQuery, _baseline, body, _bodyController, _bodyFocusNode, _changeEntryDateAndTime, _coordinator (+72 more)
...
Cohesion: 0.02
Nodes (106): budgetsProvider, financeCategoriesProvider, tagColorsProvider, transactionsProvider, abs, accent, _AnalyticsCard, anchor (+98 more)
...
Cohesion: 0.01
Nodes (230): @DriftDatabase, DateTime? stamp,
  int, fakes/fake_weather_api_client.dart, FirebaseException, _FlakySyncRepository, SyncEngine, classifySyncFailure, describeSyncFailure (+222 more)
...
Cohesion: 0.04
Nodes (63): borderColor, build, child, _closeGeneration, _closing, _create, _createFolderOrDeck, _CreateMenu (+55 more)

### Community 41 - "Test Suite — package:voyager/domain/repos"
Cohesion: 0.03
Nodes (72): IconButton, RepeatIconButton, package:voyager/core/media/widgets/media_gallery_strip.dart, package:voyager/core/widgets/repeat_selector_popover.dart, package:voyager/domain/models/recurrence_rule.dart, _anchor, captured, _choose (+64 more)

### Community 42 - "Test Suite — package:flutter_test/flutter"
Cohesion: 0.02
Nodes (101): class MockDocumentReference extends, ../test/fakes/fake_weather_api_client.dart, addCustomWord, authStateChanges, batch, batchCreatedCount, batches, bucketListRepo (+93 more)
...
Cohesion: 0.08
Nodes (25): container, _contentOffset, db, _dragBy, _entryCommands, gesture, _now, _openSheet (+17 more)
...
Cohesion: 0.02
Nodes (125): LeetCodeCheatActions get, _actions, activeTabId, allCollapsed, _beginEditingAt, _buildBody, _buildTabBody, child (+117 more)
...
Cohesion: 0.04
Nodes (59): EditableTextState, loadDictionaryFromAssets, raw, package:flutter/services.dart, package:voyager/core/media/widgets/media_paste_scope.dart, package:voyager/core/vim/vim_enabled_scope.dart, package:voyager/core/vim/vim_text_overlay.dart, package:voyager/core/widgets/notched_field_border.dart (+51 more)

### Community 74 - "Rankings Feature — rankings_edit_panel"
Cohesion: 0.03
Nodes (80): ConsumerWidget, activeWorkoutPlanProvider, devLeafGalleryPanelOpenProvider, exercisesProvider, paperShaderProvider, petalFieldParamsProvider, studyStatsProvider, workoutPlanEntriesProvider (+72 more)

### Community 75 - "Test Suite — dart:ui"
Cohesion: 0.02
Nodes (114): Container, DateTime? dateApplied,
  List, JobsTrackDraftStore? store,
  List, package:voyager/core/constants/journal_constants.dart, package:voyager/domain/models/job_models.dart, package:voyager/features/jobs/jobs_edit_panel.dart, package:voyager/features/jobs/jobs_page.dart, package:voyager/features/jobs/jobs_providers.dart (+106 more)
...
Cohesion: 0.03
Nodes (69): LeafDesign, _AnalyticsToolbar, _EmptyTrackersCard, _GridView, _HeatmapGroupDivider, _HeatmapMonthTile, _MacroStatsRow, _SectionLabel (+61 more)
...
Cohesion: 0.03
Nodes (74): financeRepositoryProvider, subscriptionsProvider, Budget, Subscription, _detach, _delete, _save, BillRadarPanel (+66 more)
...
Cohesion: 0.03
Nodes (74): dart:convert, CrdtDocumentResolver, _merger, _mergeSyncOperations, resolvePayload, detectDreamEntryConflict, detectJournalEntryConflict, detectTodoTaskConflict (+66 more)

### Community 89 - "Firebase Auth (android) — NonNull"
Cohesion: 0.02
Nodes (149): deleteBudgetWithUndo, deleteSubscriptionWithUndo, softDeleteWithUndo, MemoryFinanceUiPrefsStore? prefsStore,
  bool, package:voyager/core/utils/ids.dart, package:voyager/domain/models/enums.dart, package:voyager/domain/models/finance_models.dart, package:voyager/domain/services/contribution_room_writer.dart (+141 more)
...
Cohesion: 0.03
Nodes (77): leetcodeReviewLogProvider, LeetCodeActivityCalendar, _ActivityDetailCard, _ActivityDetailCardState, anchorRect, build, _close, _closing (+69 more)
...
Cohesion: 0.07
Nodes (26): number, package:voyager/features/leetcode/leetcode_code_field.dart, base, _code, _codeLineStarts, copyWith, _divergedTypeScale, main (+18 more)
...
Cohesion: 0.04
Nodes (45): EdgeInsets, body, build, floatingActionButton, PlatformAdaptiveScaffold, autofocus, build, child (+37 more)
...
Cohesion: 0.04
Nodes (52): _ArrivingCheatSheetButton, build, LeetCodePage, _LeetCodeViewMode, _leetCodeViewModeProvider, mode, after, before (+44 more)
...
Cohesion: 0.03
Nodes (60): Finder get, package:voyager/core/widgets/spell_check_squiggle_layer.dart, package:voyager/features/dream_journal/dream_journal_page.dart, _bodyField, container, db, _delegate, getAllEntries (+52 more)
...
Cohesion: 0.02
Nodes (80): studyFolderByIdProvider, _accent, accentColor, anchor, build, _buildCustomPage, _buildPresetPage, _commit (+72 more)
...
Cohesion: 0.05
Nodes (38): FirestoreWriteGate, appendOperation, appendOperationGroup, appendOperationsBatch, claimCalendarLock, claimWeatherFetchLock, _collection, deleteDocument (+30 more)
...
Cohesion: 0.04
Nodes (45): Archive, DriftMediaRepository, MediaRepository, archive, backupFormatVersion, backupManifestFileName, backupMediaDirectory, buildArchiveContents (+37 more)
...
Cohesion: 0.03
Nodes (90): customWordsProvider, dictionaryProvider, flaggedWordsProvider, voyagerSpellCheckServiceProvider, build, _buildForm, _buildOffer, canReplaceHere (+82 more)
...
Cohesion: 0.02
Nodes (122): DateTime? onceDate,
  List, deviceIdProvider, deviceRegistrationsProvider, reminderLogsProvider, reminderRepositoryProvider, scheduledReminderRulesProvider, thisDeviceRegistrationProvider, initState (+114 more)

### Community 134 - "Study Feature — ConsumerState"
Cohesion: 0.04
Nodes (51): confirmed, container, context, copyLeetCodeCode, current, deleteLeetCodeProblem, dismiss, draft (+43 more)
...
Cohesion: 0.02
Nodes (89): Alignment, Animation, bool? enableDrag,
  BorderRadius, _animDuration, _barVisible, build, child, _controller (+81 more)
...
Cohesion: 0.06
Nodes (30): MediaClipboard, _attachFromClipboard, build, _busy, child, clipboard, collection, createState (+22 more)
...
Cohesion: 0.03
Nodes (74): leetcodeProblemsProvider, sessionCheckpointStoreProvider, _handleKeyEvent, leetCodeCheatSheetOpenProvider, openLeetCodeCheatSheet, _applyDecision, bucket0, bucket1 (+66 more)
...
Cohesion: 0.04
Nodes (48): build, CalendarTodoPanel, _CalendarTodoPanelState, _closingAfterSave, _completed, createState, didUpdateWidget, _discard (+40 more)
...
Cohesion: 0.04
Nodes (49): Completer, http.BaseClient, DriftLeetCodeRepository, LeetCodeRepository, package:voyager/data/remote/leetcode_api_client.dart, StreamedResponse, _FakeLeetCodeRepository, db (+41 more)
...
Cohesion: 0.04
Nodes (50): colorPaletteProvider, build, _changeEventColor, _add, _changeEventColor, pickAccentColor, _addMinorPetalColor, _controller (+42 more)
...
Cohesion: 0.05
Nodes (59): studyCardsProvider, studyDeckByIdProvider, studyDeckGraphProvider, studyDeckStatsProvider, StudyDeckLink, build, _cramSession, createState (+51 more)
...
Cohesion: 0.03
Nodes (58): getOrderedDestinations, icon, index, label, order, OrderedDestination, page, path (+50 more)
...
Cohesion: 0.05
Nodes (60): leetCodeRepositoryProvider, remoteSyncServiceProvider, studyRepositoryProvider, todoListsProvider, todoRepositoryProvider, initState, _syncServiceOrNull, _save (+52 more)
...
Cohesion: 0.03
Nodes (57): FirebaseAuthMultiFactorException, Color, Component, ComponentRegistrar, FirebaseAuthException, JobApplication, build, color (+49 more)
...
Cohesion: 0.04
Nodes (51): publishAsset, publishReference, _remoteSync, JournalWriteCoordinator, RemoteSyncService, _bind, build, _controller (+43 more)
...
Cohesion: 0.06
Nodes (33): DriftStudyRepository, StudyRepository, NavigatorState, _StubStudyRepository, _RecordingStudyRepository, _FakeStudyRepository, _FakeStudyRepository, build (+25 more)
...
Cohesion: 0.02
Nodes (88): DateTime? deletedAt,
  int, MoodGradientSlider, searchEntries, SearchService, package:drift/drift.dart, package:voyager/app/providers.dart, package:voyager/core/widgets/keep_alive_scroll.dart, package:voyager/core/widgets/mood_gradient_slider.dart (+80 more)
...
Cohesion: 0.02
Nodes (82): File, package:drift/native.dart, package:voyager/core/widgets/notification_urgency_dot.dart, package:voyager/domain/models/leetcode_cheat_models.dart, package:voyager/features/analytics/tracker_entry_row.dart, close, customStatement, db (+74 more)
...
Cohesion: 0.04
Nodes (42): DateTime? now,
  bool, applySettings, devForceConflictUi, disableCache, loadFromSettings, _persist, setDevForceConflictUi, setDisableCache (+34 more)
...
Cohesion: 0.04
Nodes (78): WindowVisibility, VimTextOverlay, _VimTextOverlayState, _VimFieldOverlay, _VimFieldOverlayState, VimTextScope, _VimTextScopeState, AutocorrectFlashLayer (+70 more)
...
Cohesion: 0.03
Nodes (55): package:voyager/core/soft_delete/restore_contract.dart, package:voyager/domain/models/ranking_models.dart, package:voyager/features/rankings/rankings_actions.dart, package:voyager/features/rankings/rankings_edit_panel.dart, package:voyager/features/rankings/rankings_header.dart, package:voyager/features/rankings/rankings_row.dart, _category, container (+47 more)
...
Cohesion: 0.04
Nodes (51): Quote, build, createState, _datePanelHeight, dispose, initState, _keepTitleInDraft, _lastTouchedId (+43 more)
...
Cohesion: 0.07
Nodes (28): Card, budget, color, _EmptyBudgets, pace, _PacingBar, spentCents, spentFraction (+20 more)
...
Cohesion: 0.03
Nodes (72): DateTimeRange, goalAllocationsProvider, savingsGoalsProvider, build, CompactBackBar, label, onBack, SavingsGoal (+64 more)

### Community 286 - "Leetcode Feature — leetcode_activity_chart"
Cohesion: 0.06
Nodes (34): AsyncNotifier, SettingsNotifier, package:voyager/features/leetcode/leetcode_providers.dart, package:voyager/features/leetcode/leetcode_review_deck.dart, static AppSettings?, _ThemedSettings, _FixedSettings, _FixedSettings (+26 more)
...
Cohesion: 0.06
Nodes (35): LeetCodeApiClient, _FlakyCountsApi, _algorithmField, button, _codeField, db, _dialogButton, ensureVisible (+27 more)
...
Cohesion: 0.02
Nodes (98): srsMasteryColor, copyWith, fieldHintStyle, theme, roundedDragProxy, barrierDismissible, build, createState (+90 more)
...
Cohesion: 0.06
Nodes (33): package:voyager/core/media/widgets/media_drop_target.dart, package:voyager/core/media/widgets/media_fan_stack.dart, package:voyager/core/media/widgets/media_image.dart, main, attach, _contrast, darker, db (+25 more)
...
Cohesion: 0.06
Nodes (33): AppSettings, SettingsRepository, package:voyager/features/leetcode/leetcode_track_draft_store.dart, _StubSettingsRepository, getSettings, main, _MemorySettingsRepository, saveSettings (+25 more)
...
Cohesion: 0.02
Nodes (152): ConsumerState, ConsumerStatefulWidget, allDreamEntriesProvider, allJournalEntriesProvider, allTodoTasksProvider, analyticsServiceProvider, calendarTodoMarkersProvider, calendarViewEventsProvider (+144 more)

### Community 334 - "Leetcode Feature — leetcode_activity_data"
Cohesion: 0.06
Nodes (32): package:voyager/features/leetcode/leetcode_track_modal.dart, button, db, ensureVisible, examples, _exampleText, field, listProblems (+24 more)
...
Cohesion: 0.06
Nodes (32): , _advance, createState, _done, _frame, GeometricTextureWarmup, _GeometricTextureWarmupState, _startWarmup (+24 more)
...
Cohesion: 0.02
Nodes (117): _Device, GlassButton, _GlassButtonState, DriftSettingsRepository, ListView, package:voyager/core/sync/firestore_document_mapper.dart, package:voyager/core/tags/tag_palette.dart, package:voyager/data/database/app_database.dart (+109 more)
...
Cohesion: 0.03
Nodes (75): EditableText, context, focus, isTextInputFocused, subtreeIsVisible, package:voyager/core/platform/windows_keyboard_workaround.dart, package:voyager/core/snippets/snippet_enabled_scope.dart, package:voyager/core/snippets/snippet_index.dart (+67 more)
...
Cohesion: 0.06
Nodes (31): _buffered, notify, notifyOne, onWrite, SyncedWriteNotifier, package:voyager/features/leetcode/leetcode_cheat_export.dart, package:voyager/features/leetcode/leetcode_cheat_search.dart, package:voyager/features/leetcode/leetcode_cheat_text.dart (+23 more)
...
Cohesion: 0.02
Nodes (98): Icon, package:voyager/core/constants/calendar_constants.dart, package:voyager/domain/models/calendar_models.dart, package:voyager/domain/services/reminder_schedule.dart, package:voyager/features/calendar/calendar_event_panel.dart, package:voyager/features/calendar/calendar_manage_sheet.dart, package:voyager/features/calendar/calendar_page.dart, required CalendarEvent? event,
  double (+90 more)
...
Cohesion: 0.05
Nodes (35): dart:math, accentColor, alignLabelToTop, borderRadius, borderWidth, build, child, color (+27 more)
...
Cohesion: 0.13
Nodes (22): rankingChildrenByParentProvider, rankingParentsProvider, RankingFilters, build, _CategoryBody, _closePanel, _createCategory, _createParent (+14 more)

### Community 388 - "Analytics Feature — stat_number_format"
Cohesion: 0.06
Nodes (29): double?, showSessionResumeToast, accent, build, important, NotificationUrgencyDot, size, build (+21 more)
...
Cohesion: 0.07
Nodes (27): _auth, AuthNotifier, dispose, _isAuthenticated, _subscription, _Repaint, CapsLockState, DevSettingsController (+19 more)

### Community 411 - "Shared Widgets — confirm_dialog"
Cohesion: 0.04
Nodes (58): assetRoomEventsProvider, assetsProvider, assetValuationsProvider, contributionRoomsProvider, AssetRoomEvent, Asset, _NetWorthCard, _asOf (+50 more)
...
Cohesion: 0.02
Nodes (109): autocorrectScopeProvider, devGeometricTexturePanelOpenProvider, devGeometricWavePanelOpenProvider, geometricDebugRowFadeProvider, geometricShaderProvider, geometricTextureParamsProvider, geometricWaveParamsProvider, snippetScopeProvider (+101 more)

### Community 417 - "Settings Feature — package:voyager/domain/model"
Cohesion: 0.04
Nodes (53): dart:ui, Error, colorForTag, extractTags, index, journalTagPattern, kTagPaletteDark, kTagPaletteLight (+45 more)
...
Cohesion: 0.07
Nodes (27): package:voyager/core/text/list_text_editing.dart, package:voyager/core/vim/vim_text_scope.dart, _dreamId, _dreamSeed, _enterDreamScope, enterText, entry, _journalSeed (+19 more)
...
Cohesion: 0.03
Nodes (64): byId, refreshed, OverlayState, package:voyager/domain/services/fractional_index.dart, package:voyager/features/workout/exercise_detail_view.dart, return, container, db (+56 more)

### Community 429 - "Dev — dev_flags"
Cohesion: 0.06
Nodes (34): AnalyticsService, booleanTrueCount, completedTasks, countWords, heatmapIntensity, integerSeries, interpolateConsecutive, rollingMax (+26 more)
...
### Community 447 - "Jobs"
Cohesion: 0.09
Nodes (22): WorkoutSetLog, controller, count, createState, _CurrentExerciseTitle, didUpdateWidget, _discard, dispose (+14 more)
...
Cohesion: 0.08
Nodes (24): package:voyager/core/widgets/datetime_picker_dialog.dart, package:voyager/features/finance/finance_asset_modal.dart, package:voyager/features/finance/finance_category_modal.dart, package:voyager/features/jobs/jobs_manage_sheet.dart, package:voyager/features/jobs/jobs_track_modal.dart, package:voyager/features/journal/journal_entry_actions.dart, package:voyager/features/journal/journal_manage_sheet.dart, package:voyager/features/rankings/rankings_category_dialog.dart (+16 more)
...
Cohesion: 0.08
Nodes (22): package:flutter_code_editor/flutter_code_editor.dart, package:voyager/core/widgets/field_scroll_padding.dart, package:voyager/core/widgets/voyager_text_field.dart, main, _pumpField, pumpWidget, accentRun, bytes (+14 more)
...
Cohesion: 0.11
Nodes (16): assets, captions, collect, context, messenger, ordered, rankingsLightboxViewportFraction, service (+8 more)

### Community 491 - "Text — list_text_editing"
Cohesion: 0.06
Nodes (28): contains, embedded, firebaseAuthErrorMessage, invalidCredentialHints, _isGenericInternalMessage, lower, _messageFromEmbeddedDetails, normalizedCode (+20 more)
...
Cohesion: 0.09
Nodes (20): defaultColorPalette, paletteColor, resolvePaletteColor, package:voyager/core/utils/journal_tags.dart, db, ensureVisible, listProblems, main (+12 more)
...
Cohesion: 0.09
Nodes (20): day, days, hours, local, mins, parts, reminderCadenceLabel, reminderDistanceLabel (+12 more)
...
Cohesion: 0.04
Nodes (49): from typing import List, clear, controllerFor, _controllers, dispose, entryFor, generation, _lastLanguage (+41 more)
...
Cohesion: 0.02
Nodes (104): double? contentWidth,
  bool, int? initialColor,
  String, journalDebugLoggerProvider, DevFlags, disableCache, disablePetalField, forceOffline, showLifeTrackerRestore (+96 more)

### Community 523 - "InternalPhoneMultiFactorAssertion"
Cohesion: 0.02
Nodes (103): ByteData, Image, _Await, accent, _anchorKey, _bellHeight, _bellWidth, createState (+95 more)
...
Cohesion: 0.11
Nodes (19): _CapsLockCaretPainter, VimAnchoredChrome, ClampToTargetBounds, _ContextualPopoverRoute, _TapThroughBarrier, buildModalBarrier, createRenderObject, guardBarrier (+11 more)
...
Cohesion: 0.06
Nodes (28): FirestorePullService, close, kProseHighlightMark, kProseHighlightRadius, offset, open, paintProseHighlights, path (+20 more)
...
Cohesion: 0.06
Nodes (30): _auth, _authErrorMessage, authStateChanges, _controller, currentUserId, dispose, fallback, FirebaseAuthRepository (+22 more)
...
Cohesion: 0.18
Nodes (10): build, _controller, createState, dispose, hintText, initialValue, showWorkoutNameModal, _submit (+2 more)
...
Cohesion: 0.04
Nodes (62): lifeTrackerStatsProvider, syncActivityProvider, build, devDisablePetalFieldProvider, devForceOfflineProvider, DevPage, devShowTimeSelectorHitboxesProvider, devSlowHeatmapPopoverAnimationProvider (+54 more)

### Community 589 - "MultiFactorTotpHostApi"
Cohesion: 0.14
Nodes (13): Exercise, build, createState, dispose, exercise, ExerciseTarget, _reps, _setsController (+5 more)
...
Cohesion: 0.09
Nodes (21): DateTime?, JournalEntry, current, entry, JournalEntryDeletion, media, mediaDeletedAt, remoteSync (+13 more)
...
Cohesion: 0.07
Nodes (27): BorderRadius, BoxFit, IconData, asset, borderRadius, byHeight, _bytes, byWidth (+19 more)
...
Cohesion: 0.05
Nodes (37): _dreamRepository, DreamWriteCoordinator, _findTask, _journalRepository, _remoteSync, saveEntry, saveTask, _todoRepository (+29 more)
...
Cohesion: 0.03
Nodes (60): GoRouter, Key? get, auth, _preloadedShellPaths, settingsRepo, Opacity, package:go_router/go_router.dart, package:voyager/core/motion/modal_scrim_observer.dart (+52 more)
...
Cohesion: 0.22
Nodes (9): _RenderCapsLockCaret, RenderVimAnchoredChrome, RenderClampToTargetBounds, _RenderTapThroughBarrier, _RenderModalBarrierGuard, RenderProseHighlightUnderlay, RenderScrollOffsetFollower, _RenderReportHeight (+1 more)
...
Cohesion: 0.06
Nodes (34): _authorizationEndpoint, DesktopGoogleOAuth, redirectUri, _tokenEndpoint, close, _endpoint, fetchBySlug, fetchMostRecentAcceptedSubmission (+26 more)
...
Cohesion: 0.04
Nodes (71): bool?, authNotifierProvider, backgroundSyncOrchestratorProvider, connectivityStatusProvider, databaseProvider, firestoreWriteGateProvider, journalAllEntryIdsProvider, journalEntryCountsProvider (+63 more)

### Community 643 - "_SparklineTouchScope"
Cohesion: 0.03
Nodes (55): build, _counts, createdId, _createdJournalId, _createJournal, createState, _deleteJournal, initState (+47 more)
...
Cohesion: 0.04
Nodes (52): dart:async, clearLog, _enqueue, log, _logFileName, logFilePath, _maxLogBytes, readLog (+44 more)
...
### Community 1069 - "package:voyager/core/sync/text_delta_injector.dart"
Cohesion: 0.50
Nodes (4): FLTAuthStateChannelStreamHandler, -initWithAuth, FlutterStreamHandler, NSObject

### Community 1070 - "package:voyager/domain/services/weather_forecast_chart.dart"
Cohesion: 0.50
Nodes (4): FLTIdTokenChannelStreamHandler, -initWithAuth, FlutterStreamHandler, NSObject

## Knowledge Gaps
- **21004 isolated node(s):** `s`, `ops`, `pos`, `main`, `s1` (+20999 more)
...
- **Why does `ActionCodeInfoOperation` connect `Shared Widgets — keep_alive_scroll` to `Firebase Auth (ios) — firebase_auth_messages.g`, `Firebase Auth (macos) — firebase_auth_messages.g`, `Firebase Auth (android) — NonNull`, `Firebase Auth (android) — NonNull`, `Firebase Auth (windows) — messages.g.cpp`?**
...
- **Why does `ActionCodeInfoOperationBox` connect `Firebase Auth (ios) — firebase_auth_messages.g` to `Shared Widgets — keep_alive_scroll`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **What connects `s`, `ops`, `pos` to the rest of the system?**
  _21005 weakly-connected nodes found - possible documentation gaps or missing edges._
