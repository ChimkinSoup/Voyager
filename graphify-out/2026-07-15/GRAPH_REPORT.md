# Graph Report - Voyager  (2026-07-13)

## Corpus Check
- 308 files · ~255,494 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6453 nodes · 9117 edges · 265 communities (229 shown, 36 thin omitted)
...
2. `journalRepositoryProvider` - 29 edges
3. `FlutterEngine` - 26 edges
4. `todoRepositoryProvider` - 25 edges
5. `settingsProvider` - 25 edges
6. `DartProject` - 25 edges
7. `Win32Window` - 22 edges
8. `_JournalPageState` - 19 edges
9. `MethodCodec` - 19 edges
10. `_VoyagerBootstrapState` - 17 edges
...
- `_reload` --references--> `todoRepositoryProvider`  [EXTRACTED]
  lib/features/todo/todo_manage_sheet.dart → lib/app/providers.dart
...
Cohesion: 0.01
Nodes (395): BoolColumn get, _, _accentColorMeta, actualTableName, _addedAtMeta, _alertOnPeriodicPromptsMeta, _alertTimeHourMeta, _alias (+387 more)
...
Cohesion: 0.02
Nodes (84): _applyPendingNotesMerge, _buildHeader, _clearDueDate, _close, color, _compactIconButtonStyle, _controller, createState (+76 more)

### Community 8 - "Repositories Domain"
Cohesion: 0.03
Nodes (73): appendOperation, authStateChanges, claimCalendarLock, claimWeatherFetchLock, countEntriesByJournal, currentUserId, deleteAllEntries, deleteAllEvents (+65 more)
...
Cohesion: 0.09
Nodes (23): detectJournalEntryConflict, detectTodoTaskConflict, isConflict, _isCorruptedOpChain, _isHardMetadataCollision, _isHardTodoMetadataCollision, _merger, payloadJson (+15 more)

### Community 11 - "Todo Features"
Cohesion: 0.03
Nodes (66): CurvedAnimation, _activeInList, _animController, _applyListMoveOptimistic, _applyOptimisticActiveOrder, _applyPersistedSortBatchToUi, _applySortBatchOptimistic, _checkScale (+58 more)

### Community 12 - "Models Domain"
Cohesion: 0.03
Nodes (67): accentColor, alertOnPeriodicPrompts, alertTimeHour, birthYear, calendarNavigateLeftKey, calendarNavigateRightKey, colorPalette, copyWith (+59 more)

### Community 13 - "Calendar Markers"
Cohesion: 0.03
Nodes (64): build, buildCalendarTodoMarkers, calendarMaxTodoIconsPerDay, calendarMorphTodoIconProgress, calendarPackWeekAllDayShelf, calendarPackWeekEvents, calendarTodoIconOverlapStep, calendarTodoIconSize (+56 more)
...
Cohesion: 0.03
Nodes (62): countEntriesByJournal, _db, deleteAllEntries, deleteAllEvents, deleteAllJournals, deleteConflict, deleteConflictsForDocument, DriftSyncConflictRepository (+54 more)

### Community 16 - "Sync Weather"
Cohesion: 0.05
Nodes (51): _, @DriftDatabase, fakes/fake_weather_api_client.dart, SyncEngine, AppDatabase, InMemorySyncRepository, package:flutter_test/flutter_test.dart, package:voyager/core/auth/firebase_auth_errors.dart (+43 more)
...
Cohesion: 0.02
Nodes (88): AsyncValue, AuthNotifier, CacheStatusSnapshot, DataExportService, DataImportService, DevSettingsController, JournalDebugLogger, JournalWriteCoordinator (+80 more)

### Community 19 - "Analytics Features"
Cohesion: 0.01
Nodes (146): AnalyticsService, DateTime get, Key? dateKey,
  double, accent, _addOption, analytics, _AnalyticsViewMode, anchorDateRect (+138 more)
...
Cohesion: 0.04
Nodes (51): accentColor, _applyHighlightText, build, contentPadding, controller, createState, cursorColor, decoration (+43 more)
...
Cohesion: 0.05
Nodes (40): CapturedThemes, Color get, accentColor, barrierColor, barrierDismissible, barrierLabel, _borderWidth, build (+32 more)
...
Cohesion: 0.05
Nodes (38): ColorScheme, build, _ClockDial, _ClockTimeMode, colorScheme, createState, _date, _end (+30 more)
...
Cohesion: 0.08
Nodes (16): map, string, vector, EncodableValue, optional, EncodableValue, EncodableValue, EncodableValue (+8 more)

### Community 34 - "Shell Features"
Cohesion: 0.05
Nodes (42): accent, branchIndex, child, color, createState, didUpdateWidget, dispose, event (+34 more)

### Community 35 - "Import Export"
Cohesion: 0.07
Nodes (31): class MockDocumentReference extends, DocumentReference, Exception, FirebaseFirestore, package:fake_cloud_firestore/fake_cloud_firestore.dart, package:voyager/data/remote/firestore_sync_repository.dart, package:voyager/features/settings/services/data_export_service.dart, package:voyager/features/settings/services/data_import_service.dart (+23 more)
...
Cohesion: 0.06
Nodes (34): DateTimeRange, build, _buildPayload, CalendarEventPanel, _CalendarEventPanelState, _closingAfterSave, _colorValue, createState (+26 more)

### Community 41 - "Sync Conflict"
Cohesion: 0.10
Nodes (19): _confirmPermanentRemoteDelete, conflict, _ConflictDocumentIds, createState, _DiffColumn, dispose, heading, _loadedConflictId (+11 more)

### Community 42 - "Calendar Features"
Cohesion: 0.04
Nodes (45): _EmptyTrackersCard, _GridView, _HeatmapGroupDivider, _HeatmapMonthTile, _SectionLabel, _StatChip, CalendarDayCell, CalendarDayEventBar (+37 more)

### Community 43 - "Features Dev"
Cohesion: 0.07
Nodes (37): authNotifierProvider, backgroundSyncOrchestratorProvider, databaseProvider, deviceIdProvider, lazyLoadProvider, liveSyncProvider, shellDataWarmupProvider, syncEngineProvider (+29 more)
...
Cohesion: 0.09
Nodes (24): build, _buildEditor, createState, date, didUpdateWidget, dispose, _formatDate, initState (+16 more)
...
Cohesion: 0.05
Nodes (41): _activeIsStart, _applyDuration, _applyEndDt, _applyStartDt, _applyTimeDt, build, _canPop, createState (+33 more)
...
Cohesion: 0.06
Nodes (33): isExpired, purgeEligibleAfter, SoftDeletePolicy, accentColor, alignLabelToTop, borderRadius, borderWidth, build (+25 more)
...
Cohesion: 0.07
Nodes (26): allJournals, assigner, choice, color, controller, created, defaultColor, deleteJournalList (+18 more)
...
Cohesion: 0.15
Nodes (25): CalendarEventsTableCompanion, CalendarEventsTableData, DataClass, JournalEntriesTableCompanion, JournalEntriesTableData, JournalsTableCompanion, JournalsTableData, PendingUploadData (+17 more)
...
Cohesion: 0.07
Nodes (44): AutomaticKeepAliveClientMixin, EdgeInsetsGeometry, IndexedWidgetBuilder, _PalettePickDialog, _PalettePickDialogState, DateSelectorPopover, _DateSelectorPopoverState, _ClockTimePicker (+36 more)
...
Cohesion: 0.07
Nodes (27): bool?, boolValue, cadence, colorValue, copyWith, defaultBool, defaultEnumOption, defaultInt (+19 more)
...
Cohesion: 0.04
Nodes (47): BorderRadius, anchor, _anim, borderRadius, build, _buildMenu, capturedThemes, child (+39 more)
...
Cohesion: 0.11
Nodes (28): calendarRepositoryProvider, deviceIdProvider, devSettingsProvider, journalRepositoryProvider, build, _confirmDeleteAllCalendarEvents, _confirmDeleteAllEntries, _confirmResetJournals (+20 more)
...
Cohesion: 0.09
Nodes (18): MessageHandler, BinaryMessengerImpl, handlers_, messenger_, Send, SetMessageHandler, BinaryMessageHandler, FlutterDesktopMessengerRef (+10 more)
...
Cohesion: 0.11
Nodes (16): dart:async, _callbacks, flushAll, instance, PendingFlushRegistry, register, unregister, _authorizationEndpoint (+8 more)
...
Cohesion: 0.10
Nodes (20): Animation, AnimationController, _animDuration, _barVisible, build, child, _controller, createState (+12 more)
...
Cohesion: 0.07
Nodes (28): dataExportServiceProvider, dataImportServiceProvider, settingsRepositoryProvider, CalendarViewMode, HeatmapMode, StartupPageMode, TrackerCadence, TrackerStyle (+20 more)
...
Cohesion: 0.13
Nodes (14): dart:io, Future, clearLog, _enqueue, log, _logFileName, logFilePath, _maxLogBytes (+6 more)
...
Cohesion: 0.15
Nodes (13): @DataClassName, CalendarEventsTable, JournalEntriesTable, JournalsTable, PendingUploadsTable, SettingsTable, SyncConflictsTable, TagColorsTable (+5 more)

### Community 127 - "Menu Widgets"
Cohesion: 0.17
Nodes (11): bool get, _auth, dispose, _isAuthenticated, _subscription, isAndroid, isWindows, VoyagerPlatform (+3 more)

### Community 128 - "Sync Outbox"
Cohesion: 0.07
Nodes (27): WindowProcDelegate, GetRegistrar(), FlutterDesktopPluginRegistrarRef, set, T, unique_ptr, PluginRegistrar, AddPlugin (+19 more)
...
Cohesion: 0.14
Nodes (13): DriftTodoRepository, TodoRepository, archive, DataImportService, _db, extractZipIsolate, importFromZip, journalFile (+5 more)
...
Cohesion: 0.10
Nodes (20): BaseSliderTrackShape, Color, currentWeatherProvider, accent, build, getPreferredRect, gradient, GradientSliderTrackShape (+12 more)
...
Cohesion: 0.10
Nodes (39): ConsumerState, allTodoTasksProvider, remoteSyncServiceProvider, todoListsProvider, todoListStatsProvider, todoRepositoryProvider, todoTasksProvider, _CalendarPageState (+31 more)
...
Cohesion: 0.07
Nodes (25): Delay, Duration, Duration get, cancel, DebouncedCallback, debounceDelay, Debouncer, delay (+17 more)
...
Cohesion: 0.14
Nodes (15): pendingStatEntriesProvider, todoSortDebugLoggerProvider, build, StatisticsActionFab, build, DevTodoSortDebugSection, _showLogDialog, _reorderActiveTasks (+7 more)
...
Cohesion: 0.33
Nodes (6): CalendarEvent, Journal, JournalEntry, SoftDeletable, TodoListModel, TodoTask
...
Cohesion: 0.25
Nodes (10): cacheStatusSnapshotProvider, devSettingsProvider, _scaledMorphDuration, build, _CacheStatusItemList, CacheStatusOverlay, _CacheStatusSummary, compact (+2 more)
...
Cohesion: 0.06
Nodes (35): colorPaletteProvider, build, weatherIconData, createJournalList, build, created, _createJournal, createState (+27 more)
...
Cohesion: 0.13
Nodes (13): configureDesktopWindow, desktopWindowChromeActive, _desktopWindowConfigured, exception, installWindowsKeyboardWorkaround, _isKnownWindowsKeyboardDesync, message, previous (+5 more)
...
Cohesion: 0.07
Nodes (28): copyWithDeleted, createdAt, deletedAt, id, isDeleted, updatedAt, version, allLists (+20 more)
...
Cohesion: 0.12
Nodes (28): ConsumerWidget, allJournalEntriesProvider, analyticsServiceProvider, periodicPromptServiceProvider, trackersProvider, trackerValuesProvider, AnalyticsPage, _analyticsViewModeProvider (+20 more)
...
Cohesion: 0.17
Nodes (10): decoration, restingColor, selectedColor, VoyagerListItemSurface, dark, VoyagerTheme, OutlinedBorder, package:flutter/material.dart (+2 more)
...
Cohesion: 0.25
Nodes (7): isDue, longestJournalStreak, missedPeriods, _nextPeriod, PeriodicPromptService, periodStartFor, package:voyager/domain/models/enums.dart
...
Cohesion: 0.06
Nodes (52): journalAllEntryIdsProvider, journalDebugLoggerProvider, journalEntryCacheInvalidatorProvider, journalEntryCountsProvider, journalListEntriesProvider, journalRepositoryProvider, journalsProvider, journalWriteCoordinatorProvider (+44 more)
...
Cohesion: 0.25
Nodes (7): build, HeatmapCalendar, month, tracker, values, package:voyager/domain/models/analytics_models.dart, StatisticTracker
...
### Community 227 - "@immutable"
Cohesion: 0.33
Nodes (6): syncConflictsProvider, build, _refreshAfterResolve, SyncConflictBanner, SyncConflictResolutionDialog, _SyncConflictResolutionDialogState

### Community 228 - "_VoyagerAppState"
Cohesion: 0.07
Nodes (31): ConsumerStatefulWidget, trackerRepositoryProvider, _CalendarCell, _CalendarCellState, _createTracker, _delete, _HeatmapBucket, _HeatmapBucketState (+23 more)

### Community 229 - "static const"
Cohesion: 0.60
Nodes (4): build, DevAnalyticsMonthOverride, devAnalyticsMonthOverrideProvider, DevCalendarDebugSection

### Community 230 - "accentColor"
Cohesion: 0.67
Nodes (3): GeometricTextureParams, GeometricTextureParamsNotifier, StateNotifier
...
### Community 361 - "build"
Cohesion: 0.50
Nodes (5): cachedCurrentWeatherProvider, currentWeatherProvider, build, _RailClockWeather, _RailClockWeatherState

### Community 362 - "dart:ui"
Cohesion: 0.04
Nodes (49): dart:convert, CrdtDocumentResolver, _merger, _mergeSyncOperations, resolvePayload, appSettingsWithGeometricTextureParams, copyWith, geometricTextureParamsFromSettings (+41 more)

## Knowledge Gaps
- **4563 isolated node(s):** `_fallbackDeviceId`, `_useCloudFunctions`, `_openWeatherApiKey`, `db`, `syncConflictRepositoryProvider` (+4558 more)
...
- **Why does `StreamHandlerError` connect `Windows Ephemeral` to `Windows Cpp`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `MethodChannel` connect `Dev Sync` to `Registrar Windows`, `Windows Cpp`, `Windows Ephemeral`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **What connects `_fallbackDeviceId`, `_useCloudFunctions`, `_openWeatherApiKey` to the rest of the system?**
  _4563 weakly-connected nodes found - possible documentation gaps or missing edges._
