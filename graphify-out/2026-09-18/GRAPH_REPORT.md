# Graph Report - Voyager  (2026-09-18)

## Corpus Check
- 1083 files · ~1,516,757 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27020 nodes · 42839 edges · 734 communities (665 shown, 69 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 294 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fdaaccf3`
- Run `git rev-parse HEAD` and compare to check if the graph is stale.
- Run `graphify update .` after code changes (no API cost).

## Community Hubs (Navigation)
- Drift Database Schema — app_database
- Firebase Auth — CHANGELOG
- Drift Repositories — drift_repositories
- Calendar Feature — calendar_page
- Repository Interfaces
- Calendar Feature — calendar_day_grid
- Analytics Feature — analytics_page
- Sync Engine — remote_sync_service
- Todo Feature — todo_page
- Journal Feature — journal_page
- Firebase Auth (windows) — messages.g.cpp
- Finance Feature — finance_transaction_modal
- Life Tracker Feature — life_tree_canvas
- Domain Models — settings_models
- Test Suite — study_card_editor_images_tes
- Sync Engine — firestore_document_mapper
- Firebase Auth (ios) — -readValueOfType
- Firebase Auth (macos) — -readValueOfType
- Study Feature — ConsumerState
- Journal Feature — journal_page
- Shell Feature — weather_forecast_chart
- Vim Editing — vim_text_ops
- Firebase Auth (android) — NonNull
- Vim Editing — vim_session
- Analytics Feature — ConsumerWidget
- Jobs Feature — StatelessWidget
- Firebase Auth (lib) — firebase_auth
- Todo Feature — todo_page
- Study Feature — ConsumerState
- Test Suite — journal_settings_dialog_test
- Finance Feature — finance_analytics_view
- Firebase Auth (windows) — messages.g.cpp
- Test Suite — jobs_track_flow_test
- Journal Feature — journal_list_actions
- Test Suite — study_card_editor_images_tes
- Calendar Feature — calendar_week_timeline
- Study Feature — ConsumerState
- Firebase Auth (windows) — messages.g.cpp
- Life Tracker Feature — life_tree_geometry
- Drift Database Schema — app_database
- Media Handling — media_fan_stack
- Test Suite — package:voyager/domain/repos
- Test Suite — package:flutter_test/flutter
- Test Suite — package:flutter_test/flutter
- Study Feature — ConsumerState
- Jobs Feature — jobs_page
- Shared Widgets — petal_field
- Firebase Auth (android) — NonNull
- Test Suite — package:voyager/domain/model
- Test Suite — package:flutter/services
- Finance Feature — finance_analytics_view
- Vim Editing — vim_text_overlay
- Test Suite — notification_inbox_wrap_mark
- Calendar Feature — calendar_grid
- Study Feature — ConsumerState
- Ephemeral — string
- Text — list_text_editing
- Study Feature — study_card_tile
- Rankings
- Dev — remote_sync_compare_service
- Shared Widgets — _State
- Calendar Feature — calendar_todo_markers
- Firebase Auth (android) — NonNull
- Shared Widgets — settingsProvider
- Todo
- Jobs Feature — jobs_track_modal
- Firebase Auth (android) — NonNull
- Firebase Auth (android) — Nullable
- Ephemeral — standard_codec
- Firebase Auth (windows) — messages.g.cpp
- Shared Widgets — context_menu
- Shared Widgets — _State
- Test Suite — package:flutter_test/flutter
- Shared Widgets — _State
- Rankings Feature — rankings_edit_panel
- Test Suite — dart:ui
- Workout Feature — exercise_detail_view
- Shared Widgets — _State
- Study Feature — ConsumerState
- Shared Widgets — _State
- Test Suite — package:voyager/domain/model
- Leetcode Feature — leetcode_code_controller
- Shared Widgets — _State
- Test Suite — package:voyager/domain/repos
- Caps Lock — caps_lock_caret_indicator
- Journal Feature — journal_list_actions
- Todo Feature — todo_list_actions
- Study Feature — ConsumerState
- Test Suite — leetcode_session_hides_test
- Firebase Auth (android) — NonNull
- Test Suite — scroll_offset_isolate_test
- Shared Widgets — _State
- Domain Services — weather_service
- Test Suite — package:flutter_test/flutter
- Shared Widgets — _State
- Shared Widgets — _State
- Test Suite — scroll_offset_isolate_test
- Test Suite — secondary_collections_migrat
- Shared Widgets — _State
- Finance Feature — finance_transaction_modal
- Firebase Auth (android) — FlutterFirebaseAuthPlugin
- Test Suite — package:flutter_test/flutter
- App Wiring & Providers — voyager_app
- Jobs Feature — StatelessWidget
- Ephemeral — string
- Test Suite — rankings_page_test
- Domain Models — SoftDeletable
- Prose Markup — prose_markup
- Shared Widgets — voyager_text_field
- Study Feature — ConsumerState
- Sync Engine — sync_conflict_detector
- Sync Engine — firestore_collections
- Study Feature — ConsumerState
- Runner — win32_window.cpp
- Firebase Auth (windows) — firebase_auth_plugin.cpp
- Test Suite — package:flutter_riverpod/flu
- Test Suite — package:voyager/domain/repos
- Snippets — snippet_session
- Study Feature — ConsumerState
- Domain Models — analytics_models
- Study Feature — ConsumerState
- Test Suite — todo_page_perf_test
- Study Feature — ConsumerState
- Constants — leetcode_constants
- Remote API Clients — firestore_sync_repository
- Shared Widgets — tag_suggestion_overlay
- Prose Markup — html_to_markers
- Test Suite — package:voyager/domain/repos
- Leetcode Feature — leetcode_inline_code
- Firebase Auth (ios) — firebase_auth_messages.g
- Firebase Auth (macos) — firebase_auth_messages.g
- Study Feature — ConsumerState
- Drift Database Schema — app_database
- Test Suite — leetcode_sync_durability_tes
- Study Feature — ConsumerState
- Test Suite — package:voyager/domain/repos
- Study Feature — ConsumerState
- Ephemeral — string
- Vim Editing — vim_anchored_chrome
- Lib — main
- Shared Widgets — glass_button
- Shared Widgets — voyager_scroll_view
- Domain Services — finance_analytics
- Test Suite — recurrence_editing_test
- Media Handling — media_paste_scope
- Test Suite — leetcode_sync_durability_tes
- Test Suite — package:voyager/domain/repos
- Shared Widgets — _State
- Study Feature — ConsumerState
- Test Suite — journal_autosave_provider_re
- Shared Widgets — voyager_text_field
- Shared Widgets — voyager_dropdown_button
- Shared Widgets — time_selector_popovers
- Domain Models — SoftDeletable
- Rankings Feature — rankings_actions
- Leetcode Feature — leetcode_flashcard
- Scope Switcher — scope_switcher
- Firebase Auth (windows) — firebase_auth_plugin.cpp
- Shared Widgets — voyager_toast
- Leetcode Feature — leetcode_track_draft
- Uncategorized — Study Card Images — High-Lev
- Ephemeral — string
- Ephemeral — PluginRegistrarWindows
- Shared Widgets — datetime_picker_dialog
- Domain Services — weather_forecast_chart
- Test Suite — tracker_model_invariants_tes
- Effects
- Shared Widgets — _State
- Domain Models — notification_models
- Settings Feature — settingsRepositoryProvider
- Theming — voyager_theme
- Analytics Feature — analytics_page
- Shared Widgets — tag_suggestion_overlay
- Rankings Feature — rankings_child_list
- Workout Feature — workout_island
- Test Suite — package:voyager/domain/repos
- Workout Feature — workout_island
- Shared Widgets — voyager_time_picker_spinner
- Jobs Feature — jobs_company_field
- Test Suite — vim_overlay_wrap_alignment_t
- Uncategorized — Rankings — High Level Design
- Test Suite — package:voyager/domain/repos
- Shared Widgets — _State
- Jobs Feature — jobs_edit_panel
- Test Suite — study_card_editor_images_tes
- Shared Widgets — contextual_popover
- Firebase Auth (ios) — FLTFirebaseAuthPlugin
- Firebase Auth (macos) — FLTFirebaseAuthPlugin
- Shared Widgets — voyager_popup_menu_item
- Test Suite — connectivity_status_test
- Media Handling — media_lightbox
- Jobs Feature — jobs_actions
- Autocorrect — autocorrect_engine
- Test Suite — package:flutter_test/flutter
- Shared Widgets — _State
- Test Suite — package:flutter_riverpod/flu
- Todo Feature — todo_list_actions
- Snippets — snippet_index
- Test Suite — package:voyager/core/vim/vim
- Uncategorized — Jobs — High Level Design
- Prose Rendering — prose_text_span
- Test Suite — package:flutter_test/flutter
- Domain Models — weather_models
- Study Feature — study_keyboard_shortcuts
- Dev Feature — dev_geometric_wave_tile
- Domain Models — SoftDeletable
- Rankings Feature — rankings_score_stars
- Motion System — AnimationController
- Prose Markup — prose_markup
- Sync Engine — outbox_sync_worker
- Spell Check — voyager_spell_check_service
- Shared Widgets — spell_check_squiggle_layer
- Domain Models — SoftDeletable
- Domain Services — weather_forecast_merge
- Life Tracker Feature — life_tree_figure
- Test Suite — todo_page_perf_test
- Uncategorized — Text Snippets (HLD)
- Firebase Auth (macos) — CustomPigeonHeader
- Dev — ChangeNotifier
- Dev — journal_debug_logger
- Autocorrect — autocorrect_flash_layer
- Domain Services — calendar_recurrence
- Analytics Feature — sparkline_touch
- Domain Services — recurrence_engine
- Jobs
- Jobs Feature — package:voyager/core/widgets
- Uncategorized — crdt_scramble_test
- Shell Feature — weather_forecast_chart_trans
- Calendar Feature — calendar_overlap_engine
- Shared Widgets — _State
- Life Tracker Feature — life_tracker_page
- Shell Feature — shell_keyboard_shortcuts
- Dev Feature — dev_fps_counter_tile
- Media Handling — media_gallery_strip
- Leetcode Feature — leetcode_scratch_starter
- Settings Feature — settingsRepositoryProvider
- Shell Feature — weather_chart_plot_cache
- Study Feature — study_flip_card
- Uncategorized — Media / Images — High-Level 
- Dev — package:flutter/foundation
- Shared Widgets — spell_check_squiggle_layer
- Domain Models — leetcode_api_models
- Test Suite — leetcode_sync_durability_tes
- Test Suite — study_session_undo_test
- Test Suite — package:voyager/domain/repos
- Ephemeral — string
- Shared Widgets — search_highlight_text
- Test Suite — vim_text_scope_test
- Domain Models — int?
- Sync Engine — sync_activity
- Prose Rendering — prose_text_span
- Shared Widgets — notched_field_border
- Leetcode Feature — leetcode_review_deck
- Firebase Auth (ios) — FLTFirebaseAuthPlugin
- Firebase Auth (macos) — FLTFirebaseAuthPlugin
- Shell Feature — weather_forecast_sheet
- Workout Feature — workout_island
- Leetcode Feature — leetcode_mini_flashcard
- Test Suite — study_card_editor_images_tes
- Media Handling — media_image
- Caps Lock — package:flutter/widgets
- Shared Widgets — spell_check_field_support
- Analytics Feature — ConsumerWidget
- Domain Models — SoftDeletable
- Rankings Feature — rankings_field_editor
- Test Suite — journal_autosave_provider_re
- Jobs Feature — jobs_track_draft_store
- Test Suite — package:voyager/domain/repos
- Study Feature — ConsumerState
- Test Suite — leetcode_inline_code_test
- Life Tracker Feature — life_tree_popover
- Sync Engine — dart:async
- Dev — fps_monitor_controller
- Uncategorized — LeetCode Track Modal — Local
- Shared Widgets — voyager_number_wheel
- Shared Widgets — _State
- Jobs Feature — job_clipboard_parser
- Firebase Auth (windows) — messages.g.cpp
- Shared Widgets — keep_alive_scroll
- Firebase Auth (android) — NonNull
- Uncategorized — Components
- Leetcode Feature — leetcode_scratch_session
- Auth Feature
- Journal Feature — journal_list_actions
- Shared Widgets — _State
- Shared Widgets — date_selector_popover
- Leetcode Feature — leetcode_activity_chart
- Life Tracker Feature — life_tracker_stats
- Workout Feature — workout_actions
- Sync Feature
- Remote API Clients — firebase_auth_repository
- Test Suite — vim_chrome_placement_test
- Test Suite — scroll_offset_isolate_test
- Test Suite — package:voyager/domain/repos
- Firebase Auth (android) — NonNull
- Study Feature — ConsumerState
- Calendar Feature — calendar_overlap_engine
- Caps Lock — caps_lock_state
- Test Suite — package:voyager/domain/repos
- Shell Feature — weather_chart_transition_war
- Shared Widgets — voyager_checkbox
- Domain Services — study_srs_engine
- Calendar Feature — calendar_list_actions
- Leetcode Feature — leetcode_activity_bubble
- Study Feature — ConsumerState
- Leetcode Feature — leetcode_session_page
- Life Tracker Feature — List
- Shared Widgets — _State
- Test Suite — shell_destinations
- Firebase Auth (ios) — firebase_auth_messages.g
- Firebase Auth (macos) — firebase_auth_messages.g
- Shared Widgets — paper_texture
- Leetcode Feature — leetcode_scratch_diff
- Uncategorized — crdt_scramble_test
- Sync Engine — pending_text_merge
- Shared Widgets — resizable_pane_divider
- Domain Models — SoftDeletable
- Study Feature — ConsumerState
- Uncategorized — Two-device sync validation (
- Uncategorized — Saving & Sync Audit
- Test Suite — jobs_track_flow_test
- Uncategorized — Caps Lock Caret Indicator (H
- Autocorrect — autocorrect_flash_layer
- Domain Models — int?
- Settings Feature — settingsRepositoryProvider
- Shared Widgets — settingsProvider
...
- Firebase Auth (windows) — firebase_auth_plugin.cpp
- Life Tracker Feature — List
- Lib — forecast_archive.js
- Firebase Auth (windows) — messages.g.cpp
- Spell Check — dictionary_search
- Shared Widgets — desktop_window_title_bar
- Calendar Feature — calendar_overlap_engine
- Leetcode Feature — leetcode_activity_data
- Shared Widgets — _State
- Test Suite — package:voyager/domain/model
- Firebase Auth (android) — FlutterFirebaseMultiFactor
- Src — forecast_archive.ts
- Dev Feature — dev_fps_counter_tile
- Core Utilities — key_binding
- Domain Services — calendar_recurrence_editing
- Shell Feature — weather_chart_curve
- Workout Feature — package:phosphoricons_flutte
- Dev Feature — dev_sync_compare_tile
- Motion System — voyager_crossfade
- Theming — voyager_menu_theme
- Shared Widgets — desktop_window_frame
- Domain Models — int?
- Journal Feature — journal_manage_sheet
- @immutable
- Test Suite — package:voyager/domain/model
- Shell Feature — shell_page_transition
- Firebase Auth (windows) — firebase_auth_plugin.cpp
- Hotkeys Feature
- Uncategorized — NEETCODE150
- Shared Widgets — glass_surface
- Firebase Auth (windows) — firebase_auth_plugin.cpp
- trackerRepositoryProvider
- Remote API Clients — desktop_google_oauth
- Remote API Clients — leetcode_content
- Calendar Feature — calendar_keyboard_shortcuts
- Study Feature — package:voyager/core/motion/
- Uncategorized — Right-click Add Snippet — Hi
- Test Suite — package:flutter_riverpod/flu
- dev_fps_counter_tile.dart
- Firebase Auth (ios) — CustomPigeonHeader
- Firebase Auth (ios) — CustomPigeonHeader
- Uncategorized — Background Pipeline
- Life Tracker Feature — blossom_stat_popup
- Analytics Feature — analytics_page
- Media Handling — media_clipboard
- Shared Widgets — create_name_color_dialog
- Calendar Feature — calendar_manage_sheet
- Leetcode Feature — leetcode_scratch_session
- Study Feature — study_debug_generator
- Workout Feature — workout_day_column
- Test Suite — package:flutter_riverpod/flu
- Uncategorized — App-wide dictionary (HLD)
- Docs — Flutter toolchain
- Test Suite — workout_test
- Shared Widgets — color_picker_field
- Sync Engine — Timer?
- Shared Widgets — tag_suggestion_overlay
- Domain Models — SoftDeletable
- Domain Models — DateTime?
- Domain Models — sync_conflict
- Workout Feature — workout_target_editor
- Analytics Feature — stat_number_format
- Study Feature — study_keyboard_shortcuts
- Study Feature — ConsumerState
- Test Suite — workout_test
- Uncategorized — Snippet undo vs Vim `u`
- Uncategorized — Voyager Analytics Page: Comp
- jobs_track_draft_store.dart
- Uncategorized — crdt_scramble_test
- Functions — package.json
- Shared Widgets — chart_hover_bubble
- Todo Feature — todo_page
- Life Tracker Feature — life_tree_figure
- Study Feature — study_import_text_modal
- Test Suite — prose_highlight_rounding_test
- Firebase Auth (android) — NonNull
- Firebase Auth (android) — NonNull
- Firebase Auth (ios) — firebase_auth_messages.g
- Firebase Auth (ios) — firebase_auth_messages.g
...
- Calendar Feature — calendar_list_actions
- Test Suite — vim_text_scope_test
- Shared Widgets — confirm_dialog
- Demo Feature
- Uncategorized — Text box widget: `NotchedFie
- Functions — compilerOptions
- Auth
- Text — typedef
- Settings Feature — package:voyager/domain/model
- Shell Feature — shell_page_storage_keys
- Ephemeral — string
- Ephemeral — string
- Uncategorized — Studying Page
- Firebase Auth (ios) — CustomPigeonHeader
- Firebase Auth (macos) — firebase_auth_messages.g
- Firebase Auth (macos) — CustomPigeonHeader
- Shell Feature — shell_keyboard_shortcuts
- Shell Feature — app_shell
- Shared Widgets — double?
- Finance Feature — finance_bill_radar
- Dev — dev_flags
- Sync Engine — char_ops_encoder
- Domain Services — color_palette_codec
- Uncategorized — Product
- Firebase Auth (ios) — FLTFirebaseAuthPlugin
- Firebase Auth (macos) — FLTFirebaseAuthPlugin
- heatmap_calendar.dart
- Uncategorized — FEEDBACK
- Constants — String get
- Constants — hotkey_defaults
- Constants — journal_constants
- Snippets — snippet_enabled_scope
- Domain Services — weather_service
- Settings Feature — settingsRepositoryProvider
- Firebase Auth (macos) — CustomPigeonHeader
- Uncategorized — 2. State Management & Logic 
- Uncategorized — delta_scramble_test
- Study Feature — ConsumerState
- Jobs
- Spell Check — spell_check_suggestions
- Shared Widgets — context_menu
- Test Suite — package:voyager/domain/model
- Ephemeral — string
- Firebase Auth (ios) — CustomPigeonHeader
- Uncategorized — delta_scramble_test
- Uncategorized — GLASS_BUTTON
- Uncategorized — Page Architecture & Layout
- Test Suite — package:flutter_riverpod/flu
- Settings Feature — settingsRepositoryProvider
- Theming — voyager_spacing
- Uncategorized — PLAN
- Uncategorized — Rankings — UI/UX Redesign HL
- Firebase Auth (windows) — messages.g.cpp
- Uncategorized — VIM
- Uncategorized — High-Level Design: Voyager W
- Ephemeral — string
- Uncategorized — IMPORT_EXPORT
- Journal Feature — journal_page
- Constants — neetcode150
- Core Utilities — ids
- Leetcode Feature — leetcode_activity_calendar
- Test Suite — todo_list_search_test
- Firebase Auth (android) — FlutterFirebaseAuthRegistrar
- Adr — ADR 002: Sync Protocol Bound
- Motion System — AnimationController
- Shared Widgets — tag_suggestion_overlay
- Uncategorized — Rankings — UI/UX Redesign HL
- Uncategorized — Rankings — UI/UX Redesign HL
- Firebase Auth (ios) — firebase_auth_messages.g
- Uncategorized — Workout Tracker
- Uncategorized — anagram_test
- Ephemeral — string
- Adr — ADR 001: Local-First Data Mo
- Adr — ADR 003: Module Structure
- Uncategorized — Dream Journal
- Caps Lock — caps_lock_caret_indicator
- Spell Check — word_token
- Uncategorized — Unified Canvas
- Shell Feature — weather_chart_plot_cache
- Firebase Auth — CHANGELOG
- Firebase Auth — CHANGELOG
- Firebase Auth (ios) — firebase_auth_messages.g
- Text — list_text_editing
- Android — gradlew
- Calendar Feature — CustomClipper
- Uncategorized — deinterleave_test
- Caps Lock — caps_lock_caret_indicator
- Core Utilities — journal_tags
- Uncategorized — Rankings — UI/UX Redesign HL
- Firebase Auth (macos) — CustomPigeonHeader
- Firebase Auth — Firebase Auth for Flutter
- Uncategorized — TIME_SELECTOR
- Uncategorized — UNIFIED_NOTIFICATIONS
- Uncategorized — ANALYTICS_FEEDBACK
- Constants — app_constants
- Constants — job_constants
- Motion System — rubber_band
- Core Utilities — all_view_destination
- Shared Widgets — voyager_scroll_view
- Shared Widgets — voyager_scroll_view
- Test Suite — dictionary_search_test
- Uncategorized — Rankings — UI/UX Redesign HL
- Uncategorized — Rankings — UI/UX Redesign HL
- Uncategorized — Rankings — UI/UX Redesign HL
- Uncategorized — Rankings — UI/UX Redesign HL
...
- Src — MainActivity
- Calendar Feature — calendar_day_grid
- Constants — todo_sort_constants
- Core Utilities — calendar_days
- Test Suite — package:voyager/core/sync/te
- Test Suite — package:flutter/services
- Todo Feature — todo_page
- InternalPhoneMultiFactorAssertion
- Firebase Auth (ios) — PackageDescription
- Uncategorized — Rankings — UI/UX Redesign HL
- Uncategorized — Rankings — UI/UX Redesign HL
- Uncategorized — Rankings — UI/UX Redesign HL
- Tool
- Rules
- Workflows
- Firebase Auth (windows) — TEST()
- Journal Feature — journal_page
- leetcode_scratch_draft_store.dart
- Constants — default_color_palette
- Domain Services — openweather_mapper
- Analytics Feature — analytics_page
- Calendar Feature — calendar_day_grid
- Calendar Feature — calendar_day_grid
...
- Firebase Auth (android) — Constants
- Firebase Auth (ios) — FLTFirebaseAuthPlugin
- Firebase Auth (ios) — FLTFirebaseAuthPlugin
...
- InternalUserDetails
- Drift Database Schema — app_database
- dev_geometric_texture_tile.dart
- spell_check_overlay_alignment_test.dart
- shell_page_transition.dart
- journal_entry_delete.dart
- voyager_toast_test.dart
- tag_suggestions.dart
- _TaskRowState
- character_sequence_crdt_merger.dart
- Drift Database Schema — app_database
...
- Timer?
- StudyRepository
- prompt_name_dialog.dart
- @visibleForTesting
- media_attach.dart
- calendar_overlay_dialog.dart
...
- job_experience_snippet_text_test.dart
...
- _RowHoverSurface
- _TaskRowState
- package:voyager/features/workout/workout_placement_prescription_editor.dart
- categoryId
- changedAt
- childDeckId
- childScoreMax
...
- ParseAdditionalUserInfo
- snippets_dialog.dart
- Global Hotkey Floaters — Test Methodology & Coverage
- media_file_store.dart
- workout_target_editor.dart
- workout_test.dart
- EncodableValue
- FlutterWindow
- jobs_track_draft_store.dart
- spring_motion.dart
- package:voyager/core/utils/all_view_destination.dart
- jobs_option_list.dart
- finance_origins_test.dart
- shell_page_storage_keys.dart
- workout_name_modal.dart
- dev_weather_api_tile.dart
- device_registration.dart
- connectivity_status_test.dart
- voyager_icons.dart
- _SparklineTouchScope
- _StatTile
- _TrackerDialog
...
1. `_State` - 125 edges
2. `settingsProvider` - 95 edges
3. `remoteSyncServiceProvider` - 90 edges
4. `FLTFirebaseAuthPlugin` - 87 edges
5. `FLTFirebaseAuthPlugin` - 87 edges
6. `Builder` - 86 edges
7. `Result` - 73 edges
8. `CanIgnoreReturnValue` - 70 edges
9. `FirebaseAuthPlugin` - 63 edges
10. `DataClass` - 59 edges
...
## Communities (734 total, 69 thin omitted)

### Community 0 - "Drift Database Schema — app_database"
Cohesion: 0.00
Nodes (1219): BoolColumn get, _, _accentColorMeta, _ackedAtMeta, actualTableName, _addedAtMeta, _alertOnPeriodicPromptsMeta, _alertTimeHourMeta (+1211 more)

### Community 1 - "Firebase Auth — CHANGELOG"
Cohesion: 0.01
Nodes (321): 0.0.1, 0.0.2, 0.0.2+1, 0.0.3, 0.0.3+1, 0.0.4, 0.10.0, 0.10.0+1 (+313 more)

### Community 2 - "Drift Repositories — drift_repositories"
Cohesion: 0.01
Nodes (350): JobExperienceSnippet, addCustomWord, appendLog, _applicationCompanion, applyJobExperienceSnippetEdit, applySnippetEdit, _categoryCompanion, _childCompanion (+342 more)

### Community 3 - "Calendar Feature — calendar_page"
Cohesion: 0.01
Nodes (269): AnimationStatusListener?, _, CalendarViewMode, _abortMorphAnimation, accentColor, adjacentColor, _advanceWarmup, _appliedSavedCalendarView (+261 more)

### Community 4 - "Repository Interfaces"
Cohesion: 0.01
Nodes (306): addCustomWord, appendLog, appendOperation, appendOperationGroup, appendOperationsBatch, applyJobExperienceSnippetEdit, applySnippetEdit, authStateChanges (+298 more)
...
Cohesion: 0.01
Nodes (240): AnalyticsService, await, accent, _addOption, all, analytics, anchor, anchorDateRect (+232 more)

### Community 7 - "Sync Engine — remote_sync_service"
Cohesion: 0.01
Nodes (258): CharacterOpRegistry, CharacterOpRegistry get, CharacterSequenceCrdtMerger, _activeDebouncers, _activelyEditedDocuments, addPendingTextMergeListener, _adoptLegacySnippets, applyPendingDreamEntryTextMerge (+250 more)

### Community 8 - "Todo Feature — todo_page"
Cohesion: 0.01
Nodes (200): AsyncValue, accent, accentColor, activeCount, _activeInList, _activeMatchKey, _activeSectionHeight, _addingTask (+192 more)

### Community 9 - "Journal Feature — journal_page"
Cohesion: 0.01
Nodes (181): journalListEntriesProvider, accent, accentColor, allEntriesCount, _appliedSavedPreferences, _applySavedPreferencesIfReady, _attachedEntryId, _bodyEntryId (+173 more)

### Community 10 - "Firebase Auth (windows) — messages.g.cpp"
Cohesion: 0.02
Nodes (179): GenerateInterfaces, string_view, AuthPigeonFirebaseApp, app_name_, AuthPigeonFirebaseApp::AuthPigeonFirebaseApp(), custom_auth_domain, Hash, set_app_name (+171 more)

### Community 11 - "Finance Feature — finance_transaction_modal"
Cohesion: 0.05
Nodes (57): studyCardsProvider, studyDeckByIdProvider, studyDeckStatsProvider, StudyDeckLink, build, _cramSession, createState, deckId (+49 more)
...
Cohesion: 0.01
Nodes (169): accentColor, alertOnPeriodicPrompts, alertTimeHour, autocorrectEnabled, birthDate, birthYear, calendarNavigateLeftKey, calendarNavigateRightKey (+161 more)

### Community 14 - "Test Suite — study_card_editor_images_tes"
Cohesion: 0.03
Nodes (86): dart:io, MediaService, MediaImage, _MediaImageState, MediaFileStore, package:image/image.dart, package:voyager/core/media/media_service.dart, package:voyager/data/services/media_file_store.dart (+78 more)

### Community 15 - "Sync Engine — firestore_document_mapper"
Cohesion: 0.01
Nodes (211): applicationUrl, assetRoomEventToFirestore, assetToFirestore, assetValuationToFirestore, body, bucketListItemToFirestore, budgetToFirestore, calendarEventToFirestore (+203 more)
...
### Community 17 - "Firebase Auth (macos) — -readValueOfType"
Cohesion: 0.07
Nodes (145): ActionCodeInfoOperationBox, -initWithValue, AuthPigeonFirebaseApp, +fromList, -hash, -isEqual, +makeWithAppNametenantIdcustomAuthDomain, +nullableFromList (+137 more)

### Community 18 - "Study Feature — ConsumerState"
Cohesion: 0.02
Nodes (129): accent, child, color, _completingNow, _controller, copyWith, createState, _dateLabel (+121 more)

### Community 19 - "Journal Feature — journal_page"
Cohesion: 0.01
Nodes (174): AuthNotifier, AutocorrectScopeData, CacheStatusSnapshot, ChangeNotifierProvider, ConnectivityStatusController, DataExportService, DataImportService, DevSettingsController (+166 more)

### Community 20 - "Shell Feature — weather_forecast_chart"
Cohesion: 0.02
Nodes (125): allowOverflow, allowVerticalOverflow, axisMaxY, axisMinY, belowPath, bottom, bottomAxisHeight, bucket (+117 more)

### Community 21 - "Vim Editing — vim_text_ops"
Cohesion: 0.02
Nodes (124): 0, big, body, _bracketObject, c, caret, caseSensitive, character (+116 more)
...
Cohesion: 0.02
Nodes (119): _alwaysFocused, _applyCaseOverRange, _applyMotion, _applyOperatorRange, _applyValue, _autoIndent, _blockVisualLineHorizontal, _cachedMatches (+111 more)

### Community 24 - "Analytics Feature — ConsumerWidget"
Cohesion: 0.03
Nodes (86): rankingCategoriesProvider, rankingChildrenByParentProvider, rankingParentCountsProvider, rankingParentsProvider, RankingFilters, build, _pickView, build (+78 more)

### Community 25 - "Jobs Feature — StatelessWidget"
Cohesion: 0.04
Nodes (53): CalendarEvent?, acknowledge, _act, _alertSignature, _armTimer, _bells, _deliver, deviceId (+45 more)
...
Cohesion: 0.02
Nodes (108): ContextMenuRegionState, _applyPendingNotesMerge, _beginEditingSession, build, _buildSubtaskList, _clearDueDate, _close, color (+100 more)

### Community 28 - "Study Feature — ConsumerState"
Cohesion: 0.04
Nodes (56): _accentColor, _activeQuery, _baseline, body, _bodyController, _bodyFocusNode, _changeEntryDateAndTime, _coordinator (+48 more)
...
Cohesion: 0.03
Nodes (81): abs, accent, _AnalyticsCard, anchor, _arcMidpoint, asset, _AssetRow, _AssetRowState (+73 more)

### Community 31 - "Firebase Auth (windows) — messages.g.cpp"
Cohesion: 0.03
Nodes (108): InternalAuthCredentialInput, K, FromEncodableList, operator==, ToEncodableList, AuthPigeonFirebaseApp, EncodableList, EncodableValue (+100 more)

### Community 32 - "Test Suite — jobs_track_flow_test"
Cohesion: 0.01
Nodes (174): @DriftDatabase, DateTime? stamp,
  int, _Device, InMemorySyncRepository, SyncEngine, AppDatabase, DriftJournalRepository, android (+166 more)

### Community 33 - "Journal Feature — journal_list_actions"
Cohesion: 0.07
Nodes (26): InMemorySyncRepository, package:voyager/core/soft_delete/restore_contract.dart, _StalledSyncRepository, FakeWeatherApiClient, _StalledSyncRepository, _HangingWeatherApiClient, db, main (+18 more)

### Community 34 - "Test Suite — study_card_editor_images_tes"
Cohesion: 0.03
Nodes (68): accentColor, build, cancelled, _canPop, _clear, _close, commit, createState (+60 more)
...
Cohesion: 0.02
Nodes (100): accentColor, _appliedSavedWidth, _bodyEditorKey, _bodyEntryId, _bodyFocusNode, bodyPreview, bodyTextFor, _buildEditorArea (+92 more)

### Community 37 - "Firebase Auth (windows) — messages.g.cpp"
Cohesion: 0.04
Nodes (51): FlutterDesktopMessage, GetPlatformVersion, TextureVariant, ErrorOr, v_, FlutterError, code_, details_ (+43 more)
...
Cohesion: 0.03
Nodes (119): AssetRoomEventsTableCompanion, AssetRoomEventsTableData, AssetsTableCompanion, AssetsTableData, AssetValuationsTableCompanion, AssetValuationsTableData, BucketListItemsTableCompanion, BucketListItemsTableData (+111 more)

### Community 40 - "Media Handling — media_fan_stack"
Cohesion: 0.04
Nodes (58): borderColor, child, _closeGeneration, _closing, _create, _createFolderOrDeck, _CreateMenu, createState (+50 more)
...
Cohesion: 0.02
Nodes (99): BackupFormatException, class MockDocumentReference extends, ../test/fakes/fake_weather_api_client.dart, addCustomWord, authStateChanges, batch, batchCreatedCount, batches (+91 more)

### Community 43 - "Test Suite — package:flutter_test/flutter"
Cohesion: 0.09
Nodes (22): byDay, countFor, days, difficulty, easy, hard, kLeetCodeActivityWindowDays, leetCodeBusiestDayInYear (+14 more)
...
Cohesion: 0.03
Nodes (57): anchor, _BreakdownRow, build, child, count, counts, date, difficulty (+49 more)
...
Cohesion: 0.03
Nodes (11): InternalFirebaseAuthSettings, InternalTotpSecret, InternalAdditionalUserInfo, InternalFirebaseAuthSettings, InternalIdTokenResult, InternalTotpSecret, InternalUserInfo, Nullable (+3 more)

### Community 48 - "Test Suite — package:voyager/domain/model"
Cohesion: 0.03
Nodes (66): AnimatedContainer, package:flutter/gestures.dart, package:voyager/core/theme/voyager_list_item_surface.dart, package:voyager/features/todo/todo_edit_panel.dart, package:voyager/features/todo/todo_list_search_bar.dart, support/todo_page_harness.dart, deleteTaskFromRow, gesture (+58 more)
...
Cohesion: 0.04
Nodes (59): financeRepositoryProvider, FinancialTransaction?, amountCents, _amountController, autofocus, build, _close, container (+51 more)
...
Cohesion: 0.04
Nodes (55): _dreamRepository, DreamWriteCoordinator, _findTask, _journalRepository, _remoteSync, saveEntry, saveTask, _todoRepository (+47 more)
...
Cohesion: 0.06
Nodes (35): DecoratedBox, _RenderCapsLockCaret, RenderVimAnchoredChrome, RenderClampToTargetBounds, _RenderTapThroughBarrier, _RenderModalBarrierGuard, RenderProseHighlightUnderlay, RenderScrollOffsetFollower (+27 more)
...
Cohesion: 0.03
Nodes (75): _addInstantDiff, allMatched, _charMerger, compareAllJournalEntries, compareAllTodoLists, comparedAt, _compareJournalEntry, compareTodoList (+67 more)

### Community 60 - "Shared Widgets — _State"
Cohesion: 0.02
Nodes (90): VimSession, accentColor, _active, _autocorrectActive, autocorrectAllowed, _autocorrectScope, autocorrectSession, _badge (+82 more)
...
Cohesion: 0.13
Nodes (3): MultiFactorInfo, InternalMultiFactorInfo, InternalMultiFactorInfo
...
Cohesion: 0.04
Nodes (8): GeneratedAndroidFirebaseAuth, InternalAuthCredential, InternalAuthCredentialInput, InternalMultiFactorSession, InternalSignInProvider, InternalUserProfile, Override, SuppressWarnings

### Community 67 - "Firebase Auth (android) — Nullable"
Cohesion: 0.09
Nodes (21): ActivityAware, ActivityPluginBinding, FlutterFirebasePlugin, FlutterPlugin, FlutterPluginBinding, Task, FlutterFirebaseAuthPlugin, Activity (+13 more)
...
Nodes (129): DateTime? deletedAt,
  int, MoodGradientSlider, DriftSettingsRepository, searchEntries, SearchService, ListView, package:drift/drift.dart, package:flutter_test/flutter_test.dart (+121 more)
...
Cohesion: 0.03
Nodes (77): CrdtDocumentResolver, Debouncer, BackgroundSyncOrchestrator, backoffMultiplier, _bucketListRepository, _calendarRepository, cancelScheduledDocumentSync, _crdtResolver (+69 more)

### Community 73 - "Shared Widgets — _State"
Cohesion: 0.05
Nodes (46): _, studyDeckGraphProvider, studyDecksProvider, studyFoldersProvider, _linkTile, _blocked, build, createState (+38 more)

### Community 74 - "Rankings Feature — rankings_edit_panel"
Cohesion: 0.04
Nodes (45): MemoryFinanceUiPrefsStore? prefsStore,
  bool, package:voyager/domain/services/finance_analytics.dart, package:voyager/features/finance/finance_net_flow_chart.dart, package:voyager/features/finance/finance_net_flow_hero.dart, package:voyager/features/finance/finance_ui_prefs.dart, SegmentedButton, main, tx (+37 more)

### Community 75 - "Test Suite — dart:ui"
Cohesion: 0.02
Nodes (115): Container, DateTime? dateApplied,
  List, package:voyager/core/constants/job_constants.dart, package:voyager/domain/models/job_models.dart, package:voyager/features/jobs/jobs_edit_panel.dart, package:voyager/features/jobs/jobs_page.dart, package:voyager/features/jobs/jobs_providers.dart, package:voyager/features/jobs/jobs_table.dart (+107 more)

### Community 76 - "Workout Feature — exercise_detail_view"
Cohesion: 0.03
Nodes (69): anchorRect, anchorRectFor, box, _ChartPlaceholder, _close, _controller, createState, _cuesController (+61 more)

### Community 77 - "Shared Widgets — _State"
Cohesion: 0.07
Nodes (26): colorForLeetCodeDifficulty, key, kLeetCodeEasyColor, kLeetCodeHardColor, kLeetCodeMediumColor, labelForLeetCodeDifficulty, labelForLeetCodeLanguage, leetCodeCodeLanguages (+18 more)

### Community 78 - "Study Feature — ConsumerState"
Cohesion: 0.03
Nodes (56): FirebaseAuthMultiFactorException, Color, FirebaseAuthException, accent, build, important, NotificationUrgencyDot, size (+48 more)
...
Cohesion: 0.06
Nodes (35): 10. Component sketch (implementation guide), 11. Risks & constraints, 12. Acceptance checklist, 13. Follow-ups (explicitly later), 14.1 App page drawn inside the journal floater (not confirmed), 14.2 Alt+Tab behaviour around floaters (fixed 2026-09-18, for context), 14. Known issues, 1. Goals (+27 more)

### Community 81 - "Leetcode Feature — leetcode_code_controller"
Cohesion: 0.03
Nodes (62): 0, apostrophe, at, backspace, bare, base, caret, char (+54 more)
...
Cohesion: 0.03
Nodes (59): CurvedAnimation, accentColor, allowed, attach, _blockCaret, build, capsLockBadgeVisible, CapsLockCaretIndicator (+51 more)

### Community 85 - "Journal Feature — journal_list_actions"
Cohesion: 0.04
Nodes (51): _builtMode, createState, day, _DayHeader, dispose, _EmptyDayRow, _emptyJumpDay, _EmptyLedger (+43 more)

### Community 86 - "Todo Feature — todo_list_actions"
Cohesion: 0.04
Nodes (47): allLists, assigner, choice, color, container, context, deletedList, deleteTodoList (+39 more)

### Community 87 - "Study Feature — ConsumerState"
Cohesion: 0.03
Nodes (63): build, createState, DevRemotePurgeSection, _DevRemotePurgeSectionState, dispose, _entryIdController, _purgeEntry, _purging (+55 more)
...
Cohesion: 0.02
Nodes (120): fakes/fake_weather_api_client.dart, deleteBudgetWithUndo, deleteSubscriptionWithUndo, softDeleteWithUndo, package:flutter_riverpod/flutter_riverpod.dart, package:voyager/app/providers.dart, package:voyager/app/voyager_app.dart, package:voyager/core/utils/ids.dart (+112 more)

### Community 90 - "Test Suite — scroll_offset_isolate_test"
Cohesion: 0.02
Nodes (147): EditableText, EditableTextState, loadDictionaryFromAssets, raw, srsMasteryColor, context, focus, isTextInputFocused (+139 more)
...
Cohesion: 0.04
Nodes (48): Delay, FirestoreWriteGate, _authRepo, _beforeInitialize, clearFor, _clearPending, data, _db (+40 more)
...
Cohesion: 0.03
Nodes (112): ConsumerState, ConsumerStatefulWidget, allDreamEntriesProvider, allTodoTasksProvider, dreamRepositoryProvider, dreamWriteCoordinatorProvider, exerciseSetLogsProvider, leetcodeProblemsProvider (+104 more)
...
Cohesion: 0.06
Nodes (31): Animation, AnimationController, _animDuration, _barVisible, build, child, _controller, createState (+23 more)
...
Cohesion: 0.04
Nodes (54): financeRepositoryProvider, subscriptionsProvider, Subscription, _save, _detach, _delete, _save, BillRadarPanel (+46 more)
...
Cohesion: 0.04
Nodes (47): LeetCodeProblem, build, _CompletionRow, _CompletionRowState, count, createState, duplicateCount, _DuplicateMarker (+39 more)
...
Cohesion: 0.02
Nodes (83): integers,
  half,, activeChildTemplate, activeParentTemplate, archivedAt, categoryId, childScoreMax, childScorePrecision, childTemplate (+75 more)
...
Cohesion: 0.04
Nodes (44): accent, build, color, count, items, label, maxWidth, onSelected (+36 more)

### Community 109 - "Study Feature — ConsumerState"
Cohesion: 0.04
Nodes (46): _applyDecision, bucket0, bucket1, bucket2, _BucketProgressBar, _canRedo, _canUndo, cardIds (+38 more)

### Community 110 - "Sync Engine — sync_conflict_detector"
Cohesion: 0.05
Nodes (36): Curve, animateTo, controller, defaultSpring, dispose, jumpTo, _spring, stop (+28 more)

### Community 111 - "Sync Engine — firestore_collections"
Cohesion: 0.03
Nodes (64): assetRoomEvents, assets, assetValuations, bucketListItems, budgets, calendarEvents, calendars, contributionRooms (+56 more)

### Community 112 - "Study Feature — ConsumerState"
Cohesion: 0.03
Nodes (64): build, CompactBackBar, label, onBack, FinanceCategory, build, _canSave, _CategoryModal (+56 more)
...
Cohesion: 0.15
Nodes (57): AuthError, FederatedOAuthProvider, FutureBase, AuthPigeonFirebaseApp, AuthResult, FlutterError, function, InternalActionCodeSettings (+49 more)
...
Cohesion: 0.04
Nodes (52): boolValue, buildDreamLoggedTracker, buildJournalEntriesTracker, buildStreakTracker, buildWordCountTracker, buildWorkedOutTracker, cadence, cap (+44 more)
...
Cohesion: 0.07
Nodes (27): CapturedThemes, Color get, _ContextualPopoverRoute, VoyagerPopupMenuRoute, accentColor, anchor, barrierColor, barrierDismissible (+19 more)
...
Cohesion: 0.04
Nodes (46): studyAllCardsProvider, studyStatsProvider, build, _returnRestoredCard, _StudyStatsHeader, accent, after, before (+38 more)

### Community 124 - "Remote API Clients — firestore_sync_repository"
Cohesion: 0.05
Nodes (39): appendOperation, appendOperationGroup, appendOperationsBatch, claimCalendarLock, claimWeatherFetchLock, _collection, deleteDocument, deleteOperations (+31 more)

### Community 125 - "Shared Widgets — tag_suggestion_overlay"
Cohesion: 0.04
Nodes (52): FocusOnKeyEventCallback?, tagPoolProvider, accentColor, _accept, build, _caretGap, child, _close (+44 more)
...
Cohesion: 0.04
Nodes (48): _buildReplacementEditor, _buildResults, _bundledSeen, _BundledWordRow, _candidateQuery, _candidates, _controller, createState (+40 more)

### Community 132 - "Drift Database Schema — app_database"
Cohesion: 0.04
Nodes (61): @DataClassName, @TableIndex, AssetRoomEventsTable, AssetsTable, AssetValuationsTable, BucketListItemsTable, BudgetsTable, CalendarEventsTable (+53 more)

### Community 133 - "Test Suite — leetcode_sync_durability_tes"
Cohesion: 0.04
Nodes (46): ContextMenuItem, _allDevices, _body, createState, _delete, _deviceIds, dispose, _enabled (+38 more)

### Community 134 - "Study Feature — ConsumerState"
Cohesion: 0.04
Nodes (50): confirmed, container, context, copyLeetCodeCode, current, deleteLeetCodeProblem, dismiss, draft (+42 more)
...
Cohesion: 0.03
Nodes (70): accent, _actions, _active, affected, _all, busy, categories, category (+62 more)
...
Cohesion: 0.04
Nodes (48): ClipRectLayer, LayerLink, anchorOffset, applyPaintTransform, asIs, attach, build, _checkScheduled (+40 more)
...
Cohesion: 0.05
Nodes (39): build, _CalendarManageDialog, _CalendarManageDialogState, _calendars, _counts, _createCalendar, _createdCalendarId, createdId (+31 more)

### Community 144 - "Media Handling — media_paste_scope"
Cohesion: 0.05
Nodes (39): MediaClipboard, _attachFromClipboard, build, _busy, child, clipboard, collection, createState (+31 more)
...
Cohesion: 0.04
Nodes (46): _applyDecision, bucket0, bucket1, bucket2, _BucketProgressBar, _canRedo, _canUndo, _cardKey (+38 more)
...
Cohesion: 0.04
Nodes (51): _allDayFocusNode, build, _buildPayload, _calendarFlagColor, _calendarId, calendars, _closingAfterSave, _colorValue (+43 more)
...
Cohesion: 0.03
Nodes (65): analyticsServiceProvider, formatTime12Hour, formatTimeOfDay12Hour, jm, local, now, build, _closingAfterSave (+57 more)
...
Cohesion: 0.03
Nodes (68): allSegments, buildExerciseHistory, byDay, colorValue, completed, completedAt, copyWith, count (+60 more)
...
Cohesion: 0.04
Nodes (44): LeetCodeSolution? get, algorithm, byCreated, bySolved, code, codeLanguage, compareLeetCodeProblemsNewestFirst, copyWith (+36 more)

### Community 156 - "Scope Switcher — scope_switcher"
Cohesion: 0.04
Nodes (47): Archive, DriftMediaRepository, MediaRepository, archive, backupFormatVersion, backupManifestFileName, backupMediaDirectory, buildArchiveContents (+39 more)

### Community 157 - "Firebase Auth (windows) — firebase_auth_plugin.cpp"
Cohesion: 0.05
Nodes (46): ackedAt, armedAt, at, body, copyWith, createdAt, deliveryStateId, detail (+38 more)

### Community 158 - "Shared Widgets — voyager_toast"
Cohesion: 0.04
Nodes (50): Duration? dwell,
  Duration, IconData? icon,
  List, actions, build, _contrast, _controller, createState, didChangeAppLifecycleState (+42 more)
...
Cohesion: 0.06
Nodes (31): AccessibilityMode, GpuPreference, _In_, _In_opt_, UIThreadPolicy, FlutterViewId, HWND, LPARAM (+23 more)
...
Cohesion: 0.08
Nodes (23): bool?, LeetCodeProblem? get, buildScratchArea, dispose, _expanding, _expandScratch, flushScratch, focusScratch (+15 more)

### Community 168 - "Domain Models — notification_models"
Cohesion: 0.04
Nodes (47): CalendarEvent, bill, buildNotificationFeed, copyWith, createdAt, _dayKey, days, daysUntil (+39 more)

### Community 169 - "Settings Feature — settingsRepositoryProvider"
Cohesion: 0.04
Nodes (54): AppThemeMode, colorPaletteProvider, build, ColorPickerField, _ColorPickerFieldState, _changeEventColor, _add, _changeEventColor (+46 more)

### Community 170 - "Theming — voyager_theme"
Cohesion: 0.05
Nodes (40): accentLineAmount, accentLineTarget, appBar, blurScale, brightness, _build, card, chartGrid (+32 more)
...
Cohesion: 0.05
Nodes (42): addDropToCurrentSet, cancelRest, collapse, completeCurrentSet, completedCount, copyWith, currentSet, cursor (+34 more)

### Community 175 - "Test Suite — package:voyager/domain/repos"
Cohesion: 0.03
Nodes (56): getOrderedDestinations, icon, index, label, order, OrderedDestination, page, path (+48 more)
...
### Community 181 - "Test Suite — package:voyager/domain/repos"
Cohesion: 0.07
...
Cohesion: 0.04
Nodes (52): _accentBorderWidth, accentColor, barrierColor, barrierDismissible, barrierLabel, box, build, builder (+44 more)
...
Cohesion: 0.06
Nodes (35): RankingStatus, accent, build, category, children, createState, _decoration, _hasProgress (+27 more)
...
Cohesion: 0.05
Nodes (38): _accent, accentColor, anchor, build, _buildCustomPage, _buildPresetPage, _commit, createState (+30 more)
...
Cohesion: 0.04
Nodes (83): entityRemindersProvider, journalEntryCacheInvalidatorProvider, journalWriteCoordinatorProvider, leetCodeApiClientProvider, leetCodeRepositoryProvider, remoteSyncServiceProvider, searchServiceProvider, studyRepositoryProvider (+75 more)
...
Cohesion: 0.05
Nodes (39): appendOperation, appendOperationGroup, appendOperationsBatch, _calendarLock, claimCalendarLock, claimWeatherFetchLock, _collectionWatchers, _currentWeather (+31 more)
...
Cohesion: 0.06
Nodes (35): fakes/input_order_random.dart, package:voyager/features/study/study_cram_page.dart, _cardOffset, cards, container, _deckId, main, now (+27 more)

### Community 204 - "Dev Feature — dev_geometric_wave_tile"
Cohesion: 0.04
Nodes (70): WindowVisibility, _VimFieldOverlay, _VimFieldOverlayState, VimTextScope, _VimTextScopeState, _PalettePickDialog, _PalettePickDialogState, DateTimeSelectorPopover (+62 more)

### Community 205 - "Domain Models — SoftDeletable"
Cohesion: 0.05
Nodes (46): ContributionRoom, AssetValuation, FinancialTransaction, GoalAllocation, applicationId, applicationUrl, archivedAt, categoryId (+38 more)
...
Cohesion: 0.02
Nodes (101): File, package:drift/native.dart, package:voyager/core/widgets/notification_urgency_dot.dart, package:voyager/data/database/app_database.dart, package:voyager/features/analytics/tracker_entry_row.dart, main, close, customStatement (+93 more)

### Community 210 - "Spell Check — voyager_spell_check_service"
Cohesion: 0.06
Nodes (31): _boundaryBackward, _boundaryChar, _boundaryForwardPad, checkIncremental, checkTextSync, _customWords, _dictionary, dictionaryLoaded (+23 more)

### Community 211 - "Shared Widgets — spell_check_squiggle_layer"
Cohesion: 0.10
Nodes (19): AppThemeMode, BillingPeriod, CalendarViewMode, GeometricWaveShape, HeatmapMode, LeetCodeDifficulty, StartupPageMode, TrackerCadence (+11 more)

### Community 212 - "Domain Models — SoftDeletable"
Cohesion: 0.06
Nodes (35): body, byCreated, byDate, colorValue, compareJournalEntriesNewestFirst, copyWith, customQuote, end (+27 more)

### Community 213 - "Domain Services — weather_forecast_merge"
Cohesion: 0.06
...
Cohesion: 0.08
Nodes (24): 10. Implementation sketch (ordered), 11. Open implementation choices (non-blocking), 1. Goals, 2. Non-goals (v1), 3. Product decisions (locked), 4.1 Domain, 4.2 Persistence, 4.3 Suggestion query (+16 more)

### Community 216 - "Uncategorized — Text Snippets (HLD)"
Cohesion: 0.06
...
Cohesion: 0.05
Nodes (38): build, count, LeetCodeTagMatrix, problems, tag, weight, _WeightedTagPill, package:voyager/core/widgets/scroll_offset_isolate.dart (+30 more)
...
Cohesion: 0.02
Nodes (124): CustomPaint, dart:ui, Error, empty, hasImage, hasText, imageBytes, _imageFormats (+116 more)
...
### Community 225 - "Jobs Feature — package:voyager/core/widgets"
Cohesion: 0.06
...
Cohesion: 0.06
Nodes (33): backtickStrings, blockComments, char, charLiterals, closer, _closesAsCharLiteral, _cStyle, false (+25 more)

### Community 230 - "Life Tracker Feature — life_tracker_page"
Cohesion: 0.11
Nodes (28): deviceIdProvider, syncActivityProvider, trackerRepositoryProvider, _commitPendingForDateChange, build, devDisablePetalFieldProvider, devForceOfflineProvider, DevPage (+20 more)
...
Cohesion: 0.05
Nodes (48): mediaServiceProvider, mediaStorageProvider, build, _reload, build, _reload, _reorder, _load (+40 more)
...
Cohesion: 0.05
Nodes (39): brace, _braceDelta, cleaned, containerDepth, delta, depth, _deriveBraces, deriveLeetCodeStarter (+31 more)

### Community 235 - "Settings Feature — settingsRepositoryProvider"
Cohesion: 0.05
Nodes (39): LeetCodeCramPage, LeetCodeSessionPage, package:voyager/domain/models/leetcode_models.dart, package:voyager/features/leetcode/leetcode_cram_page.dart, package:voyager/features/leetcode/leetcode_session_page.dart, main, now, _problem (+31 more)

### Community 236 - "Shell Feature — weather_chart_plot_cache"
Cohesion: 0.08
Nodes (23): active, _barFor, build, _clearHover, compact, createState, difficulty, dimmed (+15 more)
...
Cohesion: 0.09
Nodes (27): Auth, auth::AuthStateListener, auth::IdTokenListener, mutex, StreamHandler<flutter::EncodableValue>, AuthStateStreamHandler, auth_, listener_ (+19 more)

### Community 241 - "Domain Models — leetcode_api_models"
Cohesion: 0.08
Nodes (22): Client, CloudFunctionWeatherClient, _apiKey, DevOpenWeatherClient, _http, _periodFromForecastItem, refreshForecast, refreshWeather (+14 more)

### Community 242 - "Test Suite — leetcode_sync_durability_tes"
Cohesion: 0.05
Nodes (37): Exception, SyncBackpressureException, MediaImageFormat, MediaStoragePermanentFailure, SyncPayloadTooLargeException, bytes, byteSize, contentHash (+29 more)

### Community 243 - "Test Suite — study_session_undo_test"
Cohesion: 0.04
Nodes (59): calendarRepositoryProvider, calendarsProvider, calendarTodoMarkersProvider, calendarViewEventsProvider, googleCalendarSyncProvider, workoutDaysProvider, build, CalendarDayTodoPopover (+51 more)

### Community 244 - "Test Suite — package:voyager/domain/repos"
Cohesion: 0.04
Nodes (43): FadeTransition, package:voyager/features/study/study_deck_workbench_page.dart, package:voyager/features/study/study_page.dart, countCardsReviewedToday, countCardsReviewedTotal, countDueCards, _folder, getFolder (+35 more)

### Community 245 - "Ephemeral — string"
Cohesion: 0.03
Nodes (62): build, _kLeetCodeActivityBreakpoint, _kLeetCodeActivityCardWidth, _kLeetCodeSplitBreakpoint, LeetCodeDashboardHeader, package:voyager/domain/models/enums.dart, package:voyager/features/leetcode/leetcode_activity_calendar.dart, package:voyager/features/leetcode/leetcode_activity_card.dart (+54 more)
...
Cohesion: 0.06
Nodes (33): package:voyager/features/rankings/rankings_edit_panel.dart, package:voyager/features/rankings/rankings_header.dart, package:voyager/features/rankings/rankings_providers.dart, package:voyager/features/rankings/rankings_row.dart, container, db, _dialogTaps, main (+25 more)
...
Cohesion: 0.04
Nodes (47): int?, build, colorValue, tag, TagChip, LeetCodeSolution, anchorRect, build (+39 more)

### Community 251 - "Shared Widgets — notched_field_border"
Cohesion: 0.07
Nodes (27): _attach, back, build, controller, createState, _detach, didUpdateWidget, dispose (+19 more)
...
Cohesion: 0.08
Nodes (27): _AddImageButton, _AddImageButtonState, autofocus, _back, _busy, _cardId, controller, createState (+19 more)

### Community 257 - "Leetcode Feature — leetcode_mini_flashcard"
Cohesion: 0.07
Nodes (26): MessageHandler, MethodCallHandler, BasicMessageChannel, codec_, messenger_, name_, BinaryReply, string (+18 more)

### Community 258 - "Test Suite — study_card_editor_images_tes"
Cohesion: 0.05
Nodes (38): double? contentWidth,
  bool, build, _CreateNameColorDialog, _CreateNameColorDialogState, createState, dispose, initialColor, initState (+30 more)

### Community 259 - "Media Handling — media_image"
Cohesion: 0.04
Nodes (53): class _RenderTagFlow extends RenderBox, accent, accentColor, build, _buildSuggestions, _commit, _contentPadding, _controller (+45 more)

### Community 260 - "Caps Lock — package:flutter/widgets"
Cohesion: 0.05
Nodes (42): Completer, http.BaseClient, SettingsRepository, package:voyager/data/remote/leetcode_api_client.dart, StreamedResponse, _StubSettingsRepository, db, ensureVisible (+34 more)
...
Cohesion: 0.06
Nodes (33): trackerValuesProvider, TrackerValue, build, _buildEditor, _capLabelExtent, _capLabelFontSize, _capLabelGap, _clampInt (+25 more)

### Community 263 - "Domain Models — SoftDeletable"
Cohesion: 0.07
Nodes (28): assetCount, byteSize, collection, contentHash, copyWith, displayWidthPx, documentId, downloadState (+20 more)
...
Cohesion: 0.06
Nodes (31): StudyCard, backImages, build, card, _face, frontImages, keywords, matches (+23 more)
...
Cohesion: 0.03
Nodes (70): Icon, IconButton, byId, refreshed, RepeatIconButton, package:voyager/core/media/widgets/media_gallery_strip.dart, package:voyager/core/widgets/repeat_selector_popover.dart, package:voyager/domain/models/recurrence_rule.dart (+62 more)

### Community 278 - "Shared Widgets — keep_alive_scroll"
Cohesion: 0.05
Nodes (36): DriftFinanceRepository, FinanceRepository, package:voyager/domain/services/contribution_room_writer.dart, package:voyager/features/finance/finance_analytics_view.dart, addAsset, addRoom, contribute, db (+28 more)

### Community 279 - "Firebase Auth (android) — NonNull"
Cohesion: 0.03
Nodes (55): AppTray?, HotKey?, buildOverscrollIndicator, buildScrollbar, createState, didChangeAppLifecycleState, dispose, _flushAllPendingEdits (+47 more)
...
Cohesion: 0.04
Nodes (47): Directory, LeetCodeScratchSession? get, LeetCodeScratchSession, _chain, clear, _deleteQuietly, _file, FileLeetCodeScratchDraftStore (+39 more)
...
Cohesion: 0.02
Nodes (126): ProseSpanBuilder, AutocorrectFlashLayer, _AutocorrectFlashLayerState, _bleed, build, _buildPath, _cachedPath, _cachedSize (+118 more)

### Community 284 - "Shared Widgets — _State"
Cohesion: 0.07
Nodes (26): dispose, _handleLifecycleState, initState, _isVisible, _lifecycle, _lifecycleVisible, _minimized, onWindowBlur (+18 more)

### Community 285 - "Shared Widgets — date_selector_popover"
Cohesion: 0.09
Nodes (21): AppLifecycleListener?, ChangeNotifier, ReminderEngine, _away, _controller, dispose, _focusedSingleLineEditable, _handleFocusChange (+13 more)

### Community 286 - "Leetcode Feature — leetcode_activity_chart"
Cohesion: 0.15
Nodes (12): int? integerCap,
  int, TrackerType, boolValue, defaultInt, enumValue, epoch, integerCap, intValue (+4 more)
...
Cohesion: 0.07
Nodes (28): addExerciseToDay, clearExercisePrescription, createExercise, currentExercise, deleted, deletePlanEntry, exercise, ExerciseDeletion (+20 more)
...
Cohesion: 0.10
Nodes (19): 10. Open follow-ups (not this HLD), 1. Goals, 2. Non-goals, 3. Shortcut policy, 4. Shared helper, 5.1 Rules, 5.2 Per-sheet chains, 5. Finance Enter focus chains (finance-only Enter change) (+11 more)

### Community 291 - "Test Suite — vim_chrome_placement_test"
Cohesion: 0.07
...
Nodes (34): int? current,
  Set, assign, nextColor, palette, PaletteAssigner, paletteFromItems, pickColorFromPalette, pickPaletteColorWithRef (+26 more)

### Community 293 - "Test Suite — package:voyager/domain/repos"
Cohesion: 0.02
Nodes (86): FocusNode, FocusNode get, buildTextSpan, dispose, _emphasis, focusNode, _forward, _markupFor (+78 more)
...
Cohesion: 0.11
Nodes (19): Duration get, _branch, build, children, createState, currentIndex, didChangeDependencies, didUpdateWidget (+11 more)

### Community 296 - "Calendar Feature — calendar_overlap_engine"
Cohesion: 0.06
Nodes (30): double?, build, dark, fill, icon, size, stroke, weatherDuotoneIconData (+22 more)
...
Cohesion: 0.05
Nodes (33): package:voyager/core/constants/todo_sort_constants.dart, package:voyager/core/sync/crdt_document_resolver.dart, package:voyager/domain/models/todo_models.dart, package:voyager/features/todo/todo_list_search.dart, main, db, journalRepo, main (+25 more)
...
Cohesion: 0.47
Nodes (3): TotpSecret, FlutterFirebaseTotpMultiFactor, Override
...
Cohesion: 0.05
Nodes (36): Finder get, package:voyager/core/spellcheck/voyager_spell_check_service.dart, package:voyager/core/widgets/spell_check_squiggle_layer.dart, _editable, _harness, main, _top, combined (+28 more)

### Community 307 - "Shared Widgets — _State"
Cohesion: 0.05
Nodes (35): Duration, build, _buildLayer, children, createState, didChangeDependencies, didUpdateWidget, dispose (+27 more)

### Community 308 - "Test Suite — shell_destinations"
Cohesion: 0.06
Nodes (30): _auth, AuthNotifier, dispose, _isAuthenticated, _subscription, autofocus, build, child (+22 more)
...
### Community 310 - "Firebase Auth (macos) — firebase_auth_messages.g"
Cohesion: 0.08
Nodes (25): <FirebaseAuthHostApi>, -applyActionCodeAppcodecompletion, -checkActionCodeAppcodecompletion, -confirmPasswordResetAppcodenewPasswordcompletion, -createUserWithEmailAndPasswordAppemailpasswordcompletion, -fetchSignInMethodsForEmailAppemailcompletion, -initializeRecaptchaConfigAppcompletion, -registerAuthStateListenerAppcompletion (+17 more)
...
Cohesion: 0.09
Nodes (21): InheritedWidget, MediaPasteOwnerScope, SnippetEnabledScope, SnippetSettingsLauncher, updateShouldNotify, AutocorrectEnabledScope, ProsePasteScope, enabled (+13 more)
...
### Community 318 - "Uncategorized — Two-device sync validation ("
Cohesion: 0.08
...
### Community 319 - "Uncategorized — Saving & Sync Audit"
Cohesion: 0.08
...
### Community 320 - "Test Suite — jobs_track_flow_test"
Cohesion: 0.06
...
### Community 321 - "Uncategorized — Caps Lock Caret Indicator (H"
Cohesion: 0.09
...
Cohesion: 0.03
Nodes (92): ConsumerWidget, activeWorkoutPlanProvider, devLeafGalleryPanelOpenProvider, exercisesProvider, paperShaderProvider, petalFieldParamsProvider, workoutPlanEntriesProvider, workoutPlansProvider (+84 more)

### Community 323 - "Domain Models — int?"
Cohesion: 0.09
Nodes (22): DateTime get, colorValue, completed, copyWith, dueDate, dueDateSetAt, effectiveRecurrenceAnchor, fromJson (+14 more)
...
Cohesion: 0.04
Nodes (52): dart:typed_data, FirebaseStorage, googleOAuthClientId, _googleOAuthClientIdRaw, googleOAuthClientSecret, _googleOAuthClientSecretRaw, googleOAuthRedirectPort, id (+44 more)
...
Cohesion: 0.13
Nodes (16): _createTracker, _editTracker, _handleTap, _HeatmapBucket, _HeatmapBucketState, _heatmapDraggingProvider, _HoverEditPopover, _HoverEditPopoverState (+8 more)
...
Cohesion: 0.05
Nodes (23): ByteBuffer, Retention, Target, FlutterFirebaseTotpSecret, Override, FlutterError, GenerateInterfaces, MultiFactoResolverHostApi (+15 more)

### Community 335 - "Shared Widgets — _State"
Cohesion: 0.04
Nodes (48): VoyagerSpellCheckService, _activeEditRange, build, _cachedSpans, controller, createState, descenderClearance, didChangeDependencies (+40 more)
...
Cohesion: 0.15
Nodes (12): MultiFactorAssertion, MultiFactorResolver, FlutterFirebaseMultiFactor, AuthPigeonFirebaseApp, InternalMultiFactorInfo, InternalMultiFactorSession, InternalPhoneMultiFactorAssertion, InternalUserCredential (+4 more)
...
### Community 339 - "Dev Feature — dev_fps_counter_tile"
Cohesion: 0.07
Nodes (28): Algorithm (v1), Architecture, Autosave, Collapsed session layout, Compare mode, Cram (`LeetCodeCramPage`), Edge cases, Entry points (+20 more)
...
Cohesion: 0.05
Nodes (39): Exercise?, package:voyager/features/workout/exercise_detail_view.dart, container, db, entry, _entryId, exercise, _exerciseId (+31 more)
...
Cohesion: 0.07
Nodes (50): assetRoomEventsProvider, assetsProvider, assetValuationsProvider, budgetsProvider, contributionRoomsProvider, financeCategoriesProvider, tagColorsProvider, transactionsProvider (+42 more)
...
Cohesion: 0.04
Nodes (49): DateTime? asOf,
  List, AssetRoomEvent, Asset, asset, assets, container, counterName, deleteRoomEventWithUndo (+41 more)
...
Cohesion: 0.07
Nodes (27): JournalWriteCoordinator, RemoteSyncService, coordinator, journalRepository, remoteSync, saveEntry, SearchEntrySaveHelper, package:voyager/core/sync/journal_write_coordinator.dart (+19 more)
...
Cohesion: 0.06
Nodes (31): dart:convert, list, loadQuotesFromAssets, raw, CharOpsPayload, applyMergedPayload, applyMergedText, _completeCharOpPayloads (+23 more)
...
Cohesion: 0.13
Nodes (14): ClipRect, VoyagerSpinnerWheel, package:voyager/core/widgets/voyager_spinner_wheel.dart, package:voyager/features/rankings/rankings_score_input.dart, package:voyager/features/rankings/rankings_score_stars.dart, _host, _ignore, main (+6 more)

### Community 358 - "trackerRepositoryProvider"
Cohesion: 0.03
Nodes (86): LeafDesign, _AnalyticsToolbar, _EmptyTrackersCard, _GridView, _HeatmapGroupDivider, _HeatmapMonthTile, _MacroStatsRow, _SectionLabel (+78 more)

### Community 359 - "Remote API Clients — desktop_google_oauth"
Cohesion: 0.05
Nodes (36): at, buffer, composing, formatEditUpdate, i, mapped, normalizeNewlines, NormalizeNewlinesFormatter (+28 more)

### Community 360 - "Remote API Clients — leetcode_content"
Cohesion: 0.07
Nodes (26): @visibleForTesting, renderEditableOf, sync, reconcile, charOpEncodeIsolateThreshold, charOps, CharOpsEncodeRequest, chunks (+18 more)

### Community 361 - "Calendar Feature — calendar_keyboard_shortcuts"
Cohesion: 0.06
Nodes (31): build, CalendarKeyboardShortcuts, _CalendarKeyboardShortcutsState, calendarNavShortcutsEnabled, child, createState, dispose, _handleKeyEvent (+23 more)
...
Cohesion: 0.06
Nodes (30): MediaPasteScope, _MediaPasteScopeState, package:voyager/core/media/widgets/media_drop_target.dart, package:voyager/core/media/widgets/media_fan_stack.dart, package:voyager/core/media/widgets/media_image.dart, main, attach, db (+22 more)
...
Cohesion: 0.04
Nodes (67): build, customQuotesProvider, customWordsProvider, dictionaryProvider, flaggedWordsProvider, journalDebugLoggerProvider, mediaDiskLowProvider, mediaStorageUsageProvider (+59 more)
...
Cohesion: 0.20
Nodes (21): jobApplicationsProvider, jobCategoriesProvider, jobCompaniesProvider, jobSeasonsProvider, jobStagesProvider, build, _CategoriesTab, _CategoriesTabState (+13 more)

### Community 374 - "Leetcode Feature — leetcode_scratch_session"
Cohesion: 0.12
Nodes (16): code, copyWith, endedNormally, expanded, fromJson, hasText, isOrphan, kLeetCodeScratchSessionVersion (+8 more)
...
### Community 379 - "Docs — Flutter toolchain"
Cohesion: 0.12
...
Cohesion: 0.05
Nodes (39): active, _anchorFor, _armed, _arrivedAt, _bounded, completeWith, confirmation, dismiss (+31 more)

### Community 381 - "Shared Widgets — color_picker_field"
Cohesion: 0.03
Nodes (75): DailyFlow, NetFlowSeries, 1, build, busiest, _CalendarHover, _columnsFor, createState (+67 more)
...
Cohesion: 0.07
Nodes (26): 10. Acceptance criteria, 11. Implementation sketch (non-binding), 12. Decision log (this feature), 1. Goals, 2. Non-goals (v1), 3. Product decisions (locked), 4.1 `RankingParent`, 4.2 Normalization (+18 more)
...
### Community 393 - "Uncategorized — Voyager Analytics Page: Comp"
Cohesion: 0.13
...
Cohesion: 0.06
Nodes (31): AppDatabase, DateTime? onceDate,
  List, DriftReminderRepository, ReminderScheduleKind, db, _deviceId, dismiss, dismissed (+23 more)
...
Cohesion: 0.04
Nodes (50): journalRepositoryProvider, journalsProvider, Journal, _confirmDeleteAllEntries, _confirmResetJournals, affectedEntryIds, allJournals, assigner (+42 more)
...
Cohesion: 0.05
Nodes (37): BoxFit, IconData?, asset, borderRadius, byHeight, _bytes, byWidth, color (+29 more)

### Community 402 - "Firebase Auth (android) — NonNull"
Cohesion: 0.12
Nodes (15): Key? dateKey,
  double, alphaBlend, base, build, ChartHoverBubble, chartTooltipBubbleColor, chartTooltipDateStyle, chartTooltipDateValueColumn (+7 more)

### Community 403 - "Firebase Auth (android) — NonNull"
Cohesion: 0.04
Nodes (50): defaultColorPalette, id, OutOfSyncJournalEntryPurge, OutOfSyncJournalEntryTarget, purgeAll, purgeOne, searchHint, targets (+42 more)
...
Cohesion: 0.10
Nodes (25): InternalAdditionalUserInfo, InternalAuthCredential, InternalUserCredential, FromEncodableList, operator==, InternalAuthCredential, access_token, FromEncodableList (+17 more)
...
Cohesion: 0.05
Nodes (60): financeUiPrefsProvider, HotkeyService, authNotifierProvider, backgroundSyncOrchestratorProvider, connectivityStatusProvider, databaseProvider, firestoreWriteGateProvider, journalAllEntryIdsProvider (+52 more)

### Community 412 - "Demo Feature"
Cohesion: 0.05
Nodes (36): GoRouter, Key? get, auth, _preloadedShellPaths, routerProvider, settingsRepo, package:go_router/go_router.dart, package:voyager/core/widgets/desktop_window_frame.dart (+28 more)

### Community 413 - "Uncategorized — Text box widget: `NotchedFie"
Cohesion: 0.13
Nodes (14): Files touched by this migration, How it works, Intentional exception: the inline todo-item rename field, Known limitations / non-goals, `LabeledTextField` (`lib/core/widgets/labeled_text_field.dart`), `TagHighlightedTextField` (`lib/core/widgets/tag_highlighted_text_field.dart`), Text box widget: `NotchedFieldBorder`, The label's half of the gutter (`FieldEdgeFade`) (+6 more)

### Community 414 - "Functions — compilerOptions"
Cohesion: 0.15
...
Cohesion: 0.07
Nodes (23): dart:math, applyStyledRanges, at, base, buildStyledRuns, children, cursor, next (+15 more)
...
Cohesion: 0.03
Nodes (72): package:voyager/core/constants/calendar_constants.dart, package:voyager/core/constants/journal_constants.dart, package:voyager/domain/models/calendar_models.dart, package:voyager/features/calendar/calendar_manage_sheet.dart, package:voyager/features/calendar/calendar_page.dart, calendars, container, db (+64 more)
...
### Community 422 - "Firebase Auth (ios) — CustomPigeonHeader"
Cohesion: 0.26
...
Cohesion: 0.03
Nodes (56): BackdropFilter, BuildContext, ColoredBox, WindowSizeClassX, ModalBarrier, package:voyager/core/widgets/paper_texture.dart, package:voyager/core/widgets/surface_grain.dart, package:voyager/core/widgets/voyager_time_picker_spinner.dart (+48 more)
...
Cohesion: 0.09
Nodes (24): reminderEngineProvider, ReminderSourceView, build, _busy, count, createState, didUpdateWidget, dispose (+16 more)
...
Cohesion: 0.06
Nodes (35): IgnorePointer, arrowsNavigateHistory, build, child, createState, dispose, _enabled, _handleGradeKey (+27 more)
...
### Community 433 - "Firebase Auth (ios) — FLTFirebaseAuthPlugin"
Cohesion: 0.11
...
### Community 444 - "Uncategorized — 2. State Management & Logic "
Cohesion: 0.20
...
### Community 447 - "Jobs"
Cohesion: 0.07
Nodes (28): day, days, hours, local, mins, parts, reminderCadenceLabel, reminderOffsetLabel (+20 more)
...
Cohesion: 0.20
Nodes (10): _CapsLockCaretPainter, VimAnchoredChrome, ClampToTargetBounds, _TapThroughBarrier, _ModalBarrierGuard, ProseHighlightUnderlay, ScrollOffsetFollower, _SingleChildViewport (+2 more)
...
### Community 454 - "Uncategorized — GLASS_BUTTON"
Cohesion: 0.20
Nodes (9): 1. Basic Icon + Text Button (Toolbar / App Header), 2. Custom Size & Recolor (Primary Action), 3. Icon-Only Glass Button, API Reference, File Locations, GlassButton, Key Features, Parameters (+1 more)
...
Cohesion: 0.07
Nodes (29): WeightUnit, formatDisplay, formatKilograms, formatKilogramsWithUnit, fromKilograms, kilogramsForWheelIndex, label, max (+21 more)
...
Cohesion: 0.10
Nodes (36): POINT, HWND, LPARAM, LRESULT, RECT, Size, UINT, wchar_t (+28 more)
...
### Community 460 - "Uncategorized — Rankings — UI/UX Redesign HL"
Cohesion: 0.22
...
Cohesion: 0.05
Nodes (46): Brightness?, DateTimeRange, goalAllocationsProvider, savingsGoalsProvider, SavingsGoal, _AllocateModal, _AllocateModalState, _amountController (+38 more)
...
### Community 466 - "Journal Feature — journal_page"
Cohesion: 0.12
Nodes (15): 1. Product decisions (locked), 2. Goals, 3. Header, 4.1 Trigger actions, 4.2 Rows, 4. Hidden, 5.1 When it fires, 5.2 Lifetime (+7 more)

### Community 467 - "Constants — neetcode150"
Cohesion: 0.25
...
Cohesion: 0.20
Nodes (9): ADR 002: Sync Protocol Boundaries, Amendment: Jobs hard delete (2026-08-22), Consequences, Consequences, Context, Context, Decision, Decision (+1 more)

### Community 473 - "Motion System — AnimationController"
Cohesion: 0.06
Nodes (31): WorkoutPlanEntry, _accept, active, allEntries, build, createState, dayIndex, _edit (+23 more)
...
Cohesion: 0.29
Nodes (7): 15. Implementation checklist, Bugs, Editor, Layout & chrome, List, Menus, Tests

### Community 476 - "Uncategorized — Rankings — UI/UX Redesign HL"
Cohesion: 0.29
...
Cohesion: 0.09
Nodes (23): _Repaint, CapsLockState, DevSettingsController, FpsMonitorController, JournalDebugLogger, PerfStallLogger, TodoSortDebugLogger, begin (+15 more)
...
### Community 479 - "Uncategorized — anagram_test"
Cohesion: 0.33
Nodes (5): list1, list2, main, s1, s2

### Community 480 - "Ephemeral — string"
Cohesion: 0.33
Nodes (5): configureDesktopWindow, desktopWindowChromeActive, _desktopWindowConfigured, package:voyager/core/platform/platform_info.dart, package:window_manager/window_manager.dart

### Community 481 - "Adr — ADR 001: Local-First Data Mo"
Cohesion: 0.33
Nodes (5): ADR 001: Local-First Data Model, Consequences, Context, Decision, Status

### Community 482 - "Adr — ADR 003: Module Structure"
Cohesion: 0.33
Nodes (5): ADR 003: Module Structure, Consequences, Context, Decision, Status

### Community 483 - "Uncategorized — Dream Journal"
Cohesion: 0.33
...
Cohesion: 0.08
Nodes (22): package:voyager/domain/services/search_service.dart, required String title,
  String, support/search_page_harness.dart, entry, _entryId, main, _openEntryDialog, _readEntry (+14 more)

### Community 485 - "Spell Check — word_token"
Cohesion: 0.15
Nodes (12): base, _digit, isCustomWordToken, isKnownWord, normalizeCustomWord, _possessiveBase, runHasDigit, substring (+4 more)

### Community 486 - "Uncategorized — Unified Canvas"
Cohesion: 0.33
Nodes (5): Blossoms, Bucket List Popup, Fallen Leaves, Swing And Bubble, Unified Canvas

### Community 487 - "Shell Feature — weather_chart_plot_cache"
Cohesion: 0.12
Nodes (16): 1. A save whose target and payload came from different owners, 2. A wedged Firestore write queue held the window open, Fixed, Fixed: nothing resumed the drain when the gate reopened, Fixed: the default calendar could never sync, Fixed: the gate had no way back — 2026-09-16, Fixed: the stale-buffer read, Fixed: todo writes that failed in silence (+8 more)

### Community 488 - "Firebase Auth — CHANGELOG"
Cohesion: 0.33
Nodes (6): 0.18.0, `AuthProvider` & `AuthCredential`, `FirebaseAuth`, General, `User`, `UserCredential`

### Community 489 - "Firebase Auth — CHANGELOG"
Cohesion: 0.33
...
Cohesion: 0.08
Nodes (32): class, deviceIdProvider, deviceRegistrationsProvider, reminderOsNotifierProvider, ReminderPermission, build, _ReminderHistoryDialog, _save (+24 more)
...
Cohesion: 0.04
Nodes (48): color, createRenderObject, paint, _paintFill, _paragraphOf, updateRenderObject, package:voyager/core/tags/tag_suggestions.dart, package:voyager/core/text/prose_highlight_paint.dart (+40 more)

### Community 496 - "Core Utilities — journal_tags"
Cohesion: 0.07
Nodes (27): LeetCodeScratchPad, required String title,
  List, addTwo, build, card, _focusPad, id, listProblems (+19 more)
...
### Community 500 - "Uncategorized — TIME_SELECTOR"
Cohesion: 0.40
...
### Community 501 - "Uncategorized — UNIFIED_NOTIFICATIONS"
Cohesion: 0.40
Nodes (4): Additional Notes, Icon UI:, Popover Layout, UX Of Clearing

### Community 502 - "Uncategorized — ANALYTICS_FEEDBACK"
Cohesion: 0.50
Nodes (3): 1. The Sparklines (Consecutive Trackers), 2. The Heatmap Grid, 3. Calendar View

### Community 503 - "Constants — app_constants"
Cohesion: 0.50
Nodes (3): accentBorderAlpha, softDeleteRetentionDays, syncDebounceSeconds

### Community 504 - "Constants — job_constants"
Cohesion: 0.50
Nodes (3): jobDefaultStage, jobSeedCompanies, jobSeedStages

### Community 505 - "Motion System — rubber_band"
Cohesion: 0.50
Nodes (3): magnitude, projectMomentum, rubberBand

### Community 506 - "Core Utilities — all_view_destination"
Cohesion: 0.50
...
Cohesion: 0.50
Nodes (4): 10.1 Image order, 10.2 Lightbox captions, 10.3 Implementation notes, 10. Open gallery (context menu)

### Community 511 - "Uncategorized — Rankings — UI/UX Redesign HL"
Cohesion: 0.50
Nodes (4): 3.1 Hero stats (left of center), 3.2 Status chips (Jobs-style), 3.3 Right side, 3. Stats band

### Community 512 - "Uncategorized — Rankings — UI/UX Redesign HL"
Cohesion: 0.50
Nodes (4): 7.1 Surface treatment, 7.2 Row content, 7.3 Parent context menu (`ContextMenuRegion`), 7. Parent list rows

### Community 513 - "Uncategorized — Rankings — UI/UX Redesign HL"
Cohesion: 0.50
...
Cohesion: 0.15
Nodes (12): from typing import List, package:voyager/features/leetcode/leetcode_scratch_starter.dart, CACHE, main, MinStack, Node, now, _problem (+4 more)
...
Cohesion: 0.06
Nodes (36): @immutable, CacheItemStatus get, CacheItemStatus, CacheStatusSnapshot, ConfettiEffect, SnippetMarks, AutocorrectFlash, EmphasisSpan (+28 more)
...
Cohesion: 0.02
Nodes (102): ByteData, Image, _Await, accent, _anchorKey, _bellHeight, _bellWidth, _controller (+94 more)

### Community 525 - "Uncategorized — Rankings — UI/UX Redesign HL"
Cohesion: 0.67
Nodes (3): 2.1 Two-tier layout (Jobs pattern), 2.2 Category switcher (stats-band), 2. Page chrome

### Community 526 - "Uncategorized — Rankings — UI/UX Redesign HL"
Cohesion: 0.67
Nodes (3): 4.1 Filter popover contents, 4.2 Sort / filter popover bugs (must fix), 4. Toolbar

### Community 527 - "Uncategorized — Rankings — UI/UX Redesign HL"
Cohesion: 0.67
...
Cohesion: 0.12
Nodes (14): FirestorePullService, candidates, filterTransactionOrigins, LedgerTitle, ledgerTransactionTitle, n, needle, o (+6 more)
...
Cohesion: 0.09
Nodes (22): build, _canSave, _colorValue, container, createState, _datePopoverOpen, dispose, existing (+14 more)
...
Cohesion: 0.09
Nodes (35): allDreamEntriesProvider, allJournalEntriesProvider, analyticsServiceProvider, AnalyticsPage, _AnalyticsPageState, build, _buildPage, _calendarViewMonthlyBaseYearProvider (+27 more)
...
Cohesion: 0.05
Nodes (38): package:voyager/features/todo/todo_settings_dialog.dart, SwitchListTile, closeSettings, container, db, _firstId, firstWhere, journals (+30 more)
...
Cohesion: 0.11
Nodes (18): dropdownMenuTheme, _itemHighlightRadius, itemPadding, menuBorderRadius, menuColor, menuColorOf, menuStyle, menuTheme (+10 more)

### Community 550 - "calendar_manage_sheet.dart"
Cohesion: 0.07
Nodes (34): JournalEntry?, journalEntryCacheInvalidatorProvider, JournalRepository, journalRepositoryProvider, JournalWriteCoordinator, journalWriteCoordinatorProvider, _bind, build (+26 more)

### Community 558 - "Drift Database Schema — app_database"
Cohesion: 0.22
Nodes (8): 1. Caret draws past the bottom border, 2. Permanent vertical gaps that do not scroll away, Acceptance checks, Desired behavior, Implementation constraints (for whoever fixes this), Multiline field scroll insets and caret clipping, Relevant code (starting points), Symptoms

### Community 559 - "Drift Database Schema — app_database"
Cohesion: 0.20
...
Cohesion: 0.33
Nodes (6): 3.5 Delimiter reveal reflow, Alternatives considered, Decision: reflow is acceptable, What Obsidian does, When users will notice it, Why it happens

### Community 562 - "Drift Database Schema — app_database"
Cohesion: 0.40
Nodes (5): 2.1 Nesting, 2.2 Unclosed delimiters, 2.3 Parsing precedence, 2.4 List bullets vs italic, 2. Syntax

### Community 563 - "Drift Database Schema — app_database"
Cohesion: 0.40
...
Cohesion: 0.08
Nodes (23): _deviceId, fetchForecastIfNeeded, isCacheStale, isForecastCacheStale, _lockDuration, mergeForecastLocally, _persistCache, _persistForecast (+15 more)
...
Cohesion: 0.09
Nodes (24): WorkoutSetLog, controller, count, createState, _CurrentExerciseTitle, didUpdateWidget, _discard, dispose (+16 more)

### Community 581 - "Drift Database Schema — app_database"
Cohesion: 0.03
Nodes (58): Alignment, bool? enableDrag,
  BorderRadius, BorderRadius, body, build, floatingActionButton, PlatformAdaptiveScaffold, build (+50 more)
...
Cohesion: 0.08
Nodes (24): cachedCurrentWeatherProvider, currentWeatherProvider, build, _controller, createState, didUpdateWidget, dispose, _error (+16 more)

### Community 584 - "MultiFactorUserHostApi"
Cohesion: 0.12
Nodes (20): InternalActionCodeInfoData, InternalActionCodeInfo, unique_ptr, InternalActionCodeInfo, data_, FromEncodableList, Hash, operation_ (+12 more)
...
Cohesion: 0.16
Nodes (18): User, EncodableList, InternalUserCredential, InternalUserDetails, InternalUserInfo, InternalUserProfile, vector, GetPluginConstantsForFirebaseApp (+10 more)

### Community 590 - "leetcode_constants.dart"
Cohesion: 0.10
Nodes (17): WeatherForecast, WeatherSnapshot, refreshForecast, refreshWeather, package:voyager/domain/models/weather_models.dart, package:voyager/domain/services/weather_forecast_merge.dart, forecastCalls, forecastResult (+9 more)

### Community 591 - "Timer?"
Cohesion: 0.11
Nodes (16): publishAsset, publishReference, _remoteSync, assets, captions, collect, context, messenger (+8 more)
...
Cohesion: 0.07
Nodes (26): isExpired, purgeCutoff, purgeEligibleAfter, SoftDeletePolicy, accent, build, createState, destination (+18 more)
...
Cohesion: 0.09
Nodes (29): build, FloaterAppIcon, floaterControllerProvider, build, _closePanel, createState, _datePanelHeight, dispose (+21 more)
...
### Community 607 - "-getFIRAuthCredentialFromArgumentsappcompletion"
Cohesion: 0.24
Nodes (12): -getFIRAuthCredentialFromArgumentsappcompletion, -handleInternalErrorwithError, -handleMultiFactorErrorcompletionwithError, -linkWithCredentialAppinputcompletion, -reauthenticateWithCredentialAppinputcompletion, -sendSignInLinkToEmailAppemailactionCodeSettingscompletion, -signInWithCredentialAppinputcompletion, -signInWithCustomTokenApptokencompletion (+4 more)
...
### Community 613 - "soft_delete_undo_toast_test.dart"
Cohesion: 0.13
...
### Community 616 - "FLTFirebaseAuthPlugin"
Cohesion: 0.13
Nodes (13): package:voyager/features/jobs/job_clipboard_parser.dart, package:voyager/features/jobs/jobs_actions.dart, package:voyager/features/jobs/jobs_stage_colors.dart, main, _application, container, db, ensureSeeded (+5 more)

### Community 617 - "SingleChildLayoutDelegate"
Cohesion: 0.14
...
### Community 618 - "local_overlay_wrapper.dart"
Cohesion: 0.05
Nodes (36): back, cards, front, inBack, lineNumber, lines, normalized, parseStudyBulkImportText (+28 more)

### Community 619 - "package:voyager/core/soft_delete/soft_delete_toast.dart"
Cohesion: 0.10
...
### Community 620 - "dev_remote_purge_tile.dart"
Cohesion: 0.14
...
### Community 621 - "_ExerciseDetailCardState"
Cohesion: 0.14
Nodes (16): Credential, AdditionalUserInfo, EncodableMap, InternalAdditionalUserInfo, map, PhoneAuthCredential, Variant, firebase_auth_windows::FirebaseAuthPlugin::ConvertToEncodableMap() (+8 more)

### Community 622 - "rankingCategoriesProvider"
Cohesion: 0.15
...
### Community 624 - "scroll_offset_isolate.dart"
Cohesion: 0.09
...
### Community 627 - "_PinnedNotesSectionState"
Cohesion: 0.15
Nodes (12): attach, cardId, copyId, db, encodePng, image, main, mediaIds (+4 more)

### Community 628 - "_SuspendingRedoAction"
Cohesion: 0.40
Nodes (5): Action, _SuspendingRedoAction, _SuspendingUndoAction, RedoTextIntent, UndoTextIntent

### Community 629 - "Path?"
Cohesion: 0.05
Nodes (48): lifeTrackerStatsProvider, accentColor, BlossomStatPopup, build, _lineWidth, _padding, painter, stat (+40 more)

### Community 630 - "StateNotifier"
Cohesion: 0.17
...
### Community 632 - "FLTPhoneNumberVerificationStreamHandler"
Cohesion: 0.40
...
### Community 633 - "MultiFactorTotpHostApi"
Cohesion: 0.09
Nodes (32): floaterControllerProvider, autocorrectScopeProvider, devGeometricTexturePanelOpenProvider, devGeometricWavePanelOpenProvider, geometricDebugRowFadeProvider, geometricShaderProvider, geometricTextureParamsProvider, geometricWaveParamsProvider (+24 more)

### Community 634 - "DevSyncBacklogSection"
Cohesion: 0.17
...
### Community 636 - "_SingleChildViewportElement"
Cohesion: 0.24
Nodes (9): financeCaptureDraftProvider, build, createState, FinanceFloater, _FinanceFloaterState, _saved, package:voyager/features/hotkeys/floaters/floater_app_icon.dart, package:voyager/features/hotkeys/floaters/floater_controller.dart (+1 more)

### Community 637 - "-checkActionCodeAppcodecompletion"
Cohesion: 0.50
Nodes (4): -checkActionCodeAppcodecompletion, +operationFromRequestType, -parseActionCode, -resolveActionCodeOperationForAppcodefallbackInfocompletion

### Community 638 - "job_experience_snippet_text_test.dart"
Cohesion: 0.20
...
### Community 639 - "BucketListRepository"
Cohesion: 0.20
...
### Community 644 - "calendarNavigateRightKey"
Cohesion: 0.25
...
### Community 649 - "_TagFlow"
Cohesion: 0.29
Nodes (7): DriftStudyRepository, StudyRepository, _RecordingStudyRepository, _FakeStudyRepository, _FakeStudyRepository, _RecordingStudyRepository, _RecordingStudyRepository

### Community 655 - "_TaskRowState"
Cohesion: 0.33
Nodes (5): CapsLockIndicatorScope, enabled, of, updateShouldNotify, package:voyager/core/caps_lock/caps_lock_state.dart

### Community 656 - "package:voyager/features/workout/workout_placement_prescription_editor.dart"
Cohesion: 0.33
Nodes (5): didChangeAppLifecycleState, didChangeViewFocus, instance, _viewFocused, static final WindowFocusWatcher

### Community 657 - "categoryId"
Cohesion: 0.50
Nodes (5): CustomClipper, _WeekTimedViewportClipper, _TrunkAndBranchesClipper, _LeftFractionClipper, Path?

### Community 658 - "changedAt"
Cohesion: 0.50
Nodes (4): trackersProvider, _AnalyticsSection, _AnalyticsSectionState, _body

### Community 659 - "childDeckId"
Cohesion: 0.50
Nodes (3): package:voyager/core/spellcheck/spell_check_suggestions.dart, dictionary, main

### Community 660 - "childScoreMax"
Cohesion: 0.50
Nodes (3): package:voyager/core/spellcheck/spell_check_tokenizer.dart, main, words

### Community 957 - "<MultiFactorTotpHostApi>"
Cohesion: 0.13
Nodes (13): <MultiFactorTotpHostApi>, -generateSecretSessionIdcompletion, -getAssertionForEnrollmentSecretKeyoneTimePasswordcompletion, -getAssertionForSignInEnrollmentIdoneTimePasswordcompletion, <MultiFactorTotpSecretHostApi>, -generateQrCodeUrlSecretKeyaccountNameissuercompletion, -openInOtpAppSecretKeyqrCodeUrlcompletion, <MultiFactorUserHostApi> (+5 more)
...
### Community 987 - "ParseAdditionalUserInfo"
Cohesion: 0.05
Nodes (41): FirebaseException, classifySyncFailure, describeSyncFailure, _permanentFirestoreCodes, SyncFailureKind, toString, byId, main (+33 more)

### Community 998 - "snippets_dialog.dart"
Cohesion: 0.11
Nodes (17): _Badge, build, createState, _editError, _editingId, label, _newRowId, onEdit (+9 more)
...
### Community 1001 - "media_file_store.dart"
Cohesion: 0.12
Nodes (15): cacheSizeBytes, deleteBytes, deleteBytesForAsset, _explicitRoot, fileFor, fileForAsset, freeSpaceFraction, hasBytes (+7 more)

### Community 1003 - "workout_target_editor.dart"
Cohesion: 0.13
...
### Community 1004 - "workout_test.dart"
Cohesion: 0.07
...
### Community 1006 - "EncodableValue"
Cohesion: 0.14
Nodes (9): any, EncodableValueVariant, partial_ordering, CustomEncodableValue, value_, EncodableValue, optional, T (+1 more)

### Community 1007 - "FlutterWindow"
Cohesion: 0.14
Nodes (13): DartProject, HWND, LPARAM, LRESULT, UINT, FlutterWindow, flutter_controller_, FlutterWindow::FlutterWindow() (+5 more)

### Community 1009 - "jobs_track_draft_store.dart"
Cohesion: 0.08
Nodes (26): clearLog, _enqueue, log, _logFileName, logFilePath, _maxLogBytes, readLog, SyncCompareLogger (+18 more)

### Community 1012 - "spring_motion.dart"
Cohesion: 0.11
Nodes (18): SpringMotion, barrierDismissible, child, createState, dispose, _ExpandingPanel, _expansion, _lastExpanded (+10 more)

### Community 1013 - "package:voyager/core/utils/all_view_destination.dart"
Cohesion: 0.09
Nodes (20): _callbacks, flushAll, instance, PendingFlushRegistry, register, unregister, _activeUntil, idleGrace (+12 more)

### Community 1015 - "jobs_option_list.dart"
Cohesion: 0.04
...
### Community 1018 - "finance_origins_test.dart"
Cohesion: 0.15
Nodes (12): TransactionType, package:voyager/domain/services/finance_origins.dart, at, cents, deletedAt, id, main, note (+4 more)

### Community 1019 - "shell_page_storage_keys.dart"
Cohesion: 0.15
Nodes (12): analyticsList, devList, financeInsights, financeLedgerNarrow, financeLedgerWide, journalEntryList, journalEntryListAll, journalPreview (+4 more)

### Community 1020 - "workout_name_modal.dart"
Cohesion: 0.15
Nodes (13): build, _controller, createState, dispose, hintText, initialValue, showWorkoutNameModal, _submit (+5 more)

### Community 1025 - "dev_weather_api_tile.dart"
Cohesion: 0.07
Nodes (28): AppSettings, _apiKeyController, build, createState, didUpdateWidget, dispose, initState, _save (+20 more)

### Community 1029 - "device_registration.dart"
Cohesion: 0.18
...
### Community 1034 - "connectivity_status_test.dart"
Cohesion: 0.06
Nodes (36): dart:async, cacheStatusSnapshotProvider, devSettingsProvider, FirestoreWriteGate, _scaledMorphDuration, build, CacheStatusOverlay, compact (+28 more)

### Community 1035 - "voyager_icons.dart"
Cohesion: 0.06
Nodes (27): calendar, debug, journal, manage, search, VoyagerIcons, kMinTouchTarget, isCompactWidth (+19 more)

## Knowledge Gaps
- **20102 isolated node(s):** `LifeTrackerCachedStats`, `_fallbackDeviceId`, `kUnresolvedDeviceId`, `_useCloudFunctions`, `_openWeatherApiKey` (+20097 more)
...
- **Why does `ActionCodeInfoOperation` connect `Ephemeral — string` to `Firebase Auth (ios) — firebase_auth_messages.g`, `Firebase Auth (macos) — firebase_auth_messages.g`, `MultiFactorUserHostApi`, `Leetcode Feature — leetcode_activity_data`, `Firebase Auth (android) — NonNull`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `BinaryMessenger` connect `Leetcode Feature — leetcode_mini_flashcard` to `Firebase Auth (android) — Nullable`, `Workout Feature — workout_target_editor`, `calendarNavigateRightKey`, `_SparklineTouchScope`, `Firebase Auth (windows) — messages.g.cpp`, `Ephemeral — string`, `Firebase Auth (windows) — messages.g.cpp`, `Leetcode Feature — leetcode_activity_data`, `Firebase Auth (windows) — firebase_auth_plugin.cpp`, `calendar_overlay_dialog.dart`, `Shared Widgets — _State`, `Firebase Auth (android) — NonNull`, `BucketListRepository`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `InternalActionCodeInfo` connect `Firebase Auth (macos) — firebase_auth_messages.g` to `Ephemeral — string`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **What connects `LifeTrackerCachedStats`, `_fallbackDeviceId`, `kUnresolvedDeviceId` to the rest of the system?**
  _20103 weakly-connected nodes found - possible documentation gaps or missing edges._
