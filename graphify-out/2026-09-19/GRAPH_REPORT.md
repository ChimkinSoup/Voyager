# Graph Report - Voyager  (2026-09-19)

## Corpus Check
- 1095 files · ~1,530,434 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27144 nodes · 42736 edges · 1051 communities (640 shown, 411 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 297 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `288dcfbf`
...
4. `Builder` - 86 edges
5. `settingsProvider` - 79 edges
6. `remoteSyncServiceProvider` - 73 edges
7. `Result` - 73 edges
...
- `main` --references--> `settingsProvider`  [EXTRACTED]
  test/study_card_editor_images_test.dart → lib/app/providers.dart

## Import Cycles
- None detected.

## Communities (1051 total, 411 thin omitted)
...
Cohesion: 0.01
Nodes (270): AnimationStatusListener?, _, CalendarViewMode, _abortMorphAnimation, accentColor, adjacentColor, _advanceWarmup, _appliedSavedCalendarView (+262 more)
...
Cohesion: 0.01
Nodes (249): accentColor, adjacentBorderT, adjacentTextT, alpha, _animatingEventId, available, barHeight, barStride (+241 more)

### Community 6 - "Analytics Feature — analytics_page"
Cohesion: 0.01
Nodes (239): AnalyticsService, accent, _addOption, all, analytics, anchor, anchorDateRect, anchorIndex (+231 more)

### Community 7 - "Sync Engine — remote_sync_service"
Cohesion: 0.01
Nodes (253): CharacterOpRegistry get, _activeDebouncers, _activelyEditedDocuments, addPendingTextMergeListener, _adoptLegacySnippets, applyPendingDreamEntryTextMerge, applyPendingJournalEntryTextMerge, applyPendingTodoTaskNotesMerge (+245 more)

### Community 8 - "Todo Feature — todo_page"
Cohesion: 0.01
Nodes (202): AsyncValue, accent, accentColor, activeCount, _activeInList, _activeMatchKey, _activeSectionHeight, _addingTask (+194 more)

### Community 9 - "Journal Feature — journal_page"
Cohesion: 0.01
Nodes (179): journalListEntriesProvider, accent, accentColor, allEntriesCount, _appliedSavedPreferences, _applySavedPreferencesIfReady, _attachedEntryId, _bodyEntryId (+171 more)

### Community 10 - "Firebase Auth (windows) — messages.g.cpp"
Cohesion: 0.02
Nodes (196): string_view, AuthPigeonFirebaseApp, app_name_, AuthPigeonFirebaseApp::AuthPigeonFirebaseApp(), custom_auth_domain, Hash, set_app_name, set_custom_auth_domain (+188 more)

### Community 11 - "Finance Feature — finance_transaction_modal"
Cohesion: 0.05
Nodes (42): _cramSession, createState, deckId, deckNameHint, _delete, _flipped, folderStack, _IncludedIn (+34 more)
...
Cohesion: 0.02
Nodes (112): dart:io, Directory, _NoScrollbarScrollBehavior, MediaService, publishAsset, publishReference, _remoteSync, MediaFileStore (+104 more)
...
Cohesion: 0.02
Nodes (132): accent, _AnalyticsSection, _AnalyticsSectionState, child, color, _completingNow, _controller, copyWith (+124 more)

### Community 19 - "Journal Feature — journal_page"
Cohesion: 0.01
Nodes (179): ChangeNotifierProvider, AuthNotifier, activeWorkoutSessionProvider, all, allJournalEntriesProvider, allJournalEntriesScope, allTodoTasksProvider, analyticsServiceProvider (+171 more)
...
Cohesion: 0.02
Nodes (124): _alwaysFocused, _applyCaseOverRange, _applyMotion, _applyOperatorRange, _applyValue, _autoIndent, _blockVisualLineHorizontal, _cachedMatches (+116 more)
...
Cohesion: 0.02
Nodes (104): ContextMenuRegionState, _applyPendingNotesMerge, _beginEditingSession, _buildSubtaskList, _clearDueDate, _close, color, _container (+96 more)

### Community 28 - "Study Feature — ConsumerState"
Cohesion: 0.03
Nodes (86): journalEntryCacheInvalidatorProvider, journalRepositoryProvider, journalWriteCoordinatorProvider, searchServiceProvider, createState, DevOutOfSyncPurgeSection, _DevOutOfSyncPurgeSectionState, _lastResults (+78 more)
...
Cohesion: 0.03
Nodes (80): abs, accent, _AnalyticsCard, anchor, _arcMidpoint, asset, _AssetRow, _AssetRowState (+72 more)

### Community 31 - "Firebase Auth (windows) — messages.g.cpp"
Cohesion: 0.03
Nodes (109): InternalActionCodeInfoData, InternalAuthCredentialInput, K, FromEncodableList, operator==, AuthPigeonFirebaseApp, EncodableList, InternalActionCodeInfo (+101 more)

### Community 32 - "Test Suite — jobs_track_flow_test"
Cohesion: 0.01
Nodes (231): @DriftDatabase, DateTime? stamp,
  int, _Device, _FlakySyncRepository, SyncEngine, AppDatabase, InMemorySyncRepository, DriftJournalRepository (+223 more)

### Community 33 - "Journal Feature — journal_list_actions"
Cohesion: 0.12
Nodes (15): AppThemeMode, BillingPeriod, CalendarViewMode, HeatmapMode, StartupPageMode, TrackerCadence, TrackerStyle, WorkoutPlanMode (+7 more)
...
Cohesion: 0.04
Nodes (45): FlutterDesktopMessage, nanoseconds, TextureVariant, ErrorOr, v_, FlutterError, code_, details_ (+37 more)
...
Cohesion: 0.02
Nodes (98): class MockDocumentReference extends, ../test/fakes/fake_weather_api_client.dart, addCustomWord, authStateChanges, batch, batchCreatedCount, batches, bucketListRepo (+90 more)
...
Cohesion: 0.02
Nodes (96): LeetCodeApiQuestion?, LeetCodeCodeController, LeetCodeProblem?, LeetCodeTrackDraft?, LeetCodeTrackDraft? draft,
  LeetCodeTrackDraftOutcome, LeetCodeTrackDraftStore, accentColor, _addExample (+88 more)
...
Cohesion: 0.01
Nodes (152): IconButton, RepeatIconButton, package:voyager/core/media/widgets/media_gallery_strip.dart, package:voyager/core/sync/crdt_document_resolver.dart, package:voyager/core/widgets/repeat_selector_popover.dart, package:voyager/domain/models/recurrence_rule.dart, package:voyager/domain/models/todo_models.dart, package:voyager/features/todo/todo_edit_panel.dart (+144 more)
...
Cohesion: 0.10
Nodes (31): rankingCategoriesProvider, rankingChildrenByParentProvider, rankingParentsProvider, RankingFilters, build, _CategorySettings, _createCategory, _TemplateEditor (+23 more)
...
Cohesion: 0.03
Nodes (74): AutocorrectScopeData, AutocorrectSession?, accentColor, _active, _autocorrectActive, autocorrectAllowed, _autocorrectScope, autocorrectSession (+66 more)
...
Cohesion: 0.03
Nodes (91): ConsumerWidget, activeWorkoutPlanProvider, exercisesProvider, financeCategoriesProvider, jobStatusEventsProvider, leetcodeQuestionCountsProvider, lifeTrackerStatsProvider, paperShaderProvider (+83 more)

### Community 75 - "Test Suite — dart:ui"
Cohesion: 0.02
Nodes (87): Container, DateTime? dateApplied,
  List, package:voyager/features/jobs/jobs_edit_panel.dart, package:voyager/features/jobs/jobs_page.dart, package:voyager/features/jobs/jobs_providers.dart, package:voyager/features/jobs/jobs_table.dart, package:voyager/features/jobs/jobs_track_draft_store.dart, container (+79 more)
...
Cohesion: 0.03
Nodes (65): build, code, _codeContentPadding, _codeDecoration, _codeEditorShortcuts, _codeFocusNode, _codeGutterPad, _codeTextStyle (+57 more)
...
Cohesion: 0.03
Nodes (88): colorPaletteProvider, todoListsProvider, todoRepositoryProvider, _add, createJournalList, _addMinorPetalColor, _PetalSettings, _pickMinorPetalColor (+80 more)
...
Cohesion: 0.01
Nodes (183): fakes/fake_weather_api_client.dart, deleteBudgetWithUndo, deleteSubscriptionWithUndo, softDeleteWithUndo, package:drift/drift.dart, package:flutter_riverpod/flutter_riverpod.dart, package:voyager/app/providers.dart, package:voyager/core/constants/todo_constants.dart (+175 more)

### Community 90 - "Test Suite — scroll_offset_isolate_test"
Cohesion: 0.01
Nodes (205): EditableTextState, Finder get, loadDictionaryFromAssets, raw, srsMasteryColor, copyWith, fieldHintStyle, theme (+197 more)
...
Cohesion: 0.03
Nodes (97): ConsumerState, ConsumerStatefulWidget, leetcodeProblemsProvider, SpringMotion, CalendarEventPanel, _CalendarEventPanelState, CalendarTodoPanel, _CalendarTodoPanelState (+89 more)
...
Cohesion: 0.06
Nodes (36): JournalWriteCoordinator, _bind, build, _controller, _coordinator, createState, _delete, _deleted (+28 more)
...
Cohesion: 0.03
Nodes (68): dart:typed_data, FirebaseStorage, _attempts, _downloadDraining, _downloadOne, _downloadWakeupPending, drain, drainDownloads (+60 more)
...
Cohesion: 0.05
Nodes (41): Completer, http.BaseClient, SettingsRepository, package:voyager/data/remote/leetcode_api_client.dart, StreamedResponse, _StubSettingsRepository, db, ensureVisible (+33 more)
...
Cohesion: 0.05
Nodes (37): Curve, animateTo, controller, defaultSpring, dispose, jumpTo, _spring, stop (+29 more)
...
Cohesion: 0.03
Nodes (57): GoRouter, Key? get, auth, _preloadedShellPaths, settingsRepo, Opacity, package:go_router/go_router.dart, package:voyager/core/motion/modal_scrim_observer.dart (+49 more)
...
Cohesion: 0.07
Nodes (26): LeetCodeDifficulty, active, _barFor, build, _clearHover, compact, createState, difficulty (+18 more)

### Community 122 - "Study Feature — ConsumerState"
Cohesion: 0.03
Nodes (62): build, DevPerfStallLogSection, _logDialogOpen, _showLogDialog, build, count, LeetCodeTagMatrix, problems (+54 more)
...
Cohesion: 0.03
Nodes (79): deviceIdProvider, deviceRegistrationsProvider, reminderLogsProvider, reminderRepositoryProvider, scheduledReminderRulesProvider, thisDeviceRegistrationProvider, initState, reminderOsNotifierProvider (+71 more)

### Community 134 - "Study Feature — ConsumerState"
Cohesion: 0.04
Nodes (46): DateTime? dueAt,
  int, leetCodeRepositoryProvider, confirmed, container, context, copyLeetCodeCode, current, deleteLeetCodeProblem (+38 more)
...
Cohesion: 0.05
Nodes (40): IconData? get, Iterable, buildCatalogMenu, calendarManageMenuEntries, configurableManageMenuEntries, defaultCalendarManageMenuEntries, defaultCatalogMenuChild, defaultConfigurableManageMenuEntries (+32 more)
...
Cohesion: 0.02
Nodes (97): _applyDecision, bucket0, bucket1, bucket2, _BucketProgressBar, _canRedo, _canUndo, _cardKey (+89 more)
...
Cohesion: 0.03
Nodes (63): CalendarEvent, _allDayFocusNode, build, _buildPayload, _calendarFlagColor, _calendarId, calendars, _closingAfterSave (+55 more)
...
Cohesion: 0.04
Nodes (49): double? contentWidth,
  bool, build, contentWidth, _controller, createState, dispose, enterToSubmit, initial (+41 more)
...
Cohesion: 0.05
Nodes (41): startLeetCodeTrackFlow, a, algorithm, b, code, codeLanguage, description, difficulty (+33 more)
...
Cohesion: 0.05
Nodes (42): FirebaseException, classifySyncFailure, describeSyncFailure, _permanentFirestoreCodes, SyncFailureKind, toString, SyncPayloadTooLargeException, android (+34 more)

### Community 163 - "Shared Widgets — datetime_picker_dialog"
Cohesion: 0.03
Nodes (79): ColorScheme, _Host, WindowVisibility, build, _ClockDial, _ClockTimeMode, _ClockTimePicker, _ClockTimePickerState (+71 more)
...
Cohesion: 0.06
Nodes (63): remoteSyncServiceProvider, studyCardImagesProvider, studyCardsProvider, studyDeckByIdProvider, studyDeckStatsProvider, studyRepositoryProvider, StudyDeckLink, _syncServiceOrNull (+55 more)
...
Cohesion: 0.04
Nodes (53): accentLineAmount, accentLineTarget, appBar, blurScale, brightness, _build, card, chartGrid (+45 more)

### Community 171 - "Analytics Feature — analytics_page"
Cohesion: 0.04
Nodes (46): accentColor, alignLabelToTop, allowShortHeight, autocorrectAllowed, autofocus, borderRadius, build, _buildField (+38 more)
...
Cohesion: 0.05
Nodes (44): ActiveWorkoutState, addDropToCurrentSet, cancelRest, collapse, completeCurrentSet, completedCount, copyWith, currentSet (+36 more)

### Community 175 - "Test Suite — package:voyager/domain/repos"
Cohesion: 0.04
Nodes (53): getOrderedDestinations, icon, index, label, order, OrderedDestination, page, path (+45 more)
...
Cohesion: 0.02
Nodes (97): mediaServiceProvider, mediaStorageProvider, accent, accentColor, _AddButton, asset, _assets, build (+89 more)
...
Cohesion: 0.04
Nodes (53): _accentBorderWidth, accentColor, barrierColor, barrierDismissible, barrierLabel, box, build, builder (+45 more)
...
Cohesion: 0.03
Nodes (76): FirebaseAuthMultiFactorException, FirebaseAuthException, JobApplication, RankingStatus, _apply, build, createState, emptyLabel (+68 more)
...
Cohesion: 0.04
Nodes (55): EventRecurrence, IconData?, _accent, accentColor, anchor, build, _buildCustomPage, _buildPresetPage (+47 more)
...
Cohesion: 0.09
Nodes (35): trackerRepositoryProvider, build, devDisablePetalFieldProvider, devForceOfflineProvider, DevPage, devShowTimeSelectorHitboxesProvider, devSlowHeatmapPopoverAnimationProvider, devSlowTodoEditPanelAnimationProvider (+27 more)
...
Cohesion: 0.05
Nodes (36): AppDatabase, MediaFileStore, MediaService, package:voyager/core/media/widgets/media_drop_target.dart, package:voyager/core/media/widgets/media_fan_stack.dart, package:voyager/core/media/widgets/media_image.dart, main, attach (+28 more)

### Community 208 - "Prose Markup — prose_markup"
Cohesion: 0.02
Nodes (113): WeightUnit, Exercise, WorkoutPlanEntry, WorkoutSetLog, controller, count, createState, _CurrentExerciseTitle (+105 more)

### Community 209 - "Sync Engine — outbox_sync_worker"
Cohesion: 0.02
Nodes (144): File, DriftFinanceRepository, FinanceRepository, ListView, package:drift/native.dart, package:voyager/core/constants/job_constants.dart, package:voyager/core/dev/out_of_sync_journal_entry_purge.dart, package:voyager/core/sync/firestore_document_mapper.dart (+136 more)
...
Cohesion: 0.04
Nodes (53): , devGeometricTexturePanelOpenProvider, devGeometricWavePanelOpenProvider, geometricDebugRowFadeProvider, geometricShaderProvider, geometricTextureParamsProvider, geometricWaveParamsProvider, _GeometricBackground (+45 more)
...
Cohesion: 0.01
Nodes (178): CustomPaint, dart:ui, Error, firestoreId, legacyTodoListFirestoreId, legacyTodoListId, localId, todoListDocumentIdForFirestore (+170 more)
...
Cohesion: 0.04
Nodes (50): dart:async, _auth, dispose, _isAuthenticated, _subscription, cacheStatusSnapshotProvider, devSettingsProvider, fpsMonitorProvider (+42 more)
...
Cohesion: 0.10
Nodes (35): build, customWordsProvider, dictionaryProvider, flaggedWordsProvider, saveJobExperienceSnippets, saveSettings, saveSnippets, settingsRepositoryProvider (+27 more)
...
Cohesion: 0.05
Nodes (38): EditableText, LeetCodeRepository, context, focus, isTextInputFocused, subtreeIsVisible, package:voyager/features/leetcode/leetcode_track_modal.dart, button (+30 more)

### Community 236 - "Shell Feature — weather_chart_plot_cache"
Cohesion: 0.07
Nodes (33): authRepositoryProvider, mediaDiskLowProvider, mediaStorageUsageProvider, todoListStatsProvider, build, createState, dispose, _emailController (+25 more)

### Community 237 - "Study Feature — study_flip_card"
Cohesion: 0.06
Nodes (30): AnimationController, Duration get, _branch, build, children, createState, currentIndex, didChangeDependencies (+22 more)
...
Cohesion: 0.06
Nodes (30): AppSettings, _apiKeyController, build, createState, DevWeatherApiTile, _DevWeatherApiTileState, didUpdateWidget, dispose (+22 more)

### Community 242 - "Test Suite — leetcode_sync_durability_tes"
Cohesion: 0.05
Nodes (41): Exception, abortIfAlreadyRestored, floor, RestoreSuperseded, restoreVersionFrom, toString, SyncBackpressureException, MediaImageFormat (+33 more)
...
Cohesion: 0.02
Nodes (101): ClipRect, double? initial,
  int, VoyagerSpinnerWheel, RankingScorePrecision, package:flutter/gestures.dart, package:voyager/core/soft_delete/restore_contract.dart, package:voyager/core/widgets/voyager_spinner_wheel.dart, package:voyager/domain/models/ranking_models.dart (+93 more)
...
Cohesion: 0.03
Nodes (67): _authorizationEndpoint, DesktopGoogleOAuth, redirectUri, _tokenEndpoint, LeetCodeSolution, anchorRect, build, _close (+59 more)
...
Cohesion: 0.02
Nodes (116): DateTimeRange, formatTime12Hour, formatTimeOfDay12Hour, jm, local, now, _amountController, _canSave (+108 more)
...
Cohesion: 0.05
Nodes (36): _AddImageButton, _AddImageButtonState, autofocus, _back, build, _busy, _cardId, _CardSide (+28 more)
...
Cohesion: 0.08
Nodes (25): container, entry, _file, FileQuickJournalPointerStore, journalId, journals, _localDayKey, now (+17 more)
...
Cohesion: 0.06
Nodes (34): trackerValuesProvider, TrackerValue, build, _buildEditor, _capLabelExtent, _capLabelFontSize, _capLabelGap, _clampInt (+26 more)
...
Cohesion: 0.06
Nodes (29): MemoryFinanceUiPrefsStore? prefsStore,
  bool, package:voyager/domain/services/finance_analytics.dart, SegmentedButton, main, tx, centre, container, db (+21 more)

### Community 268 - "Study Feature — ConsumerState"
Cohesion: 0.03
Nodes (82): Card, DateTime? dueAt,
  double, ContextMenuRegion, ContextMenuRegionState, Subscription, LeetCodeProblem, _dueColor, _dueLabel (+74 more)
...
Cohesion: 0.07
Nodes (24): defaultColorPalette, reconcileTagPalette, records, rewritten, paletteColor, resolvePaletteColor, package:voyager/core/utils/journal_tags.dart, package:voyager/domain/repositories/repositories.dart (+16 more)
...
Cohesion: 0.05
Nodes (36): Brightness, Color, build, color, ColorCornerFlag, colorValue, _CornerFlagPainter, JournalBookmarkFlag (+28 more)
...
Nodes (51): DateTime? deletedAt,
  int, package:voyager/core/constants/journal_constants.dart, package:voyager/core/widgets/mood_gradient_slider.dart, package:voyager/core/widgets/tag_highlighted_text_field.dart, support/journal_page_harness.dart, main, _bodyField, countEntriesByJournal (+43 more)

### Community 292 - "Test Suite — scroll_offset_isolate_test"
Cohesion: 0.08
Nodes (24): AppSettings, class, colorPaletteProvider, build, _changeEventColor, _changeEventColor, _addColor, build (+16 more)

### Community 293 - "Test Suite — package:voyager/domain/repos"
Cohesion: 0.04
Nodes (52): FocusNode, VoyagerSpellCheckService, buildTextSpan, dispose, _emphasis, focusNode, _forward, _markupFor (+44 more)
...
Cohesion: 0.07
Nodes (25): DateTime?, StatisticTracker, body, byCreated, byDate, compareDreamEntriesNewestFirst, copyWith, DreamEntry (+17 more)
...
Cohesion: 0.07
Nodes (25): DateTime get, byId, refreshed, colorValue, completed, copyWith, dueDate, dueDateSetAt (+17 more)
...
Cohesion: 0.04
Nodes (52): financeRepositoryProvider, Budget, _detach, _delete, _save, _delete, _duplicate, _logPayment (+44 more)
...
Cohesion: 0.16
Nodes (25): jobApplicationsProvider, jobCategoriesProvider, jobCompaniesProvider, jobSeasonsProvider, jobStagesProvider, build, _CategoriesTab, _CategoriesTabState (+17 more)
...
Cohesion: 0.06
Nodes (32): package:voyager/features/workout/exercise_detail_view.dart, container, db, exercise, _exerciseId, found, main, now (+24 more)
...
Cohesion: 0.13
Nodes (29): assetRoomEventsProvider, assetsProvider, assetValuationsProvider, budgetsProvider, contributionRoomsProvider, tagColorsProvider, transactionsProvider, _BreakdownCard (+21 more)
...
Cohesion: 0.06
Nodes (33): onWindowClose, key, keyToken, modifiers, parseHotKey, parts, _physicalKey, build (+25 more)
...
Cohesion: 0.05
Nodes (38): AsyncNotifier, SettingsNotifier, package:voyager/domain/models/leetcode_models.dart, package:voyager/features/leetcode/leetcode_providers.dart, package:voyager/features/leetcode/leetcode_review_deck.dart, static AppSettings?, _ThemedSettings, main (+30 more)
...
Cohesion: 0.03
Nodes (59): AppLifecycleListener?, configureDesktopWindow, desktopWindowChromeActive, _desktopWindowConfigured, kMainWindowMinimumSize, mainContentOnScreen, _away, _controller (+51 more)

### Community 381 - "Shared Widgets — color_picker_field"
Cohesion: 0.05
Nodes (37): DailyFlow, 90, active, _BubbleRow, build, _clearHover, color, compact (+29 more)
...
Cohesion: 0.05
Nodes (41): BoxFit, mediaTransferWorkerProvider, empty, hasImage, hasText, imageBytes, _imageFormats, isEmpty (+33 more)
...
Cohesion: 0.07
Nodes (26): id, OutOfSyncJournalEntryPurge, OutOfSyncJournalEntryTarget, purgeAll, purgeOne, searchHint, targets, title (+18 more)
...
Cohesion: 0.05
Nodes (56): authNotifierProvider, backgroundSyncOrchestratorProvider, connectivityStatusProvider, databaseProvider, firestoreWriteGateProvider, journalAllEntryIdsProvider, journalEntryCountsProvider, lazyLoadProvider (+48 more)
...
### Community 415 - "Auth"
Cohesion: 0.07
Nodes (32): accent, accentColor, asset, build, collection, count, createState, didUpdateWidget (+24 more)

### Community 416 - "Text — typedef"
Cohesion: 0.06
Nodes (40): studyDeckGraphProvider, studyDecksProvider, studyFoldersProvider, _linkTile, _blocked, build, createState, _link (+32 more)
...
Cohesion: 0.03
Nodes (75): AnimatedContainer, BackdropFilter, BuildContext, ColoredBox, WindowSizeClassX, ModalBarrier, package:voyager/core/theme/voyager_list_item_surface.dart, package:voyager/core/widgets/paper_texture.dart (+67 more)
...
Cohesion: 0.04
Nodes (60): autocorrectScopeProvider, devLeafGalleryPanelOpenProvider, petalFieldParamsProvider, snippetScopeProvider, themeModeProvider, _AppBackground, build, buildOverscrollIndicator (+52 more)
...
Cohesion: 0.06
Nodes (32): CustomPainter, _ConfettiPainter, _VimOverlayPainter, _AutocorrectFlashPainter, _ClockDialPainter, GeometricTexturePainter, _GlassBorderPainter, _LineBreakMarkPainter (+24 more)
...
Cohesion: 0.05
Nodes (37): autoExpand, build, card, createState, dispose, error, focusReplacement, initialTrigger (+29 more)
...
Cohesion: 0.07
Nodes (29): double get, _CapsLockCaretPainter, _RenderCapsLockCaret, RenderVimAnchoredChrome, VimAnchoredChrome, ClampToTargetBounds, RenderClampToTargetBounds, _RenderTapThroughBarrier (+21 more)
...
Cohesion: 0.03
Nodes (66): build, _CreateNameColorDialog, _CreateNameColorDialogState, createState, dispose, initialColor, initState, _nameController (+58 more)
...
Cohesion: 0.02
Nodes (76): narrow_window_harness.dart, package:voyager/core/utils/time_format.dart, package:voyager/domain/models/enums.dart, package:voyager/features/notifications/scheduled_reminders_section.dart, _added, _amount, container, db (+68 more)
...
Cohesion: 0.02
Nodes (125): ByteData, Image, _Await, barrierDismissible, package:voyager/core/theme/voyager_theme.dart, package:voyager/core/utils/ids.dart, package:voyager/core/widgets/notification_urgency_dot.dart, package:voyager/domain/models/analytics_models.dart (+117 more)
...
Cohesion: 0.10
Nodes (29): entityRemindersProvider, initState, _complete, _addSubtask, build, _buildFields, didUpdateWidget, initState (+21 more)
...
Cohesion: 0.14
Nodes (14): RemoteSyncService, _NoopRemoteSync, _NoopRemoteSync, _NoopRemoteSync, _NoopRemoteSync, _NoopRemoteSync, _NoopRemoteSync, _NoopRemoteSync (+6 more)
...
Cohesion: 0.09
Nodes (34): allDreamEntriesProvider, allJournalEntriesProvider, analyticsServiceProvider, AnalyticsPage, _AnalyticsPageState, build, _buildPage, _calendarViewMonthlyBaseYearProvider (+26 more)
...
Cohesion: 0.07
Nodes (41): _VimFieldOverlay, _VimFieldOverlayState, VimTextScope, _VimTextScopeState, ContextualPopoverAccentHost, _ContextualPopoverAccentHostState, RepeatSelectorPopover, _RepeatSelectorPopoverState (+33 more)
...
Cohesion: 0.06
Nodes (44): allTodoTasksProvider, calendarRepositoryProvider, calendarsProvider, calendarViewEventsProvider, devSettingsProvider, googleCalendarSyncProvider, _StatisticDetailPopup, _defaultEventColor (+36 more)
...
Cohesion: 0.15
Nodes (15): hiddenNotificationFeedProvider, _addNote, build, _clearAll, _deleteNote, _FeedSection, _Header, NotificationInboxPopover (+7 more)
...
Cohesion: 0.05
Nodes (40): _darkRestingAlpha, decoration, focusBorderColor, focusShape, hoverColor, _isDark, _restingBorderColor, restingColor (+32 more)
...
Cohesion: 0.03
Nodes (67): Color? highlightColor,
  List, color, createRenderObject, paint, _paintFill, _paragraphOf, updateRenderObject, applyStyledRanges (+59 more)
...
Cohesion: 0.06
Nodes (32): dart:math, applyStyledRanges, at, base, buildStyledRuns, children, cursor, next (+24 more)
...
Cohesion: 0.22
Nodes (10): cachedCurrentWeatherProvider, currentWeatherProvider, syncActivityProvider, build, _SyncActivityIndicator, _WeatherButton, _WeatherButtonState, build (+2 more)
...
Cohesion: 0.06
Nodes (31): _auth, _authErrorMessage, authStateChanges, _controller, currentUserId, dispose, fallback, FirebaseAuthRepository (+23 more)

### Community 620 - "google_auth_config.dart"
Cohesion: 0.18
...
### Community 622 - "journal_constants.dart"
Cohesion: 0.18
...
### Community 629 - "Path?"
Cohesion: 0.07
Nodes (26): _canvasController, createState, dispose, geometry, getClip, _globalCenterFor, _grassColor, _groundedLeavesFor (+18 more)
...
### Community 636 - "local_overlay_wrapper.dart"
Cohesion: 0.22
...
### Community 638 - "voyager_spacing.dart"
Cohesion: 0.22
...
### Community 648 - "_DreamJournalPageState"
Cohesion: 0.29
...
Cohesion: 0.10
Nodes (19): package:voyager/core/text/list_text_editing.dart, package:voyager/core/vim/vim_text_scope.dart, controller, main, _pasteAtEnd, _typeAtEnd, changes, controller (+11 more)
...
### Community 1001 - "dictionary_search_test.dart"
Cohesion: 0.50
...
Cohesion: 0.05
Nodes (42): build, CompactBackBar, label, onBack, accent, appAccent, build, color (+34 more)
...
## Knowledge Gaps
- **20234 isolated node(s):** `Overview`, `Primary`, `Neutral — light theme (paper)`, `Neutral — dark theme (grid)`, `Named Rules` (+20229 more)
...
- **Why does `ActionCodeInfoOperationBox` connect `Firebase Auth (macos) — firebase_auth_messages.g` to `Firebase Auth (android) — NonNull`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **What connects `Overview`, `Primary`, `Neutral — light theme (paper)` to the rest of the system?**
  _20235 weakly-connected nodes found - possible documentation gaps or missing edges._
