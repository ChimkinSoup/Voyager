# Graph Report - Voyager  (2026-09-15)

## Corpus Check
- 1013 files · ~1,402,910 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 25258 nodes · 39891 edges · 990 communities (607 shown, 383 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 297 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `82cc25ff`
...
## Communities (990 total, 383 thin omitted)

### Community 0 - "Drift Database Schema — app_database"
Cohesion: 0.00
Nodes (778): BoolColumn get, _, _accentColorMeta, actualTableName, _addedAtMeta, _alertOnPeriodicPromptsMeta, _alertTimeHourMeta, _algorithmMeta (+770 more)
...
Cohesion: 0.01
Nodes (313): addCustomWord, _applicationCompanion, _categoryCompanion, _childCompanion, _companyCompanion, countCardsReviewedToday, countCardsReviewedTotal, countDueCards (+305 more)

### Community 3 - "Calendar Feature — calendar_page"
Cohesion: 0.01
Nodes (268): AnimationStatusListener?, _, _abortMorphAnimation, accentColor, adjacentColor, _advanceWarmup, _appliedSavedCalendarView, _applySavedCalendarPreferences (+260 more)

### Community 4 - "Repository Interfaces"
Cohesion: 0.01
Nodes (280): addCustomWord, appendOperation, appendOperationGroup, appendOperationsBatch, authStateChanges, claimCalendarLock, claimWeatherFetchLock, countCardsReviewedToday (+272 more)
...
Cohesion: 0.01
Nodes (233): accent, _addOption, all, analytics, anchor, anchorDateRect, anchorIndex, anchorRect (+225 more)

### Community 7 - "Sync Engine — remote_sync_service"
Cohesion: 0.01
Nodes (225): CharacterOpRegistry get, _activeDebouncers, _activelyEditedDocuments, addPendingTextMergeListener, applyPendingDreamEntryTextMerge, applyPendingJournalEntryTextMerge, applyPendingTodoTaskNotesMerge, at (+217 more)

### Community 8 - "Todo Feature — todo_page"
Cohesion: 0.01
Nodes (205): AsyncValue, accent, accentColor, activeCount, _activeInList, _activeMatchKey, _activeSectionHeight, _addingTask (+197 more)
...
Cohesion: 0.02
Nodes (209): GenerateInterfaces, string_view, AuthPigeonFirebaseApp, app_name_, AuthPigeonFirebaseApp::AuthPigeonFirebaseApp(), custom_auth_domain, Hash, set_app_name (+201 more)

### Community 11 - "Finance Feature — finance_transaction_modal"
Cohesion: 0.03
Nodes (79): EditableTextState, FocusNode, package:flutter_code_editor/flutter_code_editor.dart, package:voyager/core/vim/vim_enabled_scope.dart, package:voyager/core/vim/vim_text_overlay.dart, package:voyager/core/vim/vim_text_scope.dart, package:voyager/core/widgets/field_scroll_padding.dart, package:voyager/core/widgets/notched_field_border.dart (+71 more)
...
Cohesion: 0.02
Nodes (96): dart:io, Directory, _NoScrollbarScrollBehavior, MediaService, MediaFileStore, MaterialScrollBehavior, package:image/image.dart, package:voyager/core/media/media_service.dart (+88 more)

### Community 15 - "Sync Engine — firestore_document_mapper"
Cohesion: 0.01
Nodes (189): applicationUrl, assetRoomEventToFirestore, assetToFirestore, assetValuationToFirestore, body, bucketListItemToFirestore, budgetToFirestore, calendarEventToFirestore (+181 more)
...
Cohesion: 0.01
Nodes (152): hiddenNotificationFeedProvider, notificationRepositoryProvider, pinnedNotesProvider, trackersProvider, visibleNotificationFeedProvider, accent, _addNote, _AnalyticsSection (+144 more)

### Community 19 - "Journal Feature — journal_page"
Cohesion: 0.02
Nodes (134): ChangeNotifierProvider, activeWorkoutSessionProvider, all, allJournalEntriesScope, backupCollectionsProvider, bills, brightness, buildBackupCollections (+126 more)

### Community 20 - "Shell Feature — weather_forecast_chart"
Cohesion: 0.02
Nodes (123): allowOverflow, allowVerticalOverflow, axisMaxY, axisMinY, belowPath, bottom, bottomAxisHeight, bucket (+115 more)
...
Cohesion: 0.05
Nodes (44): actionLabel, _ArchivedBanner, categories, category, children, childrenByParent, collapsed, count (+36 more)
...
Cohesion: 0.02
Nodes (100): _applyPendingNotesMerge, _beginEditingSession, _buildFields, _buildSubtaskList, _clearDueDate, _close, color, _container (+92 more)

### Community 28 - "Study Feature — ConsumerState"
Cohesion: 0.03
Nodes (78): defaultColorPalette, JournalWriteCoordinator, paletteColor, resolvePaletteColor, coordinator, journalRepository, remoteSync, saveEntry (+70 more)
...
Cohesion: 0.03
Nodes (105): InternalAuthCredentialInput, K, FromEncodableList, operator==, AuthPigeonFirebaseApp, EncodableList, InternalActionCodeSettings, InternalAdditionalUserInfo (+97 more)

### Community 32 - "Test Suite — jobs_track_flow_test"
Cohesion: 0.01
Nodes (173): @DriftDatabase, File, GlassButton, AppDatabase, DriftSettingsRepository, ListView, package:drift/native.dart, package:fake_cloud_firestore/fake_cloud_firestore.dart (+165 more)
...
Cohesion: 0.02
Nodes (108): allDreamEntriesProvider, dreamRepositoryProvider, dreamWriteCoordinatorProvider, accentColor, _appliedSavedWidth, _bodyEditorKey, _bodyFocusNode, bodyPreview (+100 more)
...
Cohesion: 0.04
Nodes (105): AssetRoomEventsTableCompanion, AssetRoomEventsTableData, AssetsTableCompanion, AssetsTableData, AssetValuationsTableCompanion, AssetValuationsTableData, BucketListItemsTableCompanion, BucketListItemsTableData (+97 more)
...
Cohesion: 0.03
Nodes (60): AnimatedContainer, DateTime? deletedAt,
  int, MoodGradientSlider, package:drift/drift.dart, package:voyager/core/constants/journal_constants.dart, package:voyager/core/constants/todo_constants.dart, package:voyager/core/theme/voyager_list_item_surface.dart, String? applicationUrl,
  List (+52 more)

### Community 42 - "Test Suite — package:flutter_test/flutter"
Cohesion: 0.02
Nodes (96): class MockDocumentReference extends, Exception, MediaStoragePermanentFailure, SyncPayloadTooLargeException, MediaIngestException, BackupFormatException, package:voyager/data/remote/firestore_sync_repository.dart, ../test/fakes/fake_weather_api_client.dart (+88 more)

### Community 43 - "Test Suite — package:flutter_test/flutter"
Cohesion: 0.07
Nodes (26): int? integerCap,
  int, TrackerType, package:voyager/domain/services/analytics_service.dart, analytics, body, _byDay, _entry, entryDate (+18 more)
...
Cohesion: 0.17
Nodes (20): budgetsProvider, financeCategoriesProvider, tagColorsProvider, transactionsProvider, _BreakdownCard, _breakdownFocusProvider, build, _CashFlowCard (+12 more)
...
Cohesion: 0.03
Nodes (63): package:flutter/gestures.dart, package:voyager/features/todo/todo_edit_panel.dart, package:voyager/features/todo/todo_list_search_bar.dart, deleteTaskFromRow, gesture, main, pumpAndSettle, tap (+55 more)
...
Cohesion: 0.05
Nodes (39): ProviderContainer, container, db, _journalA, _journalB, main, readMood, repo (+31 more)
...
Cohesion: 0.03
Nodes (65): Duration, _FakeLeetCodeApi, LeetCodeTrackDraft? draft,
  String?, close, _endpoint, fetchBySlug, fetchMostRecentAcceptedSubmission, fetchQuestionCounts (+57 more)
...
Cohesion: 0.09
Nodes (21): _authorizationEndpoint, DesktopGoogleOAuth, redirectUri, _tokenEndpoint, caption, color, gradientColors, label (+13 more)
...
Cohesion: 0.02
Nodes (87): currentWeatherProvider, package:flutter_riverpod/flutter_riverpod.dart, package:voyager/app/providers.dart, package:voyager/core/soft_delete/restore_contract.dart, package:voyager/domain/models/life_tracker_models.dart, package:voyager/features/calendar/calendar_todo_markers.dart, package:voyager/features/life_tracker/blossom_stat_popup.dart, package:voyager/features/life_tracker/bucket_list_popup.dart (+79 more)

### Community 70 - "Shared Widgets — context_menu"
Cohesion: 0.03
Nodes (63): anchor, _anim, borderRadius, build, _buildRootMenu, _buildSubmenu, capturedThemes, child (+55 more)
...
Cohesion: 0.03
Nodes (59): BackgroundSyncOrchestrator, backoffMultiplier, _bucketListRepository, _calendarRepository, cancelScheduledDocumentSync, _crdtResolver, _debouncer, _debouncerFor (+51 more)
...
Cohesion: 0.02
Nodes (82): formatTime12Hour, formatTimeOfDay12Hour, jm, local, now, RankingsActions, accent, _actions (+74 more)

### Community 75 - "Test Suite — dart:ui"
Cohesion: 0.06
Nodes (39): _cramSession, createState, deckId, deckNameHint, _delete, _duplicate, _flipped, folderStack (+31 more)
...
Cohesion: 0.06
Nodes (32): AsyncNotifier, SettingsNotifier, AppSettings, package:voyager/features/leetcode/leetcode_providers.dart, package:voyager/features/leetcode/leetcode_review_deck.dart, static AppSettings?, _FixedSettings, _FixedSettings (+24 more)
...
Cohesion: 0.11
Nodes (24): autocorrectScopeProvider, devGeometricTexturePanelOpenProvider, geometricDebugRowFadeProvider, geometricShaderProvider, geometricTextureParamsProvider, snippetScopeProvider, themeModeProvider, _AppBackground (+16 more)

### Community 86 - "Todo Feature — todo_list_actions"
Cohesion: 0.03
Nodes (80): authRepositoryProvider, build, createState, dispose, _emailController, _error, _formatAuthError, _googleSignIn (+72 more)

### Community 87 - "Study Feature — ConsumerState"
Cohesion: 0.03
Nodes (106): leetCodeRepositoryProvider, remoteSyncServiceProvider, studyRepositoryProvider, todoListsProvider, todoRepositoryProvider, _syncServiceOrNull, _save, _LeetCodeSessionPageState (+98 more)
...
Cohesion: 0.02
Nodes (150): fakes/fake_weather_api_client.dart, TransactionType, deleteBudgetWithUndo, deleteSubscriptionWithUndo, softDeleteWithUndo, MemoryFinanceUiPrefsStore? prefsStore,
  bool, package:voyager/core/utils/ids.dart, package:voyager/data/remote/in_memory_sync.dart (+142 more)
...
Cohesion: 0.04
Nodes (61): authNotifierProvider, backgroundSyncOrchestratorProvider, connectivityStatusProvider, databaseProvider, deviceIdProvider, lazyLoadProvider, liveSyncProvider, quoteBankProvider (+53 more)
...
Cohesion: 0.05
Nodes (43): brightness, _categoryById, _closePanel, _companyByKey, _CompanyColors, _confirmDelete, _createApplication, createState (+35 more)
...
Cohesion: 0.03
Nodes (56): studyFolderByIdProvider, accentColor, build, _canPop, createState, didUpdateWidget, dispose, _firstSelected (+48 more)
...
Cohesion: 0.06
Nodes (33): RankingStatus, accent, build, category, children, createState, _decoration, _hasProgress (+25 more)

### Community 109 - "Study Feature — ConsumerState"
Cohesion: 0.04
Nodes (54): sessionShuffleRandomProvider, _syncProblems, _syncQueue, _applyDecision, bucket0, bucket1, bucket2, _BucketProgressBar (+46 more)
...
Cohesion: 0.03
Nodes (57): assetRoomEvents, assets, assetValuations, bucketListItems, budgets, calendarEvents, calendars, contributionRooms (+49 more)
...
Cohesion: 0.04
Nodes (51): dart:convert, CrdtDocumentResolver, _merger, _mergeSyncOperations, resolvePayload, SyncEngine, list, loadQuotesFromAssets (+43 more)
...
Cohesion: 0.04
Nodes (54): FocusNode get, buildTextSpan, dispose, _emphasis, focusNode, _forward, _markupFor, overlaySpan (+46 more)
...
Cohesion: 0.07
Nodes (27): BackdropFilter, ColoredBox, package:voyager/core/widgets/paper_texture.dart, package:voyager/core/widgets/voyager_time_picker_spinner.dart, package:voyager/features/jobs/jobs_company_field.dart, required List, _blurSigma, filter (+19 more)

### Community 121 - "Test Suite — todo_page_perf_test"
Cohesion: 0.05
Nodes (37): DateTime? dueAt,
  int, _back, build, createState, _face, _footer, _front, keywords (+29 more)
...
Cohesion: 0.05
Nodes (39): JobsActions get, _actions, category, _CategoryTile, _chain, color, companies, company (+31 more)
...
Cohesion: 0.05
Nodes (34): build, _calendars, _counts, _createCalendar, _createdCalendarId, createdId, createState, _deleteCalendar (+26 more)
...
Cohesion: 0.04
Nodes (54): @DataClassName, @TableIndex, AssetRoomEventsTable, AssetsTable, AssetValuationsTable, BucketListItemsTable, BudgetsTable, CalendarEventsTable (+46 more)

### Community 133 - "Test Suite — leetcode_sync_durability_tes"
Cohesion: 0.04
Nodes (55): FocusOnKeyEventCallback?, InputCounterWidgetBuilder?, accentColor, autocorrectAllowed, autofocus, borderRadius, build, buildCounter (+47 more)
...
Cohesion: 0.24
Nodes (16): assetRoomEventsProvider, assetsProvider, assetValuationsProvider, contributionRoomsProvider, _NetWorthCard, build, _RoomSection, build (+8 more)

### Community 136 - "Study Feature — ConsumerState"
Cohesion: 0.03
Nodes (73): rankingCategoriesProvider, accent, _actions, _active, affected, _all, build, busy (+65 more)
...
Cohesion: 0.04
Nodes (44): alignment, autofocus, borderColor, borderOpacity, borderRadius, borderWidth, canRequestFocus, child (+36 more)
...
Cohesion: 0.04
Nodes (45): _applyDecision, bucket0, bucket1, bucket2, _BucketProgressBar, _canRedo, _canUndo, _cardKey (+37 more)

### Community 147 - "Shared Widgets — _State"
Cohesion: 0.04
Nodes (49): DriftLeetCodeRepository, LeetCodeRepository, package:voyager/features/leetcode/leetcode_track_modal.dart, _FakeLeetCodeRepository, _MutableLeetCodeRepository, button, db, ensureVisible (+41 more)
...
Cohesion: 0.04
Nodes (55): FormField, FormFieldState, InputDecoration?, accentColor, build, createState, decoration, decoratorKey (+47 more)
...
Cohesion: 0.05
Nodes (44): Duration? dwell,
  Duration, IconData? icon,
  List, actions, build, _controller, createState, didChangeAppLifecycleState, didUpdateWidget (+36 more)
...
Cohesion: 0.03
Nodes (122): ConsumerState, ConsumerStatefulWidget, allTodoTasksProvider, calendarViewEventsProvider, jobApplicationsProvider, jobCategoriesProvider, jobCompaniesProvider, jobSeasonsProvider (+114 more)
...
Cohesion: 0.03
Nodes (73): colorPaletteProvider, mediaDiskLowProvider, mediaStorageUsageProvider, build, _changeEventColor, _add, _changeEventColor, build (+65 more)
...
Cohesion: 0.04
Nodes (74): _Host, CapsLockCaretIndicator, _CapsLockCaretIndicatorState, VimTextOverlay, _VimTextOverlayState, _VimFieldOverlay, _VimFieldOverlayState, VimTextScope (+66 more)
...
Cohesion: 0.05
Nodes (41): ActiveWorkoutState, cancelRest, collapse, completeCurrentSet, completedCount, copyWith, currentSet, cursor (+33 more)

### Community 175 - "Test Suite — package:voyager/domain/repos"
Cohesion: 0.04
Nodes (53): rankingParentCountsProvider, Calendar, build, calendars, _checked, createState, host, _others (+45 more)
...
Cohesion: 0.04
Nodes (59): dart:typed_data, FirebaseStorage, _auth, _classify, currentUid, delete, download, FirebaseMediaStorage (+51 more)

### Community 194 - "Shared Widgets — _State"
Cohesion: 0.05
Nodes (42): leetcodeProblemsProvider, leetcodeQuestionCountsProvider, build, build, LeetCodeDashboard, build, LeetCodeProgressRings, after (+34 more)
...
Cohesion: 0.03
Nodes (60): Icon, IconButton, RepeatIconButton, RecurrenceRule, package:voyager/core/widgets/repeat_selector_popover.dart, package:voyager/domain/models/recurrence_rule.dart, package:voyager/domain/todo/todo_recurring_completion.dart, package:voyager/features/calendar/calendar_event_panel.dart (+52 more)
...
Cohesion: 0.05
Nodes (39): AnimationController, Curve, animateTo, controller, defaultSpring, dispose, jumpTo, _spring (+31 more)
...
Cohesion: 0.06
Nodes (49): journalAllEntryIdsProvider, journalEntryCacheInvalidatorProvider, journalEntryCountsProvider, journalListEntriesProvider, journalRepositoryProvider, journalsProvider, journalWriteCoordinatorProvider, quotePoolProvider (+41 more)
...
Cohesion: 0.04
Nodes (47): _append, applySettings, _appStartMarker, bodyDraftEntryIds, bodyFocused, bodyText, clearLog, enabled (+39 more)

### Community 220 - "Autocorrect — autocorrect_flash_layer"
Cohesion: 0.04
Nodes (47): studyAllCardsProvider, studyAllDecksProvider, build, _cramCard, _returnRestoredCard, accent, after, before (+39 more)
...
Cohesion: 0.06
Nodes (33): package:voyager/core/media/widgets/media_drop_target.dart, package:voyager/core/media/widgets/media_fan_stack.dart, package:voyager/core/media/widgets/media_image.dart, package:voyager/core/sync/firestore_collections.dart, main, attach, db, encodePng (+25 more)
...
Cohesion: 0.05
Nodes (46): lifeTrackerStatsProvider, accentColor, BlossomStatPopup, build, _lineWidth, _padding, painter, stat (+38 more)
...
Cohesion: 0.04
Nodes (60): mediaServiceProvider, mediaStorageProvider, build, _reload, build, _reload, _reorder, _load (+52 more)
...
Cohesion: 0.11
Nodes (33): build, customWordsProvider, dictionaryProvider, flaggedWordsProvider, saveSettings, settingsRepositoryProvider, voyagerSpellCheckServiceProvider, build (+25 more)
...
Cohesion: 0.01
Nodes (156): DateTimeRange, build, CompactBackBar, label, onBack, build, child, EnterToSubmitScope (+148 more)
...
Cohesion: 0.12
Nodes (16): AssetRoomEvent, Asset, asset, assets, container, counterName, deleteRoomEventWithUndo, _edit (+8 more)
...
Cohesion: 0.07
Nodes (33): DateFormat, weatherForecastLastDayProvider, weatherForecastProvider, DailyForecastSummary, _populatePlotCacheIdle, build, createState, _DailyCard (+25 more)
...
Cohesion: 0.07
Nodes (30): asset, container, _ContributionRoomModal, _ContributionRoomModalState, createState, _deleteRoom, _detach, dispose (+22 more)
...
Cohesion: 0.12
Nodes (16): Duration get, _branch, build, children, createState, currentIndex, didChangeDependencies, didUpdateWidget (+8 more)
...
Cohesion: 0.07
Nodes (29): allOps, CharacterOpRegistry, CharacterOpSession, clear, clientId, ensureSession, _insertOp, key (+21 more)
...
Cohesion: 0.03
Nodes (58): IconData, int? initialColor,
  String, accentColor, build, child, dense, ellipsize, fillWhenActive (+50 more)
...
Cohesion: 0.03
Nodes (64): DailyFlow, NetFlowSeries, 1, build, busiest, _CalendarHover, _columnsFor, createState (+56 more)

### Community 271 - "Sync Engine — dart:async"
Cohesion: 0.03
Nodes (75): DriftRankingRepository, RankingRepository, narrow_window_harness.dart, package:voyager/domain/models/ranking_models.dart, package:voyager/features/rankings/rankings_edit_panel.dart, package:voyager/features/rankings/rankings_header.dart, package:voyager/features/rankings/rankings_providers.dart, package:voyager/features/rankings/rankings_row.dart (+67 more)
...
Cohesion: 0.03
Nodes (59): FadeTransition, build, QuickJournalPopup, QuickTodoPopup, getOrderedDestinations, icon, index, label (+51 more)
...
Cohesion: 0.04
Nodes (49): AppLifecycleListener?, dispose, _handleLifecycleState, initState, _isVisible, _lifecycle, _lifecycleVisible, _minimized (+41 more)

### Community 285 - "Shared Widgets — date_selector_popover"
Cohesion: 0.03
Nodes (61): Color, accent, build, important, NotificationUrgencyDot, size, accent, build (+53 more)
...
Cohesion: 0.09
Nodes (25): _ActivityDetailCard, _ActivityDetailCardState, anchorRect, _close, _closing, _controller, createState, dispose (+17 more)

### Community 296 - "Calendar Feature — calendar_overlap_engine"
Cohesion: 0.07
Nodes (29): _ContextMenuLayoutDelegate, _SubmenuLayoutDelegate, _PopoverLayoutDelegate, _TextFieldContextMenuLayoutDelegate, VoyagerPopupMenuRouteLayout, _SparklineBubbleLayout, _ChartBubbleLayout, anchor (+21 more)
...
Cohesion: 0.07
Nodes (27): , _advance, build, createState, dispose, _done, _frame, initState (+19 more)
...
Cohesion: 0.12
Nodes (14): cancel, DebouncedCallback, debounceDelay, Debouncer, delay, dispose, schedule, _timer (+6 more)
...
Cohesion: 0.05
Nodes (41): Brightness, goalAllocationsProvider, savingsGoalsProvider, build, color, ColorCornerFlag, colorValue, _CornerFlagPainter (+33 more)

### Community 308 - "Test Suite — shell_destinations"
Cohesion: 0.02
Nodes (89): ByteData, Image, srsMasteryColor, _Await, copyWith, fieldHintStyle, theme, roundedDragProxy (+81 more)
...
Cohesion: 0.04
Nodes (47): FirebaseException, classifySyncFailure, describeSyncFailure, _permanentFirestoreCodes, SyncFailureKind, toString, android, DefaultFirebaseOptions (+39 more)
...
Cohesion: 0.04
Nodes (50): RemoteSyncService, LeetCodeCramPage, LeetCodeSessionPage, package:voyager/features/leetcode/leetcode_cram_page.dart, package:voyager/features/leetcode/leetcode_session_page.dart, _NoopRemoteSync, _NoopRemoteSync, _NoopRemoteSync (+42 more)
...
Cohesion: 0.05
Nodes (38): FirestoreSyncRepository, NoOpSyncRepository, InMemorySyncRepository, SyncRepository, package:voyager/core/sync/synced_write_notifier.dart, package:voyager/domain/services/weather_service.dart, db, main (+30 more)

### Community 333 - "Calendar Feature — calendar_overlap_engine"
Cohesion: 0.03
Nodes (77): loadDictionaryFromAssets, raw, autofocus, build, child, CtrlEnterToSubmitScope, isSubmitChord, key (+69 more)

### Community 334 - "Leetcode Feature — leetcode_activity_data"
Cohesion: 0.10
Nodes (20): double? initial,
  int, RankingScorePrecision, build, _clickOutside, createState, _Host, initial, initState (+12 more)

### Community 335 - "Shared Widgets — _State"
Cohesion: 0.05
Nodes (37): GoRouter, Key? get, auth, _preloadedShellPaths, settingsRepo, package:go_router/go_router.dart, package:voyager/core/motion/modal_scrim_observer.dart, package:voyager/core/widgets/desktop_window_frame.dart (+29 more)
...
Cohesion: 0.07
Nodes (26): DateTime?, StatisticTracker, JournalEntry, build, HeatmapCalendar, month, tracker, values (+18 more)
...
Cohesion: 0.07
Nodes (34): studyDeckGraphProvider, studyDecksProvider, studyFoldersProvider, studyStatsProvider, _linkTile, _blocked, build, createState (+26 more)
...
Cohesion: 0.06
Nodes (34): amountCents, _amountController, container, createState, _date, _datePopoverOpen, dispose, draft (+26 more)
...
Cohesion: 0.05
Nodes (34): accent, chars, formattedDate, formattedTime, paragraphs, readingTimeMin, sentences, showMoveToJournalDialog (+26 more)
...
Cohesion: 0.06
Nodes (32): @visibleForTesting, renderEditableOf, sync, reconcile, restoreIfSelectAll, handleCharacter, build, CalendarKeyboardShortcuts (+24 more)

### Community 362 - "Study Feature — package:voyager/core/motion/"
Cohesion: 0.05
Nodes (42): applyStyledRanges, at, base, buildStyledRuns, children, cursor, next, out (+34 more)
...
Cohesion: 0.02
Nodes (103): CustomPaint, dart:ui, Error, empty, hasImage, hasText, imageBytes, _imageFormats (+95 more)
...
Cohesion: 0.03
Nodes (68): LeetCodeProblem, LeetCodeSolution, anchorRect, build, _close, _closing, _ComplexityTile, _controller (+60 more)

### Community 371 - "Media Handling — media_clipboard"
Cohesion: 0.10
Nodes (28): studyCardImagesProvider, studyCardsProvider, studyDeckByIdProvider, studyDeckStatsProvider, StudyDeckLink, build, build, StudyDeckWorkbenchPage (+20 more)

### Community 372 - "Shared Widgets — create_name_color_dialog"
Cohesion: 0.07
Nodes (25): buildOverscrollIndicator, buildScrollbar, createState, didChangeAppLifecycleState, dispose, _flushAllPendingEdits, getScrollPhysics, initState (+17 more)
...
Cohesion: 0.12
Nodes (27): rankingChildrenByParentProvider, rankingParentsProvider, RankingFilters, build, _pickView, build, _CategoryBody, _closePanel (+19 more)
...
Cohesion: 0.12
Nodes (25): syncActivityProvider, build, devDisablePetalFieldProvider, devForceOfflineProvider, DevPage, devShowTimeSelectorHitboxesProvider, devSlowHeatmapPopoverAnimationProvider, devSlowTodoEditPanelAnimationProvider (+17 more)
...
Cohesion: 0.08
Nodes (22): dart:async, _auth, AuthNotifier, dispose, _isAuthenticated, _subscription, _callbacks, flushAll (+14 more)
...
Cohesion: 0.04
Nodes (45): id, OutOfSyncJournalEntryPurge, OutOfSyncJournalEntryTarget, purgeAll, purgeOne, searchHint, targets, title (+37 more)
...
Cohesion: 0.06
Nodes (31): AppThemeMode, BillingPeriod, CalendarViewMode, HeatmapMode, LeetCodeDifficulty, StartupPageMode, TrackerCadence, TrackerStyle (+23 more)
...
Cohesion: 0.06
Nodes (29): dart:math, nextQuote, QuoteBank, _quotes, _random, _used, axisReservedSize, chars (+21 more)
...
Cohesion: 0.03
Nodes (74): package:voyager/core/constants/calendar_constants.dart, package:voyager/features/calendar/calendar_day_grid.dart, package:voyager/features/calendar/calendar_manage_sheet.dart, package:voyager/features/calendar/calendar_page.dart, package:voyager/features/shell/reveal_request.dart, calendars, container, db (+66 more)

### Community 419 - "Ephemeral — string"
Cohesion: 0.08
Nodes (24): Animation, _animDuration, _barVisible, build, child, _controller, createState, didChangeDependencies (+16 more)
...
Cohesion: 0.05
Nodes (51): ConsumerWidget, activeWorkoutPlanProvider, exercisesProvider, paperShaderProvider, workoutPlanEntriesProvider, workoutPlansProvider, _PaperBackground, build (+43 more)
...
Cohesion: 0.04
Nodes (48): day, event, RevealRequest, RevealTargetType, task, type, package:voyager/domain/models/todo_models.dart, required int done,
  bool (+40 more)
...
Cohesion: 0.09
Nodes (22): DriftJournalRepository, DriftStudyRepository, DriftTodoRepository, StudyRepository, TodoRepository, ThrowingJournalRepository, db, deviceA (+14 more)

### Community 442 - "Settings Feature — settingsRepositoryProvider"
Cohesion: 0.06
Nodes (33): _append, applySettings, clearLog, enabled, _enqueue, _formatAllListsSnapshot, _formatTaskHeader, _formatTaskLine (+25 more)
...
Cohesion: 0.03
Nodes (57): package:voyager/features/jobs/jobs_page.dart, package:voyager/features/jobs/jobs_track_draft_store.dart, application, clipboardText, container, controllerFor, db, ensureSeeded (+49 more)

### Community 457 - "Settings Feature — settingsRepositoryProvider"
Cohesion: 0.08
Nodes (26): CloudFunctionWeatherClient, DevOpenWeatherClient, WeatherForecast, WeatherSnapshot, refreshForecast, refreshWeather, WeatherApiClient, package:voyager/domain/models/weather_models.dart (+18 more)
...
Cohesion: 0.06
Nodes (27): MessageHandler, MethodCallHandler, BasicMessageChannel, codec_, messenger_, name_, BinaryReply, string (+19 more)
...
Cohesion: 0.11
Nodes (17): package:voyager/core/text/list_text_editing.dart, controller, main, _typeAtEnd, changes, controller, key, _keyFor (+9 more)
...
Cohesion: 0.03
Nodes (74): EditableText, context, focus, isTextInputFocused, subtreeIsVisible, package:voyager/core/platform/windows_keyboard_workaround.dart, package:voyager/core/snippets/snippet_enabled_scope.dart, package:voyager/core/snippets/snippet_index.dart (+66 more)
...
Nodes (14): DateTime? recurrenceEndDate,
  String, required DateTime end,
  RecurrenceRule, d, end, exceptionDates, fakeNewId, idCounter, main (+6 more)
...
Cohesion: 0.03
Nodes (55): firestoreId, legacyTodoListFirestoreId, legacyTodoListId, localId, todoListDocumentIdForFirestore, todoListDocumentIdFromFirestore, byId, refreshed (+47 more)
...
Cohesion: 0.13
Nodes (15): SpringMotion, child, createState, dispose, _ExpandingPanel, _expansion, _lastExpanded, reduced (+7 more)
...
Cohesion: 0.13
Nodes (15): _addColor, build, createState, dispose, _hexController, _hexError, _hexFocusNode, palette (+7 more)
...
Cohesion: 0.02
Nodes (118): financeRepositoryProvider, subscriptionsProvider, Budget, Subscription, _save, _detach, _delete, _save (+110 more)
...
Cohesion: 0.20
Nodes (9): CalendarDayEntry, build, CalendarDayEntryBar, date, entry, fontSize, height, onTap (+1 more)
...
Cohesion: 0.13
Nodes (13): _activeUntil, idleGrace, instance, maxWait, noteActivity, ScrollActivityGate, waitUntilIdle, handle (+5 more)
...
Cohesion: 0.04
Nodes (50): build, _kLeetCodeActivityBreakpoint, _kLeetCodeActivityCardWidth, _kLeetCodeSplitBreakpoint, LeetCodeDashboardHeader, package:voyager/features/leetcode/leetcode_activity_bubble.dart, package:voyager/features/leetcode/leetcode_activity_calendar.dart, package:voyager/features/leetcode/leetcode_activity_card.dart (+42 more)
...
Cohesion: 0.07
Nodes (26): DateTime? stamp,
  int, _dreamRepository, DreamWriteCoordinator, _findTask, _journalRepository, _remoteSync, saveEntry, saveTask (+18 more)

### Community 571 - "fractional_index.dart"
Cohesion: 0.02
Nodes (127): LeafDesign, _AnalyticsToolbar, _EmptyTrackersCard, _GridView, _HeatmapGroupDivider, _HeatmapMonthTile, _MacroStatsRow, _SectionLabel (+119 more)
...
### Community 573 - "out_of_sync_journal_entry_purge.dart"
Cohesion: 0.13
...
Cohesion: 0.08
Nodes (21): bool get, BuildContext, googleOAuthClientId, _googleOAuthClientIdRaw, googleOAuthClientSecret, _googleOAuthClientSecretRaw, googleOAuthRedirectPort, id (+13 more)
...
Cohesion: 0.02
Nodes (103): Axis, WeightUnit, Exercise, WorkoutPlanEntry, controller, count, createState, _CurrentExerciseTitle (+95 more)
...
### Community 587 - "desktop_google_oauth.dart"
Cohesion: 0.18
...
### Community 588 - "search_snippet_test.dart"
Cohesion: 0.18
Nodes (10): entry, _entryId, main, _openEntryDialog, _readEntry, _seed, settle, tap (+2 more)
...
### Community 591 - "BinaryMessengerImpl"
Cohesion: 0.50
...
Cohesion: 0.08
Nodes (22): VimSession, package:voyager/core/vim/vim_session.dart, a, b, changesB, focusA, focusB, main (+14 more)

### Community 602 - "CustomClipper"
Cohesion: 0.40
Nodes (6): CustomClipper, _ViewportClipper, _WeekTimedViewportClipper, _TrunkAndBranchesClipper, _LeftFractionClipper, Path?

### Community 603 - "geometric_texture_settings.dart"
Cohesion: 0.33
...
### Community 606 - "<MultiFactorUserHostApi>"
Cohesion: 0.33
...
### Community 611 - "calendarTodoMarkersProvider"
Cohesion: 0.67
Nodes (3): calendarTodoMarkersProvider, build, CalendarDayTodoPopover

### Community 630 - "TextStyle"
Cohesion: 0.05
...
## Knowledge Gaps
- **18763 isolated node(s):** `s`, `ops`, `pos`, `main`, `s1` (+18758 more)
...
- **Why does `ActionCodeInfoOperation` connect `Auth` to `Firebase Auth (ios) — firebase_auth_messages.g`, `Firebase Auth (macos) — firebase_auth_messages.g`, `Test Suite — vim_chrome_placement_test`, `Firebase Auth (ios) — firebase_auth_messages.g`, `Firebase Auth (android) — NonNull`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `InternalActionCodeInfo` connect `Firebase Auth (macos) — firebase_auth_messages.g` to `_TaskRowState`, `Auth`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `ActionCodeInfoOperationBox` connect `Firebase Auth (macos) — firebase_auth_messages.g` to `_TaskRowState`, `Auth`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **What connects `s`, `ops`, `pos` to the rest of the system?**
  _18764 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Drift Database Schema — app_database` be split into smaller, more focused modules?**
  _Cohesion score 0.0025673940949935813 - nodes in this community are weakly interconnected._
