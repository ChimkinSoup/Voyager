...
## Corpus Check
- 1018 files · ~1,409,831 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 25421 nodes · 40082 edges · 977 communities (594 shown, 383 thin omitted)
...
## Communities (977 total, 383 thin omitted)
...
Cohesion: 0.01
Nodes (227): CharacterOpRegistry get, _activeDebouncers, _activelyEditedDocuments, addPendingTextMergeListener, applyPendingDreamEntryTextMerge, applyPendingJournalEntryTextMerge, applyPendingTodoTaskNotesMerge, at (+219 more)

### Community 8 - "Todo Feature — todo_page"
Cohesion: 0.01
Nodes (214): AsyncValue, accent, accentColor, activeCount, _activeInList, _activeMatchKey, _activeSectionHeight, _addingTask (+206 more)

### Community 9 - "Journal Feature — journal_page"
Cohesion: 0.01
Nodes (177): JournalDebugLogger?, JournalEntry?, JournalRepository?, JournalWriteCoordinator?, accent, accentColor, allEntriesCount, _appliedSavedPreferences (+169 more)
...
Cohesion: 0.02
Nodes (114): EditableText, EditableTextState, FocusNode, context, focus, isTextInputFocused, subtreeIsVisible, package:voyager/core/platform/windows_keyboard_workaround.dart (+106 more)
...
Cohesion: 0.02
Nodes (164): dart:io, dart:typed_data, Directory, MediaService, publishAsset, publishReference, _remoteSync, MediaImage (+156 more)
...
Cohesion: 0.01
Nodes (139): ChangeNotifierProvider, activeWorkoutSessionProvider, all, allJournalEntriesScope, backupCollectionsProvider, bills, brightness, buildBackupCollections (+131 more)
...
Cohesion: 0.08
Nodes (29): activeWorkoutPlanProvider, exercisesProvider, workoutPlanEntriesProvider, workoutPlansProvider, WorkoutPlan, build, _dateForDay, entries (+21 more)
...
Cohesion: 0.02
Nodes (103): _applyPendingNotesMerge, _beginEditingSession, build, _buildFields, _buildSubtaskList, _clearDueDate, _close, color (+95 more)

### Community 28 - "Study Feature — ConsumerState"
Cohesion: 0.03
Nodes (61): defaultColorPalette, paletteColor, resolvePaletteColor, _accentColor, _activeQuery, _baseline, body, _bodyController (+53 more)
...
Cohesion: 0.02
Nodes (97): financeCategoriesProvider, transactionsProvider, abs, accent, _AnalyticsCard, anchor, _arcMidpoint, asset (+89 more)
...
Cohesion: 0.04
Nodes (63): dart:convert, FirebaseException, SyncEngine, InMemorySyncRepository, list, loadQuotesFromAssets, raw, package:voyager/core/sync/crdt_document_resolver.dart (+55 more)

### Community 33 - "Journal Feature — journal_list_actions"
Cohesion: 0.07
Nodes (30): DriftJournalRepository, JournalRepository, ThrowingJournalRepository, _bodyField, countEntriesByJournal, countEntriesCalls, _CountingJournalRepository, _delegate (+22 more)
...
Cohesion: 0.02
Nodes (106): DreamEntry?, accentColor, _appliedSavedWidth, _bodyEditorKey, _bodyFocusNode, bodyPreview, _buildEditorArea, _buildEntryList (+98 more)
...
Cohesion: 0.03
Nodes (91): studyDecksProvider, studyFoldersProvider, studyStatsProvider, _blocked, build, createState, _link, _linking (+83 more)
...
Cohesion: 0.02
Nodes (85): LeetCodeDifficulty, description, difficulty, easy, examples, hard, LeetCodeQuestionCounts, medium (+77 more)
...
Cohesion: 0.05
Nodes (78): journalEntryCacheInvalidatorProvider, journalListEntriesProvider, journalRepositoryProvider, journalsProvider, journalWriteCoordinatorProvider, leetCodeRepositoryProvider, remoteSyncServiceProvider, searchServiceProvider (+70 more)
...
Cohesion: 0.02
Nodes (99): AnimatedContainer, DateTime? deletedAt,
  int, MoodGradientSlider, package:drift/drift.dart, package:flutter/gestures.dart, package:flutter_test/flutter_test.dart, package:voyager/core/constants/journal_constants.dart, package:voyager/core/constants/todo_constants.dart (+91 more)
...
Cohesion: 0.04
Nodes (52): AppThemeMode, BackdropFilter, ColoredBox, barrierDismissible, ModalBarrier, package:voyager/core/theme/voyager_theme.dart, package:voyager/core/widgets/notched_field_border.dart, package:voyager/core/widgets/paper_texture.dart (+44 more)
...
Cohesion: 0.02
Nodes (89): @DriftDatabase, _Device, AppDatabase, DriftSettingsRepository, ListView, package:fake_cloud_firestore/fake_cloud_firestore.dart, package:voyager/core/sync/outbox_sync_worker.dart, package:voyager/core/widgets/snippet_editor.dart (+81 more)
...
Cohesion: 0.03
Nodes (70): fakes/fake_weather_api_client.dart, package:voyager/core/soft_delete/restore_contract.dart, package:voyager/data/remote/in_memory_sync.dart, package:voyager/features/finance/finance_page.dart, package:voyager/features/rankings/rankings_actions.dart, package:voyager/features/search/search_page.dart, package:voyager/features/shell/shell_page_storage_keys.dart, container (+62 more)

### Community 75 - "Test Suite — dart:ui"
Cohesion: 0.03
Nodes (65): _chain, clear, _deleteQuietly, draft, _draftFileName, _file, FileJobsTrackDraftStore, JobsTrackDraftStore (+57 more)
...
Cohesion: 0.05
Nodes (41): authRepositoryProvider, mediaDiskLowProvider, mediaStorageUsageProvider, todoListStatsProvider, build, createState, dispose, _emailController (+33 more)

### Community 78 - "Study Feature — ConsumerState"
Cohesion: 0.04
Nodes (49): package:voyager/core/constants/todo_sort_constants.dart, package:voyager/core/media/widgets/media_gallery_strip.dart, package:voyager/domain/models/todo_models.dart, package:voyager/features/todo/todo_list_search.dart, main, db, journalRepo, main (+41 more)
...
Cohesion: 0.02
Nodes (119): DriftFinanceRepository, TransactionType, FinanceRepository, deleteBudgetWithUndo, deleteSubscriptionWithUndo, softDeleteWithUndo, MemoryFinanceUiPrefsStore? prefsStore,
  bool, package:voyager/core/utils/ids.dart (+111 more)
...
Cohesion: 0.03
Nodes (108): JobsActions get, jobApplicationsProvider, jobCategoriesProvider, jobCompaniesProvider, jobSeasonsProvider, jobStagesProvider, _actions, build (+100 more)
...
Cohesion: 0.04
Nodes (47): buildOverscrollIndicator, buildScrollbar, createState, didChangeAppLifecycleState, dispose, _flushAllPendingEdits, getScrollPhysics, initState (+39 more)

### Community 113 - "Runner — win32_window.cpp"
Cohesion: 0.03
Nodes (60): ClipRect, double? initial,
  int, VoyagerSpinnerWheel, RankingFieldValue, RankingScorePrecision, RankingTemplateField, accent, accentColor (+52 more)
...
Cohesion: 0.03
Nodes (61): firestoreId, legacyTodoListFirestoreId, legacyTodoListId, localId, todoListDocumentIdForFirestore, todoListDocumentIdFromFirestore, package:voyager/domain/services/fractional_index.dart, return (+53 more)

### Community 116 - "Test Suite — package:voyager/domain/repos"
Cohesion: 0.05
Nodes (42): buildTextSpan, dispose, _emphasis, focusNode, _forward, _markupFor, overlaySpan, ProseEditingController (+34 more)
...
Cohesion: 0.02
Nodes (142): FocusNode get, FocusOnKeyEventCallback?, InputCounterWidgetBuilder?, accentColor, alignLabelToTop, allowShortHeight, autocorrectAllowed, autofocus (+134 more)
...
Cohesion: 0.04
Nodes (81): _Host, WindowVisibility, VimTextOverlay, _VimTextOverlayState, _VimFieldOverlay, _VimFieldOverlayState, VimTextScope, _VimTextScopeState (+73 more)
...
Cohesion: 0.06
Nodes (36): animation, build, clampWidth, createState, defaultWidth, didUpdateWidget, _dragging, _dragStartWidth (+28 more)
...
Cohesion: 0.04
Nodes (52): formatTime12Hour, formatTimeOfDay12Hour, jm, local, now, build, _closingAfterSave, _completed (+44 more)
...
Cohesion: 0.10
Nodes (18): JournalWriteCoordinator, coordinator, journalRepository, remoteSync, saveEntry, SearchEntrySaveHelper, package:voyager/core/sync/journal_write_coordinator.dart, package:voyager/core/sync/pending_flush_registry.dart (+10 more)
...
Cohesion: 0.06
Nodes (30): _buffered, _maxBuffered, notify, notifyOne, onWrite, SyncedWriteNotifier, DriftCalendarRepository, CalendarRepository (+22 more)
...
Cohesion: 0.04
Nodes (49): colorPaletteProvider, build, _changeEventColor, _add, _changeEventColor, pickAccentColor, _addMinorPetalColor, _controller (+41 more)
...
Cohesion: 0.04
Nodes (51): JobApplication, jobStatusEventsProvider, accentColor, application, applicationId, build, _commit, companies (+43 more)
...
Cohesion: 0.03
Nodes (65): Axis, budgetsProvider, tagColorsProvider, WorkoutPlanEntry, budget, BudgetPanel, _BudgetRow, build (+57 more)
...
Cohesion: 0.07
Nodes (29): accentColor, build, createState, emptyColor, fill, filledColor, fraction, _gap (+21 more)
...
Cohesion: 0.05
Nodes (47): TrackerValue, ContributionRoom, AssetValuation, FinancialTransaction, GoalAllocation, applicationId, applicationUrl, archivedAt (+39 more)
...
Cohesion: 0.06
Nodes (31): Curve, double? get, animateTo, controller, defaultSpring, dispose, jumpTo, _spring (+23 more)
...
Cohesion: 0.07
Nodes (39): autocorrectScopeProvider, devGeometricTexturePanelOpenProvider, devGeometricWavePanelOpenProvider, devLeafGalleryPanelOpenProvider, geometricDebugRowFadeProvider, geometricShaderProvider, geometricTextureParamsProvider, geometricWaveParamsProvider (+31 more)
...
Cohesion: 0.02
Nodes (99): CustomPaint, empty, hasImage, hasText, imageBytes, _imageFormats, isEmpty, isImageOnly (+91 more)
...
Cohesion: 0.05
Nodes (34): applySettings, devForceConflictUi, disableCache, loadFromSettings, _persist, setDevForceConflictUi, setDisableCache, setShowCacheStatus (+26 more)
...
Cohesion: 0.04
Nodes (55): DateTimeRange, _amountController, _canSave, container, createState, _date, _datePopoverOpen, dispose (+47 more)
...
Cohesion: 0.03
Nodes (59): Journal, decodeColorPaletteJson, encodeColorPaletteJson, formatColorHex, jsonEncode, normalizeColorValue, normalized, paletteContains (+51 more)
...
Cohesion: 0.08
Nodes (25): LeetCodeProblem, LeetCodeSolution, _BackSolution, _backTitleKey, _cardRadius, controller, createState, _frontTitleKey (+17 more)

### Community 248 - "Domain Models — int?"
Cohesion: 0.05
Nodes (36): dart:async, _capName, clusters, deletedMessage, _guarded, hiddenMessage, _HideStreak, keys (+28 more)
...
Cohesion: 0.08
Nodes (23): Brightness, SavingsGoal, allocatedCents, _EmptyGoals, goal, _GoalCard, _milestoneLabel, onCreate (+15 more)
...
Cohesion: 0.05
Nodes (38): AnimationController, Duration get, _branch, build, children, createState, currentIndex, didChangeDependencies (+30 more)
...
Nodes (146): DateTime? stamp,
  int, File, package:drift/native.dart, package:path/path.dart, package:voyager/core/sync/firestore_document_mapper.dart, package:voyager/core/tags/tag_palette.dart, package:voyager/data/database/app_database.dart, package:voyager/data/repositories/drift_repositories.dart (+138 more)
...
Cohesion: 0.04
Nodes (51): build, QuickJournalPopup, QuickTodoPopup, getOrderedDestinations, icon, index, label, order (+43 more)
...
Cohesion: 0.33
Nodes (7): CustomClipper, _ViewportClipper, _WeekTimedViewportClipper, _TrunkAndBranchesClipper, _LeftFractionClipper, Path?, Rect
...
Cohesion: 0.05
Nodes (38): FirebaseAuthMultiFactorException, FirebaseAuthException, kCycleWorkoutPlanId, kMaxReps, kMaxSets, kMaxWeightKg, kMaxWeightLb, kStarterExercises (+30 more)

### Community 286 - "Leetcode Feature — leetcode_activity_chart"
Cohesion: 0.04
Nodes (54): int? integerCap,
  int, StatisticTracker, AnalyticsService, booleanTrueCount, completedTasks, countWords, heatmapIntensity, integerSeries (+46 more)
...
Cohesion: 0.09
Nodes (20): , _activeUntil, idleGrace, instance, maxWait, noteActivity, ScrollActivityGate, waitUntilIdle (+12 more)
...
Cohesion: 0.04
Nodes (52): ByteData, Image, _Await, container, db, _displayTextOrigin, _displayTextSize, _editTextOrigin (+44 more)
...
Cohesion: 0.03
Nodes (68): build, createState, DevRemotePurgeSection, _DevRemotePurgeSectionState, dispose, _entryIdController, _purgeEntry, _purging (+60 more)
...
Cohesion: 0.06
Nodes (45): ConsumerWidget, allDreamEntriesProvider, allJournalEntriesProvider, analyticsServiceProvider, periodicPromptServiceProvider, trackerCacheInvalidatorProvider, trackersProvider, trackerValuesProvider (+37 more)
...
Cohesion: 0.02
Nodes (92): dart:ui, Error, colorForTag, extractTags, index, journalTagPattern, kTagPaletteDark, kTagPaletteLight (+84 more)

### Community 334 - "Leetcode Feature — leetcode_activity_data"
Cohesion: 0.12
Nodes (25): rankingChildrenByParentProvider, rankingParentsProvider, RankingFilters, build, _CategoryBody, _closePanel, _createCategory, _createParent (+17 more)

### Community 335 - "Shared Widgets — _State"
Cohesion: 0.11
Nodes (17): package:voyager/features/study/study_session_page.dart, container, db, _deckId, _deleteShownCard, gesture, main, now (+9 more)
...
Cohesion: 0.06
Nodes (37): remoteSyncCompareServiceProvider, syncCompareLoggerProvider, todoSortDebugLoggerProvider, DevFlags, disableCache, disablePetalField, forceOffline, showLifeTrackerRestore (+29 more)
...
Cohesion: 0.04
Nodes (50): FirestorePullService, RemoteSyncService, package:voyager/core/sync/remote_sync_service.dart, package:voyager/features/leetcode/leetcode_page.dart, package:voyager/features/leetcode/leetcode_track_draft_store.dart, RenderObject?, _background, _boundaryKey (+42 more)
...
Cohesion: 0.05
Nodes (56): assetRoomEventsProvider, assetsProvider, assetValuationsProvider, contributionRoomsProvider, AssetRoomEvent, Asset, _NetWorthCard, _asOf (+48 more)
...
Cohesion: 0.04
Nodes (75): allDreamEntriesProvider, allTodoTasksProvider, dreamRepositoryProvider, dreamWriteCoordinatorProvider, journalAllEntryIdsProvider, journalDebugLoggerProvider, journalEntryCacheInvalidatorProvider, journalEntryCountsProvider (+67 more)
...
Cohesion: 0.02
Nodes (89): DateTime? dueAt,
  double, StudyDeckLink, _cramSession, createState, deckId, deckNameHint, _delete, _flipped (+81 more)
...
Cohesion: 0.03
Nodes (60): build, CompactBackBar, label, onBack, build, child, EnterToSubmitScope, onSubmit (+52 more)
...
Cohesion: 0.29
Nodes (7): DocumentReference, FirebaseFirestore, Fake, MockDocumentReference, MockFirebaseFirestore, MockFirestoreBatch, WriteBatch

### Community 365 - "dev_fps_counter_tile.dart"
Cohesion: 0.06
Nodes (31): accent, color, createState, didChangeDependencies, dispose, _formatRemaining, _LiveDot, _LiveDotState (+23 more)

### Community 366 - "Firebase Auth (ios) — CustomPigeonHeader"
Cohesion: 0.04
Nodes (52): narrow_window_harness.dart, package:voyager/domain/models/ranking_models.dart, package:voyager/features/rankings/rankings_edit_panel.dart, package:voyager/features/rankings/rankings_header.dart, package:voyager/features/rankings/rankings_providers.dart, package:voyager/features/rankings/rankings_row.dart, container, db (+44 more)
...
Cohesion: 0.09
Nodes (20): appSettingsWithGeometricTextureParams, appSettingsWithGeometricWaveParams, copyWith, geometricTextureParamsFromSettings, geometricWaveParamsFromSettings, CharOpsPayload, applyMergedPayload, applyMergedText (+12 more)
...
Cohesion: 0.12
Nodes (16): MediaAsset, asset, _assets, build, createState, documentId, _GridTile, initState (+8 more)
...
Cohesion: 0.03
Nodes (83): currentWeatherProvider, accent, _anchorKey, _bellHeight, _bellWidth, _controller, createState, dispose (+75 more)
...
Cohesion: 0.05
Nodes (35): VoyagerSpellCheckService, package:voyager/core/widgets/spell_check_squiggle_layer.dart, package:voyager/core/widgets/tag_highlighted_text_field.dart, RenderParagraph, required String title,
  String, SpellCheckService, support/search_page_harness.dart, body (+27 more)
...
Cohesion: 0.11
Nodes (26): deviceIdProvider, syncActivityProvider, build, _confirmDeleteAllCalendarEvents, devDisablePetalFieldProvider, devForceOfflineProvider, DevPage, devShowTimeSelectorHitboxesProvider (+18 more)
...
Cohesion: 0.03
Nodes (67): double? contentWidth,
  bool, int? initialColor,
  String, journalDebugLoggerProvider, build, createState, dispose, initialColor, initState (+59 more)
...
Cohesion: 0.03
Nodes (57): BoxFit, Color?, double?, asset, borderRadius, byHeight, _bytes, byWidth (+49 more)
...
Cohesion: 0.12
Nodes (15): _dreamRepository, DreamWriteCoordinator, _findTask, _journalRepository, _remoteSync, saveEntry, saveTask, _todoRepository (+7 more)

### Community 411 - "Shared Widgets — confirm_dialog"
Cohesion: 0.06
Nodes (48): authNotifierProvider, backgroundSyncOrchestratorProvider, connectivityStatusProvider, databaseProvider, lazyLoadProvider, liveSyncProvider, mediaTransferWorkerProvider, quotesLoadedProvider (+40 more)

### Community 412 - "Demo Feature"
Cohesion: 0.04
Nodes (50): GoRouter, Key? get, auth, _preloadedShellPaths, settingsRepo, package:fake_async/fake_async.dart, package:go_router/go_router.dart, package:voyager/core/motion/modal_scrim_observer.dart (+42 more)
...
### Community 415 - "Auth"
Cohesion: 0.14
Nodes (27): build, customWordsProvider, dictionaryProvider, flaggedWordsProvider, saveSettings, settingsRepositoryProvider, voyagerSpellCheckServiceProvider, build (+19 more)

### Community 416 - "Text — typedef"
Cohesion: 0.10
Nodes (18): dart:math, axisReservedSize, chars, compactNumberLabel, intervals, magnitude, magnitudeSuffixes, mantissa (+10 more)

### Community 417 - "Settings Feature — package:voyager/domain/model"
Cohesion: 0.04
Nodes (50): _attachedToastDwell, attachImagesForOwner, count, facet, fileStore, images, pickImageFiles, result (+42 more)

### Community 418 - "Shell Feature — shell_page_storage_keys"
Cohesion: 0.02
Nodes (94): Icon, package:voyager/core/constants/calendar_constants.dart, package:voyager/domain/models/calendar_models.dart, package:voyager/features/calendar/calendar_event_panel.dart, package:voyager/features/calendar/calendar_manage_sheet.dart, package:voyager/features/calendar/calendar_page.dart, package:voyager/features/notifications/notification_inbox_popover.dart, package:voyager/features/shell/reveal_request.dart (+86 more)
...
Cohesion: 0.05
Nodes (37): IconData, isExpired, purgeCutoff, purgeEligibleAfter, SoftDeletePolicy, accentColor, build, child (+29 more)
...
Cohesion: 0.06
Nodes (34): package:voyager/domain/models/leetcode_models.dart, package:voyager/features/leetcode/leetcode_detail_view.dart, package:voyager/features/leetcode/leetcode_flashcard.dart, package:voyager/features/leetcode/leetcode_inline_code.dart, String? description,
...
Cohesion: 0.06
Nodes (30): classifySyncFailure, describeSyncFailure, _permanentFirestoreCodes, SyncFailureKind, toString, android, DefaultFirebaseOptions, windows (+22 more)
...
Cohesion: 0.06
Nodes (29): package:voyager/core/constants/job_constants.dart, package:voyager/domain/models/job_models.dart, package:voyager/features/jobs/job_clipboard_parser.dart, package:voyager/features/jobs/jobs_actions.dart, package:voyager/features/jobs/jobs_stage_colors.dart, String? applicationUrl,
  List, String? id,
  String, main (+21 more)
...
Cohesion: 0.03
Nodes (75): financeRepositoryProvider, subscriptionsProvider, FinanceCategory, Subscription, _detach, _delete, _save, BillRadarPanel (+67 more)
...
Cohesion: 0.06
Nodes (34): applyStyledRanges, at, base, buildStyledRuns, children, cursor, next, out (+26 more)
...
Cohesion: 0.07
Nodes (22): BuildContext, calendar, debug, journal, manage, search, VoyagerIcons, kMinTouchTarget (+14 more)
...
Cohesion: 0.05
Nodes (38): CrdtDocumentResolver, _merger, _mergeSyncOperations, resolvePayload, detectDreamEntryConflict, detectJournalEntryConflict, detectTodoTaskConflict, isConflict (+30 more)
...
Cohesion: 0.03
Nodes (104): ConsumerState, ConsumerStatefulWidget, calendarViewEventsProvider, settingsProvider, ColorPickerField, _ColorPickerFieldState, build, canManage (+96 more)
...
### Community 605 - "package:voyager/core/soft_delete/soft_delete_toast.dart"
Cohesion: 0.18
Nodes (10): Exception, abortIfAlreadyRestored, floor, RestoreSuperseded, restoreVersionFrom, toString, MediaStoragePermanentFailure, SyncPayloadTooLargeException (+2 more)
...
### Community 613 - "scroll_offset_isolate.dart"
Cohesion: 0.05
Nodes (41): Alignment, bool? enableDrag,
  BorderRadius, BorderRadius?, accentBorder, alignment, blurSigma, borderRadius, build (+33 more)
...
## Knowledge Gaps
- **18863 isolated node(s):** `Overview`, `Primary`, `Neutral — light theme (paper)`, `Neutral — dark theme (grid)`, `Named Rules` (+18858 more)
...
- **What connects `Overview`, `Primary`, `Neutral — light theme (paper)` to the rest of the system?**
  _18864 weakly-connected nodes found - possible documentation gaps or missing edges._
