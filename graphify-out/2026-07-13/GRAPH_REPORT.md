...
## Corpus Check
- 309 files · ~259,288 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6474 nodes · 9067 edges · 366 communities (223 shown, 143 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 47 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1c87b37c`
...
5. `DartProject` - 25 edges
6. `settingsProvider` - 22 edges
...
- `StandardCodecSerializer::WriteValue()` --calls--> `WriteValue`  [INFERRED]
  windows/flutter/ephemeral/cpp_client_wrapper/standard_codec.cc → windows/flutter/ephemeral/cpp_client_wrapper/include/flutter/standard_codec_serializer.h
- `_reload` --references--> `journalRepositoryProvider`  [EXTRACTED]
  lib/features/journal/journal_manage_sheet.dart → lib/app/providers.dart

## Import Cycles
- None detected.

## Communities (366 total, 143 thin omitted)
...
Cohesion: 0.17
Nodes (12): ByteBufferStreamWriter, bytes_, ByteStreamWriter, WriteAlignment, WriteByte, WriteBytes, WriteSize, T (+4 more)

### Community 11 - "Todo Features"
Cohesion: 0.03
Nodes (70): CurvedAnimation, todoSortDebugLoggerProvider, build, DevTodoSortDebugSection, _showLogDialog, _activeInList, _animController, _applyListMoveOptimistic (+62 more)
...
Cohesion: 0.03
Nodes (68): build, buildCalendarTodoMarkers, CalendarDayTodoBar, CalendarDayTodoIcons, CalendarDayTodoTile, calendarMaxTodoIconsPerDay, calendarMorphTodoIconProgress, calendarPackWeekAllDayShelf (+60 more)
...
Cohesion: 0.05
Nodes (55): _, @DriftDatabase, fakes/fake_weather_api_client.dart, SyncEngine, AppDatabase, InMemorySyncRepository, DriftSettingsRepository, SettingsRepository (+47 more)
...
Cohesion: 0.03
Nodes (71): AsyncValue, all, allJournalEntriesProvider, allJournalEntriesScope, buildCalendarTodoMarkers, cachedCurrentWeatherProvider, controller, dailyTrackers (+63 more)

### Community 19 - "Analytics Features"
Cohesion: 0.01
Nodes (149): AnalyticsService, DateTime get, Key? dateKey,
  double, accent, _addOption, analytics, _AnalyticsViewMode, anchorDateRect (+141 more)

### Community 20 - "Merger Services"
Cohesion: 0.11
Nodes (23): authRepositoryProvider, dataExportServiceProvider, dataImportServiceProvider, build, createState, dispose, _emailController, _error (+15 more)

### Community 21 - "Search Features"
Cohesion: 0.06
Nodes (34): _accentColor, _bodyController, _bodyFocusNode, _coordinator, createState, dispose, entry, initState (+26 more)
...
Cohesion: 0.15
Nodes (23): EncodedType, StandardCodecSerializer, ReadSize, ReadValue, ReadValueOfType, WriteValue, EncodableValue, string (+15 more)
...
Cohesion: 0.14
Nodes (11): string, vector, EncodableValue, EncodableValue, EncodableValue, EncodableValue, EncodableValue, EncodableValue (+3 more)

### Community 34 - "Shell Features"
Cohesion: 0.05
Nodes (38): accent, branchIndex, child, color, createState, dispose, event, glow (+30 more)

### Community 35 - "Import Export"
Cohesion: 0.05
Nodes (41): class MockDocumentReference extends, dart:async, dart:io, Exception, _callbacks, flushAll, instance, PendingFlushRegistry (+33 more)
...
Cohesion: 0.50
Nodes (4): colorPaletteProvider, didChangeDependencies, _RankingDialog, _RankingDialogState

### Community 39 - "Sync Engine"
Cohesion: 0.04
Nodes (51): Duration, Duration get, cancel, DebouncedCallback, debounceDelay, Debouncer, delay, dispose (+43 more)

### Community 40 - "Calendar Event"
Cohesion: 0.05
Nodes (39): DateTimeRange, settingsProvider, build, _buildPayload, CalendarEventPanel, _CalendarEventPanelState, _closingAfterSave, _colorValue (+31 more)
...
Cohesion: 0.05
Nodes (41): _EmptyTrackersCard, _GridView, _HeatmapGrid, _HeatmapMonthTile, _SectionLabel, _StatChip, CalendarDayCell, CalendarDayEventBar (+33 more)

### Community 43 - "Features Dev"
Cohesion: 0.08
Nodes (25): authNotifierProvider, databaseProvider, deviceIdProvider, _bootstrap, build, configureDesktopWindow, createState, dispose (+17 more)
...
Cohesion: 0.10
Nodes (18): GetRegistrar(), FlutterDesktopPluginRegistrarRef, set, T, unique_ptr, Plugin, PluginRegistrar, AddPlugin (+10 more)
...
Cohesion: 0.06
Nodes (32): copyWithDeleted, createdAt, deletedAt, id, isDeleted, updatedAt, version, allJournals (+24 more)
...
Cohesion: 0.04
Nodes (45): Future, clearLog, _enqueue, log, _logFileName, logFilePath, _maxLogBytes, readLog (+37 more)
...
Cohesion: 0.09
Nodes (37): _PalettePickDialog, _PalettePickDialogState, _ContextMenuOverlay, _ContextMenuOverlayState, ContextMenuRegion, _ContextMenuRegionState, _CreateNameColorDialog, _CreateNameColorDialogState (+29 more)
...
Cohesion: 0.05
Nodes (43): BorderRadius, anchor, _anim, borderRadius, build, _buildMenu, capturedThemes, child (+35 more)
...
Cohesion: 0.12
Nodes (25): calendarRepositoryProvider, deviceIdProvider, devSettingsProvider, journalRepositoryProvider, build, _confirmDeleteAllCalendarEvents, _confirmDeleteAllEntries, _confirmResetJournals (+17 more)
...
Cohesion: 0.21
Nodes (15): backgroundSyncOrchestratorProvider, lazyLoadProvider, liveSyncProvider, quoteBankProvider, quotesLoadedProvider, shellDataWarmupProvider, syncEngineProvider, warmupTrackerProvider (+7 more)
...
Cohesion: 0.12
Nodes (16): class, dart:ui, geometricShaderProvider, _GeometricBackground, _advance, build, createState, _done (+8 more)
...
Cohesion: 0.13
Nodes (13): _pickCalendarKey, _showReorderNavDialog, _showStartupPageDialog, _startupPageLabel, _statCountLabel, package:file_picker/file_picker.dart, package:voyager/core/constants/hotkey_defaults.dart, package:voyager/core/widgets/keep_alive_scroll.dart (+5 more)

### Community 117 - "Sync Debouncer"
Cohesion: 0.17
Nodes (10): Client, _apiKey, _http, _periodFromForecastItem, refreshForecast, refreshWeather, package:http/http.dart, package:voyager/domain/repositories/weather_api_client.dart (+2 more)
...
Cohesion: 0.08
Nodes (24): EditableText, body, build, floatingActionButton, PlatformAdaptiveScaffold, decoration, restingColor, selectedColor (+16 more)
...
Cohesion: 0.33
Nodes (5): bool get, configureDesktopWindow, desktopWindowChromeActive, _desktopWindowConfigured, package:window_manager/window_manager.dart
...
Cohesion: 0.08
Nodes (52): ConsumerState, ConsumerStatefulWidget, allTodoTasksProvider, colorPaletteProvider, remoteSyncServiceProvider, todoListsProvider, todoListStatsProvider, todoRepositoryProvider (+44 more)
...
Cohesion: 0.06
Nodes (31): Delay, _authRepo, _db, _firestore, initialize, _instance, _isDraining, isInitialized (+23 more)
...
Cohesion: 0.20
Nodes (9): pendingStatEntriesProvider, isExpired, purgeEligibleAfter, SoftDeletePolicy, build, StatisticsActionFab, package:flutter_riverpod/flutter_riverpod.dart, package:voyager/core/constants/app_constants.dart (+1 more)
...
Cohesion: 0.12
Nodes (16): build, _captured, createState, current, dispose, _handleKeyEvent, initState, _KeyBindingDialog (+8 more)

### Community 148 - "Shell App"
Cohesion: 0.20
Nodes (10): RankingConfig, RankingValue, StatisticTracker, TrackerValue, CalendarEvent, Journal, JournalEntry, SoftDeletable (+2 more)
...
Cohesion: 0.06
Nodes (38): _auth, dispose, _isAuthenticated, _subscription, id, OutOfSyncJournalEntryPurge, OutOfSyncJournalEntryTarget, purgeAll (+30 more)
...
Cohesion: 0.18
Nodes (15): cacheStatusSnapshotProvider, devSettingsProvider, _scaledMorphDuration, build, _CacheStatusItemList, CacheStatusOverlay, _CacheStatusSummary, compact (+7 more)
...
Cohesion: 0.05
Nodes (44): weatherIconData, createState, DevOutOfSyncPurgeSection, _DevOutOfSyncPurgeSectionState, _lastResults, _purgeAll, _purging, createState (+36 more)
...
Cohesion: 0.25
Nodes (7): exception, installWindowsKeyboardWorkaround, _isKnownWindowsKeyboardDesync, message, previous, resyncWindowsKeyboardState, package:voyager/core/platform/platform_info.dart
...
Cohesion: 0.08
Nodes (20): BinaryMessengerImpl, handlers_, messenger_, Send, SetMessageHandler, BinaryMessageHandler, FlutterDesktopMessengerRef, map (+12 more)
...
Cohesion: 0.08
Nodes (43): allJournalEntriesProvider, analyticsServiceProvider, ConsumerWidget, _AddRankingButton, AnalyticsPage, _analyticsViewModeProvider, build, _calendarSelectedTrackerProvider (+35 more)
...
Cohesion: 0.67
Nodes (3): calendarEventsProvider, calendarTodoMarkersProvider, build
...
Cohesion: 0.06
Nodes (48): analyticsServiceProvider, journalAllEntryIdsProvider, journalDebugLoggerProvider, journalEntryCacheInvalidatorProvider, journalEntryCountsProvider, journalListEntriesProvider, journalRepositoryProvider, journalsProvider (+40 more)
...
Cohesion: 0.04
Nodes (56): dart:convert, CrdtDocumentResolver, _merger, _mergeSyncOperations, resolvePayload, detectJournalEntryConflict, detectTodoTaskConflict, isConflict (+48 more)

### Community 363 - "_ShellBranchChangeFlusherState"
Cohesion: 0.50
Nodes (4): didUpdateWidget, _ShellBranchChangeFlusher, _ShellBranchChangeFlusherState, settingsRepositoryProvider

## Knowledge Gaps
- **4590 isolated node(s):** `_AnalyticsViewMode`, `_CalendarScale`, `override`, `now`, `totalEntries` (+4585 more)
...
- **Why does `FlutterEngine` connect `Windows Ephemeral` to `Windows Ephemeral`, `Dev Sync`, `MessageHandler`, `Constants Todo`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `MessageCodec` connect `trackerRepositoryProvider` to `Windows Cpp`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **What connects `_AnalyticsViewMode`, `_CalendarScale`, `override` to the rest of the system?**
