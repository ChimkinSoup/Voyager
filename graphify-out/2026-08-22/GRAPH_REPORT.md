# Graph Report - Voyager  (2026-08-19)

## Corpus Check
- 696 files · ~890,105 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 17465 nodes · 28181 edges · 490 communities (434 shown, 56 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 296 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a476bfef`
...
3. `Builder` - 86 edges
4. `Result` - 73 edges
5. `remoteSyncServiceProvider` - 70 edges
6. `CanIgnoreReturnValue` - 70 edges
7. `FirebaseAuthPlugin` - 63 edges
8. `AuthPigeonFirebaseApp` - 56 edges
9. `FlutterFirebaseAuthPlugin` - 52 edges
10. `settingsProvider` - 50 edges

## Surprising Connections (you probably didn't know these)
- `ReadValueOfType` --calls--> `ReadValue`  [INFERRED]
  third_party/firebase_auth-6.5.3/windows/messages.g.h → windows/flutter/ephemeral/cpp_client_wrapper/include/flutter/standard_codec_serializer.h
...
## Communities (490 total, 56 thin omitted)

### Community 0 - "Database Data"
Cohesion: 0.00
Nodes (837): BoolColumn get, _, _accentColorMeta, actualTableName, _addedAtMeta, _alertOnPeriodicPromptsMeta, _alertTimeHourMeta, _algorithmMeta (+829 more)

### Community 1 - "Calendar Features"
Cohesion: 0.01
Nodes (259): AnimationStatusListener?, _, _abortMorphAnimation, accentColor, adjacentColor, _advanceWarmup, anchor, _applyYearTransform (+251 more)

### Community 2 - "Calendar Day"
Cohesion: 0.01
Nodes (234): accentColor, adjacentBorderT, adjacentTextT, alpha, _animatingEventId, available, barHeight, barStride (+226 more)

### Community 3 - "Journal Features"
Cohesion: 0.01
Nodes (160): JournalDebugLogger?, JournalWriteCoordinator?, accentColor, _appliedSavedPreferences, _applyJournalDeletedUiState, _applySavedPreferencesIfReady, _bodyFocusNode, bodyPreview (+152 more)
...
Cohesion: 0.01
Nodes (183): CharacterOpRegistry get, _activeDebouncers, _activelyEditedDocuments, addPendingTextMergeListener, applyPendingDreamEntryTextMerge, applyPendingJournalEntryTextMerge, applyPendingTodoTaskNotesMerge, at (+175 more)

### Community 7 - "Todo Features"
Cohesion: 0.02
Nodes (86): _applyPendingNotesMerge, _beginEditingSession, _buildHeader, _clearDueDate, _close, color, _controller, createState (+78 more)

### Community 8 - "Repositories Domain"
Cohesion: 0.01
Nodes (202): addCustomWord, appendOperation, appendOperationGroup, appendOperationsBatch, authStateChanges, claimCalendarLock, claimWeatherFetchLock, countCardsReviewedToday (+194 more)
...
Cohesion: 0.01
Nodes (158): AsyncValue, CurvedAnimation, _activeInList, _activeSectionHeight, animateIn, _animController, _appliedSavedShowAllTasks, _applyListMoveOptimistic (+150 more)

### Community 12 - "Models Domain"
Cohesion: 0.01
Nodes (150): AppThemeMode, GeometricWaveShape, accentColor, alertOnPeriodicPrompts, alertTimeHour, birthDate, birthYear, calendarNavigateLeftKey (+142 more)
...
Cohesion: 0.01
Nodes (212): addCustomWord, countCardsReviewedToday, countCardsReviewedTotal, countDueCards, countDueCardsInDeck, countEntriesByJournal, _db, deleteAllEntries (+204 more)

### Community 16 - "Sync Weather"
Cohesion: 0.03
Nodes (80): class MockDocumentReference extends, Exception, SyncPayloadTooLargeException, BackupFormatException, package:voyager/data/remote/firestore_sync_repository.dart, package:voyager/features/settings/services/data_import_service.dart, ../test/fakes/fake_weather_api_client.dart, addCustomWord (+72 more)

### Community 17 - "Todo Task"
Cohesion: 0.03
Nodes (69): activeTasks, activeTopLevelTasks, applyDueDateChange, applyMoveToBottomOfCategory, applyNewUndatedTask, applyNormalizeUnstarredIfNeeded, applyReorder, _applyStar (+61 more)

### Community 18 - "App Providers"
Cohesion: 0.01
Nodes (139): activeWorkoutSessionProvider, all, allJournalEntriesScope, assetsProvider, backupCollectionsProvider, bills, bucketListItemsProvider, bucketListRepositoryProvider (+131 more)

### Community 19 - "Analytics Features"
Cohesion: 0.01
Nodes (222): DateTime get, accent, _addOption, all, analytics, anchor, anchorDateRect, anchorIndex (+214 more)
...
Cohesion: 0.02
Nodes (115): hiddenNotificationFeedProvider, accent, _addNote, _AnalyticsSection, _AnalyticsSectionState, build, child, _clearAll (+107 more)
...
Cohesion: 0.07
Nodes (26): Archive, archive, BackupImportSummary, BackupRecordUploader, BackupSettingsUploader, _collections, DataImportService, _db (+18 more)
...
Cohesion: 0.04
Nodes (55): AddListDropdownValue, addListLabel, _AddListMenuItem, _AddListMenuItemState, _addListSentinel, BorderedRoundedDropdown, build, closedTrailing (+47 more)
...
Cohesion: 0.03
Nodes (67): FixedExtentScrollController, FixedExtentScrollPhysics, applyTo, build, _controller, createBallisticSimulation, createState, didUpdateWidget (+59 more)
...
Cohesion: 0.02
Nodes (96): _FakeLeetCodeApi, LeetCodeTrackDraft? draft,
  String?, _endpoint, fetchBySlug, fetchMostRecentAcceptedSubmission, fetchQuestionCounts, _http, LeetCodeApiClient (+88 more)

### Community 34 - "Shell Features"
Cohesion: 0.04
Nodes (60): studyDeckStatsProvider, studyStatsProvider, borderColor, build, child, _closing, _create, _createFolderOrDeck (+52 more)

### Community 35 - "Import Export"
Cohesion: 0.05
Nodes (43): FocusOnKeyEventCallback?, InputCounterWidgetBuilder?, accentColor, autofocus, borderRadius, build, buildCounter, _buildField (+35 more)
...
Cohesion: 0.02
Nodes (119): assetToFirestore, assetValuationToFirestore, body, bucketListItemToFirestore, budgetToFirestore, calendarEventToFirestore, calendarToFirestore, copyWith (+111 more)
...
Cohesion: 0.07
Nodes (27): await, package:voyager/domain/models/notification_models.dart, package:voyager/features/notifications/notification_inbox_popover.dart, RenderBox, container, db, _displayTextOrigin, _displayTextSize (+19 more)

### Community 50 - "Windows Ephemeral"
Cohesion: 0.04
Nodes (51): IgnorePointer, package:voyager/features/study/study_cram_page.dart, package:voyager/features/study/study_flip_card.dart, package:voyager/features/study/study_keyboard_shortcuts.dart, package:voyager/features/study/study_session_page.dart, _cardOffset, cards, container (+43 more)

### Community 51 - "Widgets Text"
Cohesion: 0.03
Nodes (59): 2, copyWith, _dateOnly, days, due, dueAt, dueLeetCodeProblems, effectiveNow (+51 more)

### Community 52 - "Weather Features"
Cohesion: 0.12
Nodes (30): EncodedType, ByteBufferStreamWriter, bytes_, StandardCodecSerializer, ReadSize, ReadValue, ReadValueOfType, WriteSize (+22 more)

### Community 53 - "Widgets Field"
Cohesion: 0.04
Nodes (51): DateTimeRange, assetValuationsProvider, financeRepositoryProvider, _save, _asOf, _AssetModal, _AssetModalState, build (+43 more)
...
Cohesion: 0.04
Nodes (50): 1, busiest, byDay, _CalendarHover, _columnsFor, counts, createState, date (+42 more)

### Community 56 - "Windows Ephemeral"
Cohesion: 0.04
Nodes (48): Axis, Axis get, AxisDirection, AxisDirection get, class _RenderSingleChildViewport extends, class _SingleChildViewportElement extends, LayerHandle, applyPaintTransform (+40 more)
...
Cohesion: 0.04
Nodes (69): Asset, assetsProvider, AssetValuation?, assetValuationsProvider, CashFlowGranularity, financeCategoriesProvider, abs, accent (+61 more)

### Community 63 - "Models Domain"
Cohesion: 0.06
Nodes (34): body, byCreated, byDate, colorValue, compareJournalEntriesNewestFirst, copyWith, customQuote, entryDate (+26 more)
...
Cohesion: 0.05
Nodes (75): AssetsTableCompanion, AssetsTableData, AssetValuationsTableCompanion, AssetValuationsTableData, BucketListItemsTableCompanion, BucketListItemsTableData, BudgetsTableCompanion, BudgetsTableData (+67 more)

### Community 66 - "Features Shell"
Cohesion: 0.04
Nodes (45): accent, _anchorKey, _bellHeight, _bellWidth, createState, _hovered, _openPopover, _accentColor (+37 more)

### Community 67 - "Windows Ephemeral"
Cohesion: 0.03
Nodes (70): dart:typed_data, VimSession, package:voyager/core/vim/vim_session.dart, _Pixels, RenderRepaintBoundary, _alpha, argbAt, boundary (+62 more)

### Community 68 - "Firestore Data"
Cohesion: 0.04
Nodes (59): customWordsProvider, dictionaryProvider, DictionarySearchResult, _BrowseQuotesDialog, _BrowseQuotesDialogState, _persistEntryListWidth, _persistLastViewedJournal, _persistShowAllJournals (+51 more)
...
Cohesion: 0.07
Nodes (27): allJournals, assigner, choice, color, context, created, defaultColor, deleteJournalList (+19 more)
...
Cohesion: 0.05
Nodes (36): studyFolderByIdProvider, display, divisions, _GeometricTextureSlider, label, max, min, onChanged (+28 more)

### Community 75 - "Domain Services"
Cohesion: 0.05
Nodes (36): FlutterDesktopMessage, variant, TextureVariant, ErrorOr, v_, FlutterError, code_, details_ (+28 more)

### Community 76 - "Main App"
Cohesion: 0.04
Nodes (55): id, OutOfSyncJournalEntryPurge, OutOfSyncJournalEntryTarget, purgeAll, purgeOne, searchHint, targets, title (+47 more)

### Community 77 - "Widgets Date"
Cohesion: 0.05
Nodes (39): at, buffer, composing, formatEditUpdate, i, mapped, normalizeNewlines, NormalizeNewlinesFormatter (+31 more)
...
Cohesion: 0.02
Nodes (121): 0, big, body, _bracketObject, c, caret, caseSensitive, character (+113 more)

### Community 81 - "Domain Services"
Cohesion: 0.08
Nodes (23): allCalendars, assigner, choice, color, context, created, defaultColor, deleteCalendarList (+15 more)

### Community 82 - "Shell Shortcuts"
Cohesion: 0.07
Nodes (32): Intent, _SubmitIntent, _CodeOutdentIntent, _CodeTabIntent, _blockingShortcuts, _BlockShellTabIntent, BlockShellTabShortcuts, build (+24 more)
...
Cohesion: 0.06
Nodes (37): autoExpand, _Badge, createState, dispose, _editError, _editingId, error, initState (+29 more)

### Community 95 - "Theme Menu"
Cohesion: 0.05
Nodes (43): LeetCodeRepository, LeetCodeCramPage, package:voyager/features/leetcode/leetcode_cram_page.dart, package:voyager/features/leetcode/leetcode_session_page.dart, _FakeLeetCodeRepository, _RecordingLeetCodeRepository, _RecordingLeetCodeRepository, _button (+35 more)
...
Cohesion: 0.06
Nodes (45): bool?, authNotifierProvider, backgroundSyncOrchestratorProvider, connectivityStatusProvider, databaseProvider, deviceIdProvider, lazyLoadProvider, liveSyncProvider (+37 more)
...
Cohesion: 0.03
Nodes (156): flutter::StandardCodecSerializer, string_view, AuthPigeonFirebaseApp::AuthPigeonFirebaseApp(), EncodableMap, EncodableValue, FlutterError, InternalActionCodeSettings, string (+148 more)
...
Cohesion: 0.02
Nodes (113): _applyCaseOverRange, _applyMotion, _applyOperatorRange, _applyValue, _Await, _blockVisualLineHorizontal, _cachedMatches, _cachedMatchesFor (+105 more)

### Community 106 - "Widgets Clamp"
Cohesion: 0.07
Nodes (29): TrackerValue, Calendar, CalendarEvent, calendarId, colorValue, copyWith, end, EventRecurrence (+21 more)
...
Cohesion: 0.08
Nodes (24): DriftTodoRepository, DriftTrackerRepository, package:voyager/core/constants/todo_sort_constants.dart, package:voyager/domain/todo/todo_task_sorting.dart, required String id,
  bool, db, journalRepo, main (+16 more)
...
Cohesion: 0.07
Nodes (31): goalAllocationsProvider, savingsGoalsProvider, SavingsGoal, _AllocateModal, _AllocateModalState, _amountController, build, _canSave (+23 more)
...
Cohesion: 0.04
Nodes (47): _absorbEdit, _advanceTabstop, _applying, _applyValue, _caret, contains, cutsLiteral, dispose (+39 more)
...
Cohesion: 0.09
Nodes (22): Journal, JournalEntry, colorValue, completed, copyWith, dueDate, dueDateSetAt, fromJson (+14 more)

### Community 121 - "Settings Palette"
Cohesion: 0.03
Nodes (61): appendOperation, appendOperationGroup, appendOperationsBatch, claimCalendarLock, claimWeatherFetchLock, _collection, deleteDocument, deleteOperations (+53 more)
...
Cohesion: 0.02
Nodes (126): EditableText, EditableTextState, FocusNode, loadDictionaryFromAssets, raw, context, focus, isTextInputFocused (+118 more)

### Community 124 - "Shell Features"
Cohesion: 0.05
Nodes (36): firestoreId, firestoreJournalId, journalDocumentIdForFirestore, journalDocumentIdFromFirestore, journalReferenceIdForFirestore, journalReferenceIdFromFirestore, legacyJournalFirestoreId, legacyJournalId (+28 more)
...
Cohesion: 0.05
Nodes (38): @DataClassName, AssetsTable, AssetValuationsTable, BucketListItemsTable, BudgetsTable, CalendarEventsTable, CalendarsTable, CustomQuotesTable (+30 more)
...
Cohesion: 0.04
Nodes (48): Finder get, package:voyager/features/dream_journal/dream_journal_page.dart, _bodyField, container, db, _delegate, getAllEntries, getAllEntriesCalls (+40 more)
...
Cohesion: 0.04
Nodes (52): formatTime12Hour, formatTimeOfDay12Hour, jm, local, now, _closingAfterSave, _completed, createState (+44 more)
...
Cohesion: 0.03
Nodes (71): DateTime? dueAt,
  int, _back, build, createState, _face, _footer, _front, keywords (+63 more)
...
Cohesion: 0.07
Nodes (26): _buildEditor, _clampInt, commit, _commitPendingForDateChange, createState, date, didUpdateWidget, _dirty (+18 more)
...
Cohesion: 0.03
Nodes (61): FirebaseAuthMultiFactorException, dart:math, FirebaseAuthException, indices, main, r, sorted, kCycleWorkoutPlanId (+53 more)
...
Cohesion: 0.03
Nodes (73): accentColor, _advanceWidth, boxes, build, _caretForegroundFor, caretOffset, child, computeLuminance (+65 more)
...
Cohesion: 0.03
Nodes (76): _, @DriftDatabase, CalendarRepository, _Device, _buffered, _maxBuffered, notify, notifyOne (+68 more)
...
Cohesion: 0.04
Nodes (44): WeightUnit, _accept, active, allEntries, build, createState, dayIndex, _edit (+36 more)
...
Cohesion: 0.04
Nodes (49): ClipRectLayer, LayerLink, anchorOffset, applyPaintTransform, asIs, attach, build, _checkScheduled (+41 more)
...
Cohesion: 0.06
Nodes (34): _controller, createState, dispose, divisions, _focusNode, initialUsername, label, _LeetCodeUsernameDialog (+26 more)
...
Cohesion: 0.08
Nodes (23): getOrderedDestinations, icon, index, label, order, OrderedDestination, page, path (+15 more)

### Community 164 - "App Providers"
Cohesion: 0.03
Nodes (60): accentColor, _active, _badge, _beginSuspension, blockCaret, build, builder, caretColor (+52 more)
...
Cohesion: 0.05
Nodes (41): customWordsProvider, dropdownMenuTheme, _itemHighlightRadius, itemPadding, menuBorderRadius, menuColor, menuColorOf, menuStyle (+33 more)

### Community 169 - "@immutable"
Cohesion: 0.06
Nodes (29): _auth, AuthNotifier, dispose, _isAuthenticated, _subscription, _auth, _authErrorMessage, authStateChanges (+21 more)

### Community 170 - "ByteBufferStreamReader"
Cohesion: 0.05
Nodes (41): BackdropFilter, build, CompactBackBar, label, onBack, build, _controller, createState (+33 more)
...
Cohesion: 0.07
Nodes (35): journalListEntriesProvider, journalRepositoryProvider, journalWriteCoordinatorProvider, searchServiceProvider, _confirmDeleteAllEntries, _confirmResetJournals, build, created (+27 more)
...
Cohesion: 0.03
Nodes (75): studyAllCardsProvider, after, before, _canRedo, _canUndo, _cardKey, _clearHistory, createState (+67 more)

### Community 177 - "dart:math"
Cohesion: 0.12
Nodes (17): trackerRepositoryProvider, _createTracker, _delete, _deleteTracker, _editTracker, _handleTap, _HeatmapBucket, _HeatmapBucketState (+9 more)
...
Cohesion: 0.05
Nodes (42): leetCodeRepositoryProvider, _authorizationEndpoint, DesktopGoogleOAuth, redirectUri, _tokenEndpoint, confirmed, context, copyLeetCodeCode (+34 more)
...
Cohesion: 0.10
Nodes (31): studyCardsProvider, studyDeckByIdProvider, build, build, createState, deckId, deckNameHint, _delete (+23 more)
...
Cohesion: 0.04
Nodes (52): _applyDecision, bucket0, bucket1, bucket2, _BucketProgressBar, _canRedo, _canUndo, _cardKey (+44 more)
...
Cohesion: 0.04
Nodes (56): budgetsProvider, tagColorsProvider, transactionsProvider, Budget, FinanceCategory, _BudgetModal, _BudgetModalState, build (+48 more)
...
Cohesion: 0.05
Nodes (41): assets, assetValuations, bucketListItems, budgets, calendarEvents, calendars, crdtBacked, customQuotes (+33 more)
...
Cohesion: 0.04
Nodes (57): Delay, DocumentReference, FirebaseFirestore, FirebaseFunctions?, _authRepo, clearFor, _clearPending, data (+49 more)

### Community 203 - "Color"
Cohesion: 0.04
Nodes (57): cachedCurrentWeatherProvider, syncActivityProvider, accent, axis, _bottomFade, branchIndex, build, child (+49 more)
...
Cohesion: 0.07
Nodes (42): ConsumerState, ConsumerStatefulWidget, notificationBadgeStateProvider, TrackerEntryRow, TrackerEntryRowState, CalendarEventPanel, _CalendarEventPanelState, CalendarTodoPanel (+34 more)
...
Cohesion: 0.06
Nodes (29): dart:ui, Error, package:voyager/core/widgets/geometric_texture.dart, package:voyager/core/widgets/spell_check_field_support.dart, controller, decoratorLeft, editable, _inputGap (+21 more)
...
Cohesion: 0.04
Nodes (51): _, fakes/fake_weather_api_client.dart, GoRouter, Key? get, _kLeetCodeActivityBreakpoint, _kLeetCodeActivityCardWidth, _kLeetCodeSplitBreakpoint, LeetCodeDashboardHeader (+43 more)
...
Cohesion: 0.02
Nodes (89): LeetCodeApiQuestion?, LeetCodeCodeController, LeetCodeDifficulty, LeetCodeTrackDraft?, LeetCodeTrackDraft? draft,
  LeetCodeTrackDraftOutcome, LeetCodeTrackDraftStore, accentColor, _addExample (+81 more)
...
Cohesion: 0.09
Nodes (23): LeetCodeSolution, anchorRect, build, _close, _closing, _ComplexityTile, _controller, createState (+15 more)

### Community 231 - "_MorphAnimationLayer"
Cohesion: 0.08
Nodes (23): _amountController, build, _canSave, _colorValue, createState, _datePopoverOpen, _delete, dispose (+15 more)

### Community 233 - "MethodResultFunctions"
Cohesion: 0.03
Nodes (68): int?, build, colorValue, tag, TagChip, buffer, build, cached (+60 more)

### Community 234 - "package:voyager/core/sync/text_delta_injector.dart"
Cohesion: 0.18
Nodes (11): colorPaletteProvider, build, ColorPickerField, _ColorPickerFieldState, _changeEventColor, _createJournal, pickAccentColor, _addMinorPetalColor (+3 more)
...
Cohesion: 0.08
Nodes (23): _, allDay, allDayEvent, available, calendarDayEntriesForDay, CalendarDayEntryKind, calendarVisibleEntryCount, clamp (+15 more)
...
Cohesion: 0.06
Nodes (32): package:voyager/core/spellcheck/voyager_spell_check_service.dart, package:voyager/core/widgets/spell_check_squiggle_layer.dart, RichText, combined, count, false, main, out (+24 more)
...
Cohesion: 0.05
Nodes (48): BucketListItem, bucketListItemsProvider, bucketListRepositoryProvider, accentColor, _addItem, BucketListPopup, _BucketListPopupState, _BucketListRow (+40 more)

### Community 242 - "cadence"
Cohesion: 0.08
Nodes (27): LeetCodeProblem?, LeetCodeSolution, _BackSolution, build, _CardBack, _CardFront, _cardRadius, controller (+19 more)

### Community 243 - "geometric_texture_settings.dart"
Cohesion: 0.05
Nodes (47): leetcodeProblemsProvider, leetcodeQuestionCountsProvider, _ActivityDetailCard, _ActivityDetailCardState, anchorRect, build, _close, _closing (+39 more)
...
Cohesion: 0.06
Nodes (31): package:voyager/features/study/study_deck_workbench_page.dart, _cards, cardsByDeck, container, _controlBar, countCardsReviewedToday, countCardsReviewedTotal, countDueCards (+23 more)
...
Cohesion: 0.05
Nodes (37): dart:async, applySettings, devForceConflictUi, disableCache, loadFromSettings, _persist, setDevForceConflictUi, setDisableCache (+29 more)

### Community 248 - "dart:math"
Cohesion: 0.05
Nodes (37): LeetCodeDifficulty, description, difficulty, easy, examples, hard, LeetCodeQuestionCounts, medium (+29 more)
...
Cohesion: 0.04
Nodes (45): CalendarEvent?, EventRecurrence, _allDayFocusNode, build, _buildPayload, _calendarFlagColor, _calendarId, calendars (+37 more)
...
Cohesion: 0.05
Nodes (40): LeetCodeSolution? get, algorithm, byCreated, bySolved, code, codeLanguage, compareLeetCodeProblemsNewestFirst, copyWith (+32 more)
...
Cohesion: 0.05
Nodes (43): JournalRepository?, detectDreamEntryConflict, detectJournalEntryConflict, detectTodoTaskConflict, isConflict, _isCorruptedOpChain, _isHardDreamMetadataCollision, _isHardMetadataCollision (+35 more)

### Community 260 - "package:voyager/core/theme/voyager_theme.dart"
Cohesion: 0.03
Nodes (61): AsyncNotifier, SettingsNotifier, AppSettings, active, _barFor, build, _clearHover, compact (+53 more)
...
Cohesion: 0.05
Nodes (40): Card, DateTime? dueAt,
  double, package:voyager/core/theme/srs_mastery_color.dart, package:voyager/core/widgets/search_highlight_text.dart, package:voyager/features/study/study_card_tile.dart, algorithm, card, difficulty (+32 more)

### Community 265 - "accentColor"
Cohesion: 0.08
Nodes (25): CapturedThemes, Color get, _ContextualPopoverRoute, VoyagerPopupMenuRoute, accentColor, anchor, barrierColor, barrierDismissible (+17 more)
...
Cohesion: 0.03
Nodes (92): dart:convert, FirebaseException, SyncEngine, classifySyncFailure, describeSyncFailure, _permanentFirestoreCodes, SyncFailureKind, toString (+84 more)
...
Cohesion: 0.08
Nodes (43): ConsumerWidget, allJournalEntriesProvider, journalsProvider, periodicPromptServiceProvider, settingsProvider, todoListStatsProvider, trackersProvider, trackerValuesProvider (+35 more)
...
### Community 272 - "asOf"
Cohesion: 0.09
Nodes (21): bundled, candidates, candidatesComplete, complete, contains, custom, customMatches, dictionarySearchLimit (+13 more)
...
Cohesion: 0.07
Nodes (27): allLists, assigner, choice, color, context, deleted, deleteTodoList, initial (+19 more)
...
Cohesion: 0.05
Nodes (43): build, saveSettings, settingsRepositoryProvider, _apiKeyController, build, createState, DevWeatherApiTile, _DevWeatherApiTileState (+35 more)
...
Cohesion: 0.05
Nodes (37): CustomPainter, fpsMonitorProvider, _ConfettiPainter, _VimOverlayPainter, _ClockDialPainter, GeometricTexturePainter, _GlassBorderPainter, _NotchedBorderPainter (+29 more)

### Community 283 - "colorPaletteJson"
Cohesion: 0.09
Nodes (29): AutomaticKeepAliveClientMixin, ChildIndexGetter?, EdgeInsetsGeometry?, IndexedWidgetBuilder, _VimFieldOverlay, _VimFieldOverlayState, build, cacheExtent (+21 more)
...
Cohesion: 0.07
Nodes (28): bringCursorIntoView, buildVoyagerSpellCheckConfiguration, containerOf, copyWith, cursor, editableState, editableTextState, editableTextStateOf (+20 more)

### Community 289 - "defaultBool"
Cohesion: 0.02
Nodes (87): Directory, File, ListView, package:drift/native.dart, package:flutter_test/flutter_test.dart, package:voyager/core/constants/workout_constants.dart, package:voyager/core/widgets/keep_alive_scroll.dart, package:voyager/core/widgets/mood_gradient_slider.dart (+79 more)
...
Cohesion: 0.09
Nodes (28): activeWorkoutPlanProvider, exercisesProvider, workoutPlanEntriesProvider, workoutPlansProvider, build, _dateForDay, entries, exerciseCount (+20 more)
...
Cohesion: 0.08
Nodes (23): bool get, BuildContext, isCompactWidth, kCompactWidthBreakpoint, WindowSizeClass, WindowSizeClassX, StudyCard, _back (+15 more)
...
Cohesion: 0.07
Nodes (31): journalDebugLoggerProvider, todoSortDebugLoggerProvider, cancelLabel, confirmed, confirmLabel, deleteAllLabel, DeleteContainerChoice, moveLabel (+23 more)
...
Cohesion: 0.08
Nodes (24): ByteData, Image, background, bottom, _boundary, _broken, bytes, commonest (+16 more)
...
Cohesion: 0.12
Nodes (23): leetCodeDeckDifficultyFilterProvider, leetCodeDeckSearchQueryProvider, leetCodeDeckTagFilterProvider, leetcodeProblemsProvider, build, _ControlBar, createState, _DeckSkeleton (+15 more)
...
Cohesion: 0.08
Nodes (24): _addSolution, _algorithmField, _algorithmHint, _algorithmText, _bruteForce, button, db, ensureVisible (+16 more)

### Community 315 - "collectionName"
Cohesion: 0.13
Nodes (20): remoteSyncCompareServiceProvider, syncCompareLoggerProvider, todoListsProvider, build, _compareAllTodoLists, _compareJournalEntries, _compareTodoList, _comparing (+12 more)
...
Cohesion: 0.04
Nodes (77): remoteSyncServiceProvider, studyRepositoryProvider, todoRepositoryProvider, _deleteTodoTask, cards, changeStudyDeckColor, changeStudyFolderColor, childDecks (+69 more)
...
Cohesion: 0.06
Nodes (28): BackupCollection, backupContentEquals, BackupRecord, buildBackupCollections, content, data, fromJson, id (+20 more)

### Community 333 - "FLTAuthStateChannelStreamHandler"
Cohesion: 0.08
Nodes (22): BaseSliderTrackShape, Color?, accent, build, getPreferredRect, gradient, GradientSliderTrackShape, inactiveColor (+14 more)
...
Cohesion: 0.11
Nodes (18): buildOverscrollIndicator, buildScrollbar, createState, didChangeAppLifecycleState, dispose, _flushAllPendingEdits, getScrollPhysics, initState (+10 more)

### Community 343 - "plugin_registrar.cc"
Cohesion: 0.11
Nodes (17): FirestorePullService, Exercise, build, createState, dispose, exercise, ExerciseTarget, _ExerciseTargetEditor (+9 more)

### Community 344 - "workout_test.dart"
Cohesion: 0.11
Nodes (18): AddExerciseButton, axis, build, _createExercise, _delete, _DragFeedback, _DraggableExerciseCard, _EmptyLibraryHint (+10 more)
...
Cohesion: 0.11
Nodes (18): package:voyager/features/leetcode/leetcode_providers.dart, SettingsNotifier, static AppSettings?, back, build, _FixedSettings, flip, main (+10 more)
...
Cohesion: 0.12
Nodes (16): GlobalKey, GlobalKey get, RenderVimAnchoredChrome, attach, createRenderObject, detach, _handleScroll, _hasAttemptedScrollLookup (+8 more)
...
Cohesion: 0.12
Nodes (15): currentWeatherProvider, build, _controller, createState, didUpdateWidget, dispose, _error, initState (+7 more)
...
Cohesion: 0.02
Nodes (81): Animation, AnimationController, Curve, animateTo, controller, defaultSpring, dispose, jumpTo (+73 more)
...
### Community 358 - "Timer?"
Cohesion: 0.22
Nodes (8): imported, now, raw, remoteSync, repo, result, showStudyImportJsonModal, package:file_picker/file_picker.dart
...
Cohesion: 0.07
Nodes (28): AnimatedContainer, package:drift/drift.dart, package:flutter/gestures.dart, package:voyager/core/constants/todo_constants.dart, package:voyager/core/theme/voyager_list_item_surface.dart, support/todo_page_harness.dart, main, container (+20 more)
...
### Community 368 - "TEST"
Cohesion: 0.13
Nodes (16): InternalMultiFactorInfo, InternalMultiFactorInfo, display_name, enrollment_timestamp, factor_id, FromEncodableList, Hash, operator== (+8 more)
...
Cohesion: 0.13
Nodes (14): addExerciseToDay, createExercise, deleteExercise, deletePlanEntry, movePlanEntry, _ref, saveExercise, saveExerciseTarget (+6 more)
...
Cohesion: 0.02
Nodes (86): dart:io, _append, applySettings, _appStartMarker, bodyDraftEntryIds, bodyFocused, bodyText, clearLog (+78 more)
...
Cohesion: 0.10
Nodes (19): insideTag, tagRanges, tokenizeWords, ActiveTagToken, counts, end, filterTagSuggestions, _hashCodeUnit (+11 more)
...
Cohesion: 0.25
Nodes (8): InheritedWidget, SnippetEnabledScope, VimEnabledScope, _ContextualPopoverAccentScope, CalendarEventTapScope, CalendarMorphYearDotsOpacity, _MorphProgress, _WeekMorphProgress
...
Cohesion: 0.17
Nodes (15): devLeafGalleryPanelOpenProvider, paperShaderProvider, petalFieldParamsProvider, snippetScopeProvider, themeModeProvider, _AppBackground, build, _PaperBackground (+7 more)

### Community 398 - "asOf"
Cohesion: 0.20
Nodes (10): _ContextMenuLayoutDelegate, _SubmenuLayoutDelegate, _PopoverLayoutDelegate, _SpellCheckPopupLayoutDelegate, VoyagerPopupMenuRouteLayout, _SparklineBubbleLayout, _ChartBubbleLayout, _BubbleLayout (+2 more)
...
Cohesion: 0.22
Nodes (7): build, QuickJournalPopup, QuickTodoPopup, package:voyager/features/journal/journal_page.dart, package:voyager/features/shell/shell_keyboard_shortcuts.dart, package:voyager/features/todo/todo_page.dart, main

### Community 407 - "calendarNavigateLeftKey"
Cohesion: 0.36
Nodes (4): ByteStreamWriter, WriteAlignment, WriteByte, WriteBytes
...
Cohesion: 0.53
Nodes (6): devGeometricTexturePanelOpenProvider, geometricDebugRowFadeProvider, geometricTextureParamsProvider, _GeometricBackground, build, DevGeometricTextureSection
...
Cohesion: 0.04
Nodes (86): allTodoTasksProvider, calendarRepositoryProvider, calendarsProvider, colorPaletteProvider, financeRepositoryProvider, journalAllEntryIdsProvider, journalDebugLoggerProvider, journalEntryCacheInvalidatorProvider (+78 more)
...
Cohesion: 0.03
Nodes (96): K, EncodableList, InternalAdditionalUserInfo, InternalAuthCredential, InternalFirebaseAuthSettings, InternalIdTokenResult, InternalMultiFactorSession, InternalSignInProvider (+88 more)
...
Cohesion: 0.03
Nodes (61): Duration? dwell,
  Duration, IconData, IconData? icon,
  List, build, child, EnterToSubmitScope, onSubmit, _textFieldHasFocus (+53 more)
...
### Community 525 - "@visibleForTesting"
Cohesion: 0.18
...
### Community 654 - "package:voyager/core/sync/firestore_collections.dart"
Cohesion: 0.11
Nodes (23): allTodoTasksProvider, calendarEventsProvider, calendarRepositoryProvider, calendarsProvider, calendarTodoMarkersProvider, googleCalendarSyncProvider, workoutDaysProvider, changeCalendarListColor (+15 more)
...
Cohesion: 0.04
Nodes (45): colorForLeetCodeDifficulty, key, kLeetCodeEasyColor, kLeetCodeHardColor, kLeetCodeMediumColor, labelForLeetCodeDifficulty, labelForLeetCodeLanguage, leetCodeCodeLanguages (+37 more)
...
### Community 708 - "voyager_spacing.dart"
Cohesion: 0.22
...
## Knowledge Gaps
- **12246 isolated node(s):** `Global Inbox`, `Calendar`, `LeetCode Tracker`, `Finance`, `Settings` (+12241 more)
...
- **Why does `ActionCodeInfoOperation` connect `_QuickDelayedDragStartListener` to `Windows Ephemeral`, `Constants Google`, `Features Settings`, `addedAt`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `variant` connect `Domain Services` to `Widgets Rounded`, `Models Domain`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `InternalActionCodeInfo` connect `Constants Google` to `_QuickDelayedDragStartListener`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **What connects `Global Inbox`, `Calendar`, `LeetCode Tracker` to the rest of the system?**
  _12247 weakly-connected nodes found - possible documentation gaps or missing edges._
