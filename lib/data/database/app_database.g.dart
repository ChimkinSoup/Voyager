...
class $CalendarEventsTableTable extends CalendarEventsTable
  ...
  late final GeneratedColumn<String> calendarId = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: false,
    defaultValue: const Constant(legacyCalendarId),
  );
  static const VerificationMeta _titleMeta = const VerificationMeta('title');
  @override
  late final GeneratedColumn<String> title = GeneratedColumn<String>(
...
class $SettingsTableTable extends SettingsTable
  ...
  static const VerificationMeta _devShowCacheStatusMeta =
      const VerificationMeta('devShowCacheStatus');
  @override
  late final GeneratedColumn<bool> devShowCacheStatus = GeneratedColumn<bool>(
    'dev_show_cache_status',
    aliasedName,
    false,
    type: DriftSqlType.bool,
    requiredDuringInsert: false,
    defaultConstraints: GeneratedColumn.constraintIsAlways(
      'CHECK ("dev_show_cache_status" IN (0, 1))',
    ),
    defaultValue: const Constant(false),
  );
  static const VerificationMeta _devShowCalendarZoomPrewarmMeta =
      const VerificationMeta('devShowCalendarZoomPrewarm');
  @override
  late final GeneratedColumn<bool> devShowCalendarZoomPrewarm =
      GeneratedColumn<bool>(
        'dev_show_calendar_zoom_prewarm',
        aliasedName,
        false,
        type: DriftSqlType.bool,
        requiredDuringInsert: false,
        defaultConstraints: GeneratedColumn.constraintIsAlways(
          'CHECK ("dev_show_calendar_zoom_prewarm" IN (0, 1))',
        ),
        defaultValue: const Constant(false),
      );
  ...
  static const VerificationMeta _journalEntryListWidthMeta =
      const VerificationMeta('journalEntryListWidth');
  @override
  late final GeneratedColumn<double> journalEntryListWidth =
      GeneratedColumn<double>(
        'journal_entry_list_width',
        aliasedName,
        true,
        type: DriftSqlType.double,
        requiredDuringInsert: false,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('dev_show_cache_status')) {
      context.handle(
        _devShowCacheStatusMeta,
        devShowCacheStatus.isAcceptableOrUnknown(
          data['dev_show_cache_status']!,
          _devShowCacheStatusMeta,
        ),
      );
    }
    if (data.containsKey('dev_show_calendar_zoom_prewarm')) {
      context.handle(
        _devShowCalendarZoomPrewarmMeta,
        devShowCalendarZoomPrewarm.isAcceptableOrUnknown(
          data['dev_show_calendar_zoom_prewarm']!,
          _devShowCalendarZoomPrewarmMeta,
        ),
      );
    }
    ...
    if (data.containsKey('journal_entry_list_width')) {
      context.handle(
  ...
  SettingsTableData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return SettingsTableData(
      ...
      devShowCacheStatus: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}dev_show_cache_status'],
      )!,
      devShowCalendarZoomPrewarm: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
      ...
      journalEntryListWidth: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
...
class SettingsTableData extends DataClass
  ...
  factory SettingsTableData.fromJson(
    ...
    return SettingsTableData(
      ...
      devShowCacheStatus: serializer.fromJson<bool>(json['devShowCacheStatus']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'devShowCacheStatus': serializer.toJson<bool>(devShowCacheStatus),
  ...
  SettingsTableData copyWithCompanion(SettingsTableCompanion data) {
    return SettingsTableData(
      ...
      devShowCacheStatus: data.devShowCacheStatus.present
          ? data.devShowCacheStatus.value
          : this.devShowCacheStatus,
...
class SettingsTableCompanion extends UpdateCompanion<SettingsTableData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (devShowCacheStatus.present) {
      map['dev_show_cache_status'] = Variable<bool>(devShowCacheStatus.value);
    }
    if (devShowCalendarZoomPrewarm.present) {
      map['dev_show_calendar_zoom_prewarm'] = Variable<bool>(
    ...
    if (journalEntryListWidth.present) {
      map['journal_entry_list_width'] = Variable<double>(
        journalEntryListWidth.value,
      );
    }
...
class $PendingUploadsTableTable extends PendingUploadsTable
    with TableInfo<$PendingUploadsTableTable, PendingUploadData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $PendingUploadsTableTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _documentIdMeta = const VerificationMeta(
    'documentId',
  );
  @override
  ...
  @override
  List<GeneratedColumn> get $columns => [documentId, collectionName, addedAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'pending_uploads_table';
  @override
  VerificationContext validateIntegrity(
    Insertable<PendingUploadData> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  @override
  Set<GeneratedColumn> get $primaryKey => {documentId, collectionName};
  @override
  PendingUploadData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  $PendingUploadsTableTable createAlias(String alias) {
    return $PendingUploadsTableTable(attachedDatabase, alias);
  }
}

class PendingUploadData extends DataClass
    implements Insertable<PendingUploadData> {
  final String documentId;
  ...
  PendingUploadsTableCompanion toCompanion(bool nullToAbsent) {
  ...
  factory PendingUploadData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  @override
  String toString() {
    return (StringBuffer('PendingUploadData(')
          ..write('documentId: $documentId, ')
  ...
  @override
  int get hashCode => Object.hash(documentId, collectionName, addedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is PendingUploadData &&
          other.documentId == this.documentId &&
...
class PendingUploadsTableCompanion extends UpdateCompanion<PendingUploadData> {
  ...
  PendingUploadsTableCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       collectionName = Value(collectionName);
  static Insertable<PendingUploadData> custom({
    Expression<String>? documentId,
  ...
  PendingUploadsTableCompanion copyWith({
    Value<String>? documentId,
  ...
  @override
  String toString() {
    return (StringBuffer('PendingUploadsTableCompanion(')
          ..write('documentId: $documentId, ')
          ..write('collectionName: $collectionName, ')
          ..write('addedAt: $addedAt, ')
          ..write('rowid: $rowid')
...
class $$SettingsTableTableFilterComposer
  ...
  ColumnFilters<bool> get devShowCacheStatus => $composableBuilder(
    column: $table.devShowCacheStatus,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<bool> get devShowCalendarZoomPrewarm => $composableBuilder(
...
class $$SettingsTableTableOrderingComposer
  ...
  ColumnOrderings<bool> get devShowCacheStatus => $composableBuilder(
    column: $table.devShowCacheStatus,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<bool> get devShowCalendarZoomPrewarm => $composableBuilder(
    column: $table.devShowCalendarZoomPrewarm,
    builder: (column) => ColumnOrderings(column),
  );
  ...
  ColumnOrderings<double> get journalEntryListWidth => $composableBuilder(
    column: $table.journalEntryListWidth,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$SettingsTableTableAnnotationComposer
  ...
  GeneratedColumn<bool> get devShowCacheStatus => $composableBuilder(
    column: $table.devShowCacheStatus,
    builder: (column) => column,
  );

  GeneratedColumn<bool> get devShowCalendarZoomPrewarm => $composableBuilder(
    column: $table.devShowCalendarZoomPrewarm,
    builder: (column) => column,
  );
  ...
  GeneratedColumn<double> get journalEntryListWidth => $composableBuilder(
    column: $table.journalEntryListWidth,
    builder: (column) => column,
  );
...
typedef $$SyncConflictsTableTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$PendingUploadsTableTableCreateCompanionBuilder =
    PendingUploadsTableCompanion Function({
      required String documentId,
      required String collectionName,
      Value<DateTime> addedAt,
      Value<int> rowid,
...
class $$PendingUploadsTableTableFilterComposer
    extends Composer<_$AppDatabase, $PendingUploadsTableTable> {
  $$PendingUploadsTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$PendingUploadsTableTableOrderingComposer
    extends Composer<_$AppDatabase, $PendingUploadsTableTable> {
  $$PendingUploadsTableTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$PendingUploadsTableTableAnnotationComposer
    extends Composer<_$AppDatabase, $PendingUploadsTableTable> {
  $$PendingUploadsTableTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$PendingUploadsTableTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $PendingUploadsTableTable,
          PendingUploadData,
          $$PendingUploadsTableTableFilterComposer,
          $$PendingUploadsTableTableOrderingComposer,
          $$PendingUploadsTableTableAnnotationComposer,
          $$PendingUploadsTableTableCreateCompanionBuilder,
          $$PendingUploadsTableTableUpdateCompanionBuilder,
          (
            PendingUploadData,
            BaseReferences<
              _$AppDatabase,
          ...
          PrefetchHooks Function()
        > {
  $$PendingUploadsTableTableTableManager(
    _$AppDatabase db,
    $PendingUploadsTableTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$PendingUploadsTableTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$PendingUploadsTableTableOrderingComposer(
                $db: db,
                $table: table,
...
typedef $$PendingUploadsTableTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $PendingUploadsTableTable,
      PendingUploadData,
